...
const EXCLUDED_PACKAGES = ['@devextreme/angular', '@playgrounds/angular', '@devextreme/styles', '@devextreme/ui-core'];
...
for (const packageDirectory of packageDirectories) {
  if (existsSync(pathJoin(packageDirectory, ConfigFilename.PACKAGE))) {
