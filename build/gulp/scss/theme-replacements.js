...
module.exports = {
    ...
    'gridBase': [
        ...
        { regex: /@mixin dx-icon\((equal|close)\),/g, replacement: '@include dx-icon($1);' },
        { regex: /\.dx-icon-sizing\((14px|\$GENERIC_COMMAND_EDIT_ICON_SIZE)\),/g, replacement: '@include dx-icon-sizing($1);' },
        { regex: /@mixin dx-icon-sizing\((\$MATERIAL_GRID_BASE_HEADER_ICON_SIZE|\$MATERIAL_COMMAND_EDIT_ICON_SIZE)\),/g, replacement: '@include dx-icon-sizing($1);' },
        ...
        { regex: /(px|LINE_HEIGHT|FONT_SIZE|inherit|relative|alternation-bg|middle|\$GENERIC_GRID_BASE_CELL_PADDING|\$GENERIC_COMMAND_EDIT_ICON_MARGIN|\$MATERIAL_COMMAND_EDIT_ICON_MARGIN),/g, replacement: '$1;' },
