...
export const dependencies: FlatStylesDependencies = {
  ...
  diagram: ['loadindicator', 'validation', 'button', 'popup', 'loadpanel', 'scrollview', 'toolbar', 'textbox', 'contextmenu', 'list', 'checkbox', 'selectbox', 'numberbox', 'colorbox', 'popover', 'accordion', 'tooltip', 'multiview', 'tabs', 'tabpanel', 'progressbar', 'fileuploader'],
