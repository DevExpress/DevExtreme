...
export const dependencies: FlatStylesDependencies = {
  ...
  gallery: [],
  toolbar: ['validation', 'button', 'loadindicator', 'loadpanel', 'scrollview', 'popup', 'popover'],
  ...
  treelist: ['loadindicator', 'loadpanel', 'validation', 'button', 'textbox', 'contextmenu', 'scrollview', 'popup', 'popover', 'toolbar'],
