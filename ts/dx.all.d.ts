...
declare module DevExpress.ui {
    ...
    export interface dxDiagramOptions extends WidgetOptions<dxDiagram> {
        ...
        /** @name dxDiagram.Options.editingSettings */
        editingSettings?: { allowAddShape?: boolean, allowAddShapeFromToolbox?: boolean, allowChangeConnection?: boolean, allowChangeConnectorPoints?: boolean, allowChangeConnectorText?: boolean, allowChangeShapeText?: boolean, allowDeleteConnector?: boolean, allowDeleteShape?: boolean, allowResizeShape?: boolean };
    ...
    export interface dxDiagramAddShapeArgs {
        /** @name dxDiagramAddShapeArgs.position */
        position?: any;
        /** @name dxDiagramAddShapeArgs.shape */
        shape?: dxDiagramShape;
    }
    /** @name dxDiagramAddShapeFromToolboxArgs */
    export interface dxDiagramAddShapeFromToolboxArgs {
        /** @name dxDiagramAddShapeFromToolboxArgs.shapeType */
    ...
    export interface dxDiagramBeforeChangeConnectorTextArgs {
        /** @name dxDiagramBeforeChangeConnectorTextArgs.connector */
        connector?: dxDiagramConnector;
        /** @name dxDiagramBeforeChangeConnectorTextArgs.index */
        index?: number;
    }
    /** @name dxDiagramBeforeChangeShapeTextArgs */
    export interface dxDiagramBeforeChangeShapeTextArgs {
        /** @name dxDiagramBeforeChangeShapeTextArgs.shape */
        shape?: dxDiagramShape;
    }
    /** @name dxDiagramChangeConnectionArgs */
    export interface dxDiagramChangeConnectionArgs {
        /** @name dxDiagramChangeConnectionArgs.connectionPointIndex */
        connectionPointIndex?: number;
        /** @name dxDiagramChangeConnectionArgs.connector */
        connector?: dxDiagramConnector;
        /** @name dxDiagramChangeConnectionArgs.connectorPosition */
        connectorPosition?: 'start' | 'end';
        /** @name dxDiagramChangeConnectionArgs.shape */
        shape?: dxDiagramShape;
    }
    /** @name dxDiagramChangeConnectorPointsArgs */
    export interface dxDiagramChangeConnectorPointsArgs {
        /** @name dxDiagramChangeConnectorPointsArgs.connector */
        connector?: dxDiagramConnector;
        /** @name dxDiagramChangeConnectorPointsArgs.newPoints */
        newPoints?: Array<any>;
        /** @name dxDiagramChangeConnectorPointsArgs.oldPoints */
        oldPoints?: Array<any>;
    }
    /** @name dxDiagramChangeConnectorTextArgs */
    export interface dxDiagramChangeConnectorTextArgs {
        /** @name dxDiagramChangeConnectorTextArgs.connector */
        connector?: dxDiagramConnector;
        /** @name dxDiagramChangeConnectorTextArgs.index */
        index?: number;
        /** @name dxDiagramChangeConnectorTextArgs.text */
        text?: string;
    }
    /** @name dxDiagramChangeShapeTextArgs */
    export interface dxDiagramChangeShapeTextArgs {
        /** @name dxDiagramChangeShapeTextArgs.shape */
        shape?: dxDiagramShape;
        /** @name dxDiagramChangeShapeTextArgs.text */
        text?: string;
    }
    ...
    export interface dxDiagramDeleteConnectorArgs {
        /** @name dxDiagramDeleteConnectorArgs.connector */
        connector?: dxDiagramConnector;
    }
    /** @name dxDiagramDeleteShapeArgs */
    export interface dxDiagramDeleteShapeArgs {
        /** @name dxDiagramDeleteShapeArgs.shape */
        shape?: dxDiagramShape;
    }
    /** @name dxDiagramItem */
    ...
    export interface dxDiagramResizeShapeArgs {
        /** @name dxDiagramResizeShapeArgs.newSize */
        newSize?: Array<any>;
        /** @name dxDiagramResizeShapeArgs.oldSize */
        oldSize?: Array<any>;
        /** @name dxDiagramResizeShapeArgs.shape */
        shape?: dxDiagramShape;
    }
    /** @name dxDiagramShape */
    ...
    export interface dxFileUploaderOptions extends EditorOptions<dxFileUploader> {
        ...
        /** @name dxFileUploader.Options.uploadAbortedMessage */
    ...
    export class dxFileUploader extends Editor {
        ...
        /** @name dxFileUploader.abortUpload() */
        abortUpload(): void;
        /** @name dxFileUploader.abortUpload(file) */
        abortUpload(file: File): void;
        /** @name dxFileUploader.abortUpload(fileIndex) */
    ...
    export interface dxGanttOptions extends WidgetOptions<dxGantt> {
        ...
        /** @name dxGantt.Options.onTaskClick */
        ...
        /** @name dxGantt.Options.onTaskDblClick */
        ...
        /** @name dxGantt.Options.taskTooltipContentTemplate */
    ...
    export interface dxGanttContextMenu {
        /** @name dxGanttContextMenu.enabled */
        enabled?: boolean;
        /** @name dxGanttContextMenu.items */
    ...
    export interface dxGanttContextMenuItem extends dxContextMenuItem {
        /** @name dxGanttContextMenuItem.name */
    ...
    export class dxHtmlEditor extends Editor {
        ...
        getLength(): number;
        /** @name dxHtmlEditor.getModule(moduleName) */
