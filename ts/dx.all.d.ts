...
declare module DevExpress {
    ...
    export interface globalConfig {
        ...
        floatingActionButtonConfig?: { closeIcon?: string, icon?: string, maxSpeedDialCount?: number, position?: 'bottom' | 'center' | 'left' | 'left bottom' | 'left top' | 'right' | 'right bottom' | 'right top' | 'top' | positionConfig | Function };
