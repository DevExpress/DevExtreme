...
declare module DevExpress {
    ...
    export class Component {
        ...
        instance(): this;
        /**
         * <-EventsMixin.off(eventName)->
         */
        off(eventName: string): this;
        /**
         * <-EventsMixin.off(eventName, eventHandler)->
         */
        off(eventName: string, eventHandler: Function): this;
        /**
         * <-EventsMixin.on(eventName, eventHandler)->
         */
        on(eventName: string, eventHandler: Function): this;
        /**
         * <-EventsMixin.on(events)->
         */
        on(events: any): this;
        /**
         * <-Component.option()->
...
declare module DevExpress.fileProvider {
    ...
    /**
     * <-ArrayFileProvider.Options->
     */
    export interface ArrayFileProviderOptions extends FileProviderOptions<ArrayFileProvider> {
        /**
         * <-ArrayFileProvider.Options.data->
         */
        data?: Array<any>;
        /**
         * <-ArrayFileProvider.Options.itemsExpr->
         */
        itemsExpr?: string | Function;
    }
    /**
    ...
    /**
     * <-CustomFileProvider.Options->
     */
    export interface CustomFileProviderOptions extends FileProviderOptions<CustomFileProvider> {
        /**
         * <-CustomFileProvider.Options.abortFileUpload->
         */
        abortFileUpload?: Function;
        /**
         * <-CustomFileProvider.Options.copyItem->
         */
        copyItem?: Function;
        /**
         * <-CustomFileProvider.Options.createDirectory->
         */
        createDirectory?: Function;
        /**
         * <-CustomFileProvider.Options.deleteItem->
         */
        deleteItem?: Function;
        /**
         * <-CustomFileProvider.Options.downloadItems->
         */
        downloadItems?: Function;
        /**
         * <-CustomFileProvider.Options.getItems->
         */
        getItems?: Function;
        /**
         * <-CustomFileProvider.Options.getItemsContent->
         */
        getItemsContent?: Function;
        /**
         * <-CustomFileProvider.Options.hasSubDirectoriesExpr->
         */
        hasSubDirectoriesExpr?: string | Function;
        /**
         * <-CustomFileProvider.Options.moveItem->
         */
        moveItem?: Function;
        /**
         * <-CustomFileProvider.Options.renameItem->
         */
        renameItem?: Function;
        /**
         * <-CustomFileProvider.Options.uploadChunkSize->
         */
        uploadChunkSize?: number;
        /**
         * <-CustomFileProvider.Options.uploadFileChunk->
         */
    ...
    export interface FileProviderOptions<T = FileProvider> {
        /**
         * <-FileProvider.Options.dateModifiedExpr->
         */
        dateModifiedExpr?: string | Function;
        /**
         * <-FileProvider.Options.isDirectoryExpr->
         */
        isDirectoryExpr?: string | Function;
        /**
         * <-FileProvider.Options.keyExpr->
         */
        keyExpr?: string | Function;
        /**
         * <-FileProvider.Options.nameExpr->
         */
        nameExpr?: string | Function;
        /**
         * <-FileProvider.Options.sizeExpr->
         */
        sizeExpr?: string | Function;
        /**
         * <-FileProvider.Options.thumbnailExpr->
         */
...
declare module DevExpress.ui {
    ...
    export interface dxButtonGroupOptions extends WidgetOptions<dxButtonGroup> {
        ...
        hoverStateEnabled?: boolean;
        /**
         * <-dxButtonGroup.Options.itemTemplate->
         * @deprecated <-dxButtonGroup.Options.itemTemplate:depNote->
         */
    ...
    export class dxDataGrid extends GridBase {
        ...
        /**
         * <-dxDataGrid.insertRow()->
         * @deprecated <-dxDataGrid.insertRow():depNote->
         */
        insertRow(): void;
        /**
        ...
        isRowSelected(key: any): boolean;
        /**
         * <-dxDataGrid.removeRow(rowIndex)->
         * @deprecated <-dxDataGrid.removeRow(rowIndex):depNote->
         */
    ...
    export interface dxDateBoxOptions extends dxDropDownEditorOptions<dxDateBox> {
        ...
        max?: Date | number | string;
        /**
         * <-dxDateBox.Options.maxZoomLevel->
         * @deprecated <-dxDateBox.Options.maxZoomLevel:depNote->
         */
        maxZoomLevel?: 'century' | 'decade' | 'month' | 'year';
        /**
        ...
        min?: Date | number | string;
        /**
         * <-dxDateBox.Options.minZoomLevel->
         * @deprecated <-dxDateBox.Options.minZoomLevel:depNote->
         */
        minZoomLevel?: 'century' | 'decade' | 'month' | 'year';
        /**
    ...
    export interface dxDiagramOptions extends WidgetOptions<dxDiagram> {
        ...
        /**
         * <-dxDiagram.Options.onDataChanged->
         */
    ...
    export interface dxDropDownBoxOptions extends DataExpressionMixinOptions<dxDropDownBox>, dxDropDownEditorOptions<dxDropDownBox> {
        ...
        /**
         * <-dxDropDownBox.Options.dropDownOptions->
         */
    ...
    export interface dxFileManagerOptions extends WidgetOptions<dxFileManager> {
        ...
        /**
         * <-dxFileManager.Options.fileProvider->
         */
        fileProvider?: any;
        /**
    ...
    export interface dxFormButtonItem {
        /**
         * <-dxFormButtonItem.alignment->
         * @deprecated <-dxFormButtonItem.alignment:depNote->
         */
    ...
    export interface dxListOptions extends CollectionWidgetOptions<dxList>, SearchBoxMixinOptions<dxList> {
        ...
        /**
         * <-dxList.Options.allowItemReordering->
         * @deprecated <-dxList.Options.allowItemReordering:depNote->
         */
    ...
    export interface dxSchedulerOptions extends WidgetOptions<dxScheduler> {
        ...
        /**
         * <-dxScheduler.Options.onAppointmentFormCreated->
         * @deprecated <-dxScheduler.Options.onAppointmentFormCreated:depNote->
         */
    ...
    export interface dxSwitchOptions extends EditorOptions<dxSwitch> {
        ...
        name?: string;
        /**
         * <-dxSwitch.Options.offText->
         * @deprecated <-dxSwitch.Options.offText:depNote->
         */
        offText?: string;
        /**
         * <-dxSwitch.Options.onText->
         * @deprecated <-dxSwitch.Options.onText:depNote->
         */
        onText?: string;
        /**
    ...
    export class dxTreeList extends GridBase {
        ...
        /**
         * <-dxTreeList.getSelectedRowKeys(leavesOnly)->
         * @deprecated <-dxTreeList.getSelectedRowKeys(leavesOnly):depNote->
         */
...
declare module DevExpress.viz {
    ...
    export interface dxChartOptions extends BaseChartOptions<dxChart> {
        ...
        /**
         * <-dxChart.Options.barWidth->
         * @deprecated <-dxChart.Options.barWidth:depNote->
         */
        barWidth?: number;
        /**
        ...
        defaultPane?: string;
        /**
         * <-dxChart.Options.equalBarWidth->
         * @deprecated <-dxChart.Options.equalBarWidth:depNote->
         */
        ...
        /**
         * <-dxChart.Options.scrollingMode->
         * @deprecated <-dxChart.Options.scrollingMode:depNote->
         */
        ...
        /**
         * <-dxChart.Options.useAggregation->
         * @deprecated <-dxChart.Options.useAggregation:depNote->
         */
        ...
        /**
         * <-dxChart.Options.zoomingMode->
         * @deprecated <-dxChart.Options.zoomingMode:depNote->
         */
    ...
    export interface dxChartArgumentAxis extends dxChartCommonAxisSettings {
        ...
        /**
         * <-dxChart.Options.argumentAxis.max->
         * @deprecated <-dxChart.Options.argumentAxis.max:depNote->
         */
        max?: number | Date | string;
        /**
         * <-dxChart.Options.argumentAxis.min->
         * @deprecated <-dxChart.Options.argumentAxis.min:depNote->
         */
    ...
    export interface dxChartValueAxis extends dxChartCommonAxisSettings {
        ...
        logarithmBase?: number;
        /**
         * <-dxChart.Options.valueAxis.max->
         * @deprecated <-dxChart.Options.valueAxis.max:depNote->
         */
        max?: number | Date | string;
        /**
        ...
        /**
         * <-dxChart.Options.valueAxis.min->
         * @deprecated <-dxChart.Options.valueAxis.min:depNote->
         */
        min?: number | Date | string;
        /**
    ...
    export interface dxChartCommonAnnotationConfig {
        /**
         * <-dxChartCommonAnnotationConfig.allowDragging->
         */
        allowDragging?: boolean;
        /**
         * <-dxChartCommonAnnotationConfig.argument->
         */
        argument?: number | Date | string;
        /**
         * <-dxChartCommonAnnotationConfig.arrowLength->
         */
        arrowLength?: number;
        /**
         * <-dxChartCommonAnnotationConfig.arrowWidth->
         */
        arrowWidth?: number;
        /**
        ...
        axis?: string;
        /**
         * <-dxChartCommonAnnotationConfig.border->
         */
        border?: { color?: string, cornerRadius?: number, dashStyle?: 'dash' | 'dot' | 'longDash' | 'solid', opacity?: number, visible?: boolean, width?: number };
        /**
         * <-dxChartCommonAnnotationConfig.color->
         */
        color?: string;
        /**
        ...
        /**
         * <-dxChartCommonAnnotationConfig.data->
         */
        data?: any;
        /**
         * <-dxChartCommonAnnotationConfig.description->
         */
        description?: string;
        /**
         * <-dxChartCommonAnnotationConfig.font->
         */
        font?: Font;
        /**
         * <-dxChartCommonAnnotationConfig.height->
         */
        height?: number;
        /**
         * <-dxChartCommonAnnotationConfig.image->
         */
        image?: string | { height?: number, url?: string, width?: number };
        /**
         * <-dxChartCommonAnnotationConfig.offsetX->
         */
        offsetX?: number;
        /**
         * <-dxChartCommonAnnotationConfig.offsetY->
         */
        offsetY?: number;
        /**
         * <-dxChartCommonAnnotationConfig.opacity->
         */
        opacity?: number;
        /**
         * <-dxChartCommonAnnotationConfig.paddingLeftRight->
         */
        paddingLeftRight?: number;
        /**
         * <-dxChartCommonAnnotationConfig.paddingTopBottom->
         */
        paddingTopBottom?: number;
        /**
         * <-dxChartCommonAnnotationConfig.series->
         */
        series?: string;
        /**
         * <-dxChartCommonAnnotationConfig.shadow->
         */
        shadow?: { blur?: number, color?: string, offsetX?: number, offsetY?: number, opacity?: number };
        /**
        ...
        /**
         * <-dxChartCommonAnnotationConfig.text->
         */
        text?: string;
        /**
         * <-dxChartCommonAnnotationConfig.textOverflow->
         */
        textOverflow?: 'ellipsis' | 'hide' | 'none';
        /**
         * <-dxChartCommonAnnotationConfig.tooltipEnabled->
         */
        ...
        /**
         * <-dxChartCommonAnnotationConfig.type->
         */
        type?: 'text' | 'image' | 'custom';
        /**
         * <-dxChartCommonAnnotationConfig.value->
         */
        value?: number | Date | string;
        /**
         * <-dxChartCommonAnnotationConfig.width->
         */
        width?: number;
        /**
         * <-dxChartCommonAnnotationConfig.wordWrap->
         */
        wordWrap?: 'normal' | 'breakWord' | 'none';
        /**
         * <-dxChartCommonAnnotationConfig.x->
         */
        x?: number;
        /**
         * <-dxChartCommonAnnotationConfig.y->
         */
        y?: number;
    }
    /**
    ...
    export interface dxPolarChartOptions extends BaseChartOptions<dxPolarChart> {
        ...
        barGroupWidth?: number;
        /**
         * <-dxPolarChart.Options.barWidth->
         * @deprecated <-dxPolarChart.Options.barWidth:depNote->
         */
        barWidth?: number;
        /**
        ...
        /**
         * <-dxPolarChart.Options.equalBarWidth->
         * @deprecated <-dxPolarChart.Options.equalBarWidth:depNote->
         */
        equalBarWidth?: boolean;
        /**
    ...
    export interface dxTreeMapOptions extends BaseWidgetOptions<dxTreeMap> {
        ...
        parentField?: string;
        /**
         * <-dxTreeMap.Options.resolveLabelOverflow->
         * @deprecated <-dxTreeMap.Options.resolveLabelOverflow:depNote->
         */
