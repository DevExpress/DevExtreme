...
test.describe.skip('Grouping API - calculateGroupValue runtime changes', () => {
  ...
  test.skip('One group: should expand grouped section after calculateGroupValue reset to null', async ({ page }) => {
