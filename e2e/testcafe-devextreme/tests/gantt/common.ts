...
test.meta({ unstable: true })('Gantt - show resources button should not have focus state (T1264485)', async (t) => {
...
test.meta({ unstable: true })('Gantt - show dependencies button should not have focus state (T1264485)', async (t) => {
  const { takeScreenshot, compareResults } = createScreenshotsComparer(t);
  await t
    .click(Selector(TOOLBAR_ITEM_BUTTON));
