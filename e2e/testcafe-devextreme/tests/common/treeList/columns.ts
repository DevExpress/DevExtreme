...
test('CheckBox position with double rows columns', async (t) => {
  ...
  await testScreenshot(t, takeScreenshot, 'T1054312', { element: treeList.getHeaders().element });
...
test('Correct display border to last column', async (t) => {
  ...
  await testScreenshot(t, takeScreenshot, 'T1053931', { element: treeList.getHeaders().element });
