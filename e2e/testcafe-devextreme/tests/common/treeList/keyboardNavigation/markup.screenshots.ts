...
test('Focused cells should look correctly', async (t) => {
  ...
  await t.click(headerCellToFocus.element)
    .pressKey('tab');
  await testScreenshot(t, takeScreenshot, 'tree-list_keyboard-navigation-header-cell-focused.png', { element: treeList.element });

  await t.click(dataCellToFocus.element)
    .pressKey('tab');
  await testScreenshot(t, takeScreenshot, 'tree_list_keyboard-navigation-data-cell-focused.png', { element: treeList.element });
...
test('Focused custom buttons should look correctly', async (t) => {
  ...
  await t.click(headerCellToFocus.element)
    .pressKey('tab');
  await testScreenshot(t, takeScreenshot, 'tree-list_keyboard-navigation-custom-buttons-header-cell-focused.png', { element: treeList.element });

  await t.pressKey('tab');
  await testScreenshot(t, takeScreenshot, 'tree-list_keyboard-navigation-custom-button-focused.png', { element: treeList.element });
