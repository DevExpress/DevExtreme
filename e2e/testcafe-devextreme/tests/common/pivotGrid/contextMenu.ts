...
test.meta({ themes: [Themes.genericLight] })('ContextMenu width should be adjusted to the width of the item text (T1106236)', async (t) => {
  ...
  await testScreenshot(t, takeScreenshot, 'PivotGrid contextmenu width.png');
