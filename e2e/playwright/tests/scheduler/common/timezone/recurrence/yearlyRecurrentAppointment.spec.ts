...
test('Should correctly display the recurrent yearly appointment if start date lower than recurrent date with the same timezone', async ({ page }) => {
  const appointmentTimezone = 'Etc/GMT+1';
  const schedulerTimezone = 'Etc/GMT+1';
...
test('Should correctly display the recurrent yearly appointment if start date lower than recurrent date with a greater time timezone', async ({ page }) => {
  const appointmentTimezone = 'Etc/GMT+10';
  const schedulerTimezone = 'Etc/GMT-2';
...
test('Should correctly display the recurrent yearly appointment if start date lower than recurrent date with a lower time timezone', async ({ page }) => {
  const appointmentTimezone = 'Etc/GMT-2';
  const schedulerTimezone = 'Etc/GMT+10';
...
test('Should correctly display the recurrent yearly appointment at first date if start date greater than recurrent date with the same timezone', async ({ page }) => {
  const appointmentTimezone = 'Etc/GMT+1';
  const schedulerTimezone = 'Etc/GMT+1';
...
test('Should correctly display the recurrent yearly appointment at next date if start date greater than recurrent date with the same timezone', async ({ page }) => {
  const appointmentTimezone = 'Etc/GMT+1';
  const schedulerTimezone = 'Etc/GMT+1';
...
test('Should correctly display the recurrent yearly appointment at first date if start date greater than recurrent date with a greater time timezone', async ({ page }) => {
  const appointmentTimezone = 'Etc/GMT+10';
  const schedulerTimezone = 'Etc/GMT-2';
...
test('Should correctly display the recurrent yearly appointment at next date if start date greater than recurrent date with a greater time timezone', async ({ page }) => {
  const appointmentTimezone = 'Etc/GMT+10';
  const schedulerTimezone = 'Etc/GMT-2';
...
test('Should correctly display the recurrent yearly appointment at first date if start date greater than recurrent date with a lower time timezone', async ({ page }) => {
  const appointmentTimezone = 'Etc/GMT-2';
  const schedulerTimezone = 'Etc/GMT+10';
...
test('Should correctly display the recurrent yearly appointment at next date if start date greater than recurrent date with a lower time timezone', async ({ page }) => {
  const appointmentTimezone = 'Etc/GMT-2';
  const schedulerTimezone = 'Etc/GMT+10';
