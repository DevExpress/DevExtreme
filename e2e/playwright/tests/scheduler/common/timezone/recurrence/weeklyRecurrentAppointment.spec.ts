...
test('Should correctly display the recurrent (one day at week) appointment with the same timezone', async ({ page }) => {
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'one-appointment__same-timezone');
});
...
test('Should correctly display the recurrent (one day at week) morning appointment with the same timezone', async ({ page }) => {
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'one-morning-appointment__same-timezone');
});
...
test('Should correctly display the recurrent (one day at week) evening appointment with the same timezone', async ({ page }) => {
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'one-evening-appointment__same-timezone');
});

test('Should correctly display the recurrent (one day at week) appointment with a greater time timezone and day shift to the next day', async ({ page }) => {
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'one-appointment__day-shift__greater-timezone');
});
...
test('Should correctly display the recurrent (one day at week) appointment with a lower timezone and day shift to the previous day', async ({ page }) => {
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'one-appointment__day-shift__lower-timezone');
});
...
test('Should correctly display the recurrent (one day at week) appointment with timezone week shift to the previous week', async ({ page }) => {
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'one-appointment__week-shift__lower-timezone');
});
...
test('Should correctly display the recurrent (one day at week) appointment with timezone week shift to the next week', async ({ page }) => {
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'one-appointment__week-shift__greater-timezone');
});

test('Should correctly display the recurrent (one day at week) appointment with timezone view period shift to the next view period at the first week', async ({ page }) => {
  const appointmentTimezone = 'Etc/GMT+10';
  const schedulerTimezone = 'Etc/GMT-10';
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'one-appointment__next-view-shift__first-week');
});

test('Should correctly display the recurrent (one day at week) appointment with timezone view period shift to the next view period at the second week', async ({ page }) => {
  const appointmentTimezone = 'Etc/GMT+10';
  const schedulerTimezone = 'Etc/GMT-10';
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'one-appointment__next-view-shift__second-week');
});

test('Should correctly display the recurrent (one day at week) appointment with timezone view period shift to the previous view period at the first week', async ({ page }) => {
  const appointmentTimezone = 'Etc/GMT-10';
  const schedulerTimezone = 'Etc/GMT+10';
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'one-appointment__previous-view-shift__first-week');
});

test('Should correctly display the recurrent (one day at week) appointment with timezone view period shift to the previous view period at the second week', async ({ page }) => {
  const appointmentTimezone = 'Etc/GMT-10';
  const schedulerTimezone = 'Etc/GMT+10';
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'one-appointment__previous-view-shift__before-week');
});
...
test('Should correctly display recurrent appointment with multiple day in week on the first week in same timezone', async ({ page }) => {
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'multiple-appointment__first-week__same-timezone');
});
...
test('Should correctly display recurrent appointment with multiple day in week on the second week in same timezone', async ({ page }) => {
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'multiple-appointment__second-week__same-timezone');
});
...
test('Should correctly display recurrent appointment with multiple day in week on the first week in a greater time timezone', async ({ page }) => {
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'multiple-appointment__first-week__greater-timezone');
});
...
test('Should correctly display recurrent appointment with multiple day in week on the second week in a greater time timezone', async ({ page }) => {
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'multiple-appointment__second-week__greater-timezone');
});
...
test('Should correctly display recurrent appointment with multiple day in week on the first week in a lower time timezone', async ({ page }) => {
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'multiple-appointment__first-week__lower-timezone');
});
...
test('Should correctly display recurrent appointment with multiple day in week on the second week in a lower time timezone', async ({ page }) => {
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'multiple-appointment__second-week__lower-timezone');
});

// === maximum timezone offset tests section ===

test('Should correctly display recurrent appointment with multiple day in week on the first week with maximum positive timezone offset', async ({ page }) => {
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'one-appointment__first-week__max-positive-timezone-offset');
});

test('Should correctly display recurrent appointment with multiple day in week on the second week with maximum positive timezone offset', async ({ page }) => {
  const appointmentTimezone = 'Etc/GMT+12';
  const timezone = 'Etc/GMT-14';
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'one-appointment__second-week__max-positive-timezone-offset');
});

test('Should correctly display recurrent appointment with multiple day in week on the first week with maximum negative timezone offset', async ({ page }) => {
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'one-appointment__first-week__max-negative-timezone-offset');
});

test('Should correctly display recurrent appointment with multiple day in week on the second week with maximum negative timezone offset', async ({ page }) => {
  const appointmentTimezone = 'Etc/GMT-14';
  const timezone = 'Etc/GMT+12';
  ...
  await screenshotTestFunc(page, SCREENSHOT_BASE_NAME, 'one-appointment__second-week__max-negative-timezone-offset');
});
