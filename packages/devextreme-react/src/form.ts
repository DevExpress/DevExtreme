...
type IGroupItemProps = React.PropsWithChildren<{
  ...
  itemType?: "empty" | "group" | "simple" | "tabbed" | "button";
  name?: string;
  template?: ((data: { component: dxForm, formData: Record<string, any> }, itemElement: any) => string) | template;
  visible?: boolean;
  visibleIndex?: number;
  render?: (...params: any) => React.ReactNode;
  component?: React.ComponentType<any>;
...
type ITabPanelOptionsProps = React.PropsWithChildren<{
  ...
  itemTitleTemplate?: ((itemData: any, itemIndex: number, itemElement: any) => string) | template;
  loop?: boolean;
  noDataText?: string;
