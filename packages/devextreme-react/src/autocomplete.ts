...
const Autocomplete = memo(
  forwardRef(
    (props: React.PropsWithChildren<IAutocompleteOptions>, ref: ForwardedRef<AutocompleteRef>) => {
      ...
      return (
        React.createElement(BaseComponent<React.PropsWithChildren<IAutocompleteOptions>>, {
...
) as (props: React.PropsWithChildren<IAutocompleteOptions> & { ref?: Ref<AutocompleteRef> }) => ReactElement | null;
...
type IDropDownOptionsProps = React.PropsWithChildren<{
  ...
  onContentReady?: ((e: EventInfo<any>) => void) | null;
  ...
  onResize?: ((e: { component: dxPopup, element: any, event: event, height: number, model: any, width: number }) => void) | null;
  onResizeEnd?: ((e: { component: dxPopup, element: any, event: event, height: number, model: any, width: number }) => void) | null;
  onResizeStart?: ((e: { component: dxPopup, element: any, event: event, height: number, model: any, width: number }) => void) | null;
  onShowing?: ((e: { cancel: boolean | any, component: dxOverlay<any>, element: any, model: any }) => void);
  onShown?: ((e: EventInfo<any>) => void);
  onTitleRendered?: ((e: { component: dxPopup, element: any, model: any, titleElement: any }) => void) | null;
