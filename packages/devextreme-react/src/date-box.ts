...
import type { ContentReadyEvent as PopupContentReadyEvent, DisposingEvent as PopupDisposingEvent, InitializedEvent as PopupInitializedEvent, OptionChangedEvent as PopupOptionChangedEvent, HiddenEvent, HidingEvent, ResizeEvent, ResizeEndEvent, ResizeStartEvent, ShowingEvent, ShownEvent, TitleRenderedEvent, dxPopupToolbarItem } from "devextreme/ui/popup";
...
type IDropDownOptionsProps = React.PropsWithChildren<{
  ...
  onOptionChanged?: ((e: PopupOptionChangedEvent) => void);
