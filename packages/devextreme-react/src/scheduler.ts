...
type IViewProps = React.PropsWithChildren<{
  ...
  appointmentCollectorTemplate?: ((model: AppointmentCollectorTemplateData | { appointmentCount: number, isCompact: boolean, items: Record<string, any> }, collectorElement: any) => string | any) | template;
