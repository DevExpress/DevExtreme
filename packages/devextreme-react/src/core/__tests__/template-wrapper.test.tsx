...
describe('Template Wrapper', () => {
  ...
  it('adds hidden node', () => {
    ...
    expect(document.querySelector('.template-container')?.outerHTML)
      .toBe('<div class="template-container"><div style="display: none;"></div><div class="template-element">My template - 1</div><div style="display: none;"></div></div>');
  });
  ...
  it('chooses hidden node element type correctly', () => {
    ...
    expect(document.querySelector('.div-container')?.outerHTML)
      .toBe('<div class="div-container"><div style="display: none;"></div><div class="template-element">My template - 1</div><div style="display: none;"></div></div>');
    expect(document.querySelector('.table-container')?.outerHTML)
      .toBe('<table class="table-container"><tbody style="display: none;"></tbody><tbody class="tbody-template-element"><tr><td>My template - 1</td></tr></tbody><tbody style="display: none;"></tbody></table>');
    expect(document.querySelector('.tbody-container')?.outerHTML)
      .toBe('<tbody class="tbody-container"><tr style="display: none;"></tr><tr class="tr-template-element"><td>My template - 1</td></tr><tr style="display: none;"></tr></tbody>');
  });
  ...
  it('adds removal listener for text templates', () => {
    ...
    expect(document.querySelector('.template-container')?.outerHTML)
      .toBe('<div class="template-container"><div style="display: none;"></div>My template - 1<div style="display: none;"></div><span style="display: none;"></span></div>');
  });
