...
function testTemplateOption(testedOption: string) {
  ...
  it('renders with text node inside component', () => {
    ...
    expect(screen.getByText('Text')?.outerHTML)
      .toBe('<div>Text<div><div>Template</div><div style="display: none;" class="__dx_react_guard_node__"></div></div></div>');
  });
  ...
  it('renders template removeEvent listener', () => {
    ...
    expect((container.firstChild?.firstChild as HTMLDivElement).outerHTML)
      .toContain('<div>Template with data<div style="display: none;" class="__dx_react_guard_node__"></div><span style="display: none;" class=""></span></div>');
  });
  ...
  it('does not render template removeEvent listener', () => {
    ...
    expect(table.innerHTML)
      .toBe('<tbody><tr><td>Template with data</td></tr></tbody><tbody style="display: none;" class="__dx_react_guard_node__"></tbody>');
  });
  ...
  it('render invisible element as tr tag', () => {
    ...
    expect(table.innerHTML)
      .toBe('<tr><td>Template with data</td></tr><tr style="display: none;" class="__dx_react_guard_node__"></tr>');
  });
