...
describe('DxDataGrid', () => {
  ...
  it('should update template with dynamic name', () => {
    ...
    TestBed.configureTestingModule({
      declarations: [TestGridComponent],
      imports: [DxDataGridComponent, DxiDataGridColumnComponent, DxoDataGridSortingComponent, DxTemplateDirective],
    });
...
describe('Nested DxDataGrid', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule(
      {
        declarations: [TestContainerComponent],
        imports: [DxDataGridComponent, DxiDataGridColumnComponent, DxoDataGridScrollingComponent, DxTemplateDirective],
      },
    );
