        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoTreeListTreeListHeaderFilterSearchComponent) => ({
                propertyName: 'search',
                className: 'DxoTreeListTreeListHeaderFilterSearchComponent',
                component
            }),
            deps: [DxoTreeListTreeListHeaderFilterSearchComponent],
         }
         ]
})
