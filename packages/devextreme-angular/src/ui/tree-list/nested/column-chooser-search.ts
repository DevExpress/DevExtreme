        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoTreeListColumnChooserSearchComponent) => ({
                propertyName: 'search',
                className: 'DxoTreeListColumnChooserSearchComponent',
                component
            }),
            deps: [DxoTreeListColumnChooserSearchComponent],
         }
         ]
})
