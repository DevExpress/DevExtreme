...
@Component({
    selector: 'dxo-tree-list-send-button-options',
    standalone: true,
    template: '',
    styles: [''],
...
export class DxoTreeListSendButtonOptionsComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  imports: [
    DxoTreeListSendButtonOptionsComponent
  ],
  exports: [
    DxoTreeListSendButtonOptionsComponent
  ],
})
export class DxoTreeListSendButtonOptionsModule { }
