...
@Component({
    selector: 'dxi-tree-list-typing-user',
    template: '',
    styles: [''],
    ...
    providers: [
        NestedOptionHost,
        {
           ...
           useExisting: DxiTreeListTypingUserComponent,
        }
    ]
})
export class DxiTreeListTypingUserComponent extends CollectionNestedOption {
    @Input()
...
@NgModule({
  imports: [
    DxiTreeListTypingUserComponent
  ],
  exports: [
    DxiTreeListTypingUserComponent
  ],
})
export class DxiTreeListTypingUserModule { }
