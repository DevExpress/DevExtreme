        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoTreeListColumnHeaderFilterComponent) => ({
                propertyName: 'headerFilter',
                className: 'DxoTreeListColumnHeaderFilterComponent',
                component
            }),
            deps: [DxoTreeListColumnHeaderFilterComponent],
         }
         ]
})
...
export class DxoTreeListColumnHeaderFilterModule { }
