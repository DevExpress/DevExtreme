...
@Component({
    selector: 'dxo-tree-list-day-header-format',
    standalone: true,
    template: '',
    styles: [''],
...
export class DxoTreeListDayHeaderFormatComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
    get currency(): string {
...
@NgModule({
  imports: [
    DxoTreeListDayHeaderFormatComponent
  ],
  exports: [
    DxoTreeListDayHeaderFormatComponent
  ],
})
export class DxoTreeListDayHeaderFormatModule { }
