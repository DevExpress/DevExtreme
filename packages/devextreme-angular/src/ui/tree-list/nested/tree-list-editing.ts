...
@Component({
    selector: 'dxo-tree-list-tree-list-editing',
    template: '',
    styles: [''],
    imports: [ DxIntegrationModule ],
    providers: [NestedOptionHost]
})
export class DxoTreeListTreeListEditingComponent extends NestedOption implements OnDestroy, OnInit  {
...
@NgModule({
  imports: [
    DxoTreeListTreeListEditingComponent
  ],
  exports: [
    DxoTreeListTreeListEditingComponent
  ],
