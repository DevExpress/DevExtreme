...
@Component({
    selector: 'dxo-tree-list-file-uploader-options',
    standalone: true,
    template: '',
    styles: [''],
...
export class DxoTreeListFileUploaderOptionsComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  imports: [
    DxoTreeListFileUploaderOptionsComponent
  ],
  exports: [
    DxoTreeListFileUploaderOptionsComponent
  ],
})
export class DxoTreeListFileUploaderOptionsModule { }
