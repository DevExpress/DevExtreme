...
@Component({
    selector: 'dxo-hide-tree-list',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoHideTreeListComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoHideTreeListComponent
  ],
  exports: [
    DxoHideTreeListComponent
  ],
})
export class DxoHideTreeListModule { }
