        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoTreeListHideComponent) => ({
                propertyName: 'hide',
                className: 'DxoTreeListHideComponent',
                component
            }),
            deps: [DxoTreeListHideComponent],
         }
         ]
})
export class DxoTreeListHideComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
