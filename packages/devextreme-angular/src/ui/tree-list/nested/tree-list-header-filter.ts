        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoTreeListTreeListHeaderFilterComponent) => ({
                propertyName: 'headerFilter',
                className: 'DxoTreeListTreeListHeaderFilterComponent',
                component
            }),
            deps: [DxoTreeListTreeListHeaderFilterComponent],
         }
         ]
})
