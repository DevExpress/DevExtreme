...
import { DxiTreeListEditorOptionsButtonComponent } from './editor-options-button-dxi';
...
export class DxoTreeListEditorOptionsComponent extends NestedOption implements OnDestroy, OnInit, AfterContentInit  {
    @Input()
    ...
    @ContentChildren(forwardRef(() => DxiTreeListEditorOptionsButtonComponent)) editorOptionsButtonsChildren!: QueryList<DxiTreeListEditorOptionsButtonComponent>
