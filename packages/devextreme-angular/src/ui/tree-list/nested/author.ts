...
@Component({
    selector: 'dxo-tree-list-author',
    template: '',
    styles: [''],
    imports: [ DxIntegrationModule ],
    providers: [NestedOptionHost]
})
export class DxoTreeListAuthorComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  imports: [
    DxoTreeListAuthorComponent
  ],
  exports: [
    DxoTreeListAuthorComponent
  ],
})
export class DxoTreeListAuthorModule { }
