        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoTreeListIconsComponent) => ({
                propertyName: 'icons',
                className: 'DxoTreeListIconsComponent',
                component
            }),
            deps: [DxoTreeListIconsComponent],
         }
         ]
})
export class DxoTreeListIconsComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get fix(): string {
