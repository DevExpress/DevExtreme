...
@Component({
    selector: 'dxo-tree-list-speech-recognition-config',
    template: '',
    styles: [''],
    imports: [ DxIntegrationModule ],
    providers: [NestedOptionHost]
})
export class DxoTreeListSpeechRecognitionConfigComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  imports: [
    DxoTreeListSpeechRecognitionConfigComponent
  ],
  exports: [
    DxoTreeListSpeechRecognitionConfigComponent
  ],
