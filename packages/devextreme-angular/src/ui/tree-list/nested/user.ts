...
@Component({
    selector: 'dxo-tree-list-user',
    template: '',
    styles: [''],
    imports: [ DxIntegrationModule ],
    providers: [NestedOptionHost]
})
export class DxoTreeListUserComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  imports: [
    DxoTreeListUserComponent
  ],
  exports: [
    DxoTreeListUserComponent
  ],
})
export class DxoTreeListUserModule { }
