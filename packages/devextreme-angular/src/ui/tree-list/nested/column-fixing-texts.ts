        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoTreeListColumnFixingTextsComponent) => ({
                propertyName: 'texts',
                className: 'DxoTreeListColumnFixingTextsComponent',
                component
            }),
            deps: [DxoTreeListColumnFixingTextsComponent],
         }
         ]
})
export class DxoTreeListColumnFixingTextsComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get fix(): string {
