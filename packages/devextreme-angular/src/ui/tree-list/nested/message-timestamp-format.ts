...
@Component({
    selector: 'dxo-tree-list-message-timestamp-format',
    standalone: true,
    template: '',
    styles: [''],
...
export class DxoTreeListMessageTimestampFormatComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
    get currency(): string {
...
@NgModule({
  imports: [
    DxoTreeListMessageTimestampFormatComponent
  ],
  exports: [
    DxoTreeListMessageTimestampFormatComponent
  ],
})
export class DxoTreeListMessageTimestampFormatModule { }
