...
@Component({
    selector: 'dxo-tree-list-ai-assistant',
    template: '',
    styles: [''],
    imports: [ DxIntegrationModule ],
    providers: [NestedOptionHost]
})
export class DxoTreeListAIAssistantComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
export class DxoTreeListAIAssistantModule { }
