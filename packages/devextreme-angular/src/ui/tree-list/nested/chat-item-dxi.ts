...
@Component({
    selector: 'dxi-tree-list-chat-item',
    template: '',
    styles: [''],
    ...
    providers: [
        NestedOptionHost,
        {
           ...
           useExisting: DxiTreeListChatItemComponent,
        }
    ]
})
export class DxiTreeListChatItemComponent extends CollectionNestedOption {
...
@NgModule({
  imports: [
    DxiTreeListChatItemComponent
  ],
  exports: [
    DxiTreeListChatItemComponent
  ],
})
export class DxiTreeListChatItemModule { }
