        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoTreeListColumnHeaderFilterSearchComponent) => ({
                propertyName: 'search',
                className: 'DxoTreeListColumnHeaderFilterSearchComponent',
                component
            }),
            deps: [DxoTreeListColumnHeaderFilterSearchComponent],
         }
         ]
})
