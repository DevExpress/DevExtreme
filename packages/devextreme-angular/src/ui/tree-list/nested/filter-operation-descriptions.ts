        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoTreeListFilterOperationDescriptionsComponent) => ({
                propertyName: 'filterOperationDescriptions',
                className: 'DxoTreeListFilterOperationDescriptionsComponent',
                component
            }),
            deps: [DxoTreeListFilterOperationDescriptionsComponent],
         }
         ]
})
