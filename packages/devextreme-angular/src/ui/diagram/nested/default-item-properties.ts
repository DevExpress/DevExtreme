        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoDiagramDefaultItemPropertiesComponent) => ({
                propertyName: 'defaultItemProperties',
                className: 'DxoDiagramDefaultItemPropertiesComponent',
                component
            }),
            deps: [DxoDiagramDefaultItemPropertiesComponent],
         }
         ]
})
