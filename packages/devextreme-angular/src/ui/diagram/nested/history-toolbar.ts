        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoDiagramHistoryToolbarComponent) => ({
                propertyName: 'historyToolbar',
                className: 'DxoDiagramHistoryToolbarComponent',
                component
            }),
            deps: [DxoDiagramHistoryToolbarComponent],
         }
         ]
})
...
export class DxoDiagramHistoryToolbarModule { }
