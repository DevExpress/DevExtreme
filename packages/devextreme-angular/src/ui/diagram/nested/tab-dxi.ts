...
export class DxiDiagramTabComponent extends CollectionNestedOption {
    ...
    @Input()
    get groups(): Array<Record<string, any>> | { commands?: Array<Command | CustomCommand>, title?: string }[] {
        return this._getOption('groups');
    }
    set groups(value: Array<Record<string, any>> | { commands?: Array<Command | CustomCommand>, title?: string }[]) {
