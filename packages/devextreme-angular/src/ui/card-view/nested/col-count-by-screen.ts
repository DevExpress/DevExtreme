        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoCardViewColCountByScreenComponent) => ({
                propertyName: 'colCountByScreen',
                className: 'DxoCardViewColCountByScreenComponent',
                component
            }),
            deps: [DxoCardViewColCountByScreenComponent],
         }
         ]
})
export class DxoCardViewColCountByScreenComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
