        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoCardViewColumnHeaderFilterSearchComponent) => ({
                propertyName: 'search',
                className: 'DxoCardViewColumnHeaderFilterSearchComponent',
                component
            }),
            deps: [DxoCardViewColumnHeaderFilterSearchComponent],
         }
         ]
})
