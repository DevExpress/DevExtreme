        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoCardViewHideComponent) => ({
                propertyName: 'hide',
                className: 'DxoCardViewHideComponent',
                component
            }),
            deps: [DxoCardViewHideComponent],
         }
         ]
})
export class DxoCardViewHideComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
