...
export class DxoCardViewPopupComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  imports: [
    DxoCardViewPopupComponent
  ],
  exports: [
    DxoCardViewPopupComponent
  ],
})
export class DxoCardViewPopupModule { }
