        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoCardViewCollisionComponent) => ({
                propertyName: 'collision',
                className: 'DxoCardViewCollisionComponent',
                component
            }),
            deps: [DxoCardViewCollisionComponent],
         }
         ]
})
export class DxoCardViewCollisionComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
