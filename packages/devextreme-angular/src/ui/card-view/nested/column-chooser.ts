        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoCardViewColumnChooserComponent) => ({
                propertyName: 'columnChooser',
                className: 'DxoCardViewColumnChooserComponent',
                component
            }),
            deps: [DxoCardViewColumnChooserComponent],
         }
         ]
})
...
export class DxoCardViewColumnChooserModule { }
