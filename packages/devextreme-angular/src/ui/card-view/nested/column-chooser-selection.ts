        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoCardViewColumnChooserSelectionComponent) => ({
                propertyName: 'selection',
                className: 'DxoCardViewColumnChooserSelectionComponent',
                component
            }),
            deps: [DxoCardViewColumnChooserSelectionComponent],
         }
         ]
})
