        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoCardViewCardViewHeaderFilterComponent) => ({
                propertyName: 'headerFilter',
                className: 'DxoCardViewCardViewHeaderFilterComponent',
                component
            }),
            deps: [DxoCardViewCardViewHeaderFilterComponent],
         }
         ]
})
