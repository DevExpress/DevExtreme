...
@Component({
    selector: 'dxo-card-view-filter-builder-popup',
    standalone: true,
    template: '',
    styles: [''],
...
export class DxoCardViewFilterBuilderPopupComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  imports: [
    DxoCardViewFilterBuilderPopupComponent
  ],
  exports: [
    DxoCardViewFilterBuilderPopupComponent
  ],
})
export class DxoCardViewFilterBuilderPopupModule { }
