        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoCardViewColumnHeaderFilterComponent) => ({
                propertyName: 'headerFilter',
                className: 'DxoCardViewColumnHeaderFilterComponent',
                component
            }),
            deps: [DxoCardViewColumnHeaderFilterComponent],
         }
         ]
})
