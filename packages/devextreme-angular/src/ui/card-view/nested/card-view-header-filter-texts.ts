        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoCardViewCardViewHeaderFilterTextsComponent) => ({
                propertyName: 'texts',
                className: 'DxoCardViewCardViewHeaderFilterTextsComponent',
                component
            }),
            deps: [DxoCardViewCardViewHeaderFilterTextsComponent],
         }
         ]
})
