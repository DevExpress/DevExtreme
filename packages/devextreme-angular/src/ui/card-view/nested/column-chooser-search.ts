        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoCardViewColumnChooserSearchComponent) => ({
                propertyName: 'search',
                className: 'DxoCardViewColumnChooserSearchComponent',
                component
            }),
            deps: [DxoCardViewColumnChooserSearchComponent],
         }
         ]
})
