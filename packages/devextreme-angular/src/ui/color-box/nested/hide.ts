        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoColorBoxHideComponent) => ({
                propertyName: 'hide',
                className: 'DxoColorBoxHideComponent',
                component
            }),
            deps: [DxoColorBoxHideComponent],
         }
         ]
})
export class DxoColorBoxHideComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
