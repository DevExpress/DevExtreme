...
@Component({
    selector: 'dxo-show-color-box',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoShowColorBoxComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoShowColorBoxComponent
  ],
  exports: [
    DxoShowColorBoxComponent
  ],
})
export class DxoShowColorBoxModule { }
