...
@Component({
    selector: 'dxi-button-color-box',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxiButtonColorBoxComponent extends CollectionNestedOption {
    @Input()
...
@NgModule({
  declarations: [
    DxiButtonColorBoxComponent
  ],
  exports: [
    DxiButtonColorBoxComponent
  ],
})
export class DxiButtonColorBoxModule { }
