...
@Component({
    selector: 'dxo-title-tree-map',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoTitleTreeMapComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
    get font(): Font {
...
@NgModule({
  declarations: [
    DxoTitleTreeMapComponent
  ],
  exports: [
    DxoTitleTreeMapComponent
  ],
})
export class DxoTitleTreeMapModule { }
