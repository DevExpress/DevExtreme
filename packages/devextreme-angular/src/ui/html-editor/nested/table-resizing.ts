        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoHtmlEditorTableResizingComponent) => ({
                propertyName: 'tableResizing',
                className: 'DxoHtmlEditorTableResizingComponent',
                component
            }),
            deps: [DxoHtmlEditorTableResizingComponent],
         }
         ]
})
export class DxoHtmlEditorTableResizingComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get enabled(): boolean {
