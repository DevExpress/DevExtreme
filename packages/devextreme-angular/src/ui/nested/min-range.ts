        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoMinRangeComponent) => ({
                propertyName: 'minRange',
                className: 'DxoMinRangeComponent',
                component
            }),
            deps: [DxoMinRangeComponent],
         }
         ]
})
export class DxoMinRangeComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get days(): number {
