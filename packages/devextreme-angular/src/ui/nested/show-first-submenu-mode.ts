        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoShowFirstSubmenuModeComponent) => ({
                propertyName: 'showFirstSubmenuMode',
                className: 'DxoShowFirstSubmenuModeComponent',
                component
            }),
            deps: [DxoShowFirstSubmenuModeComponent],
         }
         ]
})
