        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoIconsComponent) => ({
                propertyName: 'icons',
                className: 'DxoIconsComponent',
                component
            }),
            deps: [DxoIconsComponent],
         }
         ]
})
export class DxoIconsComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get fix(): string {
