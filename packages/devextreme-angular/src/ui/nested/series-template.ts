        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoSeriesTemplateComponent) => ({
                propertyName: 'seriesTemplate',
                className: 'DxoSeriesTemplateComponent',
                component
            }),
            deps: [DxoSeriesTemplateComponent],
         }
         ]
})
export class DxoSeriesTemplateComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
