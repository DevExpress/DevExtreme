        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoBreakStyleComponent) => ({
                propertyName: 'breakStyle',
                className: 'DxoBreakStyleComponent',
                component
            }),
            deps: [DxoBreakStyleComponent],
         }
         ]
})
export class DxoBreakStyleComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get color(): string {
...
export class DxoBreakStyleModule { }
