        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoStackedsplineareaComponent) => ({
                propertyName: 'stackedsplinearea',
                className: 'DxoStackedsplineareaComponent',
                component
            }),
            deps: [DxoStackedsplineareaComponent],
         }
         ],
    inputs: [
        'aggregation',
...
export class DxoStackedsplineareaModule { }
