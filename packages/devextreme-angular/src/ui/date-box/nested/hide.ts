...
@Component({
    selector: 'dxo-hide-date-box',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoHideDateBoxComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoHideDateBoxComponent
  ],
  exports: [
    DxoHideDateBoxComponent
  ],
})
export class DxoHideDateBoxModule { }
