...
@Component({
    selector: 'dxo-show-date-box',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoShowDateBoxComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoShowDateBoxComponent
  ],
  exports: [
    DxoShowDateBoxComponent
  ],
})
export class DxoShowDateBoxModule { }
