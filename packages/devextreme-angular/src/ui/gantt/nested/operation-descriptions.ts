        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoGanttOperationDescriptionsComponent) => ({
                propertyName: 'operationDescriptions',
                className: 'DxoGanttOperationDescriptionsComponent',
                component
            }),
            deps: [DxoGanttOperationDescriptionsComponent],
         }
         ]
})
