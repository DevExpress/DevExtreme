...
@Component({
    ...
    providers: [
        NestedOptionHost,
        {
           ...
           useExisting: DxiGanttButtonComponent,
        }
    ]
})
export class DxiGanttButtonComponent extends CollectionNestedOption {
    @Input()
...
@NgModule({
  imports: [
    DxiGanttButtonComponent
  ],
  exports: [
    DxiGanttButtonComponent
  ],
})
export class DxiGanttButtonModule { }
