        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoTagBoxHideComponent) => ({
                propertyName: 'hide',
                className: 'DxoTagBoxHideComponent',
                component
            }),
            deps: [DxoTagBoxHideComponent],
         }
         ]
})
export class DxoTagBoxHideComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
