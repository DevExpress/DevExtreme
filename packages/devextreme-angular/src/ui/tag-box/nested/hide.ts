...
@Component({
    selector: 'dxo-hide-tag-box',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoHideTagBoxComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoHideTagBoxComponent
  ],
  exports: [
    DxoHideTagBoxComponent
  ],
})
export class DxoHideTagBoxModule { }
