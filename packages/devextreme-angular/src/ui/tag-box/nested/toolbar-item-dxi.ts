...
@NgModule({
  imports: [
    DxiTagBoxToolbarItemComponent
  ],
  exports: [
    DxiTagBoxToolbarItemComponent
  ],
})
export class DxiTagBoxToolbarItemModule { }