...
@Component({
    selector: 'dxi-button-tag-box',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxiButtonTagBoxComponent extends CollectionNestedOption {
    @Input()
...
@NgModule({
  declarations: [
    DxiButtonTagBoxComponent
  ],
  exports: [
    DxiButtonTagBoxComponent
  ],
})
export class DxiButtonTagBoxModule { }
