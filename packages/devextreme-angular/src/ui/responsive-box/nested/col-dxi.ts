...
@Component({
    selector: 'dxi-col-responsive-box',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxiColResponsiveBoxComponent extends CollectionNestedOption {
    @Input()
...
@NgModule({
  declarations: [
    DxiColResponsiveBoxComponent
  ],
  exports: [
    DxiColResponsiveBoxComponent
  ],
})
export class DxiColResponsiveBoxModule { }
