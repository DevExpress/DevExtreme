...
export class DxResponsiveBoxComponent<TItem = any, TKey = any> extends DxComponent implements OnDestroy, OnChanges, DoCheck {
     ...
     */
    @Input()
    get cols(): Array<Record<string, any>> | { baseSize?: number | string, ratio?: number, screen?: string | undefined, shrink?: number }[] {
        return this._getOption('cols');
    }
    set cols(value: Array<Record<string, any>> | { baseSize?: number | string, ratio?: number, screen?: string | undefined, shrink?: number }[]) {
     ...
     */
    @Input()
    get rows(): Array<Record<string, any>> | { baseSize?: number | string, ratio?: number, screen?: string | undefined, shrink?: number }[] {
        return this._getOption('rows');
    }
    set rows(value: Array<Record<string, any>> | { baseSize?: number | string, ratio?: number, screen?: string | undefined, shrink?: number }[]) {
     ...
     */
    @Output() colsChange: EventEmitter<Array<Record<string, any>> | { baseSize?: number | string, ratio?: number, screen?: string | undefined, shrink?: number }[]>;
     ...
     */
    @Output() rowsChange: EventEmitter<Array<Record<string, any>> | { baseSize?: number | string, ratio?: number, screen?: string | undefined, shrink?: number }[]>;
