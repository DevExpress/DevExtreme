...
@Component({
    selector: 'dxo-show-lookup',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoShowLookupComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoShowLookupComponent
  ],
  exports: [
    DxoShowLookupComponent
  ],
})
export class DxoShowLookupModule { }
