        ...
        DxTemplateHost,
         {
            ...
            useFactory: (component: DxiLookupToolbarItemComponent) => ({
                propertyName: 'toolbarItems',
                className: 'DxiLookupToolbarItemComponent',
                component
            }),
            deps: [DxiLookupToolbarItemComponent],
         }
    ],
})
...
@NgModule({
  imports: [
    DxiLookupToolbarItemComponent
  ],
  exports: [
    DxiLookupToolbarItemComponent
  ],
})
export class DxiLookupToolbarItemModule { }
