        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoBarGaugeBarGaugeTitleSubtitleComponent) => ({
                propertyName: 'subtitle',
                className: 'DxoBarGaugeBarGaugeTitleSubtitleComponent',
                component
            }),
            deps: [DxoBarGaugeBarGaugeTitleSubtitleComponent],
         }
         ]
})
