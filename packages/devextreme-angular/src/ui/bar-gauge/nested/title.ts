        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoBarGaugeTitleComponent) => ({
                propertyName: 'title',
                className: 'DxoBarGaugeTitleComponent',
                component
            }),
            deps: [DxoBarGaugeTitleComponent],
         }
         ]
})
export class DxoBarGaugeTitleComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get font(): Font {
