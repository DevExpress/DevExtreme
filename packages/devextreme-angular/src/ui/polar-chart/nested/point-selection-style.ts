        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPolarChartPointSelectionStyleComponent) => ({
                propertyName: 'selectionStyle',
                className: 'DxoPolarChartPointSelectionStyleComponent',
                component
            }),
            deps: [DxoPolarChartPointSelectionStyleComponent],
         }
         ]
})
