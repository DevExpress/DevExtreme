        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPolarChartLoadingIndicatorComponent) => ({
                propertyName: 'loadingIndicator',
                className: 'DxoPolarChartLoadingIndicatorComponent',
                component
            }),
            deps: [DxoPolarChartLoadingIndicatorComponent],
         }
         ]
})
