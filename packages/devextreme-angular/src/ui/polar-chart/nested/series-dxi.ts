...
@Component({
    selector: 'dxi-series-polar-chart',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxiSeriesPolarChartComponent extends CollectionNestedOption {
    @Input()
...
@NgModule({
  declarations: [
    DxiSeriesPolarChartComponent
  ],
  exports: [
    DxiSeriesPolarChartComponent
  ],
})
export class DxiSeriesPolarChartModule { }
