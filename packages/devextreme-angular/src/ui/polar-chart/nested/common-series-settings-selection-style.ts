        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPolarChartCommonSeriesSettingsSelectionStyleComponent) => ({
                propertyName: 'selectionStyle',
                className: 'DxoPolarChartCommonSeriesSettingsSelectionStyleComponent',
                component
            }),
            deps: [DxoPolarChartCommonSeriesSettingsSelectionStyleComponent],
         }
         ]
})
