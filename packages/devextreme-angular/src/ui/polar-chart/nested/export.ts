        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPolarChartExportComponent) => ({
                propertyName: 'export',
                className: 'DxoPolarChartExportComponent',
                component
            }),
            deps: [DxoPolarChartExportComponent],
         }
         ]
})
...
export class DxoPolarChartExportModule { }
