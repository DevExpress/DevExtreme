        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPolarChartLengthComponent) => ({
                propertyName: 'length',
                className: 'DxoPolarChartLengthComponent',
                component
            }),
            deps: [DxoPolarChartLengthComponent],
         }
         ]
})
export class DxoPolarChartLengthComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get days(): number {
