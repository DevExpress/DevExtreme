        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPolarChartCommonSeriesSettingsHoverStyleComponent) => ({
                propertyName: 'hoverStyle',
                className: 'DxoPolarChartCommonSeriesSettingsHoverStyleComponent',
                component
            }),
            deps: [DxoPolarChartCommonSeriesSettingsHoverStyleComponent],
         }
         ]
})
export class DxoPolarChartCommonSeriesSettingsHoverStyleComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
