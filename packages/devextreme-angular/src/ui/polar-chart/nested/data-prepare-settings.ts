        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPolarChartDataPrepareSettingsComponent) => ({
                propertyName: 'dataPrepareSettings',
                className: 'DxoPolarChartDataPrepareSettingsComponent',
                component
            }),
            deps: [DxoPolarChartDataPrepareSettingsComponent],
         }
         ]
})
