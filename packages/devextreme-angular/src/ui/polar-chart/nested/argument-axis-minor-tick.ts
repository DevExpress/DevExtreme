        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPolarChartArgumentAxisMinorTickComponent) => ({
                propertyName: 'minorTick',
                className: 'DxoPolarChartArgumentAxisMinorTickComponent',
                component
            }),
            deps: [DxoPolarChartArgumentAxisMinorTickComponent],
         }
         ]
})
