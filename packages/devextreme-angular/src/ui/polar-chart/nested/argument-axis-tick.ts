        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPolarChartArgumentAxisTickComponent) => ({
                propertyName: 'tick',
                className: 'DxoPolarChartArgumentAxisTickComponent',
                component
            }),
            deps: [DxoPolarChartArgumentAxisTickComponent],
         }
         ]
})
