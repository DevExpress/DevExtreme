        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPolarChartCommonAxisSettingsComponent) => ({
                propertyName: 'commonAxisSettings',
                className: 'DxoPolarChartCommonAxisSettingsComponent',
                component
            }),
            deps: [DxoPolarChartCommonAxisSettingsComponent],
         }
         ]
})
