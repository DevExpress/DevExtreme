        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPolarChartPolarChartTitleComponent) => ({
                propertyName: 'title',
                className: 'DxoPolarChartPolarChartTitleComponent',
                component
            }),
            deps: [DxoPolarChartPolarChartTitleComponent],
         }
         ]
})
export class DxoPolarChartPolarChartTitleComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get font(): Font {
