        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPolarChartCommonAxisSettingsTickComponent) => ({
                propertyName: 'tick',
                className: 'DxoPolarChartCommonAxisSettingsTickComponent',
                component
            }),
            deps: [DxoPolarChartCommonAxisSettingsTickComponent],
         }
         ]
})
