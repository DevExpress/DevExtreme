        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPolarChartMinorTickIntervalComponent) => ({
                propertyName: 'minorTickInterval',
                className: 'DxoPolarChartMinorTickIntervalComponent',
                component
            }),
            deps: [DxoPolarChartMinorTickIntervalComponent],
         }
         ]
})
export class DxoPolarChartMinorTickIntervalComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get days(): number {
...
export class DxoPolarChartMinorTickIntervalModule { }
