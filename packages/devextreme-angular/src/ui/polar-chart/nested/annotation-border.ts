        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPolarChartAnnotationBorderComponent) => ({
                propertyName: 'border',
                className: 'DxoPolarChartAnnotationBorderComponent',
                component
            }),
            deps: [DxoPolarChartAnnotationBorderComponent],
         }
         ]
})
