        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoLoadPanelPositionComponent) => ({
                propertyName: 'position',
                className: 'DxoLoadPanelPositionComponent',
                component
            }),
            deps: [DxoLoadPanelPositionComponent],
         }
         ]
})
export class DxoLoadPanelPositionComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
