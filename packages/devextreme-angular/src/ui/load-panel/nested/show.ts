        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoLoadPanelShowComponent) => ({
                propertyName: 'show',
                className: 'DxoLoadPanelShowComponent',
                component
            }),
            deps: [DxoLoadPanelShowComponent],
         }
         ]
})
export class DxoLoadPanelShowComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
