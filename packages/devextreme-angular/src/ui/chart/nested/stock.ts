...
@Component({
    selector: 'dxo-chart-stock',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoChartStockComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoChartStockComponent
  ],
  exports: [
    DxoChartStockComponent
  ],
})
export class DxoChartStockModule { }
