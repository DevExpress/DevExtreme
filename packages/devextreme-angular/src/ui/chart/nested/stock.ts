...
@Component({
    selector: 'dxo-stock-chart',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoStockChartComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoStockChartComponent
  ],
  exports: [
    DxoStockChartComponent
  ],
})
export class DxoStockChartModule { }
