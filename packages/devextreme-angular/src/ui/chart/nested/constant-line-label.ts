        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoChartConstantLineLabelComponent) => ({
                propertyName: 'label',
                className: 'DxoChartConstantLineLabelComponent',
                component
            }),
            deps: [DxoChartConstantLineLabelComponent],
         }
         ]
})
...
export class DxoChartConstantLineLabelModule { }
