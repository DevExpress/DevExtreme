        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoChartArgumentFormatComponent) => ({
                propertyName: 'argumentFormat',
                className: 'DxoChartArgumentFormatComponent',
                component
            }),
            deps: [DxoChartArgumentFormatComponent],
         }
         ]
})
export class DxoChartArgumentFormatComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get currency(): string {
