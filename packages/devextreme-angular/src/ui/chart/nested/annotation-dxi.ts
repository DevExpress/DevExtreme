...
@Component({
    selector: 'dxi-annotation-chart',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxiAnnotationChartComponent extends CollectionNestedOption {
    @Input()
...
@NgModule({
  declarations: [
    DxiAnnotationChartComponent
  ],
  exports: [
    DxiAnnotationChartComponent
  ],
})
export class DxiAnnotationChartModule { }
