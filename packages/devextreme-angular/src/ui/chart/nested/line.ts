...
@Component({
    selector: 'dxo-line-chart',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoLineChartComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoLineChartComponent
  ],
  exports: [
    DxoLineChartComponent
  ],
})
export class DxoLineChartModule { }
