...
@Component({
    selector: 'dxo-chart-line',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoChartLineComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoChartLineComponent
  ],
  exports: [
    DxoChartLineComponent
  ],
})
export class DxoChartLineModule { }
