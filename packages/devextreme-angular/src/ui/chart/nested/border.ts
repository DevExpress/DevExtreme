...
@Component({
    selector: 'dxo-border-chart',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoBorderChartComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoBorderChartComponent
  ],
  exports: [
    DxoBorderChartComponent
  ],
})
export class DxoBorderChartModule { }
