...
@Component({
    selector: 'dxo-color-chart',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoColorChartComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoColorChartComponent
  ],
  exports: [
    DxoColorChartComponent
  ],
})
export class DxoColorChartModule { }
