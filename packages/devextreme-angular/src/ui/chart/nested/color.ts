        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoChartColorComponent) => ({
                propertyName: 'color',
                className: 'DxoChartColorComponent',
                component
            }),
            deps: [DxoChartColorComponent],
         }
         ]
})
export class DxoChartColorComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
...
export class DxoChartColorModule { }
