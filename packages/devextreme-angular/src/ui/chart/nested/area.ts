...
@Component({
    selector: 'dxo-area-chart',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoAreaChartComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoAreaChartComponent
  ],
  exports: [
    DxoAreaChartComponent
  ],
})
export class DxoAreaChartModule { }
