        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoChartAxisTitleComponent) => ({
                propertyName: 'title',
                className: 'DxoChartAxisTitleComponent',
                component
            }),
            deps: [DxoChartAxisTitleComponent],
         }
         ]
})
...
export class DxoChartAxisTitleModule { }
