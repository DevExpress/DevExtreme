        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoChartCommonSeriesSettingsLabelComponent) => ({
                propertyName: 'label',
                className: 'DxoChartCommonSeriesSettingsLabelComponent',
                component
            }),
            deps: [DxoChartCommonSeriesSettingsLabelComponent],
         }
         ]
})
