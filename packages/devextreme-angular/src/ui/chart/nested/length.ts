        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoChartLengthComponent) => ({
                propertyName: 'length',
                className: 'DxoChartLengthComponent',
                component
            }),
            deps: [DxoChartLengthComponent],
         }
         ]
})
export class DxoChartLengthComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get days(): number {
...
export class DxoChartLengthModule { }
