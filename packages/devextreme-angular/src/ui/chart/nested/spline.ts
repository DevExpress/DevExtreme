...
@Component({
    selector: 'dxo-chart-spline',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoChartSplineComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoChartSplineComponent
  ],
  exports: [
    DxoChartSplineComponent
  ],
})
export class DxoChartSplineModule { }
