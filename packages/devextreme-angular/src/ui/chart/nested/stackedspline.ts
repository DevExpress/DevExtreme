...
@Component({
    selector: 'dxo-chart-stackedspline',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoChartStackedsplineComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoChartStackedsplineComponent
  ],
  exports: [
    DxoChartStackedsplineComponent
  ],
