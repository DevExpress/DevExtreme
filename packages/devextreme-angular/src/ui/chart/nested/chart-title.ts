        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoChartChartTitleComponent) => ({
                propertyName: 'title',
                className: 'DxoChartChartTitleComponent',
                component
            }),
            deps: [DxoChartChartTitleComponent],
         }
         ]
})
export class DxoChartChartTitleComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get font(): Font {
