...
@Component({
    selector: 'dxo-height-chart',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoHeightChartComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoHeightChartComponent
  ],
  exports: [
    DxoHeightChartComponent
  ],
})
export class DxoHeightChartModule { }
