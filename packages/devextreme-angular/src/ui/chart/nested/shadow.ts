...
@Component({
    selector: 'dxo-shadow-chart',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoShadowChartComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
    get blur(): number {
...
@NgModule({
  declarations: [
    DxoShadowChartComponent
  ],
  exports: [
    DxoShadowChartComponent
  ],
})
export class DxoShadowChartModule { }
