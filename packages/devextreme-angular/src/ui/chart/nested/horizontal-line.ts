        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoChartHorizontalLineComponent) => ({
                propertyName: 'horizontalLine',
                className: 'DxoChartHorizontalLineComponent',
                component
            }),
            deps: [DxoChartHorizontalLineComponent],
         }
         ]
})
