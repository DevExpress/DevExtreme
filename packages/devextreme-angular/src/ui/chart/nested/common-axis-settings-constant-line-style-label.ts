        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoChartCommonAxisSettingsConstantLineStyleLabelComponent) => ({
                propertyName: 'label',
                className: 'DxoChartCommonAxisSettingsConstantLineStyleLabelComponent',
                component
            }),
            deps: [DxoChartCommonAxisSettingsConstantLineStyleLabelComponent],
         }
         ]
})
