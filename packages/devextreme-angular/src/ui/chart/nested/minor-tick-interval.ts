        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoChartMinorTickIntervalComponent) => ({
                propertyName: 'minorTickInterval',
                className: 'DxoChartMinorTickIntervalComponent',
                component
            }),
            deps: [DxoChartMinorTickIntervalComponent],
         }
         ]
})
export class DxoChartMinorTickIntervalComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get days(): number {
