        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPivotGridFieldChooserHeaderFilterTextsComponent) => ({
                propertyName: 'texts',
                className: 'DxoPivotGridFieldChooserHeaderFilterTextsComponent',
                component
            }),
            deps: [DxoPivotGridFieldChooserHeaderFilterTextsComponent],
         }
         ]
})
export class DxoPivotGridFieldChooserHeaderFilterTextsComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get cancel(): string {
