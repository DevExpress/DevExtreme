        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPivotGridFieldChooserTextsComponent) => ({
                propertyName: 'texts',
                className: 'DxoPivotGridFieldChooserTextsComponent',
                component
            }),
            deps: [DxoPivotGridFieldChooserTextsComponent],
         }
         ]
})
