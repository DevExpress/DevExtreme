...
@Component({
    selector: 'dxo-hide-popover',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoHidePopoverComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoHidePopoverComponent
  ],
  exports: [
    DxoHidePopoverComponent
  ],
})
export class DxoHidePopoverModule { }
