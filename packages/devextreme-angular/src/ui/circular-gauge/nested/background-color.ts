        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoCircularGaugeBackgroundColorComponent) => ({
                propertyName: 'backgroundColor',
                className: 'DxoCircularGaugeBackgroundColorComponent',
                component
            }),
            deps: [DxoCircularGaugeBackgroundColorComponent],
         }
         ]
})
