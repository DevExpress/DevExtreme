        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoCircularGaugeValueIndicatorComponent) => ({
                propertyName: 'valueIndicator',
                className: 'DxoCircularGaugeValueIndicatorComponent',
                component
            }),
            deps: [DxoCircularGaugeValueIndicatorComponent],
         }
         ]
})
