        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoSliderFormatComponent) => ({
                propertyName: 'format',
                className: 'DxoSliderFormatComponent',
                component
            }),
            deps: [DxoSliderFormatComponent],
         }
         ]
})
export class DxoSliderFormatComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get currency(): string {
...
@NgModule({
  imports: [
    DxoSliderFormatComponent
  ],
  exports: [
    DxoSliderFormatComponent
  ],
})
export class DxoSliderFormatModule { }
