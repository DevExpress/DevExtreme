...
export class DxGalleryComponent<TItem = any, TKey = any> extends DxComponent implements OnDestroy, OnChanges, DoCheck {
     ...
     */
    @Input()
    get dataSource(): DataSource | DataSourceOptions | DevExpress.data.Store.Store | null | string | Array<string | DevExpress.ui.dxGalleryItem | any> {
        return this._getOption('dataSource');
    }
    set dataSource(value: DataSource | DataSourceOptions | DevExpress.data.Store.Store | null | string | Array<string | DevExpress.ui.dxGalleryItem | any>) {
     ...
     */
    @Output() dataSourceChange: EventEmitter<DataSource | DataSourceOptions | DevExpress.data.Store.Store | null | string | Array<string | DevExpress.ui.dxGalleryItem | any>>;
