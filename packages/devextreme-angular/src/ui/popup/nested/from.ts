        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPopupFromComponent) => ({
                propertyName: 'from',
                className: 'DxoPopupFromComponent',
                component
            }),
            deps: [DxoPopupFromComponent],
         }
         ]
})
export class DxoPopupFromComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get left(): number {
