...
@Component({
    selector: 'dxo-hide-popup',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoHidePopupComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoHidePopupComponent
  ],
  exports: [
    DxoHidePopupComponent
  ],
})
export class DxoHidePopupModule { }
