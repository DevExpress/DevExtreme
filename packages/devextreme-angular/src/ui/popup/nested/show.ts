...
@Component({
    selector: 'dxo-show-popup',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoShowPopupComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoShowPopupComponent
  ],
  exports: [
    DxoShowPopupComponent
  ],
})
export class DxoShowPopupModule { }
