...
export class DxSkeletonComponent extends DxComponent implements OnDestroy {
     ...
     * [descr:dxSkeletonOptions.onContentReady]
     ...
     * [descr:dxSkeletonOptions.onDisposing]
    
    
     */
    @Output() onDisposing: EventEmitter<EventInfo<DxSkeleton>>;

    /**
    
     * [descr:dxSkeletonOptions.onInitialized]
    
    
     */
    @Output() onInitialized: EventEmitter<InitializedEventInfo<DxSkeleton>>;

    /**
    
     * [descr:dxSkeletonOptions.onOptionChanged]
    
    
     */
    @Output() onOptionChanged: EventEmitter<EventInfo<DxSkeleton> & ChangedOptionInfo>;
