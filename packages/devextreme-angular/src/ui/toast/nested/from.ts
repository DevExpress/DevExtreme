        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoToastFromComponent) => ({
                propertyName: 'from',
                className: 'DxoToastFromComponent',
                component
            }),
            deps: [DxoToastFromComponent],
         }
         ]
})
export class DxoToastFromComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get left(): number {
