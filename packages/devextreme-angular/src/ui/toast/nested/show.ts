...
@Component({
    selector: 'dxo-show-toast',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoShowToastComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoShowToastComponent
  ],
  exports: [
    DxoShowToastComponent
  ],
})
export class DxoShowToastModule { }
