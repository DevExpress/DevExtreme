        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoDropDownBoxHideComponent) => ({
                propertyName: 'hide',
                className: 'DxoDropDownBoxHideComponent',
                component
            }),
            deps: [DxoDropDownBoxHideComponent],
         }
         ]
})
export class DxoDropDownBoxHideComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
