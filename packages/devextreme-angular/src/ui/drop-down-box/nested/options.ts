    ...
    providers: [
        NestedOptionHost,
         DxTemplateHost,
         {
            ...
            useFactory: (component: DxoDropDownBoxOptionsComponent) => ({
                propertyName: 'options',
                className: 'DxoDropDownBoxOptionsComponent',
                component
            }),
            deps: [DxoDropDownBoxOptionsComponent],
         }
         ]
})
export class DxoDropDownBoxOptionsComponent extends NestedOption implements AfterViewInit, OnDestroy, OnInit,
    IDxTemplateHost {
    @Input()
