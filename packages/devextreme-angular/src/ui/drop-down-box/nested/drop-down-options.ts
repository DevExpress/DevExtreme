        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoDropDownBoxDropDownOptionsComponent) => ({
                propertyName: 'dropDownOptions',
                className: 'DxoDropDownBoxDropDownOptionsComponent',
                component
            }),
            deps: [DxoDropDownBoxDropDownOptionsComponent],
         }
         ]
})
