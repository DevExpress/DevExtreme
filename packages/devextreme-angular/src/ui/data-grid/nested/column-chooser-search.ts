        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoDataGridColumnChooserSearchComponent) => ({
                propertyName: 'search',
                className: 'DxoDataGridColumnChooserSearchComponent',
                component
            }),
            deps: [DxoDataGridColumnChooserSearchComponent],
         }
         ]
})
