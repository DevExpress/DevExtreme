        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoDataGridColumnHeaderFilterComponent) => ({
                propertyName: 'headerFilter',
                className: 'DxoDataGridColumnHeaderFilterComponent',
                component
            }),
            deps: [DxoDataGridColumnHeaderFilterComponent],
         }
         ]
})
