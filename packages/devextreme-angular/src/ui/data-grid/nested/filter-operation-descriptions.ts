        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoDataGridFilterOperationDescriptionsComponent) => ({
                propertyName: 'filterOperationDescriptions',
                className: 'DxoDataGridFilterOperationDescriptionsComponent',
                component
            }),
            deps: [DxoDataGridFilterOperationDescriptionsComponent],
         }
         ]
})
