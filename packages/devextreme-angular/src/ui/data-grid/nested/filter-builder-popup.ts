        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoDataGridFilterBuilderPopupComponent) => ({
                propertyName: 'filterBuilderPopup',
                className: 'DxoDataGridFilterBuilderPopupComponent',
                component
            }),
            deps: [DxoDataGridFilterBuilderPopupComponent],
         }
         ]
})
