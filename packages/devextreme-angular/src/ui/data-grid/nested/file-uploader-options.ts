...
@Component({
    selector: 'dxo-data-grid-file-uploader-options',
    template: '',
    styles: [''],
    imports: [ DxIntegrationModule ],
    providers: [NestedOptionHost]
})
export class DxoDataGridFileUploaderOptionsComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  imports: [
    DxoDataGridFileUploaderOptionsComponent
  ],
  exports: [
    DxoDataGridFileUploaderOptionsComponent
  ],
})
export class DxoDataGridFileUploaderOptionsModule { }
