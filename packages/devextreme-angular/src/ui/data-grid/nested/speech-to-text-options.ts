...
@Component({
    selector: 'dxo-data-grid-speech-to-text-options',
    standalone: true,
    template: '',
    styles: [''],
...
export class DxoDataGridSpeechToTextOptionsComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  imports: [
    DxoDataGridSpeechToTextOptionsComponent
  ],
  exports: [
    DxoDataGridSpeechToTextOptionsComponent
  ],
})
export class DxoDataGridSpeechToTextOptionsModule { }
