        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoDataGridDataGridHeaderFilterTextsComponent) => ({
                propertyName: 'texts',
                className: 'DxoDataGridDataGridHeaderFilterTextsComponent',
                component
            }),
            deps: [DxoDataGridDataGridHeaderFilterTextsComponent],
         }
         ]
})
