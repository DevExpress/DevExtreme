...
@Component({
    selector: 'dxo-data-grid-message-timestamp-format',
    template: '',
    styles: [''],
    imports: [ DxIntegrationModule ],
    providers: [NestedOptionHost]
})
export class DxoDataGridMessageTimestampFormatComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
    get currency(): string {
...
@NgModule({
  imports: [
    DxoDataGridMessageTimestampFormatComponent
  ],
  exports: [
    DxoDataGridMessageTimestampFormatComponent
  ],
})
export class DxoDataGridMessageTimestampFormatModule { }
