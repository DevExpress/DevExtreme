        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoDataGridColumnChooserSelectionComponent) => ({
                propertyName: 'selection',
                className: 'DxoDataGridColumnChooserSelectionComponent',
                component
            }),
            deps: [DxoDataGridColumnChooserSelectionComponent],
         }
         ]
})
