        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoDataGridDataGridHeaderFilterSearchComponent) => ({
                propertyName: 'search',
                className: 'DxoDataGridDataGridHeaderFilterSearchComponent',
                component
            }),
            deps: [DxoDataGridDataGridHeaderFilterSearchComponent],
         }
         ]
})
