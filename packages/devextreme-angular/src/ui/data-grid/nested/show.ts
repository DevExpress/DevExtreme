...
@Component({
    selector: 'dxo-show-data-grid',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoShowDataGridComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoShowDataGridComponent
  ],
  exports: [
    DxoShowDataGridComponent
  ],
})
export class DxoShowDataGridModule { }
