...
@Component({
    selector: 'dxo-data-grid-chat-editing',
    standalone: true,
    template: '',
    styles: [''],
...
export class DxoDataGridChatEditingComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  imports: [
    DxoDataGridChatEditingComponent
  ],
  exports: [
    DxoDataGridChatEditingComponent
  ],
})
export class DxoDataGridChatEditingModule { }
