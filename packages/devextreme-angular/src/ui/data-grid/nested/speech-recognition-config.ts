...
export class DxoDataGridSpeechRecognitionConfigComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  imports: [
    DxoDataGridSpeechRecognitionConfigComponent
  ],
  exports: [
    DxoDataGridSpeechRecognitionConfigComponent
  ],
})
export class DxoDataGridSpeechRecognitionConfigModule { }
