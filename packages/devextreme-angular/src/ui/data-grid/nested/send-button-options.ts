...
@Component({
    selector: 'dxo-data-grid-send-button-options',
    template: '',
    styles: [''],
    imports: [ DxIntegrationModule ],
    providers: [NestedOptionHost]
})
export class DxoDataGridSendButtonOptionsComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  imports: [
    DxoDataGridSendButtonOptionsComponent
  ],
  exports: [
    DxoDataGridSendButtonOptionsComponent
  ],
})
export class DxoDataGridSendButtonOptionsModule { }
