...
@Component({
    selector: 'dxo-data-grid-suggestions',
    template: '',
    styles: [''],
    imports: [ DxIntegrationModule ],
    providers: [NestedOptionHost]
})
export class DxoDataGridSuggestionsComponent extends NestedOption implements OnDestroy, OnInit  {
...
@NgModule({
  imports: [
    DxoDataGridSuggestionsComponent
  ],
  exports: [
    DxoDataGridSuggestionsComponent
  ],
})
export class DxoDataGridSuggestionsModule { }
