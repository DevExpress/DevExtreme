...
@Component({
    selector: 'dxo-data-grid-day-header-format',
    template: '',
    styles: [''],
    imports: [ DxIntegrationModule ],
    providers: [NestedOptionHost]
})
export class DxoDataGridDayHeaderFormatComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
    get currency(): string {
...
@NgModule({
  imports: [
    DxoDataGridDayHeaderFormatComponent
  ],
  exports: [
    DxoDataGridDayHeaderFormatComponent
  ],
})
export class DxoDataGridDayHeaderFormatModule { }
