        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoDataGridGroupOperationDescriptionsComponent) => ({
                propertyName: 'groupOperationDescriptions',
                className: 'DxoDataGridGroupOperationDescriptionsComponent',
                component
            }),
            deps: [DxoDataGridGroupOperationDescriptionsComponent],
         }
         ]
})
