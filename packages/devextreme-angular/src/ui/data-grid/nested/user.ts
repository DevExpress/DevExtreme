...
export class DxoDataGridUserComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  imports: [
    DxoDataGridUserComponent
  ],
  exports: [
    DxoDataGridUserComponent
  ],
})
export class DxoDataGridUserModule { }
