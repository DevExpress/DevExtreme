        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoDataGridKeyboardNavigationComponent) => ({
                propertyName: 'keyboardNavigation',
                className: 'DxoDataGridKeyboardNavigationComponent',
                component
            }),
            deps: [DxoDataGridKeyboardNavigationComponent],
         }
         ]
})
