        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoDataGridColumnHeaderFilterSearchComponent) => ({
                propertyName: 'search',
                className: 'DxoDataGridColumnHeaderFilterSearchComponent',
                component
            }),
            deps: [DxoDataGridColumnHeaderFilterSearchComponent],
         }
         ]
})
