...
@Component({
    selector: 'dxi-data-grid-typing-user',
    standalone: true,
    template: '',
    styles: [''],
    ...
    providers: [
        NestedOptionHost,
        {
           ...
           useExisting: DxiDataGridTypingUserComponent,
        }
    ]
})
export class DxiDataGridTypingUserComponent extends CollectionNestedOption {
    @Input()
...
@NgModule({
  imports: [
    DxiDataGridTypingUserComponent
  ],
  exports: [
    DxiDataGridTypingUserComponent
  ],
})
export class DxiDataGridTypingUserModule { }
