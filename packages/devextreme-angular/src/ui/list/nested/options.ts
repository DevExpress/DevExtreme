...
@Component({
    selector: 'dxo-options-list',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoOptionsListComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoOptionsListComponent
  ],
  exports: [
    DxoOptionsListComponent
  ],
})
export class DxoOptionsListModule { }
