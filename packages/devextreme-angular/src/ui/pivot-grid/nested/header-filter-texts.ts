        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPivotGridHeaderFilterTextsComponent) => ({
                propertyName: 'texts',
                className: 'DxoPivotGridHeaderFilterTextsComponent',
                component
            }),
            deps: [DxoPivotGridHeaderFilterTextsComponent],
         }
         ]
})
