...
@Component({
    selector: 'dxi-pivot-grid-field',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxiPivotGridFieldComponent extends CollectionNestedOption {
    @Input()
...
@NgModule({
  declarations: [
    DxiPivotGridFieldComponent
  ],
  exports: [
    DxiPivotGridFieldComponent
  ],
})
export class DxiPivotGridFieldModule { }
