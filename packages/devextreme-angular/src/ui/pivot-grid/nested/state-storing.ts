        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPivotGridStateStoringComponent) => ({
                propertyName: 'stateStoring',
                className: 'DxoPivotGridStateStoringComponent',
                component
            }),
            deps: [DxoPivotGridStateStoringComponent],
         }
         ]
})
