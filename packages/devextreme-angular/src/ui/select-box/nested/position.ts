        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoSelectBoxPositionComponent) => ({
                propertyName: 'position',
                className: 'DxoSelectBoxPositionComponent',
                component
            }),
            deps: [DxoSelectBoxPositionComponent],
         }
         ]
})
export class DxoSelectBoxPositionComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
