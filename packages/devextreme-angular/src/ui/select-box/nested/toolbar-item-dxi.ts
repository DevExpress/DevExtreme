    ...
    providers: [
        NestedOptionHost,
         DxTemplateHost,
         {
            ...
            useFactory: (component: DxiSelectBoxToolbarItemComponent) => ({
                propertyName: 'toolbarItems',
                className: 'DxiSelectBoxToolbarItemComponent',
                component
            }),
            deps: [DxiSelectBoxToolbarItemComponent],
         }
         ]
})
export class DxiSelectBoxToolbarItemComponent extends CollectionNestedOption implements AfterViewInit,
    IDxTemplateHost {
    @Input()
...
@NgModule({
  imports: [
    DxiSelectBoxToolbarItemComponent
  ],
  exports: [
    DxiSelectBoxToolbarItemComponent
  ],
})
export class DxiSelectBoxToolbarItemModule { }
