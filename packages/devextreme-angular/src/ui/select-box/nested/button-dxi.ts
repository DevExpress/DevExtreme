...
@Component({
    selector: 'dxi-button-select-box',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxiButtonSelectBoxComponent extends CollectionNestedOption {
    @Input()
...
@NgModule({
  declarations: [
    DxiButtonSelectBoxComponent
  ],
  exports: [
    DxiButtonSelectBoxComponent
  ],
})
export class DxiButtonSelectBoxModule { }
