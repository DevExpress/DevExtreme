...
@Component({
    selector: 'dxo-show-menu',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoShowMenuComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoShowMenuComponent
  ],
  exports: [
    DxoShowMenuComponent
  ],
})
export class DxoShowMenuModule { }
