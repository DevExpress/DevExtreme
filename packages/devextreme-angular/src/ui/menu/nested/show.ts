        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoMenuShowComponent) => ({
                propertyName: 'show',
                className: 'DxoMenuShowComponent',
                component
            }),
            deps: [DxoMenuShowComponent],
         }
         ]
})
export class DxoMenuShowComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
