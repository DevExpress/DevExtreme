...
@Component({
    selector: 'dxo-hide-menu',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoHideMenuComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoHideMenuComponent
  ],
  exports: [
    DxoHideMenuComponent
  ],
})
export class DxoHideMenuModule { }
