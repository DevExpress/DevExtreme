        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoLinearGaugeSubvalueIndicatorComponent) => ({
                propertyName: 'subvalueIndicator',
                className: 'DxoLinearGaugeSubvalueIndicatorComponent',
                component
            }),
            deps: [DxoLinearGaugeSubvalueIndicatorComponent],
         }
         ]
})
