...
export class DxoLinearGaugeTooltipComponent extends NestedOption implements AfterViewInit, OnDestroy, OnInit,
    IDxTemplateHost {
    @Input()
    ...
    @Input()
    get contentTemplate(): ((scaleValue: { value: number, valueText: string }, element: any) => string | any) | template {
        return this._getOption('contentTemplate');
    }
    set contentTemplate(value: ((scaleValue: { value: number, valueText: string }, element: any) => string | any) | template) {
    ...
    @Input()
    get customizeTooltip(): ((scaleValue: { value: number, valueText: string }) => Record<string, any>) {
        return this._getOption('customizeTooltip');
    }
    set customizeTooltip(value: ((scaleValue: { value: number, valueText: string }) => Record<string, any>)) {
