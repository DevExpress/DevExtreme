        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoLinearGaugeBackgroundColorComponent) => ({
                propertyName: 'backgroundColor',
                className: 'DxoLinearGaugeBackgroundColorComponent',
                component
            }),
            deps: [DxoLinearGaugeBackgroundColorComponent],
         }
         ]
})
