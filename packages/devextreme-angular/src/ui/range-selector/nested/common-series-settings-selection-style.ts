        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoRangeSelectorCommonSeriesSettingsSelectionStyleComponent) => ({
                propertyName: 'selectionStyle',
                className: 'DxoRangeSelectorCommonSeriesSettingsSelectionStyleComponent',
                component
            }),
            deps: [DxoRangeSelectorCommonSeriesSettingsSelectionStyleComponent],
         }
         ]
})
