        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoRangeSelectorLoadingIndicatorComponent) => ({
                propertyName: 'loadingIndicator',
                className: 'DxoRangeSelectorLoadingIndicatorComponent',
                component
            }),
            deps: [DxoRangeSelectorLoadingIndicatorComponent],
         }
         ]
})
