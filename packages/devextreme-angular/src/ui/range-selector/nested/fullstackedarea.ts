...
@Component({
    selector: 'dxo-fullstackedarea-range-selector',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoFullstackedareaRangeSelectorComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoFullstackedareaRangeSelectorComponent
  ],
  exports: [
    DxoFullstackedareaRangeSelectorComponent
  ],
})
export class DxoFullstackedareaRangeSelectorModule { }
