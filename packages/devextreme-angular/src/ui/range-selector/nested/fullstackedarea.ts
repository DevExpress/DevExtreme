...
@Component({
    selector: 'dxo-range-selector-fullstackedarea',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoRangeSelectorFullstackedareaComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoRangeSelectorFullstackedareaComponent
  ],
  exports: [
    DxoRangeSelectorFullstackedareaComponent
  ],
})
export class DxoRangeSelectorFullstackedareaModule { }
