...
export class DxoRangeSelectorPointImageComponent extends NestedOption implements OnDestroy, OnInit  {
    ...
    @Input()
    get url(): Record<string, any> | string | undefined | { rangeMaxPoint?: string | undefined, rangeMinPoint?: string | undefined } {
        return this._getOption('url');
    }
    set url(value: Record<string, any> | string | undefined | { rangeMaxPoint?: string | undefined, rangeMinPoint?: string | undefined }) {
