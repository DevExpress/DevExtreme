        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoRangeSelectorSliderMarkerComponent) => ({
                propertyName: 'sliderMarker',
                className: 'DxoRangeSelectorSliderMarkerComponent',
                component
            }),
            deps: [DxoRangeSelectorSliderMarkerComponent],
         }
         ]
})
export class DxoRangeSelectorSliderMarkerComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get color(): string {
