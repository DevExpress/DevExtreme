        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoRangeSelectorMaxRangeComponent) => ({
                propertyName: 'maxRange',
                className: 'DxoRangeSelectorMaxRangeComponent',
                component
            }),
            deps: [DxoRangeSelectorMaxRangeComponent],
         }
         ]
})
export class DxoRangeSelectorMaxRangeComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get days(): number {
