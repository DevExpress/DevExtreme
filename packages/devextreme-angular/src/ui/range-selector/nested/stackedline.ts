...
@Component({
    selector: 'dxo-range-selector-stackedline',
    template: '',
    styles: [''],
    providers: [NestedOptionHost]
})
export class DxoRangeSelectorStackedlineComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
@NgModule({
  declarations: [
    DxoRangeSelectorStackedlineComponent
  ],
  exports: [
    DxoRangeSelectorStackedlineComponent
  ],
})
export class DxoRangeSelectorStackedlineModule { }
