        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoRangeSelectorMinorTickIntervalComponent) => ({
                propertyName: 'minorTickInterval',
                className: 'DxoRangeSelectorMinorTickIntervalComponent',
                component
            }),
            deps: [DxoRangeSelectorMinorTickIntervalComponent],
         }
         ]
})
