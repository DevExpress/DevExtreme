        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoRangeSelectorSelectionStyleComponent) => ({
                propertyName: 'selectionStyle',
                className: 'DxoRangeSelectorSelectionStyleComponent',
                component
            }),
            deps: [DxoRangeSelectorSelectionStyleComponent],
         }
         ]
})
