        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoRangeSelectorValueErrorBarComponent) => ({
                propertyName: 'valueErrorBar',
                className: 'DxoRangeSelectorValueErrorBarComponent',
                component
            }),
            deps: [DxoRangeSelectorValueErrorBarComponent],
         }
         ]
})
