        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoRangeSelectorDataPrepareSettingsComponent) => ({
                propertyName: 'dataPrepareSettings',
                className: 'DxoRangeSelectorDataPrepareSettingsComponent',
                component
            }),
            deps: [DxoRangeSelectorDataPrepareSettingsComponent],
         }
         ]
})
