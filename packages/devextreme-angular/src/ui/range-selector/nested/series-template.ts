        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoRangeSelectorSeriesTemplateComponent) => ({
                propertyName: 'seriesTemplate',
                className: 'DxoRangeSelectorSeriesTemplateComponent',
                component
            }),
            deps: [DxoRangeSelectorSeriesTemplateComponent],
         }
         ]
})
