        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoRangeSelectorArgumentFormatComponent) => ({
                propertyName: 'argumentFormat',
                className: 'DxoRangeSelectorArgumentFormatComponent',
                component
            }),
            deps: [DxoRangeSelectorArgumentFormatComponent],
         }
         ]
})
