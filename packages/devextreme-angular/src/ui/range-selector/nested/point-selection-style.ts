        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoRangeSelectorPointSelectionStyleComponent) => ({
                propertyName: 'selectionStyle',
                className: 'DxoRangeSelectorPointSelectionStyleComponent',
                component
            }),
            deps: [DxoRangeSelectorPointSelectionStyleComponent],
         }
         ]
})
export class DxoRangeSelectorPointSelectionStyleComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
