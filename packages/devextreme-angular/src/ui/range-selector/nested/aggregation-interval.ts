        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoRangeSelectorAggregationIntervalComponent) => ({
                propertyName: 'aggregationInterval',
                className: 'DxoRangeSelectorAggregationIntervalComponent',
                component
            }),
            deps: [DxoRangeSelectorAggregationIntervalComponent],
         }
         ]
})
