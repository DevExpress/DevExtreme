        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoRangeSelectorHeightComponent) => ({
                propertyName: 'height',
                className: 'DxoRangeSelectorHeightComponent',
                component
            }),
            deps: [DxoRangeSelectorHeightComponent],
         }
         ]
})
export class DxoRangeSelectorHeightComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
