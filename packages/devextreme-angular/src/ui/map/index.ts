...
import type { ClickEvent, DisposingEvent, InitializedEvent, MarkerAddedEvent, MarkerRemovedEvent, OptionChangedEvent, ReadyEvent, RouteAddedEvent, RouteRemovedEvent, MapProvider, OsmCalculateRouteParams, OsmTileServer, RouteMode, MapType } from 'devextreme/ui/map';
...
export class DxMapComponent extends DxComponent implements OnDestroy, OnChanges, DoCheck {
     ...
     */
    @Input()
    get providerConfig(): { calculateLocation?: ((query: string) => any), calculateRoute?: ((params: OsmCalculateRouteParams) => any), mapId?: string, tileServer?: OsmTileServer | undefined, useAdvancedMarkers?: boolean } {
        return this._getOption('providerConfig');
    }
    set providerConfig(value: { calculateLocation?: ((query: string) => any), calculateRoute?: ((params: OsmCalculateRouteParams) => any), mapId?: string, tileServer?: OsmTileServer | undefined, useAdvancedMarkers?: boolean }) {
     ...
     */
    @Output() providerConfigChange: EventEmitter<{ calculateLocation?: ((query: string) => any), calculateRoute?: ((params: OsmCalculateRouteParams) => any), mapId?: string, tileServer?: OsmTileServer | undefined, useAdvancedMarkers?: boolean }>;
