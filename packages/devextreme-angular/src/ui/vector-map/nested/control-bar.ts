        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoVectorMapControlBarComponent) => ({
                propertyName: 'controlBar',
                className: 'DxoVectorMapControlBarComponent',
                component
            }),
            deps: [DxoVectorMapControlBarComponent],
         }
         ]
})
