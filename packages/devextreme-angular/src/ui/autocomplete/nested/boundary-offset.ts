        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoAutocompleteBoundaryOffsetComponent) => ({
                propertyName: 'boundaryOffset',
                className: 'DxoAutocompleteBoundaryOffsetComponent',
                component
            }),
            deps: [DxoAutocompleteBoundaryOffsetComponent],
         }
         ]
})
