        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoAutocompleteDropDownOptionsComponent) => ({
                propertyName: 'dropDownOptions',
                className: 'DxoAutocompleteDropDownOptionsComponent',
                component
            }),
            deps: [DxoAutocompleteDropDownOptionsComponent],
         }
         ]
})
