        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoAutocompleteMyComponent) => ({
                propertyName: 'my',
                className: 'DxoAutocompleteMyComponent',
                component
            }),
            deps: [DxoAutocompleteMyComponent],
         }
         ]
})
...
@NgModule({
  imports: [
    DxoAutocompleteMyComponent
  ],
  exports: [
    DxoAutocompleteMyComponent
  ],
})
export class DxoAutocompleteMyModule { }
