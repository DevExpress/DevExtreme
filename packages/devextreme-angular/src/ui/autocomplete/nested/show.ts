        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoAutocompleteShowComponent) => ({
                propertyName: 'show',
                className: 'DxoAutocompleteShowComponent',
                component
            }),
            deps: [DxoAutocompleteShowComponent],
         }
         ]
})
export class DxoAutocompleteShowComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
...
@NgModule({
  imports: [
    DxoAutocompleteShowComponent
  ],
  exports: [
    DxoAutocompleteShowComponent
  ],
})
export class DxoAutocompleteShowModule { }
