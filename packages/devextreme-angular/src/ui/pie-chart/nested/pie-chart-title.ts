        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPieChartPieChartTitleComponent) => ({
                propertyName: 'title',
                className: 'DxoPieChartPieChartTitleComponent',
                component
            }),
            deps: [DxoPieChartPieChartTitleComponent],
         }
         ]
})
export class DxoPieChartPieChartTitleComponent extends NestedOption implements OnDestroy, OnInit {
    @Input()
    get font(): Font {
