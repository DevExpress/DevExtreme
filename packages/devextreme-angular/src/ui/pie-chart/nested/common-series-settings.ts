        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoPieChartCommonSeriesSettingsComponent) => ({
                propertyName: 'commonSeriesSettings',
                className: 'DxoPieChartCommonSeriesSettingsComponent',
                component
            }),
            deps: [DxoPieChartCommonSeriesSettingsComponent],
         }
         ]
})
