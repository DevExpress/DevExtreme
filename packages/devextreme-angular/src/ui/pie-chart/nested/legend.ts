...
export class DxoPieChartLegendComponent extends NestedOption implements AfterViewInit, OnDestroy, OnInit,
    IDxTemplateHost {
    @Input()
    ...
    @Input()
    get markerTemplate(): ((legendItem: PieChartLegendItem, element: any) => string | any) | template {
        return this._getOption('markerTemplate');
    }
    set markerTemplate(value: ((legendItem: PieChartLegendItem, element: any) => string | any) | template) {
