        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoDateRangeBoxDisplayFormatComponent) => ({
                propertyName: 'displayFormat',
                className: 'DxoDateRangeBoxDisplayFormatComponent',
                component
            }),
            deps: [DxoDateRangeBoxDisplayFormatComponent],
         }
         ]
})
...
export class DxoDateRangeBoxDisplayFormatModule { }
