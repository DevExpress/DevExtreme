        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoDropDownButtonDropDownOptionsComponent) => ({
                propertyName: 'dropDownOptions',
                className: 'DxoDropDownButtonDropDownOptionsComponent',
                component
            }),
            deps: [DxoDropDownButtonDropDownOptionsComponent],
         }
         ]
})
