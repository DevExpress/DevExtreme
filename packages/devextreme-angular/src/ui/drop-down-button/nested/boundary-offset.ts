        ...
        NestedOptionHost,
         {
            ...
            useFactory: (component: DxoDropDownButtonBoundaryOffsetComponent) => ({
                propertyName: 'boundaryOffset',
                className: 'DxoDropDownButtonBoundaryOffsetComponent',
                component
            }),
            deps: [DxoDropDownButtonBoundaryOffsetComponent],
         }
         ]
})
