...
export class DxDropDownButtonComponent extends DxComponent implements OnDestroy, OnChanges, DoCheck {
     ...
     */
    @Input()
    get dataSource(): DataSource | DataSourceOptions | DevExpress.data.Store.Store | null | string | Array<DevExpress.ui.dxDropDownButtonItem | any> {
        return this._getOption('dataSource');
    }
    set dataSource(value: DataSource | DataSourceOptions | DevExpress.data.Store.Store | null | string | Array<DevExpress.ui.dxDropDownButtonItem | any>) {
     ...
     */
    @Output() dataSourceChange: EventEmitter<DataSource | DataSourceOptions | DevExpress.data.Store.Store | null | string | Array<DevExpress.ui.dxDropDownButtonItem | any>>;
