...
const DICTIONARY_SOURCE_FOLDER = 'src/js/localization/messages';
...
gulp.task('clean-cldr-data', function() {
    return del('src/js/localization/cldr-data/**', { force: true });
});
...
gulp.task('generate-community-locales', () => {
    ...
    return gulp
        .src([
            'src/js/localization/messages/*.json',
...
gulp.task('localization-generated-sources', gulp.parallel([
    {
        data: require('../../src/js/localization/messages/en.json'),
        filename: 'default_messages.js',
        exportName: 'defaultMessages',
        destination: 'src/js/localization'
    },
    {
        data: parentLocales,
        filename: 'parent_locales.js',
        destination: 'src/js/localization/cldr-data'
    },
    {
