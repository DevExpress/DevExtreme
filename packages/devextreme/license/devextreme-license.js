...
function printHelp() {
    process.stdout.write(
        [
            'Usage:',
            '  devextreme-license-verify --out <path> [options]',
            '',
            'Options:',
            ...
            '',
            'Examples:',
            '  "prebuild": "devextreme-license-verify --out src/.devextreme/license-key.ts"',
            '  "prebuild": "devextreme-license-verify --non-modular --out src/.devextreme/license-key.js"',
            '',
        ].join('\n')
    );
}
    ...
    for(let i = 0; i < args.length; i++) {
        ...
        if(a === '-h' || a === '--help') out.help = true;
            ...
            if(!next || next.startsWith('-')) {
                process.stderr.write('[devextreme-license-verify] Warning: --out requires a path argument but none was provided. Ignoring --out.\n');
            } else {
                out.outPath = args[++i];
            }
        }
...
function renderFile(lcpKey) {
    return [
        '// Auto-generated by devextreme-license-verify.',
