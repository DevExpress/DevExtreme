...
export class MultiPlatformTest {
  beforeFn!: (t: TestController, { platform }) => Promise<void>;

  afterFn!: (t: TestController, { platform }) => Promise<void>;

  before(fn: (t: TestController, { platform }) => Promise<void>): this {
    this.beforeFn = fn;
    return this;
  }

  after(fn: (t: TestController, { platform }) => Promise<void>): this {
    this.afterFn = fn;
    return this;
  }
}
