...
QUnit.module('Markup', moduleConfig, () => {
    ...
    test('should render task wrapper for each task', async function(assert) {
    ...
    test('row heights', async function(assert) {
        this.createInstance(options.allSourcesOptions);
        await this.clock.tickAsync(10);
    ...
    test('auto height', async function(assert) {
        this.createInstance(options.allSourcesOptions);
        await this.clock.tickAsync(10);
    ...
    test('fixed height', async function(assert) {
        this.createInstance(options.allSourcesOptions);
    ...
    test('invalid start or end dates', async function(assert) {
        const customTasks = [
    ...
    test('add task to empty gantt - row height', async function(assert) {
        const testTasks = [];
        this.createInstance({
    ...
    test('new added task should be selected', async function(assert) {
        const testTasks = [{
            id: 1,
        ...
        this.instance.insertTask(data);
        await await this.clock.tickAsync(10);
    ...
    test('24 format check (T1130809)', async function(assert) {
    ...
    test('12 format check (T1130809)', async function(assert) {
