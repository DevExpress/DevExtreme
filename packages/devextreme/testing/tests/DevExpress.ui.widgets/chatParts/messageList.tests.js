    ...
    QUnit.module('ScrollView', {
        ...
        QUnit.test('should be scrolled to the bottom after reducing height if it\'s initially scrolled to the bottom', function(assert) {
            ...
            setTimeout(() => {
                ...
                assert.roughEqual(scrollTop, this.getScrollOffsetMax(), 1.2, 'scroll position should be at the bottom after initialization');
                ...
                setTimeout(() => {
                    ...
                    assert.roughEqual(scrollTop, this.getScrollOffsetMax(), 1.2, 'max scroll position should be saved after reducing height');
        ...
        QUnit.test('should be scrolled to the bottom after increasing height if it\'s initially scrolled to the bottom', function(assert) {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    assert.roughEqual(scrollTop, this.getScrollOffsetMax(), 1.2, 'max scroll position should be saved after increasing height');
        ...
        QUnit.test('should update visual scroll position after reducing height if it\'s not scrolled to the bottom (fix viewport bottom point)', function(assert) {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    assert.roughEqual(scrollTop, this.getScrollOffsetMax() - 200, 1.2, 'scroll position should be set correctly after reducing height');
        ...
        QUnit.test('should keep visual scroll position after increasing height if it\'s not scrolled to the bottom (fix viewport top point)', function(assert) {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    assert.roughEqual(scrollTop, newScrollTop, 1.2, 'scroll position should be saved correctly after increasing height');
