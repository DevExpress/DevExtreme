...
QUnit.module('Column resize points', {
    beforeEach: function() {
    ...
    QUnit.module('Columns with sticky position', {
        ...
        QUnit.skipInShadowDomMode('should get the correct points when scrollLeft = 0', function(assert) {
            ...
            // assert
            assert.equal(pointsByColumns.length, 4, 'count points by columns');
            assert.deepEqual(pointsByColumns[0], { columnIndex: 0, index: 1, x: 100, y: 0 }, 'first point');
    ...
    QUnit.module('Columns with right and sticky positions', {
        ...
        QUnit.skipInShadowDomMode('should get the correct points when scrollLeft = 0', function(assert) {
            ...
            assert.deepEqual(pointsByColumns[1], { columnIndex: 1, index: 2, x: 175, y: 0 }, 'second point');
            assert.deepEqual(pointsByColumns[2], { columnIndex: 2, index: 3, x: 275, y: 0 }, 'third point');
            assert.deepEqual(pointsByColumns[3], { columnIndex: 3, index: 4, x: 300, y: 0 }, 'fourth point');
        });
        ...
        QUnit.skipInShadowDomMode('should get the correct points when scroll position is at the end', function(assert) {
            ...
            // assert
            assert.equal(pointsByColumns.length, 3, 'count points by columns');
            assert.deepEqual(pointsByColumns[0], { columnIndex: 1, index: 2, x: 73, y: 0 }, 'first point');
...
QUnit.module('Column resize points (rtlEnabled = true)', {
    beforeEach: function() {
        $('#qunit-fixture').addClass('qunit-fixture-static');
    ...
    QUnit.module('Columns with left and sticky positions', {
        ...
        QUnit.skipInShadowDomMode('should get the correct points when scrollLeft = 0', function(assert) {
            ...
            assert.deepEqual(pointsByColumns[1], { columnIndex: 1, index: 2, x: 225, y: 0 }, 'second point');
            assert.deepEqual(pointsByColumns[2], { columnIndex: 2, index: 3, x: 125, y: 0 }, 'third point');
            assert.deepEqual(pointsByColumns[3], { columnIndex: 3, index: 4, x: 100, y: 0 }, 'fourth point');
        });
        ...
        QUnit.skipInShadowDomMode('should get the correct points when scroll position is at the end', function(assert) {
            ...
            // assert
            assert.equal(pointsByColumns.length, 3, 'count points by columns');
            assert.deepEqual(pointsByColumns[0], { columnIndex: 1, index: 2, x: 327, y: 0 }, 'first point');
    ...
    QUnit.module('Columns with right and sticky positions', {
        ...
        QUnit.skipInShadowDomMode('should get the correct points when scrollLeft !== 0', function(assert) {
            ...
            assert.equal(pointsByColumns.length, 4, 'count points by columns');
            assert.deepEqual(pointsByColumns[0], { columnIndex: 0, index: 1, x: 300, y: 0 }, 'first point');
            assert.deepEqual(pointsByColumns[1], { columnIndex: 1, index: 2, x: 250, y: 0 }, 'second point');
            assert.deepEqual(pointsByColumns[2], { columnIndex: 2, index: 3, x: 175, y: 0 }, 'third point');
            assert.deepEqual(pointsByColumns[3], { columnIndex: 3, index: 4, x: 75, y: 0 }, 'fourth point');
        });
