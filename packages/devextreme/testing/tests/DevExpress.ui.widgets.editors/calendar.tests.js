...
QUnit.module('Navigator integration', {
    ...
    QUnit.test('if currentDate option is invalid we should still be able to use navigator caption (T1257679)', function(assert) {
        this.reinit({
    ...
    QUnit.test('if currentDate option is invalid we should still be able to use navigator buttons to switch months (T1257679)', function(assert) {
        this.reinit({
            currentDate: new Date('')
        });
