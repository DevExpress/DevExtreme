...
QUnit.module('multi tag support', {
    ...
    QUnit.test('multi tag remove should deselect all items grouped under it when showMultiTagOnly is false', function(assert) {
        const $tagBox = $('#tagBox').dxTagBox({
            items: [1, 2, 3, 4],
            value: [1, 2, 4],
            maxDisplayedTags: 2,
    ...
    QUnit.test('multi tag remove should deselect all items when showMultiTagOnly is true', function(assert) {
        const $tagBox = $('#tagBox').dxTagBox({
            items: [1, 2, 3, 4],
            value: [1, 2, 4],
            maxDisplayedTags: 2,
