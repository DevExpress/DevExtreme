import $ from 'jquery';
import {
    getHeight, getWidth, getInnerHeight, getInnerWidth, getOuterHeight, getOuterWidth,
    getElementBoxParams, addOffsetToMaxHeight, addOffsetToMinHeight, getVerticalOffsets, getVisibleHeight,
