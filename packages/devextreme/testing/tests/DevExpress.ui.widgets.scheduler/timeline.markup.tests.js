import $ from 'jquery';
import SchedulerTimeline from '__internal/scheduler/workspaces/timeline';
import SchedulerTimelineDay from '__internal/scheduler/workspaces/timeline_day';
import SchedulerTimelineWeek from '__internal/scheduler/workspaces/timeline_week';
import SchedulerTimelineMonth from '__internal/scheduler/workspaces/timeline_month';
...
QUnit.module('TimelineWeek with intervalCount markup', timelineWeekModuleConfig, () => {
    QUnit.test('TimelineWeek has right count of cells with view option intervalCount', async function(assert) {
        ...
        let cells = this.instance.$element().find('.dx-scheduler-date-table-cell');
        // getCellCount includes the repeated hour when the range contains a fall-back.
