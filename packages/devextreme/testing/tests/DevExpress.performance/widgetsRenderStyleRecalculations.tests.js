...
const components = [
    ...
    { name: 'dxDateBox', config: { labelMode: 'static' }, expectedRecalculations: 5 },
    ...
    { name: 'dxNumberBox', config: { labelMode: 'hidden' }, expectedRecalculations: 2 },
    { name: 'dxNumberBox', config: { labelMode: 'static' }, expectedRecalculations: 2 },
    { name: 'dxNumberBox', config: { labelMode: 'floating' }, expectedRecalculations: 2 },
    { name: 'dxNumberBox', config: { labelMode: 'outside' }, expectedRecalculations: 2 },
    { name: 'dxNumberBox', config: { label: 'Label', labelMode: 'hidden' }, expectedRecalculations: 2 },
    ...
    { name: 'dxNumberBox', config: { label: 'Label', labelMode: 'outside' }, expectedRecalculations: 2 },
    { name: 'dxNumberBox', config: { label: 'Label', labelMode: 'hidden', buttons: [{ name: 'custom', location: 'before' }] }, expectedRecalculations: 2 },
    { name: 'dxNumberBox', config: { label: 'Label', labelMode: 'static', buttons: [{ name: 'custom', location: 'before' }] }, expectedRecalculations: 2 },
    { name: 'dxNumberBox', config: { label: 'Label', labelMode: 'floating', buttons: [{ name: 'custom', location: 'before' }] }, expectedRecalculations: 2 },
    { name: 'dxNumberBox', config: { label: 'Label', labelMode: 'outside', buttons: [{ name: 'custom', location: 'before' }] }, expectedRecalculations: 2 },

    { name: 'dxRadioGroup', config: {}, expectedRecalculations: 1 },
    { name: 'dxSlider', config: {}, expectedRecalculations: 3 },
    { name: 'dxRangeSlider', config: {}, expectedRecalculations: 7 },
    ...
    { name: 'dxDateRangeBox', config: { labelMode: 'hidden' }, expectedRecalculations: 11 },
    { name: 'dxDateRangeBox', config: { labelMode: 'static' }, expectedRecalculations: 11 },
    { name: 'dxDateRangeBox', config: { labelMode: 'floating' }, expectedRecalculations: 11 },
    { name: 'dxDateRangeBox', config: { labelMode: 'outside' }, expectedRecalculations: 11 },
    { name: 'dxDateRangeBox', config: { label: 'Label', labelMode: 'hidden' }, expectedRecalculations: 11 },
    { name: 'dxDateRangeBox', config: { label: 'Label', labelMode: 'static' }, expectedRecalculations: 11 },
    { name: 'dxDateRangeBox', config: { label: 'Label', labelMode: 'floating' }, expectedRecalculations: 11 },
    { name: 'dxDateRangeBox', config: { label: 'Label', labelMode: 'outside' }, expectedRecalculations: 11 },
    { name: 'dxDateRangeBox', config: { label: 'Label', labelMode: 'hidden', buttons: [{ name: 'custom', location: 'before' }] }, expectedRecalculations: 11 },
    { name: 'dxDateRangeBox', config: { label: 'Label', labelMode: 'static', buttons: [{ name: 'custom', location: 'before' }] }, expectedRecalculations: 11 },
    { name: 'dxDateRangeBox', config: { label: 'Label', labelMode: 'floating', buttons: [{ name: 'custom', location: 'before' }] }, expectedRecalculations: 11 },
    { name: 'dxDateRangeBox', config: { label: 'Label', labelMode: 'outside', buttons: [{ name: 'custom', location: 'before' }] }, expectedRecalculations: 11 },
];
