...
const components = [
    ...
    { name: 'dxAutocomplete', config: { label: 'Label', labelMode: 'hidden', buttons: [{ name: 'custom', location: 'before' }] }, expectedRecalculations: 1 },
    ...
    { name: 'dxDateBox', config: { label: 'Label', labelMode: 'hidden' }, expectedRecalculations: 3 },
    ...
    { name: 'dxDateBox', config: { label: 'Label', labelMode: 'outside' }, expectedRecalculations: 3 },
    { name: 'dxDateBox', config: { label: 'Label', labelMode: 'hidden', buttons: [{ name: 'custom', location: 'before' }] }, expectedRecalculations: 3 },
    ...
    { name: 'dxDropDownBox', config: { label: 'Label', labelMode: 'hidden', buttons: [{ name: 'custom', location: 'before' }] }, expectedRecalculations: 1 },
    ...
    { name: 'dxTagBox', config: { label: 'Label', labelMode: 'hidden', buttons: [{ name: 'custom', location: 'before' }] }, expectedRecalculations: 1 },
    ...
    { name: 'dxTextBox', config: { label: 'Label', labelMode: 'static', buttons: [{ name: 'custom', location: 'before' }] }, expectedRecalculations: 2 },
    { name: 'dxTextBox', config: { label: 'Label', labelMode: 'floating', buttons: [{ name: 'custom', location: 'before' }] }, expectedRecalculations: 2 },
    { name: 'dxTextBox', config: { label: 'Label', labelMode: 'outside', buttons: [{ name: 'custom', location: 'before' }] }, expectedRecalculations: 2 },

    { name: 'dxDateRangeBox', config: {}, expectedRecalculations: 9 },
    ...
    { name: 'dxDateRangeBox', config: { startDateLabel: 'StartDate', endDateLabel: 'EndDate', labelMode: 'hidden', buttons: [{ name: 'custom', location: 'before' }] }, expectedRecalculations: 9 },
    ...
    { name: 'dxDateRangeBox', config: { startDateLabel: 'StartDate', endDateLabel: 'EndDate', labelMode: 'outside', buttons: [{ name: 'custom', location: 'before' }] }, expectedRecalculations: 9 },
];
