...
namespace Runner.Tools
{
    public class UIModelHelper
    {
        ...
        static readonly ICollection<string> KnownConstellations = new HashSet<string> { "export", "misc", "ui", "ui.widgets", "ui.editors", "ui.htmlEditor", "ui.grid", "ui.scheduler", "viz", "perf", "renovation", "ai" };
