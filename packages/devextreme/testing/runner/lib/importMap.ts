...
export function buildQunitImportMap({
  ...
  const rawImports: Record<string, string> = {
    ...
    'viz/series/points/label': `${SHIMS}/viz_series_label.js`,
    ...
    'viz/translators/range': `${SHIMS}/viz_range.js`,
    'viz/translators/translator1d': `${SHIMS}/viz_translator1d.js`,
    'viz/core/plaque': `${SHIMS}/viz_plaque.js`,
    'viz/range_selector/tracker': `${SHIMS}/viz_rs_tracker.js`,
    'viz/range_selector/series_data_source': `${SHIMS}/viz_rs_series_data_source.js`,
    'viz/range_selector/sliders_controller': `${SHIMS}/viz_rs_sliders_controller.js`,
    ...
    '__internal/viz/series/points/label': `${SHIMS}/viz_series_label.js`,
    ...
    '__internal/viz/translators/range': `${SHIMS}/viz_range.js`,
    '__internal/viz/translators/translator1d': `${SHIMS}/viz_translator1d.js`,
    '__internal/viz/core/plaque': `${SHIMS}/viz_plaque.js`,
    '__internal/viz/range_selector/tracker': `${SHIMS}/viz_rs_tracker.js`,
    '__internal/viz/range_selector/series_data_source': `${SHIMS}/viz_rs_series_data_source.js`,
    '__internal/viz/range_selector/sliders_controller': `${SHIMS}/viz_rs_sliders_controller.js`,
