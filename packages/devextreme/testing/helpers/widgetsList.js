...
import DxDropDownEditor from 'ui/drop_down_editor/ui.drop_down_editor';
import DxDropDownList from 'ui/drop_down_editor/ui.drop_down_list';
...
const dropDownEditorsList = {
    ...
    dxColorBox: ColorBox,
    dxDateBox: DateBox,
    dxDateRangeBox: DateRangeBox,
    dxDropDownBox: DropDownBox,
    dxDropDownButton: DropDownButton,
    dxSelectBox: SelectBox,
    dxTagBox: TagBox,
    dxDropDownEditor: DxDropDownEditor,
    dxDropDownList: DxDropDownList,
};
