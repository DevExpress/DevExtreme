...
const LoadingIndicator = stubClass(loadingIndicatorModule.LoadingIndicator);
const ExportMenu = stubClass(exportMenuModule.ExportMenu);
const Point = stubClass(pointModule.Point);
