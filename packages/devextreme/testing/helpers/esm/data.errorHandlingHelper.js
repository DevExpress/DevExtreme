// ESM version of data.errorHandlingHelper.js
...
if(typeof window !== 'undefined') {
    ...
    window.DevExpress.testing.dataErrorHandlingHelper = window.DevExpress.data?.testing?.ErrorHandlingHelper || {};
}

// ES6 exports
const dataErrorHandlingHelper = window.DevExpress?.data?.testing?.ErrorHandlingHelper || {};
export default dataErrorHandlingHelper;
export { dataErrorHandlingHelper };
