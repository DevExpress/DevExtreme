// ESM version of treeListMocks.js
// Fallback wrapper for UMD module

// Execute original UMD code
let gridBaseMock;
...
// Export from global namespace
const treeListMocks = window.DevExpress?.testing?.treeListMocks || {};

export default treeListMocks;
export { treeListMocks };
