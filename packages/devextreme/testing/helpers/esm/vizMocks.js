...
(function() {
    ...
    const Element = stubClass(rendererModule.SvgElement, {
        ...
        setMaxSize: function(maxWidth) { // for text
            ...
            const moduleObject = { textChanged: maxWidth < 50 };
        },
    ...
    if(typeof window !== 'undefined') {
        ...
        window.DevExpress.testing.vizMocks = moduleObject;
    }

    // Export module
    window.__vizMocks__ = moduleObject;
})();

// ES6 exports
const vizMocks = window.__vizMocks__;
export default vizMocks;
export { vizMocks };
