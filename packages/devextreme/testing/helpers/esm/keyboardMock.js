// ESM version of keyboardMock.js
...
import { focused } from '/js/ui/widget/selectors.js';
...
function keyboardMockFactory(element, useNativeSelection) {
    $element = $(element);
...
export default keyboardMockFactory;
