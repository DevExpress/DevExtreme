...
(async function() {
    try {
        const eventsEngineModule = await import('common/core/events/core/events_engine');
        const eventsEngine = eventsEngineModule.default || eventsEngineModule;
        ...
        console.error('Error in jQueryEventsPatch:', error);
    }
})();
