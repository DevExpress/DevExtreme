...
function parseOptions(options, textField, allowInsidePosition) {
  ...
  _console.debug.assertParam(options.rowItemSpacing, 'rowItemSpacing was not passed');
  ///#ENDDEBUG
