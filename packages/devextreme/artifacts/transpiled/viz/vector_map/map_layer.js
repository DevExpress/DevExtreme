...
exports._TESTS_stub_selectStrategy = exports._TESTS_stub_performGrouping = exports._TESTS_stub_groupBySize = exports._TESTS_stub_groupByColor = exports._TESTS_stub_MapLayerElement = exports._TESTS_stub_MapLayer = exports._TESTS_selectStrategy = exports._TESTS_performGrouping = exports._TESTS_groupBySize = exports._TESTS_groupByColor = exports._TESTS_findGroupingIndex = exports._TESTS_createProxy = exports._TESTS_MapLayerElement = exports._TESTS_MapLayer = void 0;
...
///#DEBUG
const _TESTS_MapLayer = exports._TESTS_MapLayer = MapLayer;
const _TESTS_stub_MapLayer = function (stub) {
  MapLayer = stub;
};
exports._TESTS_stub_MapLayer = _TESTS_stub_MapLayer;
const _TESTS_selectStrategy = exports._TESTS_selectStrategy = selectStrategy;
const _TESTS_stub_selectStrategy = function (stub) {
  selectStrategy = stub;
};
exports._TESTS_stub_selectStrategy = _TESTS_stub_selectStrategy;
const _TESTS_MapLayerElement = exports._TESTS_MapLayerElement = MapLayerElement;
const _TESTS_stub_MapLayerElement = function (stub) {
  MapLayerElement = stub;
};
exports._TESTS_stub_MapLayerElement = _TESTS_stub_MapLayerElement;
const _TESTS_createProxy = exports._TESTS_createProxy = createProxy;
const _TESTS_stub_performGrouping = function (stub) {
  performGrouping = stub;
};
exports._TESTS_stub_performGrouping = _TESTS_stub_performGrouping;
const _TESTS_performGrouping = exports._TESTS_performGrouping = performGrouping;
const _TESTS_stub_groupByColor = function (stub) {
  groupByColor = stub;
};
exports._TESTS_stub_groupByColor = _TESTS_stub_groupByColor;
const _TESTS_groupByColor = exports._TESTS_groupByColor = groupByColor;
const _TESTS_stub_groupBySize = function (stub) {
  groupBySize = stub;
};
exports._TESTS_stub_groupBySize = _TESTS_stub_groupBySize;
const _TESTS_groupBySize = exports._TESTS_groupBySize = groupBySize;
const _TESTS_findGroupingIndex = exports._TESTS_findGroupingIndex = findGroupingIndex;
///#ENDDEBUG