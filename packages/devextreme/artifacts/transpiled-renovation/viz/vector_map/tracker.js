...
exports._DEBUG_forceEventMode = _DEBUG_forceEventMode;
exports._DEBUG_restoreFocusType = _DEBUG_restoreFocusType;
exports._DEBUG_stubFocusType = _DEBUG_stubFocusType;
...
let EVENTS;
let Focus = exports.Focus = void 0;
setupEvents();
...
exports.Focus = Focus = function (fire) {
  let that = this;
...
function _DEBUG_forceEventMode(mode) {
  setupEvents(mode);
}
function _DEBUG_stubFocusType(focusType) {
  exports.Focus = Focus = focusType;
}
function _DEBUG_restoreFocusType() {
  exports.Focus = Focus = originFocus;
}
