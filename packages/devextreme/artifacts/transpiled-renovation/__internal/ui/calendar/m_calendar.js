...
const Calendar = _editor.default.inherit({
  ...
  _focusOutHandler(event) {
    if ((0, _renderer.default)(event.target).is(this._$viewsWrapper)) {
      ...
      this._view.option('contouredDate', null);
      (_this$_additionalView2 = this._additionalView) === null || _this$_additionalView2 === void 0 || _this$_additionalView2.option('contouredDate', null);
    }
    if (this._shouldSkipFocusEvent(event)) {
      return;
    }
  ...
  _updateViewsOption(optionName, newValue) {
    ...
    (_this$_additionalView3 = this._additionalView) === null || _this$_additionalView3 === void 0 || _this$_additionalView3.option(optionName, newValue);
    (_this$_beforeView = this._beforeView) === null || _this$_beforeView === void 0 || _this$_beforeView.option(optionName, newValue);
    (_this$_afterView = this._afterView) === null || _this$_afterView === void 0 || _this$_afterView.option(optionName, newValue);
  },
