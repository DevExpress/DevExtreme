...
// NOTE: the max*Offset bounds are absent until a dxswipestart handler sets them.
...
& Pick<SwipeStartEvent, 'maxLeftOffset' | 'maxRightOffset' | 'maxTopOffset' | 'maxBottomOffset'>;
