...
class Scheduler extends SchedulerOptionsBaseWidget {
  ...
  _optionChanged(args: OptionChanged<SafeSchedulerOptions>): void {
    ...
    switch (args.name) {
      ...
      case 'onSelectionEnd': {
        const schedulerAction = this.createSchedulerAction(name as keyof SchedulerActionMap);
        this.actions[name as keyof SchedulerActions] = schedulerAction;
        break;
      }
  ...
  getAppointmentsInstance(): AppointmentCollection {
