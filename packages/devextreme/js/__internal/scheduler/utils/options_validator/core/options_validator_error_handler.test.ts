...
class TestErrorHandler extends OptionsValidatorErrorHandler<TestValidators> {
  // eslint-disable-next-line @typescript-eslint/no-useless-constructor
  constructor(
    errorsMap: Partial<Record<TestValidators, string>>,
...
const createGlobalErrorHandlerMock = (): GlobalErrorHandler => ({
  logError: jest.fn(),
  throwError: jest.fn(),
});
