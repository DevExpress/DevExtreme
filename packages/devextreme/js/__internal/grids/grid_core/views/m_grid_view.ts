...
export class ResizingController extends modules.ViewController {
  ...
  public _initPostRenderHandlers() {
  ...
  public _setVisibleWidths(visibleColumns, widths) {
  ...
  public _toggleBestFitModeForView(view, className, isBestFit) {
  ...
  public _toggleContentMinHeight(value) {
  ...
  public _getAverageColumnsWidth(resultWidths) {
  ...
  public _processStretch(resultSizes, visibleColumns) {
  ...
  public _getRealColumnWidth(columnIndex, columnWidths, groupWidth?) {
    let ratio = 1;
  ...
  public _getTotalWidth(widths, groupWidth) {
    let result = 0;
  ...
  public _resetGroupElementHeight() {
  ...
  public _setScrollerSpacingCore() {
    const that = this;
  ...
  public _updateLastSizes($rootElement) {
...
export class SynchronizeScrollingController extends modules.ViewController {
  public _scrollChangedHandler(views, pos, viewName) {
