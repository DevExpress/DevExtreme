...
export const AI_ASSISTANT_POPUP_HEIGHT = 560;
export const AI_ASSISTANT_CONFIRM_DIALOG_WIDTH = 425;
export const AI_ASSISTANT_CONFIRM_DIALOG_COMPACT_WIDTH = 360;
