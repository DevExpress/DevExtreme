...
export class KeyboardNavigationController extends modules.ViewController {
  ...
  public _getCellPosition($cell, direction?): {
    rowIndex: number;
    columnIndex: number;
  } | undefined {
    let columnIndex;
  ...
  */
  ...
  public _fireFocusedCellChanging(
    $event: Event,
  ...
  public _memoFireFocusedCellChanged(
    rowKey: RowKey,
    columnIndex: number,
  ): void {
    const $cell = this._getFocusedCell();
  ...
  public _memoFireFocusedRowChanged(focusedRowKey: RowKey, focusedRowIndex: number): void {
