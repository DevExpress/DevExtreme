...
export const adaptivityHeadersKeyboardNavigationExtender = (
  Base: ModuleType<HeadersKeyboardNavigationController>,
): ModuleType<HeadersKeyboardNavigationController> => class AdaptivityHeadersKeyboardNavigationExtender
  extends Base {
