...
export class DOMComponent extends Component {
  ...
  _visibilityChanged?(visibility: boolean): void;
  ...
  _isDimensionChangeSupported() {
    return this._dimensionChanged !== undefined;
  }
  ...
  _isVisibilityChangeSupported() {
    return this._visibilityChanged !== undefined && hasWindow();
  }
