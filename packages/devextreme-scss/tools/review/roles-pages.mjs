...
const RU = {
  ...
  'list-border-disabled': 'Border-роль красит <b>текст</b>. Неактивный текст списка сидит на #d7d7d7 / #4c4c4c, тогда как content-роль дала бы #ababab / #767676 — заметно контрастнее. Вопрос контраста, а не гигиены имён.',
  'tabs-tab-border-disabled': '<code>content-disabled</code> красит фон индикатора неактивной вкладки. Bg-роли с таким значением нет.',
