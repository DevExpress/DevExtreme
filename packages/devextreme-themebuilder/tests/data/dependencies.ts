...
export const dependencies: FlatStylesDependencies = {
  ...
  diagram: ['loadindicator', 'validation', 'button', 'loadpanel', 'scrollview', 'popup', 'textbox', 'list', 'checkbox', 'selectbox', 'numberbox', 'popover', 'tooltip', 'multiview', 'tabs', 'tabpanel', 'progressbar'],
