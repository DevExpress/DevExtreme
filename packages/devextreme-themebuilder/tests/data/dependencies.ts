...
export const dependencies: FlatStylesDependencies = {
  ...
  diagram: ['accordion', 'colorbox', 'contextmenu', 'fileuploader', 'toolbar', 'loadindicator', 'validation', 'button', 'loadpanel', 'scrollview', 'popup', 'toolbar', 'textbox', 'contextmenu', 'list', 'checkbox', 'selectbox', 'numberbox', 'colorbox', 'popover', 'accordion', 'tooltip', 'multiview', 'tabs', 'tabpanel', 'progressbar', 'fileuploader'],
