...
export default [
    js.configs.recommended,
    {
        ...
        rules: {
            ...
            'key-spacing': 'error',
            'keyword-spacing': ['error', { overrides: { catch: { after: false }, for: { after: false }, if: { after: false }, switch: { after: false }, while: { after: false } } }],
            ...
            'spaced-comment': ['error', 'always', { exceptions: ['#DEBUG', '#ENDDEBUG'], markers: ['/'] }],
