...
const DxItemConfig = {
  ...
  props: {
    ...
    tabs: Array as PropType<Record<string, any>[]>,
    tabTemplate: {},
    template: {},
    text: String,
    title: String,
...
const DxTabPanelOptionsConfig = {
  ...
  props: {
    ...
    bindingOptions: Object as PropType<Record<string, any>>,
    dataSource: [Array, Object, String] as PropType<((any | dxTabPanelItem | string)[]) | DataSource | DataSourceOptions | null | Store | string | Record<string, any>>,
    ...
    items: Array as PropType<(any | dxTabPanelItem | string)[]>,
    itemTemplate: {},
    itemTitleTemplate: {},
    loop: Boolean,
    noDataText: String,
