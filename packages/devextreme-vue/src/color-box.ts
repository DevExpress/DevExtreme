...
const DxDropDownOptionsConfig = {
  ...
  props: {
    ...
    onResize: Function as PropType<(((e: { component: dxPopup, element: any, event: event, height: number, model: any, width: number }) => void)) | null>,
    onResizeEnd: Function as PropType<(((e: { component: dxPopup, element: any, event: event, height: number, model: any, width: number }) => void)) | null>,
    onResizeStart: Function as PropType<(((e: { component: dxPopup, element: any, event: event, height: number, model: any, width: number }) => void)) | null>,
    ...
    onTitleRendered: Function as PropType<(((e: { component: dxPopup, element: any, model: any, titleElement: any }) => void)) | null>,
