...
const componentConfig = {
  props: {
    ...
    columns: Array as PropType<(dxDataGridColumn | string)[]>,
    columnWidth: [String, Number] as PropType<Mode | number>,
    customizeColumns: Function as PropType<((columns: dxDataGridColumn[]) => void)>,
    dataRowTemplate: {},
    dataSource: [Array, Object, String] as PropType<any[] | DataSource | DataSourceOptions | null | Store | string | Record<string, any>>,
    ...
    filterValue: [Array, Function, String] as PropType<any[] | ((() => any)) | string>,
    ...
    selectionFilter: [Array, Function, String] as PropType<any[] | ((() => any)) | string>,
    showBorders: Boolean,
    showColumnHeaders: Boolean,
    showColumnLines: Boolean,
    showRowLines: Boolean,
    sortByGroupSummaryInfo: Array as PropType<Record<string, any>[]>,
...
const DxColumnConfig = {
  ...
  props: {
    ...
    buttons: Array as PropType<(DataGridPredefinedColumnButton | dxDataGridColumnButton)[]>,
    ...
    calculateFilterExpression: Function as PropType<((filterValue: any, selectedFilterOperation: string | null, target: string) => string | (() => any) | any[])>,
    ...
    encodeHtml: Boolean,
    falseText: String,
    filterOperations: Array as PropType<(FilterOperation | string)[]>,
    ...
    validationRules: Array as PropType<CommonTypes.ValidationRule[]>,
    visible: Boolean,
    visibleIndex: Number,
    width: [Number, String],
  },
...
const DxColumnHeaderFilterConfig = {
  ...
  props: {
    allowSearch: Boolean,
    allowSelectAll: Boolean,
    dataSource: [Array, Object, Function] as PropType<any[] | DataSourceOptions | (((options: { component: Record<string, any>; dataSource: DataSourceOptions | null }) => void)) | null | Store | Record<string, any>>,
...
const DxColumnLookupConfig = {
  ...
  props: {
    ...
    calculateCellValue: Function as PropType<((rowData: any) => any)>,
    dataSource: [Array, Object, Function] as PropType<any[] | DataSourceOptions | (((options: { data: Record<string, any>; key: any }) => any[] | Store | DataSourceOptions)) | null | Store | Record<string, any>>,
...
const DxCustomOperationConfig = {
  ...
  props: {
    calculateFilterExpression: Function as PropType<((filterValue: any, field: dxFilterBuilderField) => string | (() => any) | any[])>,
    caption: String,
    customizeText: Function as PropType<((fieldInfo: { field: dxFilterBuilderField; value: string | number | Date; valueText: string }) => string)>,
    dataTypes: Array as PropType<DataType[]>,
    editorTemplate: {},
    hasValue: Boolean,
    icon: String,
    name: String,
...
const DxEditingConfig = {
  ...
  props: {
    ...
    changes: Array as PropType<DataChange[]>,
...
const DxExportConfig = {
  ...
  props: {
    ...
    enabled: Boolean,
    formats: Array as PropType<(DataGridExportFormat | string)[]>,
    texts: Object as PropType<Record<string, any>>,
  },
};
...
const DxFieldConfig = {
  ...
  props: {
    calculateFilterExpression: Function as PropType<((filterValue: any, selectedFilterOperation: string) => string | (() => any) | any[])>,
    caption: String,
    ...
    editorTemplate: {},
    falseText: String,
    filterOperations: Array as PropType<(FilterBuilderOperation | string)[]>,
    format: [Object, String, Function] as PropType<Format | CommonFormat | (((value: number | Date) => string)) | Record<string, any> | string>,
    lookup: Object as PropType<Record<string, any>>,
    name: String,
    trueText: String,
...
const DxFieldLookupConfig = {
  ...
  props: {
    allowClearing: Boolean,
    dataSource: [Array, Object] as PropType<any[] | DataSourceOptions | Store | Record<string, any>>,
    displayExpr: [Function, String] as PropType<(((data: any) => string)) | string>,
...
const DxFilterBuilderConfig = {
  ...
  props: {
    ...
    customOperations: Array as PropType<dxFilterBuilderCustomOperation[]>,
    disabled: Boolean,
    elementAttr: Object as PropType<Record<string, any>>,
    fields: Array as PropType<dxFilterBuilderField[]>,
    ...
    groupOperations: Array as PropType<GroupOperation[]>,
    height: [Function, Number, String] as PropType<((() => number | string)) | number | string>,
    hint: String,
    hoverStateEnabled: Boolean,
    ...
    rtlEnabled: Boolean,
    tabIndex: Number,
    value: [Array, Function, String] as PropType<any[] | ((() => any)) | string>,
    visible: Boolean,
    width: [Function, Number, String] as PropType<((() => number | string)) | number | string>,
  },
};
...
const DxFormConfig = {
  ...
  props: {
    ...
    hoverStateEnabled: Boolean,
    isDirty: Boolean,
    items: Array as PropType<(dxFormButtonItem | dxFormEmptyItem | dxFormGroupItem | dxFormSimpleItem | dxFormTabbedItem)[]>,
...
const DxPagerConfig = {
  ...
  props: {
    allowedPageSizes: [Array, String] as PropType<((number | PagerPageSize)[]) | Mode>,
...
const DxSummaryConfig = {
  ...
  props: {
    ...
    groupItems: Array as PropType<Record<string, any>[]>,
    recalculateWhileEditing: Boolean,
    skipEmptyValues: Boolean,
    texts: Object as PropType<Record<string, any>>,
    totalItems: Array as PropType<Record<string, any>[]>,
  },
};
...
const DxToolbarConfig = {
  ...
  props: {
    disabled: Boolean,
    items: Array as PropType<(DataGridPredefinedToolbarItem | dxDataGridToolbarItem)[]>,
    visible: Boolean,
  },
};
