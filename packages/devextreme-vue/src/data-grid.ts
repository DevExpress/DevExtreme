...
const componentConfig = {
  ...
  beforeCreate() {
    ...
    (this as any).$_expectedChildren = {
      ...
      dataGridEditing: { isCollectionItem: false, optionName: "editing" },
...
prepareConfigurationComponentConfig(DxDataGridEditingConfig);

const DxDataGridEditing = defineComponent(DxDataGridEditingConfig);

(DxDataGridEditing as any).$_optionName = "editing";
(DxDataGridEditing as any).$_expectedChildren = {
  change: { isCollectionItem: true, optionName: "changes" },
  dataGridEditingTexts: { isCollectionItem: false, optionName: "texts" },
  form: { isCollectionItem: false, optionName: "form" },
  popup: { isCollectionItem: false, optionName: "popup" },
  texts: { isCollectionItem: false, optionName: "texts" }
};

const DxDataGridEditingTextsConfig = {
  emits: {
    "update:isActive": null,
    "update:hoveredElement": null,
    "update:addRow": null,
...
prepareConfigurationComponentConfig(DxDataGridEditingTextsConfig);

const DxDataGridEditingTexts = defineComponent(DxDataGridEditingTextsConfig);

(DxDataGridEditingTexts as any).$_optionName = "texts";
