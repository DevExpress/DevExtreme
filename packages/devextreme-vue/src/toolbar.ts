...
const componentConfig = {
  props: {
    dataSource: [Array, Object, String] as PropType<((any | dxToolbarItem | string)[]) | DataSource | DataSourceOptions | null | Store | string | Record<string, any>>,
    disabled: Boolean,
    elementAttr: Object as PropType<Record<string, any>>,
    hint: String,
    hoverStateEnabled: Boolean,
    itemHoldTimeout: Number,
    items: Array as PropType<(any | dxToolbarItem | string)[]>,
    itemTemplate: {},
    menuItemTemplate: {},
    multiline: Boolean,
    noDataText: String,
