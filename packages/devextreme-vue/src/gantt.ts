...
const componentConfig = {
  props: {
    ...
    sorting: Object,
    startDateRange: Date,
    stripLines: Array as PropType<Object[]>,
    tabIndex: Number,
    taskContentTemplate: {},
