...
const DxContextMenuConfig = {
  ...
  props: {
    items: Array as PropType<Array<Object | FileManagerPredefinedContextMenuItem>>
  }
};
...
const DxToolbarConfig = {
  ...
  props: {
    fileSelectionItems: Array as PropType<Array<Object | FileManagerPredefinedToolbarItem>>,
    items: Array as PropType<Array<Object | FileManagerPredefinedToolbarItem>>
  }
};
