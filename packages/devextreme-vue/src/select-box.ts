...
import { prepareConfigurationComponentConfig, prepareComponentConfig } from './core/index';
...
const componentConfig = {
  props: {
    ...
    buttons: Array as PropType<(DropDownPredefinedButton | TextEditorButton)[]>,
    customItemCreateEvent: String,
    dataSource: [Array, Object, String] as PropType<((any | CollectionWidgetItem)[]) | DataSource | DataSourceOptions | null | Store | string | Record<string, any>>,
    ...
    isDirty: Boolean,
    isValid: Boolean,
    items: Array as PropType<(any | CollectionWidgetItem)[]>,
    itemTemplate: {},
    label: String,
    ...
    searchExpr: [Array, Function, String] as PropType<(((() => any) | string)[]) | ((() => any)) | string>,
...
const DxDropDownOptionsConfig = {
  ...
  props: {
    ...
    title: String,
    titleTemplate: {},
    toolbarItems: Array as PropType<dxPopupToolbarItem[]>,
    visible: Boolean,
    width: [Function, Number, String] as PropType<((() => number | string)) | number | string>,
    wrapperAttr: {},
  },
