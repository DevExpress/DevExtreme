...
const componentConfig = {
  props: {
    ...
    isDirty: Boolean,
    isValid: Boolean,
    mediaResizing: Object as PropType<dxHtmlEditorMediaResizing | null | Record<string, any>>,
    mentions: Array as PropType<Array<dxHtmlEditorMention> | null>,
    name: String,
    ...
    tabIndex: Number,
    tableContextMenu: Object as PropType<dxHtmlEditorTableContextMenu | null | Record<string, any>>,
    tableResizing: Object as PropType<dxHtmlEditorTableResizing | null | Record<string, any>>,
    toolbar: Object as PropType<dxHtmlEditorToolbar | null | Record<string, any>>,
    validationError: {},
    ...
    value: {},
    variables: Object as PropType<dxHtmlEditorVariables | null | Record<string, any>>,
    visible: Boolean,
    width: [Number, String]
  },
  emits: {
...
const DxFileUploaderOptionsConfig = {
  ...
  props: {
    ...
    onValueChanged: Function as PropType<(((e: FileUploaderValueChangedEvent) => void)) | null>,
    progress: Number,
    readOnly: Boolean,
