...
const componentConfig = {
  props: {
    ...
    expandedExpr: [Function, String] as PropType<(((item: any) => any)) | string>,
    expandEvent: String as PropType<TreeViewExpandEvent>,
    expandIcon: String as PropType<null | string>,
    expandNodesRecursive: Boolean,
    focusStateEnabled: Boolean,
    hasItemsExpr: [Function, String] as PropType<(((item: any) => any)) | string>,
    height: [Number, String],
    hint: String,
    hoverStateEnabled: Boolean,
    itemHoldTimeout: Number,
    items: Array as PropType<Array<any | dxTreeViewItem>>,
    itemsExpr: [Function, String] as PropType<(((item: any, value: any) => any)) | string>,
    itemTemplate: {},
    ...
    parentIdExpr: [Function, String] as PropType<(((item: any, value: any) => any)) | string>,
    rootValue: {},
    rtlEnabled: Boolean,
    ...
    selectedExpr: [Function, String] as PropType<(((item: any) => any)) | string>,
