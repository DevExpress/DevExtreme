...
(function(root, factory) {
    ...
    localization.loadMessages({
        "da": {
            ...
            "dxDropDownEditor-selectLabel": "Vælg",
            "validation-required": "Påkrævet",
            "validation-required-formatted": "{0} er påkrævet",
            "validation-numeric": "Værdien skal være et tal",
            "validation-numeric-formatted": "{0} skal være et tal",
            "validation-range": "Værdien er uden for rækkevidde",
            "validation-range-formatted": "{0} er uden for rækkevidde",
            "validation-stringLength": "Længden af værdien er ikke korrekt",
            "validation-stringLength-formatted": "Længden på {0} er ikke korrekt",
            "validation-custom": "Værdien er ugyldig",
            "validation-custom-formatted": "{0} er ugyldig",
            "validation-async": "Værdien er ugyldig",
            "validation-async-formatted": "{0} er ugyldig",
            "validation-compare": "Værdierne stemmer ikke overens",
            "validation-compare-formatted": "{0} stemmer ikke overens",
            "validation-pattern": "Værdien stemmer ikke overens med mønsteret",
            "validation-pattern-formatted": "{0} stemmer ikke overens med mønsteret",
            "validation-email": "E-mailen er ugyldig",
            "validation-email-formatted": "{0} er ugyldig",
            "validation-mask": "Værdien er ugyldig",
            "dxLookup-searchPlaceholder": "Minimum antal tegn: {0}",
            "dxList-pullingDownText": "Træk ned for at opdatere...",
            "dxList-pulledDownText": "Slip for at opdatere...",
            "dxList-refreshingText": "Opdaterer...",
            "dxList-pageLoadingText": "Indlæser...",
            "dxList-nextButtonText": "Indlæs mere",
            "dxList-selectAll": "Vælg alle",
            ...
            "dxList-listAriaLabel-itemContent": "Listeelementindhold",
            "dxScrollView-pullingDownText": "Træk ned for at opdatere...",
            "dxScrollView-pulledDownText": "Slip for at opdatere...",
            "dxScrollView-refreshingText": "Opdaterer...",
            "dxScrollView-reachBottomText": "Indlæser...",
            "dxDateBox-simulatedDataPickerTitleTime": "Vælg tid",
            "dxDateBox-simulatedDataPickerTitleDate": "Vælg dato",
            "dxDateBox-simulatedDataPickerTitleDateTime": "Vælg dato og tid",
            "dxDateBox-validation-datetime": "Værdien skal være en dato eller en tid",
            "dxDateRangeBox-invalidStartDateMessage": "Startværdi skal være en dato",
            "dxDateRangeBox-invalidEndDateMessage": "Slutværdien skal være en dato",
            ...
            "dxFileUploader-selectFile": "Vælg en fil",
            ...
            "dxFileUploader-uploadFileButtonLabel": "Upload fil {0}",
            "dxRangeSlider-ariaFrom": "Fra",
            "dxRangeSlider-ariaTill": "Indtil",
            "dxSwitch-switchedOnText": "TÆNDT",
            "dxSwitch-switchedOffText": "SLUKKET",
            "dxForm-optionalMark": "valgfri",
            "dxForm-requiredMessage": "{0} er påkrævet",
            "dxForm-smartPasteButtonText": "Smart Sæt ind",
            "dxForm-resetButtonText": "Nulstil",
            "dxForm-submitButtonText": "Indsend",
            "dxNumberBox-invalidValueMessage": "Værdien skal være et tal",
            "dxNumberBox-noDataText": "Ingen data",
            "dxDataGrid-aiAssistantTitle": "AI-assistent",
            "dxDataGrid-aiAssistantProcessingMessageHeader": "Anmodning i gang",
            "dxDataGrid-aiAssistantProcessingMessage": "Behandler...",
            "dxDataGrid-aiAssistantErrorMessageHeader": "Kunne ikke behandle anmodning",
            "dxDataGrid-aiAssistantAbortMessage": "Anmodning stoppet.",
            "dxDataGrid-aiAssistantSuccessMessage": "Vellykket",
            "dxDataGrid-aiAssistantErrorMessage": "Fejl",
            "dxDataGrid-aiAssistantExecutionAbortMessage": "Udførelse afbrudt",
            "dxDataGrid-aiAssistantExecutionInProgressMessage": "Udførelse er allerede i gang. Vent venligst.",
            "dxDataGrid-aiAssistantRequestInProgressMessage": "Anmodning er allerede i gang. Vent venligst.",
            "dxDataGrid-aiAssistantUnexpectedErrorMessage": "Der opstod en uventet fejl. Prøv igen.",
            "dxDataGrid-aiAssistantInvalidResponseMessage": "Ugyldigt svar fra AI-tjenesten. Prøv igen.",
            "dxDataGrid-aiAssistantClearButtonText": "Ryd",
            "dxDataGrid-aiAssistantRegenerateButtonText": "Generer igen",
            "dxDataGrid-aiAssistantAbortConfirmText": "Lukning af AI-assistent-chatten afbryder igangværende anmodninger. Vil du lukke chatten?",
            "dxDataGrid-aiAChatEmptyViewMessage": "Chatten er tom",
            "dxDataGrid-aiChatEmptyViewPrompt": "AI-assistenten er klar til at besvare dine spørgsmål.",
            "dxDataGrid-aiPromptEditorTitle": "AI Prompteditor",
            "dxDataGrid-aiPromptEditorPlaceholder": "Anmod AI om at generere kolonneværdier...",
            "dxDataGrid-aiPromptEditorApplyButton": "Anvend",
            "dxDataGrid-aiPromptEditorRegenerateButton": "Regenerer data",
            "dxDataGrid-aiPromptEditorStopButton": "Stop",
            "dxDataGrid-aiDropDownAutofill": "Udfyld automatisk med AI",
            "dxDataGrid-aiDropDownClear": "Ryd data",
            ...
            "dxDataGrid-emptyHeaderWithColumnChooserAndGroupPanelText": "Brug {0}, eller træk en kolonne fra gruppepanelet",
            "dxDataGrid-emptyHeaderColumnChooserText": "kolonnevælger",
            "dxDataGrid-columnChooserTitle": "Kolonnevælger",
            "dxDataGrid-columnChooserEmptyText": "Træk en kolonne hertil for at skjule den",
            "dxDataGrid-groupContinuesMessage": "Fortsætter på næste side",
            "dxDataGrid-groupContinuedMessage": "Fortsat fra forrige side",
            "dxDataGrid-groupHeaderText": "Gruppér efter denne kolonne",
            "dxDataGrid-ungroupHeaderText": "Ophæv grupperingen",
            "dxDataGrid-ungroupAllText": "Ophæv grupperingen af alle",
            ...
            "dxDataGrid-editingConfirmDeleteMessage": "Er du sikker på, at du vil slette denne post?",
            "dxDataGrid-validationCancelChanges": "Annuller ændringer",
            "dxDataGrid-groupPanelEmptyText": "Træk en kolonneoverskrift her for at gruppere efter den kolonne",
            "dxDataGrid-noDataText": "Ingen data",
            "dxDataGrid-searchPanelPlaceholder": "Søg...",
            ...
            "dxDataGrid-filterRowOperationGreater": "Større end",
            "dxDataGrid-filterRowOperationGreaterOrEquals": "Større end eller lig med",
            ...
            "dxDataGrid-ariaSearchBox": "Søgefelt",
            ...
            "dxDataGrid-ariaSortedAscendingColumn": "Kolonne sorteret i stigende rækkefølge",
            "dxDataGrid-ariaSortedDescendingColumn": "Kolonne sorteret i faldende rækkefølge",
            "dxDataGrid-ariaSortIndex": "Sorter indeks {0}",
            "dxDataGrid-editingSaveAllChanges": "Gem ændringer",
            "dxDataGrid-editingCancelAllChanges": "Kassér ændringer",
            "dxDataGrid-editingAddRow": "Tilføj en række",
            ...
            "dxDataGrid-columnFixingRightPosition": "Højre",
            "dxDataGrid-columnFixingStickyPosition": "Klæbrig",
            ...
            "dxDataGrid-selectedRows": "Valgte rækker",
            "dxDataGrid-exportSelectedRows": "Eksporter valgte rækker til {0}",
            ...
            "dxDataGrid-ariaValue": "Værdi",
            "dxDataGrid-ariaError": "Fejl",
            "dxDataGrid-ariaRevertButton": "Tryk på Escape for at kassere ændringerne",
            "dxDataGrid-ariaFilterCell": "Filtercelle",
            "dxDataGrid-ariaCollapse": "Sammenklap",
            "dxDataGrid-ariaModifiedCell": "Ændret",
            "dxDataGrid-ariaDeletedCell": "Slettet",
            "dxDataGrid-ariaEditableCell": "Redigerbar",
            "dxDataGrid-ariaExpand": "Udvid",
            "dxDataGrid-ariaCollapsedRow": "Sammenklappet række",
            "dxDataGrid-ariaExpandedRow": "Udvidet række",
            "dxDataGrid-ariaDataGrid": "Datagitter med {0} rækker og {1} kolonner",
            "dxDataGrid-ariaSearchInGrid": "Søg i datagitteret",
            "dxDataGrid-ariaSelectAll": "Vælg alle",
            "dxDataGrid-ariaSelectRow": "Vælg række",
            "dxDataGrid-ariaToolbar": "Værktøjslinje for datagitter",
            ...
            "dxDataGrid-moveColumnToTheRight": "Flyt til højre",
            "dxDataGrid-moveColumnToTheLeft": "Flyt til venstre",
            ...
            "dxPager-nextPage": "Næste side",
            "dxPager-ariaLabel": "Sidenavigation",
            "dxPager-ariaPageSize": "Sidestørrelse",
            ...
            "dxPagination-nextPage": "Næste side",
            "dxPagination-ariaLabel": "Sidenavigation",
            "dxPagination-ariaPageSize": "Sidestørrelse",
            "dxPagination-ariaPageNumber": "Sidenummer",
            "dxPivotGrid-ariaLabel": "Pivot grid",
            "dxPivotGrid-grandTotal": "Samlet total",
            "dxPivotGrid-total": "{0} i alt",
            "dxPivotGrid-fieldChooserTitle": "Feltvælger",
            "dxPivotGrid-showFieldChooser": "Vis feltvælger",
            ...
            "dxPivotGrid-sortRowBySummary": "Sorter \"{0}\" efter denne række",
            "dxPivotGrid-removeAllSorting": "Fjern al sortering",
            "dxPivotGrid-dataNotAvailable": "Ikke tilgængelig",
            "dxPivotGrid-rowFields": "Rækkefelter",
            ...
            "dxPivotGrid-rowFieldArea": "Slip rækkefelter her",
            "dxPivotGrid-filterFieldArea": "Slip filterfelter her",
            "dxScheduler-dateRange": "fra {0} til {1}",
            "dxScheduler-ariaLabel": "Planlægger. {0} visning: {1} med {2} aftaler",
            "dxScheduler-ariaLabel-currentIndicator-present": "Den aktuelle tidsmåler er synlig i visningen",
            "dxScheduler-ariaLabel-currentIndicator-not-present": "Den aktuelle tidsmåler er ikke synlig på skærmen",
            "dxScheduler-appointmentAriaDescription-group": "Gruppe: {0}",
            "dxScheduler-appointmentAriaLabel-recurring": "Tilbagevendende aftale",
            "dxScheduler-hotkeysAriaDescription-delete": "Tryk på Delete for at slette denne aftale",
            "dxScheduler-hotkeysAriaDescription-homeEnd": "Tryk på Home eller End for hurtigt at navigere til den første eller sidste aftale",
            "dxScheduler-appointmentListAriaLabel": "Aftaleliste",
            "dxScheduler-newPopupTitle": "Ny aftale",
            "dxScheduler-editPopupTitle": "Rediger aftale",
            "dxScheduler-editPopupSaveButtonText": "Gem",
            ...
            "dxScheduler-noSubject": "(Intet emne)",
            "dxScheduler-navigationToday": "I dag",
            "dxScheduler-navigationPrevious": "Forrige side",
            "dxScheduler-navigationNext": "Næste side",
            "dxScheduler-openAppointment": "Åben aftale",
            ...
            "dxScheduler-recurrenceYearly": "Årligt",
            "dxScheduler-recurrenceRepeatEvery": "Gentag hver",
            "dxScheduler-recurrenceRepeatOn": "Gentag på",
            "dxScheduler-recurrenceEnd": "Slutgentagelse",
            "dxScheduler-recurrenceAfter": "Efter",
            "dxScheduler-recurrenceOn": "På",
            "dxScheduler-recurrenceUntilDateLabel": "Dato for afslutning af gentagelse",
            "dxScheduler-recurrenceOccurrenceLabel": "Antal hændelser",
            ...
            "dxScheduler-recurrenceRepeatCount": "hændelse(r)",
            ...
            "dxCalendar-currentMonth": "Nuværende måned",
            "dxCalendar-currentYear": "Nuværende år",
            "dxCalendar-currentYearRange": "Nuværende årsinterval",
            "dxCalendar-todayButtonText": "I dag",
            "dxCalendar-ariaWidgetName": "Kalender",
            "dxCalendar-previousMonthButtonLabel": "Forrige måned",
            "dxCalendar-previousYearButtonLabel": "Forrige år",
            "dxCalendar-previousDecadeButtonLabel": "Forrige årti",
            "dxCalendar-previousCenturyButtonLabel": "Forrige århundrede",
            "dxCalendar-nextMonthButtonLabel": "Næste måned",
            "dxCalendar-nextYearButtonLabel": "Næste år",
            "dxCalendar-nextDecadeButtonLabel": "Næste årti",
            "dxCalendar-nextCenturyButtonLabel": "Næste århundrede",
            "dxCalendar-captionMonthLabel": "Valg af måned",
            "dxCalendar-captionYearLabel": "Årsvalg",
            "dxCalendar-captionDecadeLabel": "Årti valg",
            "dxCalendar-captionCenturyLabel": "Århundrede valg",
            ...
            "dxCardView-ariaSearchInGrid": "Søg i kortvisningen",
            "dxCardView-ariaHeaderItemLabel": "Feltnavn {0}",
            "dxCardView-ariaHeaderItemSortingAscendingLabel": "Sorteret i stigende rækkefølge",
            "dxCardView-ariaHeaderItemSortingDescendingLabel": "Sorteret i faldende rækkefølge",
            "dxCardView-ariaHeaderItemSortingIndexLabel": "Sorteringsindeks {0}",
            "dxCardView-ariaHeaderHasHeaderFilterLabel": "Overskriftsfilter anvendt",
            "dxCardView-ariaSelectCard": "Vælg kort",
            "dxCardView-ariaCardView": "Kortvisning med {0} kort. Hvert kort har {1} felter",
            "dxCardView-ariaCard": "Kort",
            "dxCardView-ariaEditableCard": "Redigerbart kort",
            "dxCardView-ariaCardPosition": "Række {0}, kolonne {1}",
            "dxCardView-ariaSelectedCardState": "Valgt",
            "dxCardView-ariaNotSelectedCardState": "Ikke valgt",
            "dxCardView-selectAll": "Vælg alle",
            "dxCardView-clearSelection": "Ryd valg",
            "dxCardView-cardNoImageAriaLabel": "Intet billede",
            "dxCardView-headerItemDropZoneText": "Slip overskriftselementet her",
            "dxCardView-emptyHeaderPanelText": "Brug {0} til at vise kolonner",
            "dxCardView-emptyHeaderPanelColumnChooserText": "kolonnevælger",
            ...
            "dxChat-editingMessageCaption": "Rediger besked",
            ...
            "dxChat-emptyListPrompt": "Skriv din første besked",
            ...
            "dxChat-editedMessageText": "Redigeret",
            "dxChat-editingEditMessage": "Rediger",
            "dxChat-editingDeleteMessage": "Slet",
            "dxChat-editingDeleteConfirmText": "Er du sikker på, at du vil slette denne besked?",
            "dxChat-deletedMessageText": "Denne besked blev slettet",
            "dxChat-defaultImageAlt": "Billede delt i chat",
            "dxChat-fileViewLabel": "Filliste",
            "dxChat-downloadButtonLabel": "Download fil {0}",
            "dxChat-fileLimitReachedWarning": "Du valgte for mange filer. Vælg højst {0} filer og prøv igen.",
            ...
            "dxTagBox-tagRoleDescription": "Tag. Tryk på sletteknappen for at fjerne dette tag",
            ...
            "dxFilterBuilder-addCondition": "Tilføj betingelse",
            "dxFilterBuilder-addGroup": "Tilføj gruppe",
            "dxFilterBuilder-enterValueText": "<indtast en værdi>",
            ...
            "dxFilterBuilder-filterOperationGreater": "Er større end",
            "dxFilterBuilder-filterOperationGreaterOrEquals": "Er større end eller lig med",
            ...
            "dxFilterBuilder-filterAriaAddButton": "Tilføj",
            ...
            "dxHtmlEditor-link": "Tilføj link",
            "dxHtmlEditor-image": "Tilføj billede",
            "dxHtmlEditor-size": "Størrelse",
            "dxHtmlEditor-strike": "Gennemstregning",
            "dxHtmlEditor-subscript": "Sænket skrift",
            "dxHtmlEditor-superscript": "Hævet skrift",
            "dxHtmlEditor-underline": "Understregning",
            "dxHtmlEditor-blockquote": "Blokcitat",
            "dxHtmlEditor-header": "Overskrift",
            "dxHtmlEditor-increaseIndent": "Forøg indrykning",
            ...
            "dxHtmlEditor-alignRight": "Juster til højre",
            "dxHtmlEditor-alignJustify": "Juster",
            "dxHtmlEditor-codeBlock": "Kodeblok",
            "dxHtmlEditor-variable": "Tilføj variabel",
            "dxHtmlEditor-undo": "Fortryd",
            "dxHtmlEditor-redo": "Gentag",
            "dxHtmlEditor-clear": "Ryd formatering",
            "dxHtmlEditor-insertTable": "Indsæt tabel",
            "dxHtmlEditor-insertHeaderRow": "Indsæt overskriftsrække",
            "dxHtmlEditor-insertRowAbove": "Indsæt række over",
            "dxHtmlEditor-insertRowBelow": "Indsæt række under",
            "dxHtmlEditor-insertColumnLeft": "Indsæt kolonne til venstre",
            "dxHtmlEditor-insertColumnRight": "Indsæt kolonne til højre",
            "dxHtmlEditor-deleteColumn": "Slet kolonne",
            "dxHtmlEditor-deleteRow": "Slet række",
            ...
            "dxHtmlEditor-right": "Højre",
            "dxHtmlEditor-indent": "Indryk",
            "dxHtmlEditor-justify": "Retfærdiggør",
            ...
            "dxHtmlEditor-aiDialogError": "Der opstod en fejl. Prøv igen.",
            "dxHtmlEditor-aiDialogCanceled": "Generering annulleret",
            "dxHtmlEditor-aiReplace": "Erstat",
            "dxHtmlEditor-aiInsertAbove": "Indsæt over",
            "dxHtmlEditor-aiInsertBelow": "Indsæt under",
            "dxHtmlEditor-aiCopy": "Kopier",
            "dxHtmlEditor-aiRegenerate": "Regenerer",
            "dxHtmlEditor-aiGenerate": "Generer",
            "dxHtmlEditor-aiCancel": "Annuller",
            "dxHtmlEditor-aiToolbarItemAriaLabel": "AI Assistant-værktøjslinjelement",
            "dxHtmlEditor-aiResultTextAreaAriaLabel": "AI Assistant-resultat",
            "dxHtmlEditor-aiAskPlaceholder": "Bed AI om at ændre tekst",
            "dxHtmlEditor-aiCommandSummarize": "Opsummer",
            "dxHtmlEditor-aiCommandProofread": "Korrekturlæs",
            "dxHtmlEditor-aiCommandExpand": "Udvid",
            "dxHtmlEditor-aiCommandShorten": "Forkort",
            "dxHtmlEditor-aiCommandChangeStyle": "Skift stil",
            "dxHtmlEditor-aiCommandChangeTone": "Skift tone",
            "dxHtmlEditor-aiCommandTranslate": "Oversæt",
            "dxHtmlEditor-aiCommandAskAI": "Spørg AI",
            "dxHtmlEditor-aiCommandChangeStyleFormal": "Formel",
            "dxHtmlEditor-aiCommandChangeStyleInformal": "Uformel",
            "dxHtmlEditor-aiCommandChangeStyleTechnical": "Teknisk",
            "dxHtmlEditor-aiCommandChangeStyleBusiness": "Forretningsmæssig",
            ...
            "dxHtmlEditor-aiCommandChangeStyleNarrative": "Fortællende",
            "dxHtmlEditor-aiCommandChangeStyleExpository": "Forklarende",
            "dxHtmlEditor-aiCommandChangeStyleDescriptive": "Beskrivende",
            "dxHtmlEditor-aiCommandChangeStyleConversational": "Samtalende",
            "dxHtmlEditor-aiCommandChangeToneProfessional": "Professionel",
            "dxHtmlEditor-aiCommandChangeToneCasual": "Uformel",
            "dxHtmlEditor-aiCommandChangeToneStraightforward": "Ligefrem",
            "dxHtmlEditor-aiCommandChangeToneConfident": "Selvsikker",
            "dxHtmlEditor-aiCommandChangeToneFriendly": "Venlig",
            ...
            "dxFileManager-newDirectoryName": "Ny mappe",
            "dxFileManager-rootDirectoryName": "Filer",
            "dxFileManager-errorNoAccess": "Adgang nægtet. Handlingen kunne ikke fuldføres.",
            ...
            "dxFileManager-errorMaxFileSizeExceeded": "Filstørrelsen overstiger den maksimalt tilladte størrelse.",
            "dxFileManager-errorInvalidSymbols": "Dette navn indeholder ugyldige tegn.",
            "dxFileManager-errorDefault": "Uspecificeret fejl.",
            "dxFileManager-errorDirectoryOpenFailed": "Mappen kan ikke åbnes",
            "dxFileManager-commandCreate": "Opret mappe",
            "dxFileManager-commandRename": "Omdøb",
            ...
            "dxFileManager-commandThumbnails": "Miniaturevisning",
            "dxFileManager-commandDetails": "Detaljevisning",
            "dxFileManager-commandClearSelection": "Ryd valg",
            "dxFileManager-commandShowNavPane": "Vis/skjul navigationsrude",
            ...
            "dxFileManager-dialogRenameItemTitle": "Omdøb",
            "dxFileManager-dialogRenameItemButtonText": "Gem",
            "dxFileManager-dialogCreateDirectoryTitle": "Opret mappe",
            ...
            "dxFileManager-dialogDeleteItemSingleItemConfirmation": "Er du sikker på, at du vil slette {0}?",
            "dxFileManager-dialogDeleteItemMultipleItemsConfirmation": "Er du sikker på, at du vil slette {0} elementer?",
            ...
            "dxFileManager-editingRenameSingleItemProcessingMessage": "Omdøbning af et element i {0}",
            "dxFileManager-editingRenameSingleItemSuccessMessage": "Omdøbte et element i {0}",
            "dxFileManager-editingRenameSingleItemErrorMessage": "Elementet blev ikke omdøbt",
            "dxFileManager-editingRenameCommonErrorMessage": "Elementet blev ikke omdøbt",
            ...
            "dxFileManager-listDetailsColumnCaptionDateModified": "Ændret dato",
            "dxFileManager-listDetailsColumnCaptionFileSize": "Filstørrelse",
            "dxFileManager-listThumbnailsTooltipTextSize": "Størrelse",
            "dxFileManager-listThumbnailsTooltipTextDateModified": "Ændret dato",
            ...
            "dxDiagram-categoryFlowchart": "Rutediagram",
            ...
            "dxDiagram-commandFontSize": "Skrifttypestørrelse",
            ...
            "dxDiagram-commandAlignRight": "Juster til højre",
            ...
            "dxDiagram-commandPaste": "Indsæt",
            "dxDiagram-commandSelectAll": "Vælg alle",
            "dxDiagram-commandDelete": "Slet",
            "dxDiagram-commandBringToFront": "Bring forrest",
            "dxDiagram-commandSendToBack": "Send tilbage",
            "dxDiagram-commandLock": "Lås",
            "dxDiagram-commandUnlock": "Lås op",
            "dxDiagram-commandInsertShapeImage": "Indsæt billede...",
            "dxDiagram-commandEditShapeImage": "Skift billede...",
            "dxDiagram-commandDeleteShapeImage": "Slet billede",
            "dxDiagram-commandLayoutLeftToRight": "Venstre-til-højre",
            "dxDiagram-commandLayoutRightToLeft": "Højre mod venstre",
            ...
            "dxDiagram-dialogInsertShapeImageTitle": "Indsæt billede",
            "dxDiagram-dialogEditShapeImageTitle": "Skift billede",
            "dxDiagram-dialogEditShapeImageSelectButton": "Vælg billede",
            ...
            "dxDiagram-uiShowToolbox": "Vis værktøjskasse",
            "dxDiagram-uiSearch": "Søg",
            "dxDiagram-uiStyle": "Stil",
            "dxDiagram-uiLayout": "Layout",
            "dxDiagram-uiLayoutTree": "Træ",
            ...
            "dxDiagram-shapeArrowRight": "Højre pil",
            "dxDiagram-shapeArrowDown": "Pil ned",
            "dxDiagram-shapeArrowUpDown": "Pil op og ned",
            "dxDiagram-shapeArrowLeftRight": "Venstre højre pil",
            ...
            "dxDiagram-shapeCardWithImageOnTop": "Kort med billede på toppen",
            "dxDiagram-shapeCardWithImageOnRight": "Kort med billede til højre",
            ...
            "dxGantt-dialogButtonAdd": "Tilføj",
            ...
            "dxGantt-contextMenuDeleteDependency": "Slet afhængighed",
            "dxGantt-dialogTaskDeleteConfirmation": "Sletning af en opgave sletter også alle dens afhængigheder og underopgaver. Er du sikker på, at du vil slette denne opgave?",
            "dxGantt-dialogDependencyDeleteConfirmation": "Er du sikker på, at du vil slette afhængigheden fra opgaven?",
            "dxGantt-dialogResourcesDeleteConfirmation": "Sletning af en ressource sletter den også fra opgaver, som denne ressource er tildelt. Er du sikker på, at du vil slette disse ressourcer? Ressourcer: {0}",
            "dxGantt-dialogConstraintCriticalViolationMessage": "Den opgave, du forsøger at flytte, er knyttet til en anden opgave af en afhængighedsrelation. Denne ændring ville være i strid med afhængighedsreglerne. Hvordan vil du gerne komme videre?",
            "dxGantt-dialogConstraintViolationMessage": "Den opgave, du forsøger at flytte, er knyttet til en anden opgave af en afhængighedsrelation. Hvordan vil du gerne komme videre?",
            "dxGantt-dialogCancelOperationMessage": "Annuller operationen",
            "dxGantt-dialogDeleteDependencyMessage": "Slet afhængigheden",
            "dxGantt-dialogMoveTaskAndKeepDependencyMessage": "Flyt opgaven og behold afhængigheden",
            "dxGantt-dialogConstraintCriticalViolationSeveralTasksMessage": "Den opgave, du forsøger at flytte, er knyttet til en anden opgave af afhængighedsrelationer. Denne ændring ville være i strid med afhængighedsreglerne. Hvordan vil du gerne komme videre?",
            "dxGantt-dialogConstraintViolationSeveralTasksMessage": "Den opgave, du forsøger at flytte, er knyttet til en anden opgave af afhængighedsrelationer. Hvordan vil du gerne komme videre?",
            "dxGantt-dialogDeleteDependenciesMessage": "Slet afhængighedsrelationerne",
            "dxGantt-dialogMoveTaskAndKeepDependenciesMessage": "Flyt opgaven og behold afhængighederne",
            "dxGantt-undo": "Fortryd",
            "dxGantt-redo": "Gentag",
            "dxGantt-expandAll": "Udvid alle",
            "dxGantt-collapseAll": "Sammenklap alle",
            "dxGantt-addNewTask": "Tilføj ny opgave",
            "dxGantt-deleteSelectedTask": "Slet den valgte opgave",
            "dxGantt-zoomIn": "Zoom ind",
            "dxGantt-zoomOut": "Zoom ud",
            "dxGantt-fullScreen": "Fuldskærm",
            "dxGantt-quarter": "Q{0}",
            ...
            "dxGantt-showDependencies": "Vis afhængigheder",
            "dxGantt-dialogStartDateValidation": "Startdatoen skal være efter {0}",
            "dxGantt-dialogEndDateValidation": "Slutdatoen skal være efter {0}",
            ...
            "dxSplitter-resizeHandleAriaLabel": "Splitlinje",
            "dxSplitter-resizeHandleAriaRoleDescription": "Adskiller",
            "dxStepper-optionalMark": "(Valgfri)",
            "dxSpeechToText-ariaLabelStart": "Tryk for at starte stemmeafskrivning",
            "dxSpeechToText-ariaLabelStop": "Tryk for at stoppe stemmeafskrivning"
        }
    });
}));
