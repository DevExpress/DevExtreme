...
(function(root, factory) {
    ...
    localization.loadMessages({
        "ru": {
            ...
            "validation-email-formatted": "Недопустимое значение {0}",
            ...
            "dxList-listAriaLabel": "Элементы",
            "dxList-listAriaLabel-deletable": "Удаляемые элементы",
            "dxListEditDecorator-delete": "Удалить",
            "dxListEditDecorator-more": "Еще",
            "dxList-selectAll-indeterminate": "Частично отмечено",
            "dxList-selectAll-checked": "Отмечено",
            "dxList-selectAll-notChecked": "Не отмечено",
            "dxList-ariaRoleDescription": "Список",
            "dxList-listAriaLabel-itemContent": "Содержимое элемента списка",
            ...
            "dxDateRangeBox-invalidStartDateMessage": "Начальное значение должно быть датой",
            "dxDateRangeBox-invalidEndDateMessage": "Конечное значение должно быть датой",
            "dxDateRangeBox-startDateOutOfRangeMessage": "Начальная дата вне допустимого диапазона",
            "dxDateRangeBox-endDateOutOfRangeMessage": "Конечная дата вне допустимого диапазона",
            ...
            "dxFileUploader-fileListLabel": "Список файлов",
            "dxFileUploader-removeFileButtonLabel": "Удалить файл {0}",
            "dxFileUploader-uploadFileButtonLabel": "Загрузить файл {0}",
            ...
            "dxForm-smartPasteButtonText": "Умная вставка",
            "dxForm-resetButtonText": "Сбросить",
            "dxForm-submitButtonText": "Отправить",
            ...
            "dxDataGrid-aiPromptEditorTitle": "Редактор запросов AI",
            "dxDataGrid-aiPromptEditorPlaceholder": "Попросите AI сгенерировать значения для столбцов...",
            "dxDataGrid-aiPromptEditorApplyButton": "Применить",
            "dxDataGrid-aiPromptEditorRegenerateButton": "Сгенерировать заново",
            "dxDataGrid-aiPromptEditorStopButton": "Остановить",
            "dxDataGrid-aiDropDownAutofill": "Автозаполнение с AI",
            "dxDataGrid-aiDropDownClear": "Очистить данные",
            ...
            "dxDataGrid-ariaSearchBox": "Поле поиска",
            ...
            "dxDataGrid-ariaNotSortedColumn": "Несортированный столбец",
            "dxDataGrid-ariaSortedAscendingColumn": "Столбец отсортирован по возрастанию",
            "dxDataGrid-ariaSortedDescendingColumn": "Столбец отсортирован по убыванию",
            "dxDataGrid-ariaSortIndex": "Индекс сортировки {0}",
            ...
            "dxDataGrid-summaryAvg": "Среднее: {0}",
            "dxDataGrid-summaryAvgOtherColumn": "Среднее по {1} : {0}",
            "dxDataGrid-summarySum": "Сумм: {0}",
            "dxDataGrid-summarySumOtherColumn": "Сумм по {1} : {0}",
            "dxDataGrid-summaryCount": "Кол-во: {0}",
            "dxDataGrid-columnFixingFix": "Зафиксировать положение",
            "dxDataGrid-columnFixingUnfix": "Отменить фиксацию",
            "dxDataGrid-columnFixingLeftPosition": "Слева",
            "dxDataGrid-columnFixingRightPosition": "Справа",
            "dxDataGrid-columnFixingStickyPosition": "Прикрепить",
            "dxDataGrid-exportTo": "Экспортировать",
            "dxDataGrid-exportToExcel": "Экспортировать в файл Excel",
            ...
            "dxDataGrid-ariaColumnHeader": "Заголовок столбца",
            "dxDataGrid-ariaValue": "Значение",
            "dxDataGrid-ariaError": "Ошибка",
            "dxDataGrid-ariaRevertButton": "Нажмите Esc для отмены изменений",
            "dxDataGrid-ariaFilterCell": "Фильтр",
            "dxDataGrid-ariaCollapse": "Свернуть",
            "dxDataGrid-ariaModifiedCell": "Изменено",
            "dxDataGrid-ariaDeletedCell": "Удалено",
            "dxDataGrid-ariaEditableCell": "Редактируемое",
            "dxDataGrid-ariaExpand": "Развернуть",
            "dxDataGrid-ariaCollapsedRow": "Свёрнутая строка",
            "dxDataGrid-ariaExpandedRow": "Развёрнутая строка",
            ...
            "dxDataGrid-ariaEditForm": "Форма редактирования",
            ...
            "dxDataGrid-masterDetail": "Ячейка с подробностями",
            "dxDataGrid-moveColumnToTheRight": "Переместить вправо",
            "dxDataGrid-moveColumnToTheLeft": "Переместить влево",
            "dxTreeList-ariaTreeList": "Иерархическая таблица данных с {0} строками и {1} колонками",
            "dxTreeList-ariaExpandableInstruction": "Нажмите Ctrl + стрелка вправо, чтобы развернуть узел, и Ctrl + стрелка влево, чтобы свернуть его",
            ...
            "dxScheduler-dateRange": "с {0} по {1}",
            "dxScheduler-ariaLabel": "Планировщик. Вид {0}: {1}, записей: {2}",
            "dxScheduler-ariaLabel-currentIndicator-present": "Индикатор текущего времени отображается в виде",
            "dxScheduler-ariaLabel-currentIndicator-not-present": "Индикатор текущего времени не отображается на экране",
            "dxScheduler-appointmentAriaDescription-group": "Группа: {0}",
            "dxScheduler-appointmentAriaLabel-recurring": "Повторяющаяся запись",
            "dxScheduler-hotkeysAriaDescription-delete": "Нажмите Delete для удаления записи",
            "dxScheduler-hotkeysAriaDescription-homeEnd": "Нажмите Home или End для быстрой навигации к первой или последней записи",
            "dxScheduler-appointmentListAriaLabel": "Список записей",
            "dxScheduler-newPopupTitle": "Новая запись",
            "dxScheduler-editPopupTitle": "Редактирование записи",
            "dxScheduler-editPopupSaveButtonText": "Сохранить",
            "dxScheduler-editorLabelTitle": "Название",
            "dxScheduler-editorLabelStartDate": "Дата начала",
            "dxScheduler-editorAriaLabelStartTime": "Время начала",
            "dxScheduler-editorLabelEndDate": "Дата завершения",
            "dxScheduler-editorAriaLabelEndTime": "Время завершения",
            "dxScheduler-editorLabelDescription": "Описание",
            "dxScheduler-editorLabelRecurrence": "Повторение",
            "dxScheduler-noSubject": "(Без названия)",
            "dxScheduler-navigationToday": "Сегодня",
            "dxScheduler-navigationPrevious": "Предыдущий период",
            "dxScheduler-navigationNext": "Следующий период",
            ...
            "dxScheduler-recurrenceUntilDateLabel": "Дата завершения повторений",
            "dxScheduler-recurrenceOccurrenceLabel": "Количество повторений",
            "dxScheduler-recurrenceRepeatMinutely": "мин.",
            "dxScheduler-recurrenceRepeatHourly": "час.",
            "dxScheduler-recurrenceRepeatDaily": "дн.",
            "dxScheduler-recurrenceRepeatWeekly": "нед.",
            "dxScheduler-recurrenceRepeatMonthly": "мес.",
            "dxScheduler-recurrenceRepeatYearly": "г.",
            ...
            "dxScheduler-ariaEditForm": "Форма редактирования",
            "dxScheduler-confirmRecurrenceEditTitle": "Редактирование повторяющейся записи",
            "dxScheduler-confirmRecurrenceDeleteTitle": "Удаление повторяющейся записи",
            ...
            "dxCalendar-currentDay": "Сегодня",
            "dxCalendar-currentMonth": "Текущий месяц",
            "dxCalendar-currentYear": "Текущий год",
            "dxCalendar-currentYearRange": "Текущий диапазон лет",
            "dxCalendar-todayButtonText": "Сегодня",
            "dxCalendar-ariaWidgetName": "Календарь",
            "dxCalendar-previousMonthButtonLabel": "Предыдущий месяц",
            "dxCalendar-previousYearButtonLabel": "Предыдущий год",
            "dxCalendar-previousDecadeButtonLabel": "Предыдущее десятилетие",
            "dxCalendar-previousCenturyButtonLabel": "Предыдущий век",
            "dxCalendar-nextMonthButtonLabel": "Следующий месяц",
            "dxCalendar-nextYearButtonLabel": "Следующий год",
            "dxCalendar-nextDecadeButtonLabel": "Следующее десятилетие",
            "dxCalendar-nextCenturyButtonLabel": "Следующий век",
            "dxCalendar-captionMonthLabel": "Выбор месяца",
            "dxCalendar-captionYearLabel": "Выбор года",
            "dxCalendar-captionDecadeLabel": "Выбор десятилетия",
            "dxCalendar-captionCenturyLabel": "Выбор века",
            "dxCalendar-selectedDate": "Выбранная дата: {0}",
            "dxCalendar-selectedDates": "Выбранные даты",
            "dxCalendar-selectedDateRange": "Выбранный диапазон дат: с {0} по {1}",
            "dxCalendar-selectedMultipleDateRange": "с {0} по {1}",
            "dxCalendar-selectedDateRangeCount": "Выбрано диапазонов дат: {0}",
            "dxCalendar-readOnlyLabel": "Календарь только для чтения",
            "dxCardView-ariaSearchInGrid": "Поиск в виде карточек",
            "dxCardView-ariaHeaderItemLabel": "Имя поля {0}",
            "dxCardView-ariaHeaderItemSortingAscendingLabel": "Отсортировано по возрастанию",
            "dxCardView-ariaHeaderItemSortingDescendingLabel": "Отсортировано по убыванию",
            "dxCardView-ariaHeaderItemSortingIndexLabel": "Индекс сортировки {0}",
            "dxCardView-ariaHeaderHasHeaderFilterLabel": "Применён фильтр заголовка",
            "dxCardView-ariaSelectCard": "Выбрать карточку",
            "dxCardView-ariaCardView": "Вид карточек с {0} карточками. Каждая карточка содержит {1} полей",
            "dxCardView-ariaCard": "Карточка",
            "dxCardView-ariaEditableCard": "Редактируемая карточка",
            "dxCardView-ariaCardPosition": "Строка {0}, столбец {1}",
            "dxCardView-ariaSelectedCardState": "Выбрано",
            "dxCardView-ariaNotSelectedCardState": "Не выбрано",
            "dxCardView-selectAll": "Выбрать все",
            "dxCardView-clearSelection": "Очистить выделение",
            "dxCardView-cardNoImageAriaLabel": "Нет изображения",
            "dxCardView-headerItemDropZoneText": "Перетащите элемент заголовка сюда",
            "dxCardView-emptyHeaderPanelText": "Используйте {0} для отображения столбцов",
            "dxCardView-emptyHeaderPanelColumnChooserText": "выбор столбцов",
            "dxAvatar-defaultImageAlt": "Аватар",
            "dxChat-elementAriaLabel": "Чат",
            "dxChat-textareaPlaceholder": "Введите сообщение",
            "dxChat-sendButtonAriaLabel": "Отправить",
            "dxChat-cancelEditingButtonAriaLabel": "Отмена",
            "dxChat-editingMessageCaption": "Редактировать сообщение",
            "dxChat-defaultUserName": "Неизвестный пользователь",
            "dxChat-messageListAriaLabel": "Список сообщений",
            "dxChat-alertListAriaLabel": "Список ошибок",
            "dxChat-emptyListMessage": "В этом чате нет сообщений",
            "dxChat-emptyListPrompt": "Напишите первое сообщение",
            "dxChat-typingMessageSingleUser": "{0} печатает...",
            "dxChat-typingMessageTwoUsers": "{0} и {1} печатают...",
            "dxChat-typingMessageThreeUsers": "{0}, {1} и {2} печатают...",
            "dxChat-typingMessageMultipleUsers": "{0} и другие печатают...",
            "dxChat-editedMessageText": "Изменено",
            "dxChat-editingEditMessage": "Редактировать",
            "dxChat-editingDeleteMessage": "Удалить",
            "dxChat-editingDeleteConfirmText": "Вы уверены, что хотите удалить это сообщение?",
            "dxChat-deletedMessageText": "Это сообщение было удалено",
            "dxChat-defaultImageAlt": "Изображение из чата",
            "dxChat-fileViewLabel": "Список файлов",
            "dxChat-downloadButtonLabel": "Скачать файл {0}",
            "dxChat-fileLimitReachedWarning": "Выбрано слишком много файлов. Выберите не более {0} файлов и повторите попытку.",
            ...
            "dxTagBox-tagRoleDescription": "Тег. Нажмите кнопку удаления, чтобы удалить этот тег",
            "dxTagBox-ariaRoleDescription": "Поле тегов",
            ...
            "dxFilterBuilder-filterAriaRootElement": "Конструктор фильтра",
            "dxFilterBuilder-filterAriaGroupLevel": "Уровень {0}",
            "dxFilterBuilder-filterAriaGroupItem": "Элемент группы",
            "dxFilterBuilder-filterAriaOperationButton": "Операция",
            "dxFilterBuilder-filterAriaAddButton": "Добавить",
            "dxFilterBuilder-filterAriaRemoveButton": "Удалить {0}",
            "dxFilterBuilder-filterAriaItemField": "Поле элемента",
            "dxFilterBuilder-filterAriaItemOperation": "Операция элемента",
            "dxFilterBuilder-filterAriaItemValue": "Значение элемента",
            ...
            "dxHtmlEditor-borderWidth": "Ширина границы",
            ...
            "dxHtmlEditor-aiDialogTitle": "Ассистент AI",
            "dxHtmlEditor-aiDialogError": "Что-то пошло не так. Пожалуйста, попробуйте ещё раз.",
            "dxHtmlEditor-aiDialogCanceled": "Генерация отменена",
            "dxHtmlEditor-aiReplace": "Заменить",
            "dxHtmlEditor-aiInsertAbove": "Вставить выше",
            "dxHtmlEditor-aiInsertBelow": "Вставить ниже",
            "dxHtmlEditor-aiCopy": "Копировать",
            "dxHtmlEditor-aiRegenerate": "Сгенерировать заново",
            "dxHtmlEditor-aiGenerate": "Создать",
            "dxHtmlEditor-aiCancel": "Отмена",
            "dxHtmlEditor-aiToolbarItemAriaLabel": "Элемент панели инструментов ассистента AI",
            "dxHtmlEditor-aiResultTextAreaAriaLabel": "Результат ассистента AI",
            "dxHtmlEditor-aiAskPlaceholder": "Попросите AI изменить текст",
            "dxHtmlEditor-aiCommandSummarize": "Краткое изложение",
            "dxHtmlEditor-aiCommandProofread": "Проверить",
            "dxHtmlEditor-aiCommandExpand": "Расширить",
            "dxHtmlEditor-aiCommandShorten": "Сократить",
            "dxHtmlEditor-aiCommandChangeStyle": "Изменить стиль",
            "dxHtmlEditor-aiCommandChangeTone": "Изменить тон",
            "dxHtmlEditor-aiCommandTranslate": "Перевести",
            "dxHtmlEditor-aiCommandAskAI": "Спросить AI",
            "dxHtmlEditor-aiCommandChangeStyleFormal": "Деловой",
            "dxHtmlEditor-aiCommandChangeStyleInformal": "Неформальный",
            "dxHtmlEditor-aiCommandChangeStyleTechnical": "Технический",
            "dxHtmlEditor-aiCommandChangeStyleBusiness": "Бизнес",
            "dxHtmlEditor-aiCommandChangeStyleCreative": "Творческий",
            "dxHtmlEditor-aiCommandChangeStyleJournalistic": "Журналистский",
            "dxHtmlEditor-aiCommandChangeStyleAcademic": "Академический",
            "dxHtmlEditor-aiCommandChangeStylePersuasive": "Убедительный",
            "dxHtmlEditor-aiCommandChangeStyleNarrative": "Нарративный",
            "dxHtmlEditor-aiCommandChangeStyleExpository": "Разъяснительный",
            "dxHtmlEditor-aiCommandChangeStyleDescriptive": "Описательный",
            "dxHtmlEditor-aiCommandChangeStyleConversational": "Разговорный",
            "dxHtmlEditor-aiCommandChangeToneProfessional": "Профессиональный",
            "dxHtmlEditor-aiCommandChangeToneCasual": "Непринуждённый",
            "dxHtmlEditor-aiCommandChangeToneStraightforward": "Прямолинейный",
            "dxHtmlEditor-aiCommandChangeToneConfident": "Уверенный",
            "dxHtmlEditor-aiCommandChangeToneFriendly": "Дружелюбный",
            "dxHtmlEditor-aiCommandTranslateArabic": "Арабский",
            "dxHtmlEditor-aiCommandTranslateChinese": "Китайский",
            "dxHtmlEditor-aiCommandTranslateEnglish": "Английский",
            "dxHtmlEditor-aiCommandTranslateFrench": "Французский",
            "dxHtmlEditor-aiCommandTranslateGerman": "Немецкий",
            "dxHtmlEditor-aiCommandTranslateJapanese": "Японский",
            "dxHtmlEditor-aiCommandTranslateSpanish": "Испанский",
            ...
            "dxFileManager-commandThumbnails": "Режим эскизов",
            ...
            "dxFileManager-editingCopyMultipleItemsProcessingMessage": "Копирование {0} элементов в {1}",
            ...
            "dxDiagram-commandAutoZoomByContent": "Автомасштаб по содержимому",
            "dxDiagram-commandAutoZoomByWidth": "Автомасштаб по ширине",
            ...
            "dxGallery-itemName": "Элемент галереи",
            "dxMultiView-elementAriaRoleDescription": "MultiView",
            "dxMultiView-elementAriaLabel": "Используйте клавиши со стрелками или проведите пальцем для перелистывания между видами",
            "dxMultiView-itemAriaRoleDescription": "Вид",
            "dxMultiView-itemAriaLabel": "{0} из {1}",
            "dxSplitter-resizeHandleAriaLabel": "Разделитель",
            "dxSplitter-resizeHandleAriaRoleDescription": "Разделитель",
            "dxStepper-optionalMark": "(Необязательно)",
            "dxSpeechToText-ariaLabelStart": "Нажмите для начала голосовой транскрипции",
            "dxSpeechToText-ariaLabelStop": "Нажмите для остановки голосовой транскрипции"
        }
    });
}));
