...
(function(root, factory) {
    ...
    localization.loadMessages({
        "pt-BR": {
            ...
            "dxList-listAriaLabel-deletable": "Itens excluíveis",
            "dxListEditDecorator-delete": "Excluir",
            "dxListEditDecorator-more": "Mais",
            "dxList-selectAll-indeterminate": "Meio marcado",
            "dxList-selectAll-checked": "Marcado",
            "dxList-selectAll-notChecked": "Não marcado",
            "dxList-ariaRoleDescription": "Lista",
            "dxList-listAriaLabel-itemContent": "Conteúdo do item da lista",
            ...
            "dxDateBox-validation-datetime": "O valor deve ser uma data ou hora",
            "dxDateRangeBox-invalidStartDateMessage": "O valor inicial deve ser uma data",
            "dxDateRangeBox-invalidEndDateMessage": "O valor final deve ser uma data",
            "dxDateRangeBox-startDateOutOfRangeMessage": "A data de início está fora do intervalo",
            "dxDateRangeBox-endDateOutOfRangeMessage": "A data de término está fora do intervalo",
            ...
            "dxFileUploader-fileListLabel": "Lista de arquivos",
            "dxFileUploader-removeFileButtonLabel": "Remover arquivo {0}",
            "dxFileUploader-uploadFileButtonLabel": "Carregar arquivo {0}",
            ...
            "dxForm-smartPasteButtonText": "Colar Inteligente",
            "dxForm-resetButtonText": "Limpar",
            "dxForm-submitButtonText": "Enviar",
            "dxNumberBox-invalidValueMessage": "O valor deve ser um número",
            "dxNumberBox-noDataText": "Sem dados",
            "dxDataGrid-aiAssistantTitle": "Assistente de IA",
            "dxDataGrid-aiAssistantProcessingMessageHeader": "Solicitação em andamento",
            "dxDataGrid-aiAssistantProcessingMessage": "Processando...",
            "dxDataGrid-aiAssistantErrorMessageHeader": "Falha ao processar a solicitação",
            "dxDataGrid-aiAssistantAbortMessage": "Solicitação interrompida.",
            "dxDataGrid-aiAssistantSuccessMessage": "Sucesso",
            "dxDataGrid-aiAssistantErrorMessage": "Erro",
            "dxDataGrid-aiAssistantExecutionAbortMessage": "Execução interrompida",
            "dxDataGrid-aiAssistantExecutionInProgressMessage": "Execução já em andamento. Aguarde.",
            "dxDataGrid-aiAssistantRequestInProgressMessage": "Solicitação já em andamento. Aguarde.",
            "dxDataGrid-aiAssistantUnexpectedErrorMessage": "Ocorreu um erro inesperado. Tente novamente.",
            "dxDataGrid-aiAssistantInvalidResponseMessage": "Resposta inválida do serviço de IA. Tente novamente.",
            "dxDataGrid-aiAssistantClearButtonText": "Limpar",
            "dxDataGrid-aiAssistantRegenerateButtonText": "Gerar novamente",
            "dxDataGrid-aiAssistantAbortConfirmText": "Fechar o chat do Assistente de IA interrompe as solicitações em andamento. Deseja fechar o chat?",
            "dxDataGrid-aiAChatEmptyViewMessage": "O chat está vazio",
            "dxDataGrid-aiChatEmptyViewPrompt": "O Assistente de IA está pronto para responder suas perguntas.",
            "dxDataGrid-aiPromptEditorTitle": "Editor de Prompt de IA",
            "dxDataGrid-aiPromptEditorPlaceholder": "Solicite à IA para gerar valores para as colunas...",
            "dxDataGrid-aiPromptEditorApplyButton": "Aplicar",
            "dxDataGrid-aiPromptEditorRegenerateButton": "Regenerar Dados",
            "dxDataGrid-aiPromptEditorStopButton": "Parar",
            "dxDataGrid-aiDropDownAutofill": "Preencher automaticamente com IA",
            "dxDataGrid-aiDropDownClear": "Limpar Dados",
            ...
            "dxDataGrid-columnChooserEmptyText": "Arraste uma coluna até aqui para escondê-la",
            ...
            "dxDataGrid-editingConfirmDeleteMessage": "Tem certeza de que deseja excluir este registro?",
            ...
            "dxDataGrid-ariaNotSortedColumn": "Coluna não ordenada",
            ...
            "dxDataGrid-ariaSortIndex": "Índice de ordenação {0}",
            ...
            "dxDataGrid-columnFixingFix": "Definir posição fixa",
            ...
            "dxDataGrid-exportSelectedRows": "Exportar linhas selecionadas para {0}",
            "dxDataGrid-exportAll": "Exportar todos os dados para {0}",
            ...
            "dxDataGrid-ariaColumnHeader": "Cabeçalho da coluna",
            "dxDataGrid-ariaValue": "Valor",
            "dxDataGrid-ariaError": "Erro",
            "dxDataGrid-ariaRevertButton": "Pressione Escape para descartar as alterações",
            "dxDataGrid-ariaFilterCell": "Filtro de célula",
            "dxDataGrid-ariaCollapse": "Contrair",
            "dxDataGrid-ariaModifiedCell": "Modificado",
            "dxDataGrid-ariaDeletedCell": "Excluído",
            "dxDataGrid-ariaEditableCell": "Editável",
            "dxDataGrid-ariaExpand": "Expandir",
            "dxDataGrid-ariaCollapsedRow": "Linha recolhida",
            "dxDataGrid-ariaExpandedRow": "Linha expandida",
            "dxDataGrid-ariaDataGrid": "Grade de dados com {0} linhas e {1} colunas",
            ...
            "dxDataGrid-ariaEditForm": "Formulário de edição",
            ...
            "dxDataGrid-masterDetail": "Célula com detalhes",
            "dxDataGrid-moveColumnToTheRight": "Mover para a direita",
            "dxDataGrid-moveColumnToTheLeft": "Mover para a esquerda",
            "dxTreeList-ariaTreeList": "Lista em árvore com {0} linhas e {1} colunas",
            "dxTreeList-ariaExpandableInstruction": "Pressione Ctrl + seta para a direita para expandir o nó em foco e Ctrl + seta para a esquerda para recolhê-lo",
            ...
            "dxPagination-infoText": "Página {0} de {1} ({2} itens)",
            "dxPagination-pagesCountText": "de",
            "dxPagination-pageSize": "Itens por página: {0}",
            "dxPagination-pageSizesAllText": "Todos",
            "dxPagination-page": "Página {0}",
            "dxPagination-prevPage": "Página anterior",
            "dxPagination-nextPage": "Próxima página",
            "dxPagination-ariaLabel": "Navegação na página",
            "dxPagination-ariaPageSize": "Tamanho da página",
            "dxPagination-ariaPageNumber": "Número de páginas",
            ...
            "dxScheduler-ariaLabel": "Agendador. Visualização {0}: {1} com {2} compromissos",
            "dxScheduler-ariaLabel-currentIndicator-present": "O indicador de tempo atual está visível na visualização",
            "dxScheduler-ariaLabel-currentIndicator-not-present": "O indicador de tempo atual não está visível na tela",
            "dxScheduler-appointmentAriaDescription-group": "Grupo: {0}",
            "dxScheduler-appointmentAriaLabel-recurring": "Compromisso recorrente",
            "dxScheduler-hotkeysAriaDescription-delete": "Pressione Delete para excluir este compromisso",
            "dxScheduler-hotkeysAriaDescription-homeEnd": "Pressione Home ou End para navegar rapidamente para o primeiro ou último compromisso",
            "dxScheduler-appointmentListAriaLabel": "Lista de compromissos",
            "dxScheduler-newPopupTitle": "Novo compromisso",
            "dxScheduler-editPopupTitle": "Editar compromisso",
            "dxScheduler-editPopupSaveButtonText": "Salvar",
            "dxScheduler-editorLabelTitle": "Assunto",
            "dxScheduler-editorLabelStartDate": "Data de início",
            "dxScheduler-editorAriaLabelStartTime": "Hora de início",
            "dxScheduler-editorLabelEndDate": "Data final",
            "dxScheduler-editorAriaLabelEndTime": "Hora de término",
            "dxScheduler-editorLabelDescription": "Descrição",
            "dxScheduler-editorLabelRecurrence": "Repetir",
            "dxScheduler-noSubject": "(Sem assunto)",
            "dxScheduler-navigationToday": "Hoje",
            "dxScheduler-navigationPrevious": "Página anterior",
            "dxScheduler-navigationNext": "Próxima página",
            ...
            "dxScheduler-recurrenceUntilDateLabel": "Data de término da repetição",
            "dxScheduler-recurrenceOccurrenceLabel": "Número de ocorrências",
            ...
            "dxScheduler-ariaEditForm": "Editar formulário",
            ...
            "dxScheduler-confirmRecurrenceDeleteMessage": "Deseja excluir só este compromisso ou a série toda?",
            "dxScheduler-confirmRecurrenceEditSeries": "Editar série",
            "dxScheduler-confirmRecurrenceDeleteSeries": "Excluir série",
            "dxScheduler-confirmRecurrenceEditOccurrence": "Editar compromisso",
            "dxScheduler-confirmRecurrenceDeleteOccurrence": "Excluir compromisso",
            "dxScheduler-noTimezoneTitle": "Sem fuso horário",
            "dxScheduler-moreAppointments": "{0} mais",
            "dxCalendar-currentDay": "Hoje",
            "dxCalendar-currentMonth": "Mês atual",
            ...
            "dxCalendar-previousMonthButtonLabel": "Mês anterior",
            "dxCalendar-previousYearButtonLabel": "Ano anterior",
            "dxCalendar-previousDecadeButtonLabel": "Década anterior",
            "dxCalendar-previousCenturyButtonLabel": "Século anterior",
            "dxCalendar-nextMonthButtonLabel": "Próximo mês",
            "dxCalendar-nextYearButtonLabel": "Próximo ano",
            "dxCalendar-nextDecadeButtonLabel": "Próxima década",
            "dxCalendar-nextCenturyButtonLabel": "Próximo século",
            "dxCalendar-captionMonthLabel": "Seleção de mês",
            "dxCalendar-captionYearLabel": "Seleção de ano",
            "dxCalendar-captionDecadeLabel": "Seleção de década",
            "dxCalendar-captionCenturyLabel": "Seleção de século",
            "dxCalendar-selectedDate": "A data selecionada é {0}",
            "dxCalendar-selectedDates": "As datas selecionadas",
            "dxCalendar-selectedDateRange": "O intervalo de datas selecionado é de {0} a {1}",
            ...
            "dxCardView-ariaSearchInGrid": "Pesquisar na visualização de cartões",
            "dxCardView-ariaHeaderItemLabel": "Nome do campo {0}",
            "dxCardView-ariaHeaderItemSortingAscendingLabel": "Ordenado em ordem crescente",
            "dxCardView-ariaHeaderItemSortingDescendingLabel": "Ordenado em ordem decrescente",
            "dxCardView-ariaHeaderItemSortingIndexLabel": "Índice de ordenação {0}",
            "dxCardView-ariaHeaderHasHeaderFilterLabel": "Filtro de cabeçalho aplicado",
            "dxCardView-ariaSelectCard": "Selecionar cartão",
            "dxCardView-ariaCardView": "Visualização em cartões com {0} cartões. Cada cartão tem {1} campos",
            "dxCardView-ariaCard": "Cartão",
            "dxCardView-ariaEditableCard": "Cartão editável",
            "dxCardView-ariaCardPosition": "Linha {0}, coluna {1}",
            "dxCardView-ariaSelectedCardState": "Selecionado",
            "dxCardView-ariaNotSelectedCardState": "Não selecionado",
            "dxCardView-selectAll": "Selecionar tudo",
            "dxCardView-clearSelection": "Limpar seleção",
            "dxCardView-cardNoImageAriaLabel": "Sem imagem",
            "dxCardView-headerItemDropZoneText": "Solte o item de cabeçalho aqui",
            "dxCardView-emptyHeaderPanelText": "Use {0} para exibir colunas",
            "dxCardView-emptyHeaderPanelColumnChooserText": "seletor de coluna",
            ...
            "dxChat-editingMessageCaption": "Editar Mensagem",
            "dxChat-defaultUserName": "Usuário desconhecido",
            "dxChat-messageListAriaLabel": "Lista de mensagens",
            "dxChat-alertListAriaLabel": "Lista de erros",
            "dxChat-emptyListMessage": "Não há mensagens neste chat",
            "dxChat-emptyListPrompt": "Escreva sua primeira mensagem",
            "dxChat-typingMessageSingleUser": "{0} está digitando...",
            "dxChat-typingMessageTwoUsers": "{0} e {1} estão digitando...",
            "dxChat-typingMessageThreeUsers": "{0}, {1} e {2} estão digitando...",
            "dxChat-typingMessageMultipleUsers": "{0} e outros estão digitando...",
            "dxChat-editedMessageText": "Editado",
            "dxChat-editingEditMessage": "Editar",
            "dxChat-editingDeleteMessage": "Excluir",
            "dxChat-editingDeleteConfirmText": "Tem certeza de que deseja excluir esta mensagem?",
            "dxChat-deletedMessageText": "Esta mensagem foi excluída",
            "dxChat-defaultImageAlt": "Imagem compartilhada no chat",
            "dxChat-fileViewLabel": "Lista de arquivos",
            "dxChat-downloadButtonLabel": "Baixar arquivo {0}",
            "dxChat-fileLimitReachedWarning": "Você selecionou arquivos demais. Selecione no máximo {0} arquivos e tente novamente.",
            ...
            "dxTagBox-tagRoleDescription": "Tag. Pressione o botão de excluir para remover esta tag",
            "dxTagBox-ariaRoleDescription": "Caixa de tags",
            ...
            "dxFilterBuilder-filterOperationLessOrEquals": "Menor ou igual a",
            "dxFilterBuilder-filterOperationGreater": "Maior que",
            "dxFilterBuilder-filterOperationGreaterOrEquals": "Maior ou igual a",
            ...
            "dxFilterBuilder-filterAriaGroupLevel": "Nível {0}",
            "dxFilterBuilder-filterAriaGroupItem": "Item de grupo",
            "dxFilterBuilder-filterAriaOperationButton": "Operação",
            ...
            "dxFilterBuilder-filterAriaItemOperation": "Operação do item",
            ...
            "dxHtmlEditor-deleteColumn": "Excluir coluna",
            "dxHtmlEditor-deleteRow": "Excluir linha",
            "dxHtmlEditor-deleteTable": "Excluir tabela",
            ...
            "dxHtmlEditor-borderWidth": "Largura da borda",
            "dxHtmlEditor-tableBackground": "Fundo",
            "dxHtmlEditor-dimensions": "Dimensões",
            ...
            "dxHtmlEditor-aiDialogTitle": "Assistente de IA",
            "dxHtmlEditor-aiDialogError": "Algo deu errado. Por favor, tente novamente.",
            "dxHtmlEditor-aiDialogCanceled": "Geração cancelada",
            "dxHtmlEditor-aiReplace": "Substituir",
            "dxHtmlEditor-aiInsertAbove": "Inserir acima",
            "dxHtmlEditor-aiInsertBelow": "Inserir abaixo",
            "dxHtmlEditor-aiCopy": "Copiar",
            "dxHtmlEditor-aiRegenerate": "Regenerar",
            "dxHtmlEditor-aiGenerate": "Gerar",
            "dxHtmlEditor-aiCancel": "Cancelar",
            "dxHtmlEditor-aiToolbarItemAriaLabel": "Item de barra de ferramentas do Assistente de AI",
            "dxHtmlEditor-aiResultTextAreaAriaLabel": "Resultado do Assistente de AI",
            "dxHtmlEditor-aiAskPlaceholder": "Pedir à IA para modificar o texto",
            "dxHtmlEditor-aiCommandSummarize": "Resumir",
            "dxHtmlEditor-aiCommandProofread": "Revisar",
            "dxHtmlEditor-aiCommandExpand": "Expandir",
            "dxHtmlEditor-aiCommandShorten": "Encurtar",
            "dxHtmlEditor-aiCommandChangeStyle": "Alterar estilo",
            "dxHtmlEditor-aiCommandChangeTone": "Alterar tom",
            "dxHtmlEditor-aiCommandTranslate": "Traduzir",
            "dxHtmlEditor-aiCommandAskAI": "Perguntar à IA",
            ...
            "dxHtmlEditor-aiCommandChangeStyleCreative": "Criativo",
            "dxHtmlEditor-aiCommandChangeStyleJournalistic": "Jornalístico",
            "dxHtmlEditor-aiCommandChangeStyleAcademic": "Acadêmico",
            ...
            "dxHtmlEditor-aiCommandChangeStyleDescriptive": "Descritivo",
            "dxHtmlEditor-aiCommandChangeStyleConversational": "Conversacional",
            "dxHtmlEditor-aiCommandChangeToneProfessional": "Profissional",
            "dxHtmlEditor-aiCommandChangeToneCasual": "Casual",
            "dxHtmlEditor-aiCommandChangeToneStraightforward": "Direto",
            "dxHtmlEditor-aiCommandChangeToneConfident": "Confiante",
            "dxHtmlEditor-aiCommandChangeToneFriendly": "Amigável",
            "dxHtmlEditor-aiCommandTranslateArabic": "Árabe",
            "dxHtmlEditor-aiCommandTranslateChinese": "Chinês",
            "dxHtmlEditor-aiCommandTranslateEnglish": "Inglês",
            "dxHtmlEditor-aiCommandTranslateFrench": "Francês",
            "dxHtmlEditor-aiCommandTranslateGerman": "Alemão",
            "dxHtmlEditor-aiCommandTranslateJapanese": "Japonês",
            "dxHtmlEditor-aiCommandTranslateSpanish": "Espanhol",
            ...
            "dxDiagram-commandPageOrientationLandscape": "Paisagem",
            ...
            "dxGantt-dialogTaskDeleteConfirmation": "Excluir uma tarefa também exclui suas dependências e subtarefas. Você tem certeza de que quer excluir essa tarefa?",
            "dxGantt-dialogDependencyDeleteConfirmation": "Você tem certeza de que quer excluir a dependência desta tarefa?",
            "dxGantt-dialogResourcesDeleteConfirmation": "Ao excluir o recurso, ele também será excluído das tarefas em que está atribuído. Tem certeza de que quer excluir estes recursos? Recursos: {0}",
            ...
            "dxMultiView-elementAriaLabel": "Use as teclas de seta ou deslize para navegar entre as visualizações",
            "dxMultiView-itemAriaRoleDescription": "Visualização",
            "dxMultiView-itemAriaLabel": "{0} de {1}",
            "dxSplitter-resizeHandleAriaLabel": "Barra de divisão",
            "dxSplitter-resizeHandleAriaRoleDescription": "Separador",
            "dxStepper-optionalMark": "(Opcional)",
            "dxSpeechToText-ariaLabelStart": "Pressione para iniciar a transcrição de voz",
            "dxSpeechToText-ariaLabelStop": "Pressione para parar a transcrição de voz"
        }
    });
}));
