...
(function(root, factory) {
    ...
    localization.loadMessages({
        "es": {
            ...
            "No": "No",
            "Cancel": "Cancelar",
            "CheckState": "Estado de verificación",
            "Close": "Cerrar",
            "Clear": "Limpiar",
            "Done": "Hecho",
            "Loading": "Cargando...",
            ...
            "dxList-listAriaLabel": "Elementos",
            "dxList-listAriaLabel-deletable": "Elementos eliminables",
            "dxListEditDecorator-delete": "Eliminar",
            "dxListEditDecorator-more": "Más",
            "dxList-selectAll-indeterminate": "Semimarcado",
            "dxList-selectAll-checked": "Marcado",
            "dxList-selectAll-notChecked": "No marcado",
            "dxList-ariaRoleDescription": "Lista",
            "dxList-listAriaLabel-itemContent": "Contenido del elemento de lista",
            ...
            "dxDateRangeBox-startDateOutOfRangeMessage": "La fecha de inicio está fuera de rango",
            "dxDateRangeBox-endDateOutOfRangeMessage": "La fecha de fin está fuera de rango",
            ...
            "dxFileUploader-uploadAbortedMessage": "Carga cancelada",
            ...
            "dxFileUploader-fileListLabel": "Lista de archivos",
            "dxFileUploader-removeFileButtonLabel": "Eliminar archivo {0}",
            "dxFileUploader-uploadFileButtonLabel": "Subir archivo {0}",
            ...
            "dxForm-smartPasteButtonText": "Pegado inteligente",
            "dxForm-resetButtonText": "Reestablecer",
            "dxForm-submitButtonText": "Enviar",
            "dxNumberBox-invalidValueMessage": "Valor debe ser un número",
            "dxNumberBox-noDataText": "Sin datos",
            "dxDataGrid-aiAssistantTitle": "Asistente de IA",
            "dxDataGrid-aiAssistantProcessingMessageHeader": "Solicitud en curso",
            "dxDataGrid-aiAssistantProcessingMessage": "Procesando...",
            "dxDataGrid-aiAssistantErrorMessageHeader": "No se pudo procesar la solicitud",
            "dxDataGrid-aiAssistantAbortMessage": "Solicitud detenida.",
            "dxDataGrid-aiAssistantSuccessMessage": "Éxito",
            "dxDataGrid-aiAssistantErrorMessage": "Error",
            "dxDataGrid-aiAssistantExecutionAbortMessage": "Ejecución interrumpida",
            "dxDataGrid-aiAssistantExecutionInProgressMessage": "La ejecución ya está en curso. Por favor, espere.",
            "dxDataGrid-aiAssistantRequestInProgressMessage": "La solicitud ya está en curso. Por favor, espere.",
            "dxDataGrid-aiAssistantUnexpectedErrorMessage": "Se ha producido un error inesperado. Inténtelo de nuevo.",
            "dxDataGrid-aiAssistantInvalidResponseMessage": "Respuesta no válida del servicio de IA. Inténtelo de nuevo.",
            "dxDataGrid-aiAssistantClearButtonText": "Borrar",
            "dxDataGrid-aiAssistantRegenerateButtonText": "Regenerar",
            "dxDataGrid-aiAssistantAbortConfirmText": "Cerrar el chat del Asistente de IA interrumpe las solicitudes en curso. ¿Desea cerrar el chat?",
            "dxDataGrid-aiAChatEmptyViewMessage": "El chat está vacío",
            "dxDataGrid-aiChatEmptyViewPrompt": "El Asistente de IA está listo para responder sus preguntas.",
            "dxDataGrid-aiPromptEditorTitle": "Editor de indicaciones de IA",
            "dxDataGrid-aiPromptEditorPlaceholder": "Solicitar a la IA que genere valores de columna...",
            "dxDataGrid-aiPromptEditorApplyButton": "Aplicar",
            "dxDataGrid-aiPromptEditorRegenerateButton": "Regenerar datos",
            "dxDataGrid-aiPromptEditorStopButton": "Detener",
            "dxDataGrid-aiDropDownAutofill": "Autocompletar con IA",
            "dxDataGrid-aiDropDownClear": "Limpiar datos",
            "dxDataGrid-emptyHeaderWithColumnChooserText": "Usar {0} para mostrar columnas",
            "dxDataGrid-emptyHeaderWithGroupPanelText": "Arrastre una columna del panel de grupo aquí",
            "dxDataGrid-emptyHeaderWithColumnChooserAndGroupPanelText": "Usar {0} o arrastre una columna del panel de grupo",
            ...
            "dxDataGrid-ariaSearchBox": "Cuadro de búsqueda",
            ...
            "dxDataGrid-ariaNotSortedColumn": "Columna sin ordenar",
            "dxDataGrid-ariaSortedAscendingColumn": "Columna ordenada en orden ascendente",
            "dxDataGrid-ariaSortedDescendingColumn": "Columna ordenada en orden descendente",
            "dxDataGrid-ariaSortIndex": "Índice de ordenamiento {0}",
            ...
            "dxDataGrid-columnFixingFix": "Fijar posición",
            "dxDataGrid-columnFixingUnfix": "Desanclar",
            "dxDataGrid-columnFixingLeftPosition": "Izquierda",
            "dxDataGrid-columnFixingRightPosition": "Derecha",
            "dxDataGrid-columnFixingStickyPosition": "Fijo",
            ...
            "dxDataGrid-ariaColumnHeader": "Encabezado de columna",
            "dxDataGrid-ariaValue": "Valor",
            "dxDataGrid-ariaError": "Error",
            "dxDataGrid-ariaRevertButton": "Presione Escape para descartar los cambios",
            "dxDataGrid-ariaFilterCell": "Celda de filtro",
            "dxDataGrid-ariaCollapse": "Colapsar",
            "dxDataGrid-ariaModifiedCell": "Modificado",
            "dxDataGrid-ariaDeletedCell": "Eliminado",
            "dxDataGrid-ariaEditableCell": "Editable",
            "dxDataGrid-ariaExpand": "Expandir",
            "dxDataGrid-ariaCollapsedRow": "Fila contraída",
            "dxDataGrid-ariaExpandedRow": "Fila expandida",
            "dxDataGrid-ariaDataGrid": "Tabla de datos con {0} filas y {1} columnas",
            ...
            "dxDataGrid-ariaToolbar": "Barra de herramientas de la tabla de datos",
            ...
            "dxDataGrid-masterDetail": "Celda con detalles",
            "dxDataGrid-moveColumnToTheRight": "Mover a la derecha",
            "dxDataGrid-moveColumnToTheLeft": "Mover a la izquierda",
            "dxTreeList-ariaTreeList": "Lista de árbol con {0} filas y {1} columnas",
            "dxTreeList-ariaExpandableInstruction": "Presione Ctrl + flecha derecha para expandir el nodo enfocado y Ctrl + flecha izquierda para contraérlo",
            "dxTreeList-ariaSearchInGrid": "Buscar en la lista de árbol",
            "dxTreeList-ariaToolbar": "Barra de herramientas de la lista de árbol",
            "dxTreeList-editingAddRowToNode": "Añadir",
            "dxPager-infoText": "Página {0} de {1} ({2} ítems)",
            "dxPager-pagesCountText": "de",
            "dxPager-pageSize": "Elementos por página: {0}",
            ...
            "dxPagination-infoText": "Página {0} de {1} ({2} ítems)",
            "dxPagination-pagesCountText": "de",
            "dxPagination-pageSize": "Elementos por página: {0}",
            "dxPagination-pageSizesAllText": "Todos",
            "dxPagination-page": "Página {0}",
            "dxPagination-prevPage": "Página anterior",
            "dxPagination-nextPage": "Página siguiente",
            "dxPagination-ariaLabel": "Navegación de páginas",
            "dxPagination-ariaPageSize": "Tamaño de página",
            "dxPagination-ariaPageNumber": "Número de página",
            ...
            "dxScheduler-dateRange": "desde {0} hasta {1}",
            "dxScheduler-ariaLabel": "Programador. Vista {0}: {1} con {2} citas",
            "dxScheduler-ariaLabel-currentIndicator-present": "El indicador de hora actual es visible en la vista",
            "dxScheduler-ariaLabel-currentIndicator-not-present": "El indicador de hora actual no es visible en la pantalla",
            "dxScheduler-appointmentAriaDescription-group": "Grupo: {0}",
            "dxScheduler-appointmentAriaLabel-recurring": "Cita recurrente",
            "dxScheduler-hotkeysAriaDescription-delete": "Presione Suprimir para eliminar esta cita",
            "dxScheduler-hotkeysAriaDescription-homeEnd": "Presione Inicio o Fin para navegar rápidamente a la primera o última cita",
            "dxScheduler-appointmentListAriaLabel": "Lista de citas",
            "dxScheduler-newPopupTitle": "Nueva cita",
            "dxScheduler-editPopupTitle": "Editar cita",
            "dxScheduler-editPopupSaveButtonText": "Guardar",
            "dxScheduler-editorLabelTitle": "Asunto",
            "dxScheduler-editorLabelStartDate": "Fecha inicial",
            "dxScheduler-editorAriaLabelStartTime": "Hora de inicio",
            "dxScheduler-editorLabelEndDate": "Fecha final",
            "dxScheduler-editorAriaLabelEndTime": "Hora de fin",
            "dxScheduler-editorLabelDescription": "Descripción",
            "dxScheduler-editorLabelRecurrence": "Repetir",
            "dxScheduler-noSubject": "(Sin asunto)",
            "dxScheduler-navigationToday": "Hoy",
            "dxScheduler-navigationPrevious": "Página anterior",
            "dxScheduler-navigationNext": "Página siguiente",
            "dxScheduler-openAppointment": "Abrir cita",
            "dxScheduler-recurrenceNever": "Nunca",
            "dxScheduler-recurrenceMinutely": "Cada minuto",
            "dxScheduler-recurrenceHourly": "Por hora",
            ...
            "dxScheduler-recurrenceRepeatOn": "Repetir el",
            "dxScheduler-recurrenceEnd": "Terminar repetición",
            "dxScheduler-recurrenceAfter": "Después",
            "dxScheduler-recurrenceOn": "En",
            "dxScheduler-recurrenceUntilDateLabel": "Fecha en que termina la repetición",
            "dxScheduler-recurrenceOccurrenceLabel": "Número de ocurrencias",
            ...
            "dxScheduler-ariaEditForm": "Formulario de edición",
            "dxScheduler-confirmRecurrenceEditTitle": "Editar cita recurrente",
            "dxScheduler-confirmRecurrenceDeleteTitle": "Eliminar cita recurrente",
            ...
            "dxCalendar-currentDay": "Hoy",
            "dxCalendar-currentMonth": "Mes actual",
            "dxCalendar-currentYear": "Año actual",
            "dxCalendar-currentYearRange": "Intervalo de años actual",
            "dxCalendar-todayButtonText": "Hoy",
            "dxCalendar-ariaWidgetName": "Calendario",
            "dxCalendar-previousMonthButtonLabel": "Mes anterior",
            "dxCalendar-previousYearButtonLabel": "Año anterior",
            "dxCalendar-previousDecadeButtonLabel": "Década anterior",
            "dxCalendar-previousCenturyButtonLabel": "Siglo anterior",
            "dxCalendar-nextMonthButtonLabel": "Mes siguiente",
            "dxCalendar-nextYearButtonLabel": "Año siguiente",
            "dxCalendar-nextDecadeButtonLabel": "Década siguiente",
            "dxCalendar-nextCenturyButtonLabel": "Siglo siguiente",
            "dxCalendar-captionMonthLabel": "Selección de mes",
            "dxCalendar-captionYearLabel": "Selección de año",
            "dxCalendar-captionDecadeLabel": "Selección de década",
            "dxCalendar-captionCenturyLabel": "Selección de siglo",
            "dxCalendar-selectedDate": "La fecha seleccionada es {0}",
            "dxCalendar-selectedDates": "Las fechas seleccionadas",
            "dxCalendar-selectedDateRange": "El intervalo de fechas seleccionado va de {0} a {1}",
            "dxCalendar-selectedMultipleDateRange": "de {0} a {1}",
            "dxCalendar-selectedDateRangeCount": "Hay {0} intervalos de fechas seleccionados",
            "dxCalendar-readOnlyLabel": "Calendario de solo lectura",
            "dxCardView-ariaSearchInGrid": "Buscar en la vista de tarjetas",
            "dxCardView-ariaHeaderItemLabel": "Nombre de campo {0}",
            "dxCardView-ariaHeaderItemSortingAscendingLabel": "Ordenado de forma ascendente",
            "dxCardView-ariaHeaderItemSortingDescendingLabel": "Ordenado de forma descendente",
            "dxCardView-ariaHeaderItemSortingIndexLabel": "Índice de ordenamiento {0}",
            "dxCardView-ariaHeaderHasHeaderFilterLabel": "Filtro de encabezado aplicado",
            "dxCardView-ariaSelectCard": "Seleccionar tarjeta",
            "dxCardView-ariaCardView": "Vista de tarjetas con {0} tarjetas. Cada tarjeta tiene {1} campos",
            "dxCardView-ariaCard": "Tarjeta",
            "dxCardView-ariaEditableCard": "Tarjeta editable",
            "dxCardView-ariaCardPosition": "Fila {0}, columna {1}",
            "dxCardView-ariaSelectedCardState": "Seleccionado",
            "dxCardView-ariaNotSelectedCardState": "No seleccionado",
            "dxCardView-selectAll": "Seleccionar todo",
            "dxCardView-clearSelection": "Limpiar selección",
            "dxCardView-cardNoImageAriaLabel": "Sin imagen",
            "dxCardView-headerItemDropZoneText": "Suelte el elemento de encabezado aquí",
            "dxCardView-emptyHeaderPanelText": "Usar {0} para mostrar columnas",
            "dxCardView-emptyHeaderPanelColumnChooserText": "selector de columnas",
            "dxAvatar-defaultImageAlt": "Avatar",
            "dxChat-elementAriaLabel": "Chat",
            "dxChat-textareaPlaceholder": "Escribe un mensaje",
            "dxChat-sendButtonAriaLabel": "Enviar",
            "dxChat-cancelEditingButtonAriaLabel": "Cancelar",
            "dxChat-editingMessageCaption": "Editar mensaje",
            "dxChat-defaultUserName": "Usuario desconocido",
            "dxChat-messageListAriaLabel": "Lista de mensajes",
            "dxChat-alertListAriaLabel": "Lista de errores",
            "dxChat-emptyListMessage": "No hay mensajes en este chat",
            "dxChat-emptyListPrompt": "Escribe tu primer mensaje",
            "dxChat-typingMessageSingleUser": "{0} está escribiendo...",
            "dxChat-typingMessageTwoUsers": "{0} y {1} están escribiendo...",
            "dxChat-typingMessageThreeUsers": "{0}, {1} y {2} están escribiendo...",
            "dxChat-typingMessageMultipleUsers": "{0} y otros están escribiendo...",
            "dxChat-editedMessageText": "Editado",
            "dxChat-editingEditMessage": "Modificar",
            "dxChat-editingDeleteMessage": "Eliminar",
            "dxChat-editingDeleteConfirmText": "¿Está seguro de que desea eliminar este mensaje?",
            "dxChat-deletedMessageText": "Este mensaje fue eliminado",
            "dxChat-defaultImageAlt": "Imagen compartida en el chat",
            "dxChat-fileViewLabel": "Lista de archivos",
            "dxChat-downloadButtonLabel": "Descargar archivo {0}",
            "dxChat-fileLimitReachedWarning": "Ha seleccionado demasiados archivos. Seleccione no más de {0} archivos y reintente.",
            ...
            "dxTagBox-tagRoleDescription": "Etiqueta. Presione el botón eliminar para quitar esta etiqueta",
            "dxTagBox-ariaRoleDescription": "Cuadro de etiquetas",
            ...
            "dxFilterBuilder-filterAriaRootElement": "Constructor de filtros",
            "dxFilterBuilder-filterAriaGroupLevel": "Nivel {0}",
            "dxFilterBuilder-filterAriaGroupItem": "Elemento de grupo",
            "dxFilterBuilder-filterAriaOperationButton": "Operación",
            "dxFilterBuilder-filterAriaAddButton": "Agregar",
            "dxFilterBuilder-filterAriaRemoveButton": "Eliminar {0}",
            "dxFilterBuilder-filterAriaItemField": "Campo del elemento",
            "dxFilterBuilder-filterAriaItemOperation": "Operación del elemento",
            "dxFilterBuilder-filterAriaItemValue": "Valor del elemento",
            ...
            "dxHtmlEditor-link": "Añadir enlace",
            "dxHtmlEditor-image": "Añadir imagen",
            ...
            "dxHtmlEditor-delete": "Eliminar",
            "dxHtmlEditor-border": "Borde",
            "dxHtmlEditor-style": "Estilo",
            "dxHtmlEditor-width": "Anchura",
            "dxHtmlEditor-height": "Altura",
            "dxHtmlEditor-borderColor": "Color",
            "dxHtmlEditor-borderWidth": "Ancho de borde",
            ...
            "dxHtmlEditor-aiDialogTitle": "Asistente de IA",
            "dxHtmlEditor-aiDialogError": "Algo salió mal. Inténtelo de nuevo.",
            "dxHtmlEditor-aiDialogCanceled": "Generación cancelada",
            "dxHtmlEditor-aiReplace": "Reemplazar",
            "dxHtmlEditor-aiInsertAbove": "Insertar arriba",
            "dxHtmlEditor-aiInsertBelow": "Insertar abajo",
            "dxHtmlEditor-aiCopy": "Copiar",
            "dxHtmlEditor-aiRegenerate": "Regenerar",
            "dxHtmlEditor-aiGenerate": "Generar",
            "dxHtmlEditor-aiCancel": "Cancelar",
            "dxHtmlEditor-aiToolbarItemAriaLabel": "Elemento de la barra de herramientas del Asistente de IA",
            "dxHtmlEditor-aiResultTextAreaAriaLabel": "Resultado del Asistente de IA",
            "dxHtmlEditor-aiAskPlaceholder": "Pedir a la IA que modifique el texto",
            "dxHtmlEditor-aiCommandSummarize": "Resumir",
            "dxHtmlEditor-aiCommandProofread": "Corregir",
            "dxHtmlEditor-aiCommandExpand": "Expandir",
            "dxHtmlEditor-aiCommandShorten": "Acortar",
            "dxHtmlEditor-aiCommandChangeStyle": "Cambiar estilo",
            "dxHtmlEditor-aiCommandChangeTone": "Cambiar tono",
            "dxHtmlEditor-aiCommandTranslate": "Traducir",
            "dxHtmlEditor-aiCommandAskAI": "Preguntar a la IA",
            "dxHtmlEditor-aiCommandChangeStyleFormal": "Formal",
            "dxHtmlEditor-aiCommandChangeStyleInformal": "Informal",
            "dxHtmlEditor-aiCommandChangeStyleTechnical": "Técnico",
            "dxHtmlEditor-aiCommandChangeStyleBusiness": "Empresarial",
            "dxHtmlEditor-aiCommandChangeStyleCreative": "Creativo",
            "dxHtmlEditor-aiCommandChangeStyleJournalistic": "Periodístico",
            "dxHtmlEditor-aiCommandChangeStyleAcademic": "Académico",
            "dxHtmlEditor-aiCommandChangeStylePersuasive": "Persuasivo",
            "dxHtmlEditor-aiCommandChangeStyleNarrative": "Narrativo",
            "dxHtmlEditor-aiCommandChangeStyleExpository": "Expositivo",
            "dxHtmlEditor-aiCommandChangeStyleDescriptive": "Descriptivo",
            "dxHtmlEditor-aiCommandChangeStyleConversational": "Conversacional",
            "dxHtmlEditor-aiCommandChangeToneProfessional": "Profesional",
            "dxHtmlEditor-aiCommandChangeToneCasual": "Informal",
            "dxHtmlEditor-aiCommandChangeToneStraightforward": "Directo",
            "dxHtmlEditor-aiCommandChangeToneConfident": "Seguro",
            "dxHtmlEditor-aiCommandChangeToneFriendly": "Amistoso",
            "dxHtmlEditor-aiCommandTranslateArabic": "Árabe",
            "dxHtmlEditor-aiCommandTranslateChinese": "Chino",
            "dxHtmlEditor-aiCommandTranslateEnglish": "Inglés",
            "dxHtmlEditor-aiCommandTranslateFrench": "Francés",
            "dxHtmlEditor-aiCommandTranslateGerman": "Alemán",
            "dxHtmlEditor-aiCommandTranslateJapanese": "Japonés",
            "dxHtmlEditor-aiCommandTranslateSpanish": "Español",
            ...
            "dxFileManager-errorDirectoryNotFoundFormat": "Directorio '{0}' no encontrado.",
            "dxFileManager-errorWrongFileExtension": "La extensión del archivo no está permitida.",
            "dxFileManager-errorMaxFileSizeExceeded": "El tamaño del archivo supera el tamaño máximo permitido.",
            ...
            "dxFileManager-errorDirectoryOpenFailed": "No se puede abrir el directorio",
            "dxFileManager-commandCreate": "Nuevo directorio",
            ...
            "dxFileManager-commandRefresh": "Actualizar",
            ...
            "dxFileManager-commandShowNavPane": "Alternar panel de navegación",
            ...
            "dxFileManager-dialogCreateDirectoryTitle": "Nuevo directorio",
            ...
            "dxFileManager-dialogDeleteItemSingleItemConfirmation": "¿Está seguro de que desea eliminar {0}?",
            "dxFileManager-dialogDeleteItemMultipleItemsConfirmation": "¿Está seguro de que desea eliminar {0} elementos?",
            "dxFileManager-dialogButtonCancel": "Cancelar",
            "dxFileManager-editingCreateSingleItemProcessingMessage": "Creando un directorio dentro de {0}",
            "dxFileManager-editingCreateSingleItemSuccessMessage": "Directorio creado dentro de {0}",
            "dxFileManager-editingCreateSingleItemErrorMessage": "No se creó el directorio",
            "dxFileManager-editingCreateCommonErrorMessage": "No se creó el directorio",
            "dxFileManager-editingRenameSingleItemProcessingMessage": "Renombrando un elemento dentro de {0}",
            "dxFileManager-editingRenameSingleItemSuccessMessage": "Elemento renombrado dentro de {0}",
            "dxFileManager-editingRenameSingleItemErrorMessage": "El elemento no fue renombrado",
            "dxFileManager-editingRenameCommonErrorMessage": "El elemento no fue renombrado",
            ...
            "dxFileManager-editingDeleteSingleItemSuccessMessage": "Elemento eliminado de {0}",
            "dxFileManager-editingDeleteMultipleItemsSuccessMessage": "{0} elementos eliminados de {1}",
            "dxFileManager-editingDeleteSingleItemErrorMessage": "El elemento no fue eliminado",
            "dxFileManager-editingDeleteMultipleItemsErrorMessage": "{0} elementos no fueron eliminados",
            "dxFileManager-editingDeleteCommonErrorMessage": "Algunos elementos no fueron eliminados",
            ...
            "dxFileManager-editingMoveSingleItemSuccessMessage": "Elemento movido a {0}",
            "dxFileManager-editingMoveMultipleItemsSuccessMessage": "{0} elementos movidos a {1}",
            "dxFileManager-editingMoveSingleItemErrorMessage": "El elemento no fue movido",
            "dxFileManager-editingMoveMultipleItemsErrorMessage": "{0} elementos no fueron movidos",
            "dxFileManager-editingMoveCommonErrorMessage": "Algunos elementos no fueron movidos",
            ...
            "dxFileManager-editingCopySingleItemSuccessMessage": "Elemento copiado a {0}",
            "dxFileManager-editingCopyMultipleItemsSuccessMessage": "{0} elementos copiados a {1}",
            "dxFileManager-editingCopySingleItemErrorMessage": "El elemento no fue copiado",
            "dxFileManager-editingCopyMultipleItemsErrorMessage": "{0} elementos no fueron copiados",
            "dxFileManager-editingCopyCommonErrorMessage": "Algunos elementos no fueron copiados",
            ...
            "dxFileManager-editingUploadSingleItemSuccessMessage": "Elemento subido a {0}",
            "dxFileManager-editingUploadMultipleItemsSuccessMessage": "{0} elementos subidos a {1}",
            "dxFileManager-editingUploadSingleItemErrorMessage": "El elemento no fue subido",
            "dxFileManager-editingUploadMultipleItemsErrorMessage": "{0} elementos no fueron subidos",
            "dxFileManager-editingUploadCanceledMessage": "Cancelado",
            "dxFileManager-editingDownloadSingleItemErrorMessage": "El elemento no fue descargado",
            "dxFileManager-editingDownloadMultipleItemsErrorMessage": "{0} elementos no fueron descargados",
            ...
            "dxGantt-dialogTaskDetailsTitle": "Detalles de tarea",
            ...
            "dxGantt-dialogTaskDeleteConfirmation": "Al eliminar una tarea también se eliminan todas sus dependencias y subtareas. ¿Está seguro de que desea eliminar esta tarea?",
            "dxGantt-dialogDependencyDeleteConfirmation": "¿Está seguro de que desea eliminar la dependencia de la tarea?",
            "dxGantt-dialogResourcesDeleteConfirmation": "Al eliminar un recurso también se elimina de las tareas a las que está asignado. ¿Está seguro de que desea eliminar estos recursos? Recursos: {0}",
            "dxGantt-dialogConstraintCriticalViolationMessage": "La tarea que intenta mover está vinculada a una segunda tarea mediante una relación de dependencia. Este cambio entraría en conflicto con las reglas de dependencia. ¿Cómo desea proceder?",
            "dxGantt-dialogConstraintViolationMessage": "La tarea que intenta mover está vinculada a una segunda tarea mediante una relación de dependencia. ¿Cómo desea proceder?",
            "dxGantt-dialogCancelOperationMessage": "Cancelar la operación",
            "dxGantt-dialogDeleteDependencyMessage": "Eliminar la dependencia",
            "dxGantt-dialogMoveTaskAndKeepDependencyMessage": "Mover la tarea y conservar la dependencia",
            "dxGantt-dialogConstraintCriticalViolationSeveralTasksMessage": "La tarea que intenta mover está vinculada a otras tareas mediante relaciones de dependencia. Este cambio entraría en conflicto con las reglas de dependencia. ¿Cómo desea proceder?",
            "dxGantt-dialogConstraintViolationSeveralTasksMessage": "La tarea que intenta mover está vinculada a otras tareas mediante relaciones de dependencia. ¿Cómo desea proceder?",
            "dxGantt-dialogDeleteDependenciesMessage": "Eliminar las relaciones de dependencia",
            "dxGantt-dialogMoveTaskAndKeepDependenciesMessage": "Mover la tarea y conservar las dependencias",
            "dxGantt-undo": "Deshacer",
            "dxGantt-redo": "Rehacer",
            "dxGantt-expandAll": "Expandir todo",
            "dxGantt-collapseAll": "Contraer todo",
            ...
            "dxGallery-itemName": "Elemento de galería",
            "dxMultiView-elementAriaRoleDescription": "MultiView",
            "dxMultiView-elementAriaLabel": "Use las teclas de flecha o deslice para navegar entre vistas",
            "dxMultiView-itemAriaRoleDescription": "Vista",
            "dxMultiView-itemAriaLabel": "{0} de {1}",
            "dxSplitter-resizeHandleAriaLabel": "Barra divisoria",
            "dxSplitter-resizeHandleAriaRoleDescription": "Separador",
            "dxStepper-optionalMark": "(Opcional)",
            "dxSpeechToText-ariaLabelStart": "Presione para iniciar la transcripción de voz",
            "dxSpeechToText-ariaLabelStop": "Presione para detener la transcripción de voz"
        }
    });
}));
