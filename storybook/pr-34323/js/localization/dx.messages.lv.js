...
(function(root, factory) {
    ...
    localization.loadMessages({
        "lv": {
            ...
            "validation-required-formatted": "{0} ir obligāts",
            "validation-numeric": "Vērtībai jābūt skaitlim",
            "validation-numeric-formatted": "{0} jābūt skaitliskai vērtībai",
            ...
            "validation-pattern": "Vērtība neatbilst paraugam",
            "validation-pattern-formatted": "{0} neatbilst paraugam",
            "validation-email": "E-pasta adrese nav derīga",
            "validation-email-formatted": "{0} nav derīgs",
            ...
            "dxList-refreshingText": "Atjaunina...",
            "dxList-pageLoadingText": "Ielādē...",
            "dxList-nextButtonText": "Vairāk",
            "dxList-selectAll": "Izvēlēties visu",
            "dxList-listAriaLabel": "Vienumi",
            "dxList-listAriaLabel-deletable": "Dzēšami vienumi",
            "dxListEditDecorator-delete": "Dzēst",
            "dxListEditDecorator-more": "Vairāk",
            "dxList-selectAll-indeterminate": "Daļēji atzīmēts",
            "dxList-selectAll-checked": "Atzīmēts",
            "dxList-selectAll-notChecked": "Nav atzīmēts",
            "dxList-ariaRoleDescription": "Saraksts",
            "dxList-listAriaLabel-itemContent": "Saraksta vienuma saturs",
            "dxScrollView-pullingDownText": "Vilkt lejā lai atjaunotu...",
            "dxScrollView-pulledDownText": "Atlaist lai atjaunotu...",
            "dxScrollView-refreshingText": "Atjaunina...",
            ...
            "dxFileUploader-dropFile": "vai velciet failu šeit",
            ...
            "dxFileUploader-uploadFailedMessage": "Augšupielāde neizdevās",
            ...
            "dxFileUploader-fileListLabel": "Failu saraksts",
            "dxFileUploader-removeFileButtonLabel": "Noņemt failu {0}",
            "dxFileUploader-uploadFileButtonLabel": "Augšupielādēt failu {0}",
            ...
            "dxForm-smartPasteButtonText": "Viedā ielīmēšana",
            "dxForm-resetButtonText": "Atiestatīt",
            "dxForm-submitButtonText": "Iesniegt",
            "dxNumberBox-invalidValueMessage": "Vērtībai jābūt skaitlim",
            "dxNumberBox-noDataText": "Nav datu",
            "dxDataGrid-aiAssistantTitle": "AI asistents",
            "dxDataGrid-aiAssistantProcessingMessageHeader": "Pieprasījums tiek izpildīts",
            "dxDataGrid-aiAssistantProcessingMessage": "Apstrādā...",
            "dxDataGrid-aiAssistantErrorMessageHeader": "Neizdevās apstrādāt pieprasījumu",
            "dxDataGrid-aiAssistantAbortMessage": "Pieprasījums apturēts.",
            "dxDataGrid-aiAssistantSuccessMessage": "Veiksmīgi",
            "dxDataGrid-aiAssistantErrorMessage": "Kļūda",
            "dxDataGrid-aiAssistantExecutionAbortMessage": "Izpilde pārtraukta",
            "dxDataGrid-aiAssistantExecutionInProgressMessage": "Izpilde jau notiek. Lūdzu, gaidiet.",
            "dxDataGrid-aiAssistantRequestInProgressMessage": "Pieprasījums jau tiek apstrādāts. Lūdzu, gaidiet.",
            "dxDataGrid-aiAssistantUnexpectedErrorMessage": "Radās neparedzēta kļūda. Lūdzu, mēģiniet vēlreiz.",
            "dxDataGrid-aiAssistantInvalidResponseMessage": "Nederīga atbilde no AI pakalpojuma. Lūdzu, mēģiniet vēlreiz.",
            "dxDataGrid-aiAssistantClearButtonText": "Notīrīt",
            "dxDataGrid-aiAssistantRegenerateButtonText": "Atkārtoti ģenerēt",
            "dxDataGrid-aiAssistantAbortConfirmText": "Aizverot AI asistenta tērzēšanu, tiks pārtraukti notiekošie pieprasījumi. Vai vēlaties aizvērt tērzēšanu?",
            "dxDataGrid-aiAChatEmptyViewMessage": "Tērzēšana ir tukša",
            "dxDataGrid-aiChatEmptyViewPrompt": "AI asistents ir gatavs atbildēt uz jūsu jautājumiem.",
            "dxDataGrid-aiPromptEditorTitle": "AI uzvedņu redaktors",
            "dxDataGrid-aiPromptEditorPlaceholder": "Palūdzīt AI ģenerēt kolonnas vērtības...",
            "dxDataGrid-aiPromptEditorApplyButton": "Lietot",
            "dxDataGrid-aiPromptEditorRegenerateButton": "Atkārtoti ģenerēt datus",
            "dxDataGrid-aiPromptEditorStopButton": "Apturēt",
            "dxDataGrid-aiDropDownAutofill": "Automātiskais aizpildījums ar AI",
            "dxDataGrid-aiDropDownClear": "Notīrīt datus",
            "dxDataGrid-emptyHeaderWithColumnChooserText": "Izmantojiet {0}, lai parādītu kolonnas",
            "dxDataGrid-emptyHeaderWithGroupPanelText": "Velciet kolonnu no grupēšanas paneļa šeit",
            "dxDataGrid-emptyHeaderWithColumnChooserAndGroupPanelText": "Izmantojiet {0} vai velciet kolonnu no grupēšanas paneļa",
            "dxDataGrid-emptyHeaderColumnChooserText": "kolonnu izvēlne",
            "dxDataGrid-columnChooserTitle": "Kolonnu izvēlne",
            "dxDataGrid-columnChooserEmptyText": "Velciet kolonnu šeit, lai to paslēptu",
            ...
            "dxDataGrid-groupPanelEmptyText": "Velciet kolonnas galveni šeit, lai grupētu pēc tās",
            ...
            "dxDataGrid-trueText": "Jā",
            "dxDataGrid-falseText": "Nē",
            "dxDataGrid-sortingAscendingText": "Kārtot augošā secībā",
            "dxDataGrid-sortingDescendingText": "Kārtot dilstošā secībā",
            "dxDataGrid-sortingClearText": "Notīrīt kārtošanu",
            "dxDataGrid-ariaNotSortedColumn": "Nekārtota kolonna",
            "dxDataGrid-ariaSortedAscendingColumn": "Kolonna kārtota augošā secībā",
            "dxDataGrid-ariaSortedDescendingColumn": "Kolonna kārtota dilstošā secībā",
            "dxDataGrid-ariaSortIndex": "Kārtošanas indekss {0}",
            ...
            "dxDataGrid-summarySumOtherColumn": "Summa no {1} ir {0}",
            "dxDataGrid-summaryCount": "Skaits: {0}",
            "dxDataGrid-columnFixingFix": "Piestiprināt pozīciju",
            "dxDataGrid-columnFixingUnfix": "Atpiestiprināt",
            "dxDataGrid-columnFixingLeftPosition": "Pa kreisi",
            "dxDataGrid-columnFixingRightPosition": "Pa labi",
            "dxDataGrid-columnFixingStickyPosition": "Piesprausta",
            ...
            "dxDataGrid-ariaColumnHeader": "Kolonnas galvene",
            "dxDataGrid-ariaValue": "Vērtība",
            "dxDataGrid-ariaError": "Kļūda",
            "dxDataGrid-ariaRevertButton": "Spiediet Escape, lai atceltu izmaiņas",
            "dxDataGrid-ariaFilterCell": "Filtrēt šūnu",
            "dxDataGrid-ariaCollapse": "Savērst",
            "dxDataGrid-ariaModifiedCell": "Modificēta",
            "dxDataGrid-ariaDeletedCell": "Dzēsta",
            "dxDataGrid-ariaEditableCell": "Rediģējama",
            "dxDataGrid-ariaExpand": "Izvērst",
            "dxDataGrid-ariaCollapsedRow": "Savērsta rinda",
            "dxDataGrid-ariaExpandedRow": "Izvērsta rinda",
            ...
            "dxDataGrid-ariaEditForm": "Rediģēšanas forma",
            ...
            "dxDataGrid-masterDetail": "Šūna ar detaļām",
            "dxDataGrid-moveColumnToTheRight": "Pārvietot pa labi",
            "dxDataGrid-moveColumnToTheLeft": "Pārvietot pa kreisi",
            "dxTreeList-ariaTreeList": "Koka saraksts ar {0} rindām un {1} kolonnām",
            "dxTreeList-ariaExpandableInstruction": "Spiediet Ctrl + labo bultiņu, lai izvērstu fokusēto mezglu, un Ctrl + kreiso bultiņu, lai to savērstu",
            ...
            "dxPivotGrid-showFieldChooser": "Rādīt lauku izvēli",
            ...
            "dxPivotGrid-columnFieldArea": "Velciet kolonnu laukus šeit",
            "dxPivotGrid-dataFieldArea": "Velciet datu laukus šeit",
            "dxPivotGrid-rowFieldArea": "Velciet rindu laukus šeit",
            "dxPivotGrid-filterFieldArea": "Velciet filtra laukus šeit",
            "dxScheduler-dateRange": "no {0} līdz {1}",
            "dxScheduler-ariaLabel": "Plānotājs. {0} skats: {1} ar {2} apmeklējumiem",
            "dxScheduler-ariaLabel-currentIndicator-present": "Pašreizējā laika indikators ir redzams skatā",
            "dxScheduler-ariaLabel-currentIndicator-not-present": "Pašreizējā laika indikators nav redzams ekrānā",
            "dxScheduler-appointmentAriaDescription-group": "Grupa: {0}",
            "dxScheduler-appointmentAriaLabel-recurring": "Atkārtojošs apmeklējums",
            "dxScheduler-hotkeysAriaDescription-delete": "Spiediet Delete, lai dzēstu šo apmeklējumu",
            "dxScheduler-hotkeysAriaDescription-homeEnd": "Spiediet Home vai End, lai ātri pārietu uz pirmo vai pēdējo apmeklējumu",
            "dxScheduler-appointmentListAriaLabel": "Apmeklējumu saraksts",
            "dxScheduler-newPopupTitle": "Jauns apmeklējums",
            "dxScheduler-editPopupTitle": "Rediģēt apmeklējumu",
            "dxScheduler-editPopupSaveButtonText": "Saglabāt",
            "dxScheduler-editorLabelTitle": "Nosaukums",
            "dxScheduler-editorLabelStartDate": "Sākuma datums",
            "dxScheduler-editorAriaLabelStartTime": "Sākuma laiks",
            "dxScheduler-editorLabelEndDate": "Beigu datums",
            "dxScheduler-editorAriaLabelEndTime": "Beigu laiks",
            "dxScheduler-editorLabelDescription": "Apraksts",
            "dxScheduler-editorLabelRecurrence": "Atkārtot",
            "dxScheduler-noSubject": "(Nav tēmas)",
            "dxScheduler-navigationToday": "Šodien",
            "dxScheduler-navigationPrevious": "Iepriekšējā lapa",
            "dxScheduler-navigationNext": "Nākamā lapa",
            ...
            "dxScheduler-recurrenceOn": "Uz datumu",
            "dxScheduler-recurrenceUntilDateLabel": "Datums, kad beidzas atkārtošana",
            "dxScheduler-recurrenceOccurrenceLabel": "Atkārtojumu skaits",
            ...
            "dxScheduler-switcherTimelineWeek": "Laika skala nedēļa",
            ...
            "dxScheduler-ariaEditForm": "Rediģēšanas forma",
            "dxScheduler-confirmRecurrenceEditTitle": "Rediģēt atkārtojošu apmeklējumu",
            "dxScheduler-confirmRecurrenceDeleteTitle": "Dzēst atkārtojošu apmeklējumu",
            ...
            "dxCalendar-currentDay": "Šodien",
            "dxCalendar-currentMonth": "Pašreizējais mēnesis",
            "dxCalendar-currentYear": "Pašreizējais gads",
            "dxCalendar-currentYearRange": "Pašreizējais gadu diapazons",
            "dxCalendar-todayButtonText": "Šodien",
            "dxCalendar-ariaWidgetName": "Kalendārs",
            "dxCalendar-previousMonthButtonLabel": "Iepriekšējais mēnesis",
            "dxCalendar-previousYearButtonLabel": "Iepriekšējais gads",
            "dxCalendar-previousDecadeButtonLabel": "Iepriekšējā desmitgade",
            "dxCalendar-previousCenturyButtonLabel": "Iepriekšējais gadsimts",
            "dxCalendar-nextMonthButtonLabel": "Nākamais mēnesis",
            "dxCalendar-nextYearButtonLabel": "Nākamais gads",
            "dxCalendar-nextDecadeButtonLabel": "Nākamā desmitgade",
            "dxCalendar-nextCenturyButtonLabel": "Nākamais gadsimts",
            "dxCalendar-captionMonthLabel": "Mēneša izvēle",
            "dxCalendar-captionYearLabel": "Gada izvēle",
            "dxCalendar-captionDecadeLabel": "Desmitgades izvēle",
            "dxCalendar-captionCenturyLabel": "Gadsimta izvēle",
            "dxCalendar-selectedDate": "Izvēlētais datums ir {0}",
            "dxCalendar-selectedDates": "Izvēlētie datumi",
            "dxCalendar-selectedDateRange": "Izvēlētais datumu diapazons ir no {0} līdz {1}",
            "dxCalendar-selectedMultipleDateRange": "no {0} līdz {1}",
            "dxCalendar-selectedDateRangeCount": "Ir {0} izvēlētu datumu diapazoni",
            "dxCalendar-readOnlyLabel": "Tikai lasāms kalendārs",
            "dxCardView-ariaSearchInGrid": "Meklēt karšu skatā",
            "dxCardView-ariaHeaderItemLabel": "Lauka nosaukums {0}",
            "dxCardView-ariaHeaderItemSortingAscendingLabel": "Kārtots augošā secībā",
            "dxCardView-ariaHeaderItemSortingDescendingLabel": "Kārtots dilstošā secībā",
            "dxCardView-ariaHeaderItemSortingIndexLabel": "Kārtošanas indekss {0}",
            "dxCardView-ariaHeaderHasHeaderFilterLabel": "Galvenes filtrs piemērots",
            "dxCardView-ariaSelectCard": "Izvēlēties karti",
            "dxCardView-ariaCardView": "Karšu skats ar {0} kartēm. Katrai kartei ir {1} lauki",
            "dxCardView-ariaCard": "Karte",
            "dxCardView-ariaEditableCard": "Rediģējama karte",
            "dxCardView-ariaCardPosition": "Rinda {0}, kolonna {1}",
            "dxCardView-ariaSelectedCardState": "Izvēlēts",
            "dxCardView-ariaNotSelectedCardState": "Nav izvēlēts",
            "dxCardView-selectAll": "Izvēlēties visu",
            "dxCardView-clearSelection": "Notīrīt izvēlni",
            "dxCardView-cardNoImageAriaLabel": "Nav attēla",
            "dxCardView-headerItemDropZoneText": "Velciet galvenes elementu šeit",
            "dxCardView-emptyHeaderPanelText": "Izmantojiet {0}, lai attēlotu kolonnas",
            "dxCardView-emptyHeaderPanelColumnChooserText": "kolonnu izvēlne",
            "dxAvatar-defaultImageAlt": "Avatar",
            "dxChat-elementAriaLabel": "Tērzēšana",
            "dxChat-textareaPlaceholder": "Ierakstīt ziņojumu",
            "dxChat-sendButtonAriaLabel": "Nosūtīt",
            "dxChat-cancelEditingButtonAriaLabel": "Atcelt",
            "dxChat-editingMessageCaption": "Rediģēt ziņojumu",
            "dxChat-defaultUserName": "Nezināms lietotājs",
            "dxChat-messageListAriaLabel": "Ziņojumu saraksts",
            "dxChat-alertListAriaLabel": "Kļūdu saraksts",
            "dxChat-emptyListMessage": "Šajā tērzēšanā nav ziņojumu",
            "dxChat-emptyListPrompt": "Uzrakstiet savu pirmo ziņojumu",
            "dxChat-typingMessageSingleUser": "{0} raksta...",
            "dxChat-typingMessageTwoUsers": "{0} un {1} raksta...",
            "dxChat-typingMessageThreeUsers": "{0}, {1} un {2} raksta...",
            "dxChat-typingMessageMultipleUsers": "{0} un citi raksta...",
            "dxChat-editedMessageText": "Rediģēts",
            "dxChat-editingEditMessage": "Rediģēt",
            "dxChat-editingDeleteMessage": "Dzēst",
            "dxChat-editingDeleteConfirmText": "Vai tiešām vēlaties dzēst šo ziņojumu?",
            "dxChat-deletedMessageText": "Šis ziņojums tika dzēsts",
            "dxChat-defaultImageAlt": "Attēls kopīgots tērzēšanā",
            "dxChat-fileViewLabel": "Failu saraksts",
            "dxChat-downloadButtonLabel": "Lejupielādēt failu {0}",
            "dxChat-fileLimitReachedWarning": "Jūs izvēlējāties pārāk daudz failu. Izvēlieties ne vairāk kā {0} failus un mēģinājiet vēlreiz.",
            ...
            "dxTagBox-tagRoleDescription": "Atzīme. Spiediet dzēšanas pogu, lai noņemtu šo atzīmi",
            "dxTagBox-ariaRoleDescription": "Atzīmju lauks",
            ...
            "dxFilterBuilder-filterAriaRootElement": "Filtra veidotājs",
            "dxFilterBuilder-filterAriaGroupLevel": "Līmenis {0}",
            "dxFilterBuilder-filterAriaGroupItem": "Grupas elements",
            "dxFilterBuilder-filterAriaOperationButton": "Operācija",
            "dxFilterBuilder-filterAriaAddButton": "Pievienot",
            "dxFilterBuilder-filterAriaRemoveButton": "Noņemt {0}",
            "dxFilterBuilder-filterAriaItemField": "Elementa lauks",
            "dxFilterBuilder-filterAriaItemOperation": "Elementa operācija",
            "dxFilterBuilder-filterAriaItemValue": "Elementa vērtība",
            ...
            "dxHtmlEditor-dialogImageKeepAspectRatio": "Saglabāt malu attiecību",
            ...
            "dxHtmlEditor-borderWidth": "Robežas platums",
            ...
            "dxHtmlEditor-paddingVertical": "Vertikāls polsterējums",
            "dxHtmlEditor-paddingHorizontal": "Horizontāls polsterējums",
            ...
            "dxHtmlEditor-aiDialogTitle": "AI asistents",
            "dxHtmlEditor-aiDialogError": "Kaut kas nogāja greizi. Lūdzu mēģinājiet vēlreiz.",
            "dxHtmlEditor-aiDialogCanceled": "Ģenerēšana atcelta",
            "dxHtmlEditor-aiReplace": "Aizstāt",
            "dxHtmlEditor-aiInsertAbove": "Ievietot virs",
            "dxHtmlEditor-aiInsertBelow": "Ievietot zem",
            "dxHtmlEditor-aiCopy": "Kopēt",
            "dxHtmlEditor-aiRegenerate": "Atkārtoti ģenerēt",
            "dxHtmlEditor-aiGenerate": "Ģenerēt",
            "dxHtmlEditor-aiCancel": "Atcelt",
            "dxHtmlEditor-aiToolbarItemAriaLabel": "AI asistenta rīkjoslas elements",
            "dxHtmlEditor-aiResultTextAreaAriaLabel": "AI asistenta rezultāts",
            "dxHtmlEditor-aiAskPlaceholder": "Palūdzīt AI modificēt tekstu",
            "dxHtmlEditor-aiCommandSummarize": "Apkopot",
            "dxHtmlEditor-aiCommandProofread": "Pārbaudīt",
            "dxHtmlEditor-aiCommandExpand": "Izvērst",
            "dxHtmlEditor-aiCommandShorten": "Saīsināt",
            "dxHtmlEditor-aiCommandChangeStyle": "Mainīt stilu",
            "dxHtmlEditor-aiCommandChangeTone": "Mainīt toni",
            "dxHtmlEditor-aiCommandTranslate": "Tulkot",
            "dxHtmlEditor-aiCommandAskAI": "Jautāt AI",
            "dxHtmlEditor-aiCommandChangeStyleFormal": "Formāls",
            "dxHtmlEditor-aiCommandChangeStyleInformal": "Neformāls",
            "dxHtmlEditor-aiCommandChangeStyleTechnical": "Tehnisks",
            "dxHtmlEditor-aiCommandChangeStyleBusiness": "Biznesa",
            "dxHtmlEditor-aiCommandChangeStyleCreative": "Radošs",
            "dxHtmlEditor-aiCommandChangeStyleJournalistic": "Žurnālistisks",
            "dxHtmlEditor-aiCommandChangeStyleAcademic": "Akadēmisks",
            "dxHtmlEditor-aiCommandChangeStylePersuasive": "Pārliecinošs",
            "dxHtmlEditor-aiCommandChangeStyleNarrative": "Stāstījuma",
            "dxHtmlEditor-aiCommandChangeStyleExpository": "Izskaidrojošs",
            "dxHtmlEditor-aiCommandChangeStyleDescriptive": "Aprakstošs",
            "dxHtmlEditor-aiCommandChangeStyleConversational": "Sarunvalodas",
            "dxHtmlEditor-aiCommandChangeToneProfessional": "Profesionāls",
            "dxHtmlEditor-aiCommandChangeToneCasual": "Brīvs",
            "dxHtmlEditor-aiCommandChangeToneStraightforward": "Tiešs",
            "dxHtmlEditor-aiCommandChangeToneConfident": "Pārliecināts",
            "dxHtmlEditor-aiCommandChangeToneFriendly": "Draudzīgs",
            "dxHtmlEditor-aiCommandTranslateArabic": "Arābu",
            "dxHtmlEditor-aiCommandTranslateChinese": "Ķīniešu",
            "dxHtmlEditor-aiCommandTranslateEnglish": "Angļu",
            "dxHtmlEditor-aiCommandTranslateFrench": "Franču",
            "dxHtmlEditor-aiCommandTranslateGerman": "Vācu",
            "dxHtmlEditor-aiCommandTranslateJapanese": "Japāņu",
            "dxHtmlEditor-aiCommandTranslateSpanish": "Spāņu",
            "dxFileManager-newDirectoryName": "Nenosaukta mape",
            "dxFileManager-rootDirectoryName": "Faili",
            "dxFileManager-errorNoAccess": "Piekļuve liegta. Operāciju nevarēja izpildīt.",
            "dxFileManager-errorDirectoryExistsFormat": "Mape '{0}' jau eksistē.",
            "dxFileManager-errorFileExistsFormat": "Fails '{0}' jau eksistē.",
            "dxFileManager-errorFileNotFoundFormat": "Fails '{0}' nav atrasts.",
            "dxFileManager-errorDirectoryNotFoundFormat": "Mape '{0}' nav atrasta",
            ...
            "dxFileManager-errorDirectoryOpenFailed": "Mapi nevar atvērt",
            "dxFileManager-commandCreate": "Jauna mape",
            ...
            "dxFileManager-dialogCreateDirectoryTitle": "Jauna mape",
            ...
            "dxFileManager-editingCreateSingleItemProcessingMessage": "Izveido mapi mapē {0}",
            "dxFileManager-editingCreateSingleItemSuccessMessage": "Izveidota mape mapē {0}",
            "dxFileManager-editingCreateSingleItemErrorMessage": "Mape netika izveidota",
            "dxFileManager-editingCreateCommonErrorMessage": "Mape netika izveidota",
            ...
            "dxFileManager-editingMoveMultipleItemsErrorMessage": "{0} ieraksti netika pārvietoti",
            "dxFileManager-editingMoveCommonErrorMessage": "Daži ieraksti netika pārvietoti",
            "dxFileManager-editingCopySingleItemProcessingMessage": "Kopē ierakstu uz {0}",
            "dxFileManager-editingCopyMultipleItemsProcessingMessage": "Kopē {0} ierakstus uz {1}",
            ...
            "dxFileManager-editingUploadMultipleItemsSuccessMessage": "Augšupielādēja {0} ierakstus uz {1}",
            ...
            "dxFileManager-notificationProgressPanelTitle": "Gaita",
            ...
            "dxDiagram-commandLineStyleSolid": "Nepārtraukts",
            "dxDiagram-commandLineStyleDotted": "Punktēts",
            "dxDiagram-commandLineStyleDashed": "Strīpaini",
            "dxDiagram-commandFillColor": "Aizpildījuma krāsa",
            ...
            "dxDiagram-commandAutoZoom": "Automātiski pietuvināt",
            ...
            "dxDiagram-dialogEditShapeImageTitle": "Mainīt attēlu",
            "dxDiagram-dialogEditShapeImageSelectButton": "Izvēlēties attēlu",
            "dxDiagram-dialogEditShapeImageLabelText": "vai velciet failu šeit",
            ...
            "dxGantt-dialogProgressTitle": "Gaita",
            ...
            "dxGantt-quarter": "C{0}",
            "dxGantt-sortingAscendingText": "Kārtot augošā secībā",
            "dxGantt-sortingDescendingText": "Kārtot dilstošā secībā",
            ...
            "dxGallery-itemName": "Galerijas elements",
            "dxMultiView-elementAriaRoleDescription": "MultiView",
            "dxMultiView-elementAriaLabel": "Izmantojiet bultiņu taustiņus vai velciet, lai pārvietotos starp skatiem",
            "dxMultiView-itemAriaRoleDescription": "Skats",
            "dxMultiView-itemAriaLabel": "{0} no {1}",
            "dxSplitter-resizeHandleAriaLabel": "Sadalīšanas josla",
            "dxSplitter-resizeHandleAriaRoleDescription": "Atdalītājs",
            "dxStepper-optionalMark": "(Neobligāts)",
            "dxSpeechToText-ariaLabelStart": "Nospiediet, lai sāktu balss transkripciju",
            "dxSpeechToText-ariaLabelStop": "Nospiediet, lai apturētu balss transkripciju"
        }
    });
}));
