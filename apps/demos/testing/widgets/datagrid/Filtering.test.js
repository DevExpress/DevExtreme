...
runManualTest('DataGrid', 'Filtering', ['jQuery', 'React', 'Vue', 'Angular'], (test) => {
  test('Filtering', async (t) => {
    ...
    await takeScreenshot('datagrid_filtering_by_range_1_desktop.png');

    await t
      .click($('.dx-overlay-wrapper').find('.dx-menu-item').nth(6));

    await takeScreenshot('datagrid_filtering_by_range_2_desktop.png');
    ...
    await takeScreenshot('datagrid_filtering_by_range_3_desktop.png');

    await t
      .click($('body'), { offsetX: 0, offsetY: 0 });

    await takeScreenshot('datagrid_filtering_by_range_4_desktop.png');
    ...
    await takeScreenshot('datagrid_filtering_2_desktop.png');
    ...
    await takeScreenshot('datagrid_filtering_3_desktop.png');
    ...
    await takeScreenshot('datagrid_filtering_4_desktop.png');
    ...
    await takeScreenshot('datagrid_filtering_5_desktop.png');

    await t
      .click($('.dx-overlay-wrapper').find('.dx-menu-item').nth(6));

    await takeScreenshot('datagrid_filtering_6_desktop.png');

    await t
      .typeText($('.dx-datagrid-search-panel').nth(0), 'Harv Mudd');

    await takeScreenshot('datagrid_filtering_7_desktop.png');
    ...
    await takeScreenshot('datagrid_filtering_7_1_desktop.png');

    await t
      .click($('.dx-apply-button'));

    await takeScreenshot('datagrid_filtering_8_desktop.png');
    ...
    await takeScreenshot('datagrid_focus_on_filter_1_desktop.png');

    await t
      .pressKey('tab');

    await takeScreenshot('datagrid_focus_on_filter_2_desktop.png');
    ...
    await takeScreenshot('datagrid_focus_on_filter_3_desktop.png');
