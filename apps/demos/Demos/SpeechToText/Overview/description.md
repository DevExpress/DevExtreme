Our next major update (v25.2) will include a new SpeechToText component. This component will convert speech to text in real-time using [Web Speech APIs](https://developer.mozilla.org/en-US/docs/Web/API/SpeechRecognition). 
