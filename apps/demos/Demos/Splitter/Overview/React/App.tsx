      ...
      <Item resizable={true}>
        <Splitter orientation="vertical">
          ...
          <Item resizable={true} collapsible={true}>
            <Splitter>
              <Item resizable={true} collapsible={true} minSize="5%" size="30%" render={PaneContent('Nested Left Pane')} />
              <Item resizable={true} render={PaneContent('Nested Central Pane')} />
              <Item resizable={true} collapsible={true} minSize="5%" size="30%" render={PaneContent('Nested Right Pane')} />
            </Splitter>
          </Item>
        </Splitter>
      </Item>
