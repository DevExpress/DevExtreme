...
const generate = (data, element, title, initialSize) => {
            ...
            <Splitter>
              <Item
                ...
                template={(data, index, element) =>
                  generate(data, element, 'Nested Left Pane', '30%')
                }
              />
              <Item
                resizable={true}
                template={(data, index, element) =>
                  generate(data, element, 'Nested Central Pane')
                }
              />
              <Item
                resizable={true}
                ...
                minSize="5%"
                template={(data, index, element) =>
                  generate(data, element, 'Nested Right Pane', '30%')
                }
              />
            </Splitter>
          </Item>
