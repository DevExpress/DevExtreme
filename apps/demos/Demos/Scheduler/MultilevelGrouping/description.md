...
Switch between **Vertical Grouping** and **Horizontal Grouping** to change the layout. Each view sets the [`groupOrientation`](/Documentation/ApiReference/UI_Components/dxScheduler/Configuration/#groupOrientation) property to control the layout.
