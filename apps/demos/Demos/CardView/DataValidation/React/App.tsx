...
import CardView, { Column, CardCover, Editing, SearchPanel, Form, Item, Paging, RequiredRule, PatternRule, EmailRule, AsyncRule, CustomRule } from 'devextreme-react/card-view';
