...
- **Multiple sort mode**         
A user can hold the **Shift** key and click header panel items in the order the user wants to apply sorting. A number in the header panel item indicates the sort index. To cancel a field's sort settings, a user should hold the **Ctrl** key and click the header panel item.
