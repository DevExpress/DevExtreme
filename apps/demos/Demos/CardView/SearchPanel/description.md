...
CardView searches through all fields, whether they are [visible](/Documentation/ApiReference/UI_Components/dxCardView/Configuration/columns/#visible) or hidden. To search only in visible fields, enable the **searchPanel**.[searchVisibleColumnsOnly](/Documentation/ApiReference/UI_Components/dxCardView/Configuration/searchPanel/#searchVisibleColumnsOnly) property. To omit specific fields, set their [allowSearch](/Documentation/ApiReference/UI_Components/dxCardView/Configuration/columns/#allowSearch) property to `false`.
<!--split-->
