...
export default function App() {
  ...
  return (
    <div id="container">
      ...
      >
        <p>
          Full Name: <b>{currentEmployee.Full_Name}</b>
        </p>
        <p>
          Title: <b>{currentEmployee.Title}</b>
        </p>
        <p>
          City: <b>{currentEmployee.City}</b>
        </p>
        <p>
          State: <b>{currentEmployee.State}</b>
        </p>
        <p>
          Email: <b>{currentEmployee.Email}</b>
        </p>
        <p>
          Skype: <b>{currentEmployee.Skype}</b>
        </p>
        <p>
          Mobile Phone: <b>{currentEmployee.Mobile_Phone}</b>
        </p>
      </Popup>
    </div>
  );
