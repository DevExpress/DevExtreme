export const tasks = ['Prepare 2026 Financial', 'Prepare 2026 Marketing Plan', 'Update Personnel Files', 'Review Health Insurance Options Under the Affordable Care Act', 'New Brochures', '2026 Brochure Designs', 'Brochure Design Review', 'Website Re-Design Plan', 'Rollout of New Website and Marketing Brochures',
  'Update Sales Strategy Documents', 'Create 2022 Sales Report', 'Direct vs Online Sales Comparison Report', 'Review 2022 Sales Report and Approve 2026 Plans', 'Deliver R&D Plans for 2026',
  'Create 2026 R&D Plans', '2026 QA Strategy Report', '2026 Training Events', 'Approve Hiring of John Jeffers', 'Non-Compete Agreements', 'Update NDA Agreement', 'Update Employee Files with New NDA', 'Sign Updated NDA',
  ...
  'Send Email to Customers about Recall', 'Submit Refund Report for 2026 Recall', 'Give Final Approval for Refunds', 'Prepare Product Recall Report', 'Review Product Recall Report by Engineering Team',
  ...
  'Request Bandwidth Increase from ISP', 'Submit D&B Number to ISP for Credit Approval', 'Contact ISP and Discuss Payment Options', 'Prepare Year-End Support Summary Report', 'Analyze Support Traffic for 2026',
  ...
  'Review New HDMI Specification', 'Approval on Converting to New HDMI Specification', 'Create New Spike for Automation Server', 'Report on Retail Sales Strategy for 2024', 'Code Review - New Automation Server',
