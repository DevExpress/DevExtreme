...
function getGradient(type: string, color1: string, color2: string): string {
...
export function getLinearGradient(color: string): string { return getGradient('linear', color, hexToRgb(color, 0.5)); }

export function getRadialGradient(color: string): string { return getGradient('radial', hexToRgb(color, 0.5), color); }

export function getPatternImage(color: string): string {
...
export function getStrokePattern(color: string): string {
  return registerPattern({
...
export function getSquarePattern(color: string): string {
  return registerPattern({
    width: shapePatternSize,
    height: shapePatternSize,
    template: (container: SVGGElement): void => {
...
export function createRect(size: string | number, fill: string | null, stroke?: string, strokeWidth?: string | number): SVGRectElement {
