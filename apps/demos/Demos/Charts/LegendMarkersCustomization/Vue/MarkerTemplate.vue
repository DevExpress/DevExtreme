...
const markerPath: Record<string, string> = {
...
const color: string = props.item.series.isVisible() ? props.item.marker.fill : '#888';
const d: string = markerPath[props.item.series.name];
</script>
