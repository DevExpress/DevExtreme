...
Try to delete or edit messages in this demo. First, check the required options are active in the panel next to the Chat component. Right-click or long tap a message to access "Edit" and "Delete" commands in the context menu. Edit a message in the input field and click "Send" to save changes. 