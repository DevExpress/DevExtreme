...
.chat-suggestion-card {
  border-radius: 12px;
  padding: 16px;
  border: 1px solid var(--dxds-color-border-subtler, #EBEBEB);
  background: var(--dxds-color-bg-canvas, #FAFAFA);
  display: flex;
  flex-direction: column;
...
.chat-suggestion-card:hover {
  border: 1px solid var(--dxds-color-border-subtle, #E0E0E0);
  background: var(--dxds-color-bg-low, #F5F5F5);
  box-shadow: var(--dxds-box-shadow-xs, 0 4px 12px 0 rgba(0, 0, 0, 0.04), 0 4px 24px 0 rgba(0, 0, 0, 0.02));
}

.chat-suggestion-card-title {
  color: var(--dxds-color-content, #242424);
  font-size: 12px;
  font-weight: 600;
  line-height: 16px;
}
...
.chat-suggestion-card-prompt {
  color: var(--dxds-color-content-subtle, #616161);
  font-size: 12px;
  font-weight: 400;
  line-height: 16px;
}
