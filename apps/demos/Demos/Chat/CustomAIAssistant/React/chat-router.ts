...
function isRouterTarget(target: string): target is RouterTarget {
  return ROUTER_TARGETS.has(target as RouterTarget);
}

function isFormActionType(type: string): type is FormActionType {
