...
export const formFieldsConfig = [
  {
    ...
    aiOptions: {
      instruction:
        "Only fill this field with one of the allowed values (Mr., Mrs., Ms.) if a title is explicitly mentioned in the text. Never use this field for any part of a person's name.",
    },
  },
  {
    dataField: 'FirstName',
    ...
    aiOptions: {
      instruction:
        "Only fill this field if the text clearly refers to a person's given name. Never use grid/task-related words like Subject, Priority, Status, Due Date, Completion, or generic verbs like sort/filter/show as a name.",
    },
  },
  {
    dataField: 'LastName',
    ...
    aiOptions: {
      instruction:
        "If the text gives a full person name (e.g. 'customer name', 'employee name') without separately labeled first/last names, use only the first word as First Name and the rest of the name as Last Name.",
    },
  },
  {
    dataField: 'Position',
    ...
    aiOptions: {
      instruction:
        "Only fill this field with one of the allowed job position values if the text explicitly refers to the employee's own job title/role.",
    },
  },
  {
    dataField: 'State',
    ...
    aiOptions: {
      instruction:
        "Only fill this field with one of the allowed US state values if the text explicitly refers to the employee's home/office state.",
    },
  },
  {
    dataField: 'BirthDate',
    ...
    aiOptions: {
      instruction:
        "Only fill this field if the text explicitly refers to the employee's own birth date or date of birth.",
    },
  },
];
