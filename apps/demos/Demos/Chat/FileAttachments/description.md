DevExtreme Chat supports file attachments. When this feature is activated, an “Attach” button appears in the message input field, allowing users to add files to their messages. 

To enable file attachments in Chat, specify [fileUploaderOptions](/Documentation/ApiReference/UI_Components/dxChat/Configuration/#fileUploaderOptions).**uploadFile**.
