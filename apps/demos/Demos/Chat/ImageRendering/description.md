...
Starting with v25.1 you will be able to easily render an image received in responses. For example, if you use DALL-E or a similar AI service to generate pictures, you can set up image rendering using our Chat component. 