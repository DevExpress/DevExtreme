...
You can scroll the component's data horizontally using **Shift + Scroll Wheel**. Utilize the **Home**/**End** keys to jump to the focused row's first/last cells. Jump to the first cell of the first row/last cell of the last row with **Ctrl + Home**/**Ctrl + End**.