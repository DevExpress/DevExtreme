DevExtreme PivotGrid is a UI component for multi-dimensional data analysis. It can process data from local arrays and OLAP cubes (MS SQL Server Analysis Services), as well as from custom remote services. [Learn more about DevExtreme React components](/Documentation/Guide/React_Components/DevExtreme_React_Components/).
