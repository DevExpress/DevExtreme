      ...
      <div className={SCROLLVIEW_PULLDOWN}>
        ...
        <div className={SCROLLVIEW_PULLDOWN_TEXT_CLASS}>
          {refreshStrategy !== 'swipeDown' && (
            <Fragment>
              <div className={getCssClass(state, TopPocketState.STATE_RELEASED)}>
                {pullingDownText}
              </div>
              <div className={getCssClass(state, TopPocketState.STATE_READY)}>
                {pulledDownText}
              </div>
              <div className={getCssClass(state, TopPocketState.STATE_REFRESHING)}>
                {refreshingText}
              </div>
            </Fragment>
          )}
...
export class TopPocket extends JSXComponent<TopPocketProps>() {
  @InternalState() _state = TopPocketState.STATE_RELEASED;
