        ...
        each(offsets).describe('Element is smaller than container. Offset: %o', (offset) => {
          [5, 10, 20].forEach((scrollBarSize) => {
            directions.forEach((orientation) => {
              it(`should scroll to element from top side by vertical orientation. ScrollBarSize:${scrollBarSize}, Orientation: ${orientation}`, () => {
              ...
              it(`should scroll to element from bottom side by vertical orientation. ScrollBarSize:${scrollBarSize}, Orientation: ${orientation}`, () => {
              ...
              it(`should scroll to element from left side by horizontal orientation. ScrollBarSize:${scrollBarSize}, Orientation: ${orientation}`, () => {
              ...
              it(`should scroll to element from right side by horizontal orientation. ScrollBarSize:${scrollBarSize}, Orientation: ${orientation}`, () => {
              ...
              it(`should scroll to element from left side and top side by both orientation. ScrollBarSize:${scrollBarSize}, Orientation: ${orientation}`, () => {
              ...
              it(`should scroll to element from right side and top side by both orientation. ScrollBarSize:${scrollBarSize}, Orientation: ${orientation}`, () => {
              ...
              it(`should scroll to element from left side and bottom side by both orientation. ScrollBarSize:${scrollBarSize}, Orientation: ${orientation}`, () => {
              ...
              it(`should scroll to element from right side and bottom side by both orientation. ScrollBarSize:${scrollBarSize}, Orientation: ${orientation}`, () => {
