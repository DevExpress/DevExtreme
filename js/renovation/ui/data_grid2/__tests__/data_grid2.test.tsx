...
import { DataGrid2, viewFunction as DataGridView, DataGrid2Props } from '../data_grid2';
...
describe('DataGrid2', () => {
  describe('View', () => {
    it('default render', () => {
      const props = {
        props: new DataGrid2Props(),
        aria: { role: 'presentation' },
        classes: '',
        restAttributes: { 'rest-attributes': 'true' },
      } as Partial<DataGrid2>;
    ...
    it('render with dataSource and 1 column', () => {
      const props = new DataGrid2Props();
      props.dataSource = [{ id: 1 }, { id: 2 }];
      props.columns = ['id'];
      const viewProps = { props } as Partial<DataGrid2>;
    ...
    describe('Getters', () => {
      describe('aria', () => {
        it('should have role "presentation"', () => {
          expect(new DataGrid2({}).aria).toEqual({ role: 'presentation' });
        });
      });

      describe('cssClasses', () => {
        it('should have empty cssClasses', () => {
          expect(new DataGrid2({}).cssClasses).toEqual('');
        });
      });
    });
  });
