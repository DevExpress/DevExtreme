...
import {
  isDefined, isString, isNumeric, isFunction, isObject, isPlainObject, type,
...
import { orderEach, deepExtendArraySafe } from '@js/core/utils/object';
...
export const columnsControllerModule = {
  ...
  controllers: {
    columns: modules.Controller.inherit((function () {
      ...
      const createColumn = function (that, columnOptions, userStateColumnOptions?, bandColumn?): any {
      ...
      const getSerializationFormat = function (dataType, value): any {
      ...
      const getCustomizeTextByDataType = function (dataType): any {
        if (dataType === 'boolean') {
      ...
      const strictParseNumber = function (text, format): any {
