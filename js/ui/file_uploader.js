...
var FileUploader = Editor.inherit({
    ...
    _initFileInput: function() {
        ...
        if(!this._$fileInput) {
            ...
            this._$fileInput
                .on("change", $.proxy(this._inputChangeHandler, this))
    ...
    _renderSelectButton: function() {
        ...
        if(devices.real().deviceType === "desktop") {
            ...
            $button
                .off("click")
                .on("click", $.proxy(this._selectButtonClickHandler, this));
        }
    },
    ...
    _renderDragEvents: function() {
        ...
        this._$inputWrapper
            .on(eventUtils.addNamespace("dragenter", this.NAME), $.proxy(this._dragEnterHandler, this))
            .on(eventUtils.addNamespace("dragover", this.NAME), $.proxy(this._dragOverHandler, this))
            .on(eventUtils.addNamespace("dragleave", this.NAME), $.proxy(this._dragLeaveHandler, this))
            .on(eventUtils.addNamespace("drop", this.NAME), $.proxy(this._dropHandler, this));
    },
