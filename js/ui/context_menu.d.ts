...
type FilterOutHidden<T> = Omit<T, 'onFocusIn' | 'onFocusOut' | 'onItemDeleted' | 'onItemDeleting' | 'onItemHold' | 'onItemReordered' | 'onHidden' | 'onHiding' | 'onPositioning' | 'onShowing' | 'onShown'>;
