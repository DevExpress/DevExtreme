...
exports.DraggingHeaderView = gridCore.View.inherit({
    ...
    _renderCore: function() {
        this.element()
            .addClass(DATAGRID_DRAGGING_HEADER_CLASS + " " + DATAGRID_CELL_CONTENT_CLASS + " " + WIDGET_CLASS)
            .css("display", "none");
    },
    ...
    dragHeader: function(options) {
        ...
        that.element().css({
            ...
            .addClass(DATAGRID_HEADERS_DRAG_ACTION_CLASS)
...
exports.DraggingHeaderViewController = gridCore.ViewController.inherit({
                ...
                var i,
                    ...
                    subscribeToEvents = function(index, columnElement) {
                        ...
                        if(draggingPanel.allowDragging(columns[index], nameDraggingPanel, draggingPanels)) {
                            ...
                            $columnElement.on(addNamespace(dragEvents.move, DATAGRID_MODULE_NAMESPACE), { that: draggingHeader }, that.createAction(draggingHeader.moveHeader));
                            $columnElement.on(addNamespace(dragEvents.end, DATAGRID_MODULE_NAMESPACE), { that: draggingHeader }, that.createAction(draggingHeader.dropHeader));
                        }
                    };
    ...
    dock: function(parameters) {
        ...
        that._columnHeadersView.element().find("." + DATAGRID_HEADER_ROW_CLASS).toggleClass(DATAGRID_HEADERS_DROP_HIGHLIGHT_CLASS, sourceLocation !== "headers" && targetLocation === "headers" && !hasTargetVisibleIndex);
