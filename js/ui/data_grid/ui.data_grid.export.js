...
exports.DataProvider = Class.inherit({
    ...
    _initOptions: function() {
        ...
        this._options = {
            ...
            items: this._exportSelectedRows || exportController._selectionOnly ? exportController._getSelectedItems() : exportController._getAllItems(),
    ...
    ctor: function(exportController, initialColumnWidthsByColumnIndex, exportSelectedRows) {
        this._exportController = exportController;
        this._initialColumnWidthsByColumnIndex = initialColumnWidthsByColumnIndex;
        this._exportSelectedRows = exportSelectedRows;
    },
...
exports.ExportController = dataGridCore.ViewController.inherit({}).include(exportMixin).inherit({
    ...
    getDataProvider: function(exportSelectedRows) {
        const columnWidths = this._getColumnWidths(this._headersView, this._rowsView);
        ...
        return new exports.DataProvider(this, initialColumnWidthsByColumnIndex, exportSelectedRows);
    },
    /**
