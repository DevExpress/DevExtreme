        ...
        if(columnChooserEnabled) {
            if(!$showColumnChooserButton.length) {
                $columnChooserButton = $("<div />")
                    .addClass(DATAGRID_COLUMN_CHOOSER_BUTTON_CLASS)
                    .appendTo($element);
...
exports.ColumnChooserView = columnsView.ColumnsView.inherit({
    ...
    _updateList: function(allowUpdate) {
        ...
        if(!isSelectMode || !this._columnChooserList || allowUpdate) {
            this._popupContainer._wrapper()
                .toggleClass(DATAGRID_COLUMN_CHOOSER_DRAG_CLASS, !isSelectMode)
                .toggleClass(DATAGRID_COLUMN_CHOOSER_SELECT_CLASS, isSelectMode);
        ...
        return {
            ...
            itemTemplate: function(data, index, $item) {
                $item
                    ...
                    .addClass(DATAGRID_COLUMN_CHOOSER_ITEM_CLASS);
            }
        };
    },
    ...
    /**
     * @name dxDataGridMethods_showColumnChooser
    ...
    /**
     * @name dxDataGridMethods_hideColumnChooser
...
gridCore.registerModule("columnChooser", {
    defaultOptions: function() {
        return {
            /**
             * @name dxDataGridOptions_columnChooser
             * @publicName columnChooser
             * @type object
             */
            columnChooser: {
                /**
                 * @name dxDataGridOptions_columnChooser_enabled
                 * @publicName enabled
                 * @type boolean
                 * @default false
                 */
                enabled: false,
                /**
                 * @name dxDataGridOptions_columnChooser_mode
                 * @publicName mode
                 * @type string
                ...
                mode: "dragAndDrop",
                /**
                 * @name dxDataGridOptions_columnChooser_width
                 * @publicName width
                 * @type number
                 * @default 250
                 */
                width: 250,
                /**
                 * @name dxDataGridOptions_columnChooser_height
                 * @publicName height
                 * @type number
                 * @default 260
                 */
                height: 260,
                /**
                 * @name dxDataGridOptions_columnChooser_title
                 * @publicName title
                 * @type string
                ...
                /**
                 * @name dxDataGridOptions_columnChooser_emptyPanelText
