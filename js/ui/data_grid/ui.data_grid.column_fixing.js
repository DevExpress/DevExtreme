    ...
    _createCell: function(options) {
        ...
        if(that._isFixedTableRendering) {
            if(columnCommand === "transparent") {
                $cell
                    .addClass(DATAGRID_POINTER_EVENTS_NONE_CLASS)
                    .toggleClass(DATAGRID_FIRST_CELL_CLASS, transparentColumnIndex === 0 || prevFixedColumn && prevFixedColumn.command === "expand")
                    .toggleClass(DATAGRID_LAST_CELL_CLASS, fixedColumns.length && transparentColumnIndex === (fixedColumns.length - 1))
    ...
    _renderContent: function(contentElement, tableElement) {
        if(this._isFixedTableRendering) {
            return contentElement
                .empty()
                .addClass(DATAGRID_CONTENT_CLASS + " " + DATAGRID_CONTENT_FIXED_CLASS + " " + DATAGRID_POINTER_EVENTS_TARGET_CLASS)
                .append(tableElement);
        }
...
gridCore.registerModule("columnFixing", {
    defaultOptions: function() {
        return {
            /**
             * @name dxDataGridOptions_columnFixing
             * @publicName columnFixing
             * @type object
             */
            columnFixing: {
                /**
                * @name dxDataGridOptions_columnFixing_enabled
                * @publicName enabled
                * @type boolean
                * @default false
                */
                enabled: false,
                /**
                 * @name dxDataGridOptions_columnFixing_texts
                 * @publicName texts
                 * @type object
                 */
                texts: {
                    /**
                     * @name dxDataGridOptions_columnFixing_texts_fix
                     * @publicName fix
                     * @type string
                     * @default "Fix"
                     */
                    ...
                    /**
                     * @name dxDataGridOptions_columnFixing_texts_unfix
                     * @publicName unfix
                     * @type string
                     * @default "Unfix"
                     */
                    ...
                    /**
                     * @name dxDataGridOptions_columnFixing_texts_leftPosition
                    ...
                    /**
                     * @name dxDataGridOptions_columnFixing_texts_rightPosition
