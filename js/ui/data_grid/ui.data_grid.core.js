...
$.extend(exports, modules, (function() {
    ...
    var getFilterExpressionForDate = function(filterValue, selectedFilterOperation, target) {
        var column = this,
            ...
            dateInterval = target === "headerFilter" && exports.getGroupInterval(column)[values.length - 1];
        ...
        getHeaderFilterGroupParameters: function(column, remoteGrouping) {
            ...
            if(groupInterval) {
                $.each(groupInterval, function(index, interval) {
                    result.push(remoteGrouping ? { selector: dataField, groupInterval: interval, isExpanded: false } : $.proxy(getIntervalSelector, column, interval));
                });
