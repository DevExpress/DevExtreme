...
exports.KeyboardNavigationController = gridCore.ViewController.inherit({
    ...
    _isCellValid: function($cell) {
        if(commonUtils.isDefined($cell)) {
            var rowsView = this.getView("rowsView"),
                ...
                isEditingCurrentRow = editingController && (editMode === DATAGRID_EDIT_MODE_ROW ? editingController.isEditRow(visibleRowIndex) : editingController.isEditing()),
    ...
    _enterKeyHandler: function(eventArgs, isEditing) {
        ...
        if((this.option("grouping.allowCollapsing") && isGroupRow($row)) ||
            (this.option("masterDetail.enabled") && $cell && $cell.hasClass(DATAGRID_COMMAND_EXPAND_CLASS))) {
...
gridCore.registerModule("keyboardNavigation", {
    defaultOptions: function() {
        return {
            useKeyboard: true
            /**
             * @name dxDataGridOptions_onKeyDown
