...
var $ = require("jquery"),
    ...
    virtualScrollingCore = require("../grid_core/ui.grid_core.virtual_scrolling"),
    ...
    return {
        ...
        _updateContent: function(tableElement, change) {
            ...
            if(changeType === "append" || changeType === "prepend") {
                ...
                tableElement.remove();
                that._getFreeSpaceRowElements(contentTable).not(":last").remove();
            } else {
                that.callBase.apply(that, arguments);
            }
        ...
        _updateBottomLoading: function() {
            ...
            if(showBottomLoading) {
                if(!bottomLoadPanelElement) {
                    $("<div>")
                        .addClass(DATAGRID_BOTTOM_LOAD_PANEL_CLASS)
    ...
    defaultOptions: function() {
        return {
            ...
            scrolling: {
                ...
                mode: "standard",
                /**
                 * @name dxDataGridOptions_scrolling_preloadEnabled
                ...
                /**
                 * @name dxDataGridOptions_scrolling_useNative
                ...
                useNative: "auto"
                /**
                * @name dxDataGridOptions_scrolling_showScrollbar
                ...
                */
                /**
                * @name dxDataGridOptions_scrolling_scrollByContent
                * @publicName scrollByContent
                * @type boolean
                * @default true
                */
                /**
                * @name dxDataGridOptions_scrolling_scrollByThumb
