...
exports.SelectionController = gridCore.Controller.inherit((function() {
    ...
    var isSeveralRowsSelected = function(that, selectionFilter) {
        ...
        if(isComplexKey && commonUtils.isArray(selectionFilter[0]) && selectionFilter[1] === "and") {
    ...
    return {
        ...
        optionChanged: function(args) {
            ...
            switch(args.name) {
                ...
                case "selectedRowKeys":
                    if(commonUtils.isArray(args.value) && !that._selectedItemsInternalChange && that.component.getDataSource()) {
        ...
        /**
         * @name dxDataGridMethods_isRowSelected(key)
        ...
        /**
         * @name dxDataGridMethods_selectAll
        ...
        /**
         * @name dxDataGridMethods_deselectAll
        ...
        /**
         * @name dxDataGridMethods_clearSelection
        ...
        /**
         * @name dxDataGridMethods_selectRows
        ...
        /**
        * @name dxDataGridMethods_deselectRows
        ...
        */
        ...
        /**
         * @name dxDataGridMethods_selectRowsByIndexes
        ...
        /**
         * @name dxDataGridMethods_startSelectionWithCheckboxes
        ...
        /**
         * @name dxDataGridMethods_stopSelectionWithCheckboxes
...
gridCore.registerModule("selection", {
    defaultOptions: function() {
         ...
         */
            selection: {
                /**
                 * @name dxDataGridOptions_selection_mode
                 * @publicName mode
                 * @type string
                ...
                /**
                 * @name dxDataGridOptions_selection_allowSelectAll
            ...
            */
            selectionFilter: [],
            /**
             * @name dxDataGridOptions_onSelectionChanged
             ...
             */
            /**
             * @name dxDataGridOptions_selectedRowKeys
                    ...
                    if(column.command === "select") {
                        return function($cell, options) {
                            ...
                            if(column.command === "select") {
                                ...
                                groupElement = $("<div />")
                                    .appendTo($cell)
                                    .addClass(DATAGRID_SELECT_CHECKBOX_CLASS);
                            ...
                            $.each(tableElements, function(_, tableElement) {
                                $.each(change.itemIndexes || [], function(_, index) {
                                    ...
                                    if(change.items[index]) {
                                        ...
                                        $row
                                            .toggleClass(DATAGRID_ROW_SELECTION_CLASS, isSelected)
                                            .find("." + DATAGRID_SELECT_CHECKBOX_CLASS).dxCheckBox("option", "value", isSelected);
