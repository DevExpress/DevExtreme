...
exports.AdaptiveColumnsController = gridCore.ViewController.inherit({
    ...
    _isCellValid: function($cell) {
        return !$cell.hasClass(DATAGRID_MASTER_DETAIL_CELL_CLASS);
    },
    ...
    /**
     * @name dxDataGridMethods_isAdaptiveDetailRowExpanded
    ...
    /**
    * @name dxDataGridMethods_expandAdaptiveDetailRow
    ...
    */
    expandAdaptiveDetailRow: function(key) {
     ...
     /**
    * @name dxDataGridMethods_collapseAdaptiveDetailRow
...
gridCore.registerModule("adaptivity", {
    defaultOptions: function() {
        return {
            /**
            * @name dxDataGridOptions_columnHidingEnabled
            ...
            */
            ...
            /**
            * @name dxDataGridOptions_onAdaptiveDetailRowPreparing
        ...
        views: {
            rowsView: {
                _getCellTemplate: function(options) {
                    ...
                    if(column.command === DATAGRID_ADAPTIVE_COLUMN_NAME && options.rowType !== "groupFooter") {
                        return function(container) {
                            $("<span/>")
                                .addClass(DATAGRID_ADAPTIVE_COLUMN_BUTTON_CLASS)
                                .on(eventUtils.addNamespace(clickEvent.name, DATAGRID_ADAPTIVE_NAMESPACE), that.createAction(
                                    function() {
                    ...
                    if(options.rowType === DATAGRID_ADAPTIVE_ROW_TYPE && column.command === "detail") {
        ...
        controllers: {
            ...
            editing: {
                _getFormEditItemTemplate: function(cellOptions, column) {
                    if(this.getEditMode() !== DATAGRID_EDIT_MODE_ROW && cellOptions.rowType === "detailAdaptive") {
                ...
                _getRowIndicesForCascadeUpdating: function(row) {
                    ...
                    if(this._adaptiveController.isAdaptiveDetailRowExpanded(row.key)) {
                        rowIndices.push(row.rowType === DATAGRID_ADAPTIVE_ROW_TYPE ? row.rowIndex - 1 : row.rowIndex + 1);
                    }
