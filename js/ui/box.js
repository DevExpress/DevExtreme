...
var FallbackLayoutStrategy = Class.inherit({
    ...
    renderBox: function() {
        ...
        this._$element
            .off(UPDATE_EVENT)
            .on(UPDATE_EVENT, $.proxy(this.update, this));
    },
...
var Box = CollectionWidget.inherit({
    ...
    _initLayout: function() {
        this._layout = (this.option("_layoutStrategy") === "fallback") ?
            new FallbackLayoutStrategy(this.element(), $.proxy(this.option, this)) :
            new FlexLayoutStrategy(this.element(), $.proxy(this.option, this));
    },
