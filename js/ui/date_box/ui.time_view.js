...
var filterRotate = function($arrow, angle, offset) {
    ...
    $arrow.css("filter", 'progid:DXImageTransform.Microsoft.Matrix'
    ...
    _renderField: function() {
        ...
        return this._createComponent($("<div>").addClass(TIMEVIEW_FIELD_CLASS), Box, {
            ...
            items: [{
                ...
                shrink: 0,
                baseSize: "auto",
                template: $.proxy(function() { return this._hourBox.element(); }, this)
            }, {
                ratio: 0,
                shrink: 0,
                baseSize: "auto",
                ...
                shrink: 0,
                baseSize: "auto",
                template: $.proxy(function() { return this._minuteBox.element(); }, this)
            }]
        }).element();
    },
