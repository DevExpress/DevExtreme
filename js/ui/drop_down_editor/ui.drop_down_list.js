...
const DropDownList = DropDownEditor.inherit({
    ...
    _needPopupRepaint: function() {
        ...
        const needRepaint = (isDefined(this._pageIndex) && currentPageIndex <= this._pageIndex) || this._dataSource.isLastPage() || (this._dataSource.isLastPage() && !this._list._scrollViewIsFull());
