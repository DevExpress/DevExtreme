            ...
            $.each(renderedItems, (function(_, item) {
                if(currentItem.itemData === item.itemData) {
                    ...
                    for(var k = 0; k < settingsLength; k++) {
                        var currentItemSettings = objectUtils.deepExtendArraySafe({}, currentItem.settings[k], true),
                            itemSettings = objectUtils.deepExtendArraySafe({}, item.settings[k], true);

                        if(!isAgenda) {
                            delete currentItemSettings.sortedIndex;
                            delete itemSettings.sortedIndex;
                        }
