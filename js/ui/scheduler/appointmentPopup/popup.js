...
export class AppointmentPopup {
    ...
    _addMissingDSTTime(formAppointmentAdapter, clonedAppointmentAdapter) {
        ...
        const correctedStartDate = this._addMissingDSTShiftToDate(
            timeZoneCalculator,
            formAppointmentAdapter.startDate,
            clonedAppointmentAdapter.startDate
        );
        const correctedEndDate = this._addMissingDSTShiftToDate(
            timeZoneCalculator,
            formAppointmentAdapter.endDate,
            clonedAppointmentAdapter.endDate,
        );

        clonedAppointmentAdapter.startDate = correctedStartDate;
        clonedAppointmentAdapter.endDate = correctedEndDate;
    }
