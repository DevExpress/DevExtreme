...
var Scheduler = Widget.inherit({
    ...
    _dataSourceChangedHandler: function(result) {
        ...
        if(this.option("currentView") === "agenda") {
            this._appointments._renderingStrategy.calculateRows(filteredItems, 7, this._dateOption("currentDate"));
        }
    ...
    _initExpressions: function(fields) {
        ...
        $.each(fields, $.proxy(function(name, expr) {
            if(!!expr) {
    ...
    _getPopupToolbarItems: function() {
        return [
                { shortcut: "done", location: "after", onClick: $.proxy(this._doneButtonClickHandler, this) },
    ...
    getResourceManager: function() {
        ...
        //TODO: is this method useful? it's used in tests only
