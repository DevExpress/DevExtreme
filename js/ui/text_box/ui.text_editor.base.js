...
var TextEditorBase = Editor.inherit({
    ...
    _renderValueChangeEvent: function() {
        ...
        this._input()
            .on(keyPressEvent, $.proxy(this._keyPressHandler, this))
            .on(valueChangeEvent, $.proxy(this._valueChangeEventHandler, this));
    },
    ...
    _renderEnterKeyAction: function() {
        ...
        this._input()
            ...
            .on("keyup.onEnterKey.dxTextEditor", $.proxy(this._enterKeyHandlerUp, this));
    },
