...
/** @public */
export type ItemClickEvent<TItem extends Item<any> = Item<any>, TKey = any> = NativeEventInfo<dxTreeView<TItem, TKey>> & TreeViewInfo<TItem, TKey>;

/** @public */
export type ItemCollapsedEvent<TItem extends Item<any> = Item<any>, TKey = any> = NativeEventInfo<dxTreeView<TItem, TKey>> & TreeViewInfo<TItem, TKey>;

/** @public */
export type ItemContextMenuEvent<TItem extends Item<any> = Item<any>, TKey = any> = NativeEventInfo<dxTreeView<TItem, TKey>> & TreeViewInfo<TItem, TKey>;

/** @public */
export type ItemExpandedEvent<TItem extends Item<any> = Item<any>, TKey = any> = NativeEventInfo<dxTreeView<TItem, TKey>> & TreeViewInfo<TItem, TKey>;

/** @public */
export type ItemHoldEvent<TItem extends Item<any> = Item<any>, TKey = any> = NativeEventInfo<dxTreeView<TItem, TKey>> & TreeViewInfo<TItem, TKey>;

/** @public */
export type ItemRenderedEvent<TItem extends Item<any> = Item<any>, TKey = any> = NativeEventInfo<dxTreeView<TItem, TKey>> & TreeViewInfo<TItem, TKey>;

/** @public */
export type ItemSelectionChangedEvent<TItem extends Item<any> = Item<any>, TKey = any> = EventInfo<dxTreeView<TItem, TKey>> & TreeViewInfo<TItem, TKey>;
