...
var Panorama = CollectionWidget.inherit({
    ...
    _initSwipeHandlers: function() {
        this.element()
            ...
            }, $.proxy(this._swipeStartHandler, this))
            .on(eventUtils.addNamespace(swipeEvents.swipe, this.NAME), $.proxy(this._swipeUpdateHandler, this))
            .on(eventUtils.addNamespace(swipeEvents.end, this.NAME), $.proxy(this._swipeEndHandler, this));
    },
