...
const EditingController = modules.ViewController.inherit((function() {
    ...
    return {
        ...
        addRow: function(parentKey) {
            ...
            if(editMode === EDIT_MODE_POPUP) {
                ...
                that._delayedInputFocus($firstCell, function() {
                    ...
                    const $cell = that.getFirstEditableCellInRow(insertKey.rowIndex);
        ...
        saveEditData: function() {
            ...
            const resetEditIndices = function(that) {
            ...
            const editData = that._editData.slice(0);
            ...
            if(deferreds.length) {
                ...
                when.apply($, deferreds).done(function() {
                    if(that._processSaveEditDataResult(results)) {
                        ...
                        const refreshMode = that.option('editing.refreshMode');
        ...
        updateFieldValue: function(options, value, text, forceUpdateRow) {
            ...
            if(options.column.setCellValue) {
                const params = this._prepareEditDataParams(options, value, text);
