...
var ValidatingController = modules.Controller.inherit((function() {
    return {
        ...
        updateEditData: function(editData) {
            if(this._editingController.getEditMode() !== EDIT_MODE_FORM) {
            ...
            editing: {
                ...
                _beforeSaveEditData: function(editData, editIndex) {
                    ...
                    if(editData) {
                        ...
                        if(that.getEditMode() === EDIT_MODE_CELL) {
                            if(!isFullValid) {
                                that._focusEditingCell();
                                result = true;
                            }
                        } else if(that.getEditMode() === EDIT_MODE_BATCH) {
                            if(!isFullValid) {
                        ...
                        } else if(that.getEditMode() === EDIT_MODE_ROW) {
                            result = !isFullValid;
                        }
                    }
                    return result;
