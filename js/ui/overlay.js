...
var Overlay = Widget.inherit({
    ...
    _defaultOptionsRules: function() {
        return this.callBase().concat([{
            ...
            options: {
                 ...
                 * @name dxOverlayOptions_animation
                 * @publicName animation
                 * @default { show: { type: "fade", duration: 400 }, hide: { type: "fade", duration: 400, to: { opacity: 0 }, from: { opacity: 1 } } } @for android_below_version_4
                 */
                animation: {
                    show: {
                        type: "fade",
    ...
    _toggleParentsScrollSubscription: function(subscribe) {
        ...
        this._proxiedTargetParentsScrollHandler = this._proxiedTargetParentsScrollHandler
            || $.proxy(function(e) { this._targetParentsScrollHandler(e); }, this);
    ...
    _renderDrag: function() {
        ...
        $dragTarget
            .on(startEventName, $.proxy(this._dragStartHandler, this))
            .on(updateEventName, $.proxy(this._dragUpdateHandler, this));
    },
