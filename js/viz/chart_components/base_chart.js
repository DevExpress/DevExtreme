...
var BaseChart = BaseWidget.inherit({
    ...
    _renderSeries: function(drawOptions, isRotated, isLegendInside) {
        ...
        drawOptions.hideLayoutLabels = that.layoutManager.needMoreSpaceForPanesCanvas(that._getLayoutTargets(), isRotated)
                                        && !themeManager.getOptions("adaptiveLayout").keepLabels;
