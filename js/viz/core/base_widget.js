...
module.exports = isServerSide ? getEmptyComponent() : DOMComponent.inherit({
    ...
    _calculateCanvas: function() {
        var that = this,
            ...
            elementWidth = !typeUtils.isDefined(size.width) && windowUtils.hasWindow() ? that._$element.width() : 0,
            elementHeight = !typeUtils.isDefined(size.height) && windowUtils.hasWindow() ? that._$element.height() : 0,
            canvas = {
