...
test('Open by click on endDate input and select date in calendar > endDate, value: ["2021/09/17", "2021/09/28"]', async (t) => {
  const dateRangeBox = new DateRangeBox('#container');
...
// TODO: allow select the same start and end dates
...
test('Open by click on endDate input and select date in calendar < startDate, value: ["2021/09/17", "2021/09/28"]', async (t) => {
  const dateRangeBox = new DateRangeBox('#container');
