...
RTL_MODE.forEach((rtlEnabled) => {
  CROSS_SCROLLING_MODES.forEach((crossScrollingEnabled) => {
    VIEW_TYPES.forEach(({ isAllDay, views }) => {
      test(
        `Adaptive views layout test in material theme.
      ...
      test(
        `Adaptive views layout test in material theme, when horizontal grouping is used.
        crossScrollingEnabled=${crossScrollingEnabled};
        rtlEnabled=${rtlEnabled}`,
      ...
      test(`Adaptive views layout test in material theme, when vertical grouping is used.
      crossScrollingEnabled=${crossScrollingEnabled};
      rtlEnabled=${rtlEnabled}`,
