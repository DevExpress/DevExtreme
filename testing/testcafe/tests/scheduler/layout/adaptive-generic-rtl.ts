...
[false, true].forEach((crossScrollingEnabled) => {
  views.forEach((view) => {
    test(`Adaptive views layout test in generic theme (view='${view})', crossScrollingEnabled=${crossScrollingEnabled} and rtl`, async (t) => {
      await t.expect(
...
[false, true].forEach((crossScrollingEnabled) => {
  views
    ...
    .forEach((view) => {
      test(`Adaptive views layout test in generic theme (view='${view.type})', crossScrollingEnabled=${crossScrollingEnabled} when vertical grouping and rtl are used`, async (t) => {
        await t.expect(
