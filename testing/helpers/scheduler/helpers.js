...
export const CLASSES = {
    ...
    dataTableCell: '.dx-scheduler-date-table-cell',
...
export class SchedulerTestWrapper extends ElementWrapper {
    constructor(instance) {
        ...
        this.workSpace = {
            ...
            getCells: () => $(CLASSES.dataTableCell),
            ...
            getCell: (rowIndex, cellIndex) => {
                if(cellIndex !== undefined) {
                    return $('.dx-scheduler-date-table-row').eq(rowIndex).find(CLASSES.dataTableCell).eq(cellIndex);
                }
