...
namespace Runner.Tools
{
    public class UIModelHelper
    {
        ...
        static readonly ICollection<string> KnownConstellations = new HashSet<string> { "export", "misc", "ui", "ui.editors", "ui.grid", "ui.scheduler", "ui.scheduler.integrationBase", "ui.scheduler.integration", "viz", "perf", "renovation" };
