...
namespace Runner.Controllers
{
    ...
    public class TestVectorMapDataController : Controller
    {
        ...
        private const string PathToDataDirectory = "testing/qunit/content/VectorMapData/";
        ...
        private void StartNodeServer()
        {
            lock (SYNC)
            {
                ...
                {
                    var args = new[] {
                        Path.Combine(_env.ContentRootPath, "testing/qunit/helpers/vectormaputils-tester.js"),
