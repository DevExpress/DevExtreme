...
QUnit.test('xl\\worksheets\\sheet1.xml file content', function(assert) {
    const expected = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" mc:Ignorable="x14ac" xmlns:x14ac="http://schemas.microsoft.com/office/spreadsheetml/2009/9/ac"><sheetPr><outlinePr summaryBelow="0"/></sheetPr><dimension ref="A1:C1"/><sheetViews><sheetView tabSelected="1" workbookViewId="0"><pane activePane="bottomLeft" state="frozen" ySplit="1" topLeftCell="A2" /></sheetView></sheetViews><sheetFormatPr defaultRowHeight="15" outlineLevelRow="0" x14ac:dyDescent="0.25"/><cols><col width="13.57" min="1" max="1" customWidth="1" /><col width="27.86" min="2" max="2" customWidth="1" /><col width="20.71" min="3" max="3" customWidth="1" /><col width="22.14" min="4" max="4" customWidth="1" /></cols><sheetData><row r="1" spans="1:4" outlineLevel="0" x14ac:dyDescent="0.25"><c r="A1" s="0" t="b"><v>true</v></c><c r="B1" s="0" t="s"><v>0</v></c><c r="C1" s="0" t="n"><v>12</v></c><c r="D1" s="0" t="n"><v>41709.5</v></c></row><row r="2" spans="1:4" outlineLevel="0" x14ac:dyDescent="0.25"><c r="A2" s="0" t="b"><v>true</v></c><c r="B2" s="0" t="s"><v>1</v></c><c r="C2" s="0" t="n"><v>122</v></c><c r="D2" s="0" t="n"><v>41740.5</v></c></row><row r="3" spans="1:4" outlineLevel="1" x14ac:dyDescent="0.25"><c r="A3" s="0" t="b"><v>false</v></c><c r="B3" s="0" t="s"><v>2</v></c><c r="C3" s="0" t="n"><v>1</v></c><c r="D3" s="0" t="n"><v>41770.5</v></c></row><row r="4" spans="1:4" outlineLevel="1" x14ac:dyDescent="0.25"><c r="A4" s="0" t="b"><v>false</v></c><c r="B4" s="0" t="s"><v>3</v></c><c r="C4" s="0" t="n"><v>4</v></c><c r="D4" s="0" t="n"><v>41801.5</v></c></row><row r="5" spans="1:4" outlineLevel="1" x14ac:dyDescent="0.25"><c r="A5" s="0" t="b"><v>true</v></c><c r="B5" s="0" t="s"><v>4</v></c><c r="C5" s="0" t="n"><v>5</v></c><c r="D5" s="0" t="n"><v>41831.5</v></c></row><row r="6" spans="1:4" outlineLevel="1" x14ac:dyDescent="0.25"><c r="A6" s="0" t="b"><v>true</v></c><c r="B6" s="0" t="s"><v>3</v></c><c r="C6" s="0" t="n"><v>5</v></c><c r="D6" s="0" t="n"><v>41831.5</v></c></row></sheetData><autoFilter ref="A1:D6" /><ignoredErrors><ignoredError sqref="A1:D6" numberStoredAsText="1" /></ignoredErrors></worksheet>';
    const done = assert.async();
