...
QUnit.test('Print method - use export to prepare image, create hidden iFrame with image, delete iFrame after printing', function(assert) {
    ...
    const widget = this.createWidget({
        'export': {
            ...
            __test: {
                deferred: deferred,
                imageSrc: '/testing/qunit/content/exporterTestsContent/test-image.png',
                ...
                checkAssertions: function() {
                    ...
                    assert.equal(image.getAttribute('src'), '/qunit/content/exporterTestsContent/test-image.png');
