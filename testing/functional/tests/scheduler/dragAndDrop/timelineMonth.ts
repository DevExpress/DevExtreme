...
import { movementMap } from './map/timelineMonth.map';

fixture
    `Rearrange appointments in the Scheduler widget with the drag-and-drop gesture`.page(getContainerFileUrl());

test('Rearrange appointments with the drag-and-drop gesture in timelineMonth mode', async t => {
