...
test('Drag-and-drop appointments in week', async t => {
    ...
    await t
        .dragToElement(appointment, scheduler.getDateTableCellElement(1, 0))
    ...
    await t
        .dragToElement(appointment, scheduler.getDateTableCellElement(3, 0))
    ...
    await t
        .dragToElement(appointment, scheduler.getDateTableCellElement(0, 2))
