...
import { movementMap } from './map/timelineWorkWeek.map';

fixture`Rearrange appointments in the Scheduler widget for timeline views with the drag-and-drop gesture`
    .page(getContainerFileUrl());

test('Drag-and-drop appointments in TimelineWorkWeek view', async t => {
