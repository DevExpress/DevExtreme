    ...
    module('Mouse', () => {
        ['standard', 'virtual'].forEach((scrollingMode) => {
            module(`${scrollingMode} scrolling`, {
                ...
                module('Mouse Multiselection with Grouping by Date', () => {
                    [{
                        startCell: 4,
                        endCell: 6,
                        ...
                        test(`Mouse Multiselection should work correctly with ${workSpace.name} when it is grouped by date`, function(assert) {
                            const $element = this.createInstance({
                                focusStateEnabled: true,
                                onContentReady: function(e) {
                                    const scrollable = e.component.getScrollable();
