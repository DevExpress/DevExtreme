...
QUnit.test("More than 3 cloned appointments should be grouped", function(assert) {
    ...
    assert.equal(appointmentsHelper.getCompactAppointmentButtonText(), "8 more", "DropDown menu has correct text");
    assert.roughEqual(appointmentsHelper.getCompactAppointmentButton().outerWidth(), 106, 1, "DropDownMenu button width is OK");
...
QUnit.test("Full-size appointment count depends on maxAppointmentsPerCell option", function(assert) {
    ...
    assert.equal(appointmentsHelper.getCompactAppointmentButtonText(), "1 more", "DropDown menu has correct text");
});
...
QUnit.test("Full-size appointment count depends on maxAppointmentsPerCell option, 'auto' mode", function(assert) {
    ...
    assert.equal(appointmentsHelper.getCompactAppointmentButtonText(), "2 more", "DropDown menu has correct text");
...
QUnit.test("Full-size appointment count depends on maxAppointmentsPerCell option, Day view, 'auto' mode", function(assert) {
    ...
    assert.equal(appointmentsHelper.getCompactAppointmentButtonText(), "3 more", "DropDown menu has correct text");
});
...
QUnit.test("Full-size appointment count depends on maxAppointmentsPerCell option, 'numeric' mode", function(assert) {
    ...
    appointmentsHelper.clickOnCompactAppointment();
    assert.equal(appointmentsHelper.getCompactAppointmentButtonCount(), 2, "ddAppointment is rendered");
...
QUnit.test("Full-size appointment count depends on maxAppointmentsPerCell option, 'auto' mode", function(assert) {
    ...
    appointmentsHelper.clickOnCompactAppointment();
    assert.equal(appointmentsHelper.getCompactAppointmentButtonCount(), 4, "ddAppointment is rendered");
    assert.equal(tooltipHelper.getItemCount(), 1, "DropDown menu has correct items");
    assert.equal(appointmentsHelper.getCompactAppointmentButtonText(), "1 more", "DropDown menu has correct text");
});
...
QUnit.test("Full-size appointment count depends on maxAppointmentsPerCell option, 'auto' mode, narrow height", function(assert) {
    ...
    appointmentsHelper.clickOnCompactAppointment();
    assert.equal(appointmentsHelper.getCompactAppointmentButtonCount(), 8, "ddAppointment is rendered");
    assert.equal(tooltipHelper.getItemCount(), 3, "DropDown menu has correct items");
    assert.equal(appointmentsHelper.getCompactAppointmentButtonText(), "3 more", "DropDown menu has correct text");
});
...
QUnit.test("Full-size appointment count depends on maxAppointmentsPerCell option, 'auto' mode, narrow width", function(assert) {
    ...
    assert.ok(tooltipHelper.isVisible(), "ddAppointment is rendered");
    assert.equal(tooltipHelper.getItemCount(), 1, "DropDown menu has correct items");
    assert.equal(appointmentsHelper.getCompactAppointmentButtonText(), "1", "DropDown menu has correct text");
});
...
QUnit.test("Full-size appointment count depends on maxAppointmentsPerCell and width option, 'auto' mode", function(assert) {
    ...
    assert.ok(tooltipHelper.isVisible(), "ddAppointment is rendered");
    assert.equal(tooltipHelper.getItemCount(), 3, "DropDown menu has correct items");
    assert.equal(appointmentsHelper.getCompactAppointmentButtonText(), "3", "DropDown menu has correct text");
});
