...
QUnit.testInActiveWindow("Apps should be focused in right order", function(assert) {
    ...
    keyboard.keyDown("tab");
    assert.deepEqual($appointments.get(1), apptInstance._getFocusedElementOption().get(0), "app 1 in focus");

    keyboard.keyDown("tab");
    assert.deepEqual($appointments.get(2), apptInstance._getFocusedElementOption().get(0), "app 0 in focus");

    keyboard.keyDown("tab");
    assert.deepEqual($appointments.get(3), apptInstance._getFocusedElementOption().get(0), "app 3 in focus");
});
...
QUnit.testInActiveWindow("Apps should be focused in back order while press shift+tab", function(assert) {
    ...
    assert.deepEqual($appointments.get(2), apptInstance._getFocusedElementOption().get(0), "app 1 in focus");

    keyboard.keyDown("tab", { shiftKey: true });
    assert.deepEqual($appointments.get(1), apptInstance._getFocusedElementOption().get(0), "app 1 in focus");

    keyboard.keyDown("tab", { shiftKey: true });
    assert.deepEqual($appointments.get(0), apptInstance._getFocusedElementOption().get(0), "app 1 in focus");
});
