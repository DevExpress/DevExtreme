...
QUnit.test("resourceCellTemplate should work correct in timeline view", function(assert) {
    ...
    var $cell1 = this.instance.$element().find(".dx-scheduler-group-header div").eq(0),
        $cell2 = this.instance.$element().find(".dx-scheduler-group-header").eq(1);
...
QUnit.test("Group header should contain group header content with right height, groupOrientation = vertical", function(assert) {
    ...
    var $headerContents = this.instance.$element().find(".dx-scheduler-group-header"),
        cellHeight = this.instance.$element().find(".dx-scheduler-date-table-cell").eq(1).outerHeight();

    assert.roughEqual($headerContents.eq(0).outerHeight(), 7 * cellHeight, 1, "Group header content has right height");
});
