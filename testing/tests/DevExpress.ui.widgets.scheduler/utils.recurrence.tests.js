...
QUnit.module('Recurrences', function() {
    QUnit.test('get dates with undefined rule', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: undefined, start: new Date(2015, 0, 1, 0, 0, 10), min: new Date(2015, 0, 1, 0, 0, 10), max: new Date(2015, 0, 1, 0, 0, 12) });

        assert.deepEqual(dates, [], 'dates is right');
    });

    QUnit.test('get date by second recurrence', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=SECONDLY', start: new Date(2015, 0, 1, 0, 0, 10), min: new Date(2015, 0, 1, 0, 0, 10), max: new Date(2015, 0, 1, 0, 0, 12) });
    ...
    QUnit.test('get date by minute recurrence', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MINUTELY', start: new Date(2015, 0, 1, 0, 1), min: new Date(2015, 0, 1, 0, 1), max: new Date(2015, 0, 1, 0, 3) });
    ...
    QUnit.test('get date by hour recurrence', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=HOURLY', start: new Date(2015, 0, 1, 8), min: new Date(2015, 0, 1, 8), max: new Date(2015, 0, 1, 10) });
    ...
    QUnit.test('get date by day recurrence', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=DAILY', start: new Date(2015, 0, 1), min: new Date(2015, 0, 1), max: new Date(2015, 0, 3) });
    ...
    QUnit.test('get date by day recurrence, endDate of part is min', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({
            rule: 'FREQ=DAILY',
    ...
    QUnit.test('get date by week recurrence', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=WEEKLY', start: new Date(2015, 0, 15), min: new Date(2015, 0, 15), max: new Date(2015, 1, 5) });
    ...
    QUnit.test('get date by month recurrence', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MONTHLY', start: new Date(2015, 1, 15), min: new Date(2015, 1, 15), max: new Date(2015, 5, 5) });
    ...
    QUnit.test('get date by year recurrence', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=YEARLY', start: new Date(2015, 11, 15), min: new Date(2015, 11, 15), max: new Date(2019, 5, 5) });
    ...
    QUnit.test('get date by recurrence with 2 day INTERVAL', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=DAILY;INTERVAL=2', start: new Date(2015, 0, 1), min: new Date(2015, 0, 1), max: new Date(2015, 0, 7) });
    ...
    QUnit.test('getDatesByRecurrence should not handled strings only with INTERVAL', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'INTERVAL=2', start: new Date(2015, 0, 1), min: new Date(2015, 0, 1), max: new Date(2015, 0, 7) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with WEEKLY & BYDAY=SU rules and start in Sunday', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=WEEKLY;BYDAY=SU', start: new Date(2018, 4, 27), min: new Date(2018, 4, 27), max: new Date(2018, 5, 11) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with DAILY & BYDAY=MO rules and WKST=WE', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=DAILY;WKST=WE;BYDAY=MO', start: new Date(2015, 4, 18), min: new Date(2015, 4, 18), max: new Date(2015, 5, 7) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with DAILY, BYDAY = whole week, WKST rules', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=DAILY;BYDAY=SU,MO,TU,WE,TH,FR,SA;WKST=WE', start: new Date(2015, 4, 18), min: new Date(2015, 4, 18), max: new Date(2015, 4, 26) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with COUNT', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=DAILY;INTERVAL=3;COUNT=2', start: new Date(2015, 0, 1), min: new Date(2015, 0, 1), max: new Date(2015, 0, 21) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with COUNT without range', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=WEEKLY;BYDAY=MO,WE,FR;COUNT=4', start: new Date(2015, 0, 1), min: new Date(2015, 0, 1), max: new Date(2015, 0, 21) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with COUNT & BYDAY', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=WEEKLY;BYDAY=MO,WE,FR;COUNT=10', start: new Date(2015, 0, 1), min: new Date(2015, 0, 1), max: new Date(2015, 0, 20) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with COUNT & BYDAY & DAILY', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=DAILY;BYDAY=MO;COUNT=7', start: new Date(2018, 4, 14), min: new Date(2018, 4, 14), max: new Date(2018, 6, 10) });
    ...
    QUnit.test('getDatesByRecurrence: FREQ=WEEKLY;BYDAY=[all days], min: new Date(2019, 0, 6), max: new Date(2015, 0, 12)', function(assert) {
        for(let i = 0; i < days.length; i++) {
            const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=WEEKLY;BYDAY=' + days[i], start: new Date(2019, 0, 6), min: new Date(2019, 0, 6), max: new Date(2019, 0, 12) });
    ...
    QUnit.test('getDatesByRecurrence: FREQ=WEEKLY;BYDAY=[all days], min: new Date(2015, 0, 4), max: new Date(2015, 0, 17)', function(assert) {
        for(let i = 0; i < days.length; i++) {
            const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=WEEKLY;BYDAY=' + days[i], start: new Date(2019, 0, 6), min: new Date(2019, 0, 6), max: new Date(2019, 0, 19) });
    ...
    QUnit.test('getDatesByRecurrence: FREQ=WEEKLY;BYDAY=[all days];COUNT=1, min: new Date(2015, 0, 4), max: new Date(2015, 0, 17)', function(assert) {
        for(let i = 0; i < days.length; i++) {
            const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=WEEKLY;BYDAY=' + days[i] + ';COUNT=1', start: new Date(2019, 0, 6), min: new Date(2019, 0, 6), max: new Date(2019, 0, 19) });
            assert.deepEqual(dates, [new Date(2019, 0, 6 + i)], 'date are right');
        }
    });

    QUnit.test('getDatesByRecurrence should handle strings with COUNT & BYMONTH', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MONTHLY;BYMONTHDAY=2;COUNT=10', start: new Date(2017, 0, 1), min: new Date(2017, 0, 1), max: new Date(2017, 11, 20) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYYEARDAY, COUNT & YEARLY', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=YEARLY;BYYEARDAY=200,201;COUNT=10', start: new Date(2017, 0, 1), min: new Date(2017, 6, 1), max: new Date(2018, 7, 1) });
    ...
    QUnit.test('getDatesByRecurrence should not have any string if count is out', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=DAILY;INTERVAL=2;COUNT=2', start: new Date(2015, 0, 1), min: new Date(2015, 1, 1), max: new Date(2015, 1, 21) });

        assert.deepEqual(dates, [], 'date are right');
    });

    QUnit.test('getDatesByRecurrence should handle strings with UNTIL', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=DAILY;UNTIL=20160319T030000', start: new Date(2016, 2, 16, 3), min: new Date(2016, 1, 29), max: new Date(2016, 3, 10), exception: undefined });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with UNTIL greater than endDate', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=DAILY;UNTIL=20150219T000000', start: new Date(2015, 1, 1), min: new Date(2015, 1, 1), max: new Date(2015, 1, 3) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with UNTIL without time', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=DAILY;UNTIL=20150203', start: new Date(2015, 1, 1), min: new Date(2015, 1, 1), max: new Date(2015, 2, 19) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with several value in BYMONTH', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=YEARLY;BYMONTH=1,3', start: new Date(2014, 0, 1), min: new Date(2014, 0, 1), max: new Date(2015, 2, 19) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYMONTHDAY', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MONTHLY;BYMONTHDAY=2', start: new Date(2015, 0, 1), min: new Date(2015, 0, 1), max: new Date(2015, 2, 19) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with MONTHLY & BYDAY', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MONTHLY;BYDAY=MO', start: new Date(2017, 8, 25), min: new Date(2017, 8, 20), max: new Date(2017, 9, 20) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYMONTHDAY value < 0', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MONTHLY;BYMONTHDAY=-1', start: new Date(2015, 0, 1), min: new Date(2015, 0, 1), max: new Date(2015, 5, 19) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYMONTHDAY value = -1, recStart - last day of Month (31st) (T515652)', function(assert) {
        const firstRecurrence = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MONTHLY;BYMONTHDAY=-1', start: new Date(2017, 4, 31), min: new Date(2017, 4, 31), max: new Date(2017, 6, 1) });

        assert.deepEqual(firstRecurrence, [new Date(2017, 4, 31), new Date(2017, 5, 30)], 'dates are right');

        const secondRecurrence = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MONTHLY;BYMONTHDAY=-1', start: new Date(2017, 2, 31), min: new Date(2017, 2, 31), max: new Date(2017, 4, 1) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with COUNT, BYMONTHDAY=-1 and start in 31st', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MONTHLY;BYMONTHDAY=-1;COUNT=10', start: new Date(2017, 6, 31), min: new Date(2017, 6, 31), max: new Date(2017, 10, 10) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYMONTHDAY value = -31', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MONTHLY;BYMONTHDAY=-31', start: new Date(2015, 0, 1), min: new Date(2015, 0, 1), max: new Date(2015, 6, 19) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYMONTHDAY value = -25', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MONTHLY;BYMONTHDAY=-25', start: new Date(2015, 2, 1), min: new Date(2015, 2, 1), max: new Date(2015, 5, 19) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYMONTHDAY && INTERVAL=2', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MONTHLY;BYMONTHDAY=10;INTERVAL=2', start: new Date(2016, 0, 11, 9), min: new Date(2016, 0, 1), max: new Date(2016, 3, 1) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with several value in BYMONTHDAY', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MONTHLY;BYMONTHDAY=11,22', start: new Date(2015, 0, 1), min: new Date(2015, 0, 1), max: new Date(2015, 2, 19) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYMONTH & BYMONTHDAY', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MONTHLY;BYMONTH=1;BYMONTHDAY=2', start: new Date(2015, 0, 1), min: new Date(2015, 0, 1), max: new Date(2015, 2, 19) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYMONTHDAY correctly when recurrenceDate is out of range', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MONTHLY;BYMONTHDAY=26', start: new Date(2015, 4, 25, 9, 30), end: new Date(2015, 4, 26, 11, 30), min: new Date(2015, 4, 27), max: new Date(2015, 4, 27, 23, 59) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYSECOND', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MINUTELY;BYSECOND=15', start: new Date(2015, 0, 1, 1, 1, 10), min: new Date(2015, 0, 1, 1, 1, 10), max: new Date(2015, 0, 1, 1, 3, 20) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with several value in BYSECOND', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MINUTELY;BYSECOND=15,17', start: new Date(2015, 0, 1, 1, 1, 10), min: new Date(2015, 0, 1, 1, 1, 10), max: new Date(2015, 0, 1, 1, 2, 20) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYMINUTE', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=HOURLY;BYMINUTE=15', start: new Date(2015, 0, 1, 1, 10), min: new Date(2015, 0, 1, 1, 10), max: new Date(2015, 0, 1, 3, 20) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with several value in BYMINUTE', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=HOURLY;BYMINUTE=15,17', start: new Date(2015, 0, 1, 1, 10), min: new Date(2015, 0, 1, 1, 10), max: new Date(2015, 0, 1, 2, 16) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYHOUR', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=DAILY;BYHOUR=15', start: new Date(2015, 0, 1, 10), min: new Date(2015, 0, 1, 10), max: new Date(2015, 0, 3, 20) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with several value in BYHOUR', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=DAILY;BYHOUR=15,17', start: new Date(2015, 0, 1, 10), min: new Date(2015, 0, 1, 10), max: new Date(2015, 0, 2, 16) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYDAY to reduce date count', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=DAILY;BYDAY=TU', start: new Date(2015, 1, 10), min: new Date(2015, 1, 10), max: new Date(2015, 2, 9) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with several value in BYDAY to reduce date count', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=DAILY;BYDAY=TU,SA', start: new Date(2015, 1, 10), min: new Date(2015, 1, 10), max: new Date(2015, 1, 23) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYYEARDAY, YEARLY rule', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=YEARLY;BYYEARDAY=200,201', start: new Date(2015, 1, 10), min: new Date(2015, 1, 10), max: new Date(2017, 1, 23) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYWEEKNO & BYDAY, YEARLY rule', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=YEARLY;BYWEEKNO=20,21;BYDAY=TU,SA', start: new Date(2015, 1, 10), min: new Date(2015, 1, 10), max: new Date(2016, 1, 23) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYWEEKNO, YEARLY rule', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=YEARLY;BYWEEKNO=20', start: new Date(2015, 1, 10), min: new Date(2015, 1, 10), max: new Date(2016, 1, 23) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYWEEKNO on second year, YEARLY rule', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=YEARLY;BYWEEKNO=20', start: new Date(2015, 1, 10), min: new Date(2016, 1, 10), max: new Date(2017, 1, 23) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYWEEKNO & WKST=TH, YEARLY rule', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=YEARLY;BYWEEKNO=3;WKST=TH', start: new Date(2016, 0, 1), min: new Date(2016, 0, 1), max: new Date(2016, 11, 31) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYWEEKNO & WKST=FR, YEARLY rule', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=YEARLY;BYWEEKNO=3;WKST=FR', start: new Date(2016, 0, 1), min: new Date(2016, 0, 1), max: new Date(2016, 11, 31) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYWEEKNO & WKST=SA, YEARLY rule', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=YEARLY;BYWEEKNO=3;WKST=SA', start: new Date(2016, 0, 1), min: new Date(2016, 0, 1), max: new Date(2016, 11, 31) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYWEEKNO & WKST=SU, YEARLY rule', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=YEARLY;BYWEEKNO=3;WKST=SU', start: new Date(2016, 0, 1), min: new Date(2016, 0, 1), max: new Date(2016, 11, 31) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYWEEKNO & WKST=MO, YEARLY rule', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=YEARLY;BYWEEKNO=3;WKST=MO', start: new Date(2016, 0, 1), min: new Date(2016, 0, 1), max: new Date(2016, 11, 31) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYWEEKNO & WKST=TU, YEARLY rule', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=YEARLY;BYWEEKNO=3;WKST=TU', start: new Date(2016, 0, 1), min: new Date(2016, 0, 1), max: new Date(2016, 11, 31) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYWEEKNO & WKST=WE, YEARLY rule', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=YEARLY;BYWEEKNO=3;WKST=WE', start: new Date(2016, 0, 1), min: new Date(2016, 0, 1), max: new Date(2016, 11, 31) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with WKST, WEEKLY rule', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=WEEKLY;BYDAY=TU;WKST=WE;INTERVAL=2', start: new Date(2017, 0, 12, 9, 0), min: new Date(2017, 0, 9), max: new Date(2017, 1, 1) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings with BYSETPOS', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=YEARLY;BYWEEKNO=8;BYSETPOS=-1,3', start: new Date(2017, 0, 1, 10), min: new Date(2017, 0, 1), max: new Date(2018, 0, 1) });
    ...
    QUnit.test('getDatesByRecurrence should handle recurrence exception in long format, DAILY rule', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=DAILY', start: new Date(2015, 4, 24, 2), min: new Date(2015, 4, 24), max: new Date(2015, 4, 27, 10), exception: '20150525T020000' });
    ...
    QUnit.test('getDatesByRecurrence should handle recurrence exception, WEEKLY rule', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=WEEKLY;BYDAY=MO', start: new Date(2015, 0, 1), min: new Date(2015, 0, 5), max: new Date(2015, 0, 7), exception: '20150105' });
    ...
    QUnit.test('Weekly recurrences should be shown on the 29 February, WEEKLY rule', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=WEEKLY;BYDAY=MO', start: new Date(2016, 1, 1, 2, 0), min: new Date(2016, 1, 1), max: new Date(2016, 2, 7) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings correctly if interval starts from any day, WEEKLY rule', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=WEEKLY;BYDAY=MO,TH,SA', start: new Date(2015, 2, 12), min: new Date(2015, 2, 12), max: new Date(2015, 2, 18, 23, 59) });
    ...
    QUnit.test('getDatesByRecurrence should handle strings correctly for WEEKLY rule with BYDAY for next week', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=WEEKLY;BYDAY=MO,TU,WE,TH', start: new Date(2017, 5, 29, 9), min: new Date(2017, 6, 3), max: new Date(2017, 6, 7, 23, 59) });
    ...
    QUnit.test('get date by month recurrence with start date at 31', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MONTHLY', start: new Date(2015, 0, 31), min: new Date(2015, 1, 15), max: new Date(2015, 5, 5) });
    ...
    QUnit.test('get date by month recurrence with BYMONTHDAY at 31', function(assert) {
        const dates = getRecurrenceProcessor().getDatesByRecurrence({ rule: 'FREQ=MONTHLY;BYMONTHDAY=31', start: new Date(2015, 1, 15), min: new Date(2015, 1, 15), max: new Date(2015, 5, 5) });
