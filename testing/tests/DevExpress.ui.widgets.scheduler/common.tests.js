    ...
    QUnit.test("onAppointmentRendered should contain information about all recurring appts on agenda view", function(assert) {
        this.createInstance({
            ...
            onAppointmentRendered: function(e) {
                ...
                assert.equal(targetedAppointmentData.appointmentSettings.startDate.getTime(), new Date(2015, 1, 9 + appointmentIndex, 16).getTime(), "Start date is OK");
                assert.equal(targetedAppointmentData.appointmentSettings.endDate.getTime(), new Date(2015, 1, 9 + appointmentIndex, 17).getTime(), "End date is OK");
            },
            currentDate: new Date(2015, 1, 9),
            views: ["agenda"],
            currentView: "agenda"
