...
QUnit.module('Integration: Appointments on vertical views (day, week, workWeek)', {
    ...
    QUnit.test('Appointments should filter correctly if scrolling.mode = "virtual"', function(assert) {
        const data = [
            {
    ...
    QUnit.test('Appointments should filter correctly if resources and scrolling.mode = "virtual"', function(assert) {
        const data = [
            {
                startDate: new Date(2016, 9, 5, 0, 0),
                endDate: new Date(2016, 9, 5, 0, 30),
    ...
    QUnit.test('Appointments should filter correctly if groups, resources and scrolling.mode = "virtual"', function(assert) {
        const data = [
            {
                startDate: new Date(2016, 9, 5, 0, 0),
                endDate: new Date(2016, 9, 5, 0, 30),
