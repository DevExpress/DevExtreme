...
QUnit.test('Tasks should have right boundOffset', function(assert) {
    ...
    const draggableBounds = $appointment.dxDraggable('instance').option('boundOffset');
    const allDayPanelHeight = this.instance.$element().find('.dx-scheduler-all-day-table-cell').first().outerHeight();
...
QUnit.test('Draggable rendering option \'immediate\' should be turned off', function(assert) {
    ...
    const $appointment = $(this.instance.$element()).find('.' + APPOINTMENT_CLASS).eq(0);
    const immediate = $appointment.dxDraggable('instance').option('immediate');
...
QUnit.test('Tasks should have right draggable area', function(assert) {
    ...
    const $appointment = $(this.instance.$element()).find('.' + APPOINTMENT_CLASS).eq(0);
    const draggableArea = $appointment.dxDraggable('instance').option('area');
...
QUnit.test('Appointment should have correct position while vertical dragging', function(assert) {
    ...
    const allDayHeight = this.instance.$element().find('.dx-scheduler-all-day-table-cell').first().outerHeight();
    const scrollDistance = 400;
    const dragDistance = -300;
    const headerPanelHeight = this.instance.$element().find('.dx-scheduler-header-panel').outerHeight(true);
...
QUnit.test('getWorkSpaceScrollableScrollTop should be called while dragging from allDay panel, vertical grouping', function(assert) {
    ...
    const getScrollableOffset = this.instance.getWorkSpaceScrollableScrollTop;
...
QUnit.test('Appointment should have correct position while horizontal dragging', function(assert) {
    ...
    const timePanelWidth = this.instance.$element().find('.dx-scheduler-time-panel').outerWidth(true);
