...
QUnit.test("Many grouped allDay dropDown appts should be grouped correctly (T489535)", function(assert) {
    ...
    var firstGroupDropDown = this.instance.element().find(".dx-scheduler-dropdown-appointments").eq(0).dxDropDownMenu("instance"),
        secondGroupDropDown = this.instance.element().find(".dx-scheduler-dropdown-appointments").eq(0).dxDropDownMenu("instance");
...
QUnit.test("AllDay recurrent appointment should be rendered correctly after changing currentDate", function(assert) {
    var appointment = {
        text: "Appointment",
