...
module('Scheduler grid and appointment time zone', moduleConfig, () => {
    ...
    test('Appointments in DST should not have offset when ' +
        ...
        assert.equal(appointments.getDateText(0), '2:00 PM - 2:30 PM', 'should be without offset');
        assert.equal(appointments.getDateText(1), '2:00 PM - 2:30 PM', 'should be wwithoutith offset');
