...
QUnit.test("Header panel, all-day panel, date table should always take all work space width", function(assert) {
    ...
    assert.roughEqual(headerPanelWidth, 896, 5, "Width is OK");
    assert.roughEqual(allDayTableWidth, 896, 5, "Width is OK");
    assert.roughEqual(dateTableWidth, 896, 5, "Width is OK");
});
