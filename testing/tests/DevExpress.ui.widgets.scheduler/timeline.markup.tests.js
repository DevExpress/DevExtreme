...
QUnit.module('Timeline markup', moduleConfig, () => {
    ...
    QUnit.test('Group table should contain right rows and cells count', function(assert) {
        ...
        const $secondRowCells = $groupRows.eq(1).find('.dx-scheduler-group-header');
        const $thirdRowCells = $groupRows.eq(2).find('.dx-scheduler-group-header');
        const $fourthRowCells = $groupRows.eq(3).find('.dx-scheduler-group-header');
