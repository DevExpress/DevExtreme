...
QUnit.test('Custom colors', function(assert) {
    ...
    this.rangeContainer.render({
        width: 1,
        backgroundColor: { defsColor: 'id_color_0' },
        ranges: [
            { startValue: 10, endValue: 20, color: { defsColor: 'id_color_1' } },
            { startValue: 30, endValue: 50, color: { defsColor: 'id_color_2' } },
            { startValue: 50, endValue: 80, color: { defsColor: 'id_color_3' } }
        ]
    });
