...
QUnit.test('Recursive empty inner exception (T1081655) - complex case', function(assert) {
    const done = assert.async();
    ...
    ajaxMock.setup({
        ...
        responseText: {
            error: {
                'message': {
                    'value': 'An error occurred while processing this request.See the inner exception for details.'
                },
                'innererror': {
                    'internalexception': {
                        'message': 'The DELETE statement conflicted with the REFERENCE constraint',
