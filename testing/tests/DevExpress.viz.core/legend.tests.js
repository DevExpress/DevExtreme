...
QUnit.test('Change state - leads to redraw marker', function(assert) {
    ...
    markersGroup.children[0].children[0].stub('clear').resetHistory();
...
QUnit.test('applyHover from invisible series', function(assert) {
    this.renderer.rect.getCall(0).returnValue.stub('smartAttr').resetHistory();
    this.renderer.rect.getCall(1).returnValue.stub('smartAttr').resetHistory();
