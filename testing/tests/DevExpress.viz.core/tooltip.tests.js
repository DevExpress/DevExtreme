...
QUnit.test('Show preparations. W/o customize, w/ text', function(assert) {
    ...
    const result = this.tooltip.show({ valueText: 'some-text' }, { x: 100, y: 200, offset: 300 });
...
QUnit.test('Show preparations. W/o customize, w/ text from \'description\' filed', function(assert) {
    ...
    const result = this.tooltip.show({ description: 'some-text' }, { x: 100, y: 200, offset: 300 });
...
QUnit.test('Show. W/o params', function(assert) {
    ...
    // act
    const result = this.tooltip.show({ valueText: 'some-text' }, { x: 100, y: 200, offset: 300 }, eventData);
...
QUnit.test('Show. W/ params', function(assert) {
    ...
    // act
    const result = this.tooltip.show({ valueText: 'some-text' }, { x: 10, y: 20, offset: 30 });
