...
var $ = require("jquery"),
    constants = require("viz/axes/axes_constants"),
...
var environment = {
    beforeEach: function() {
        ...
        this.tickManager.stub("getOptions").returns({ labelOptions: { visible: true, indentFromAxis: 10, overlappingBehavior: {} } });
    ...
    updateOptions: function(options) {
        this.axis.updateOptions($.extend(true, options, {
            label: {
                visible: true, indentFromAxis: 10, overlappingBehavior: {}
            },
...
QUnit.test("T310394. Check label format", function(assert) {
    var that = this;
    that.formats = {
        count: 0
    };
    var stubFormatLabel = sinon.stub(constants, "formatLabel", function() {
        if(that.formats[arguments[1].format || "test_format"] === undefined) {
            that.formats.count += 1;
            that.formats[arguments[1].format || "test_format"] = 0;
        }
        //that.formats.count += that.formats[arguments[1].format] !== undefined ? 0 : that.formats[arguments[1].format] + 1;
        return arguments[0];
    });
    var renderer = new vizMocks.Renderer(),
        translator = new StubTranslator(),
        additionalTranslator = new StubTranslator(),
        axis = new Axis({
            renderer: renderer,
    ...
    translator.stub("getBusinessRange").returns({ minVisible: new Date(2011, 0, 1), maxVisible: new Date(2015, 11, 1), addRange: sinon.stub() });

    translator.stub("translateSpecialCase").withArgs("canvas_position_start").returns(0);
    translator.stub("translateSpecialCase").withArgs("canvas_position_end").returns(300);

    additionalTranslator.stub("getBusinessRange").returns({ addRange: sinon.stub() });

    axis.setTranslator(translator, additionalTranslator);
    axis.draw();

    assert.equal(this.formats.count, 1);
    stubFormatLabel.restore();
});
...
QUnit.test("Draw ticks. Horizontal. Continuous with decimated ticks", function(assert) {
    ...
    this.tickManager.stub("getDecimatedTicks").returns([2, 4]);
...
QUnit.test("Draw ticks. Horizontal. Semidiscrete with decimated ticks", function(assert) {
    //arrange
    var renderer = this.renderer;
    this.createAxis();
    this.updateOptions({
    ...
    assert.deepEqual(renderer.path.getCall(0).args, [[10, 0, 10, 20], "line"]);
    assert.deepEqual(renderer.path.getCall(1).args, [[50, 0, 50, 20], "line"]);
    assert.deepEqual(renderer.path.getCall(2).args, [[30, 0, 30, 20], "line"]);
    assert.deepEqual(renderer.path.getCall(3).args, [[70, 0, 70, 20], "line"]);
});
...
QUnit.test("Draw ticks. Horizontal. Categories. Decimated ticks", function(assert) {
    //arrange
    var renderer = this.renderer;
    this.createAxis();
    this.updateOptions({
    ...
    this.tickManager.stub("getTicks").returns(["a", "b"]);
    this.tickManager.stub("getDecimatedTicks").returns(["c", "e"]);
    ...
    this.translator.stub("translate").withArgs("a", 1).returns(25);
    this.translator.stub("translate").withArgs("b", 1).returns(40);
    this.translator.stub("translate").withArgs("c", 1).returns(35);
    this.translator.stub("translate").withArgs("e", 1).returns(50);
    ...
    //assert
    assert.equal(renderer.path.callCount, 3, "Path call count");
    ...
    assert.deepEqual(renderer.path.getCall(2).args, [[35, 6, 35, 14], "line"], "Path points");
    assert.deepEqual(renderer.path.getCall(2).returnValue.attr.lastCall.args[0], { "stroke-width": 5, "stroke-opacity": 0.3, "stroke": "#123456" }, "Path style");
    assert.deepEqual(renderer.path.getCall(2).returnValue.sharp.lastCall.args[0], "h", "Path sharp params");
});
...
QUnit.test("Horizontal axis. Position - bottom. Overlapping behavior mode = stagger", function(assert) {
    //arrange
    var renderer = this.renderer;
    this.createAxis();
    this.updateOptions({
    ...
    this.tickManager.stub("getTicks").returns([1, 2]);
    this.tickManager.stub("getOverlappingBehavior").returns({ mode: "stagger", staggeringSpacing: 10 });
    this.translator.stub("translate").withArgs(1).returns(25);
    this.translator.stub("translate").withArgs(2).returns(40);
    ...
    assert.deepEqual(renderer.text.getCall(0).args, ["1", 25, 20], "Text args");
    assert.strictEqual(renderer.text.getCall(0).returnValue.stub("move").called, false, "move");

    assert.deepEqual(renderer.text.getCall(1).args, ["2", 40, 20], "Text args");
    assert.deepEqual(renderer.text.getCall(1).returnValue.move.getCall(0).args, [0, 20], "move");
});
...
QUnit.test("Horizontal axis. Position - top. Overlapping behavior mode = stagger", function(assert) {
    //arrange
    var renderer = this.renderer;
    this.createAxis();
    this.updateOptions({
    ...
    this.tickManager.stub("getTicks").returns([1, 2]);
    this.tickManager.getOverlappingBehavior = sinon.stub().returns({ mode: "stagger", staggeringSpacing: 10 });
    this.translator.stub("translate").withArgs(1).returns(25);
    this.translator.stub("translate").withArgs(2).returns(40);
...
QUnit.test("Horizontal axis. Position - bottom. Labels alignment - left", function(assert) {
    ...
    this.tickManager.stub("getOptions").returns({ labelOptions: { visible: true, indentFromAxis: 10, alignment: "left", overlappingBehavior: {} } });
    this.tickManager.stub("getTicks").returns([1, 2]);
    this.translator.stub("translate").withArgs(1).returns(25);
    this.translator.stub("translate").withArgs(2).returns(40);
...
QUnit.test("Horizontal axis. Position - bottom. Labels alignment - center", function(assert) {
    ...
    this.tickManager.stub("getOptions").returns({ labelOptions: { visible: true, indentFromAxis: 10, alignment: "center", overlappingBehavior: {} } });
    this.tickManager.stub("getTicks").returns([1, 2]);
    this.translator.stub("translate").withArgs(1).returns(25);
    this.translator.stub("translate").withArgs(2).returns(40);
...
QUnit.test("Horizontal axis. Position - bottom. Labels alignment - right", function(assert) {
    ...
    this.tickManager.stub("getOptions").returns({ labelOptions: { visible: true, indentFromAxis: 10, alignment: "right", overlappingBehavior: {} } });
    this.tickManager.stub("getTicks").returns([1, 2]);
    this.translator.stub("translate").withArgs(1).returns(25);
    this.translator.stub("translate").withArgs(2).returns(40);
