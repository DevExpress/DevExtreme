...
QUnit.test("Get full ticks", function(assert) {
    ...
    assert.deepEqual(this.tickManager.getFullTicks(), [0.00001, 0.0001, 0.001, 0.01, 0.1, 0.5, 1, 1.5, 2.5, 10, 100, 1000, 10000]);
});
...
QUnit.test("Get boundary ticks", function(assert) {
    ...
    assert.deepEqual(this.tickManager.getBoundaryTicks(), [11000]);
});
