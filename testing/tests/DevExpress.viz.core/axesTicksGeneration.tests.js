...
QUnit.test("0-10, screenDelta 200 - tickInterval 5", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0, max: 10, addRange: function() { } });
...
QUnit.test("0-100, screenDelta 250 - tickInterval 20", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0, max: 100, addRange: function() { } });
...
QUnit.test("0-2, screenDelta 500 - tickInterval 1", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0, max: 2, addRange: function() { } });
...
QUnit.test("0-2.1, screenDelta 5000 - tickInterval 0.025", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0, max: 2.1, addRange: function() { } });
...
QUnit.test("Adjust numeric ticks", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 1.2e-7, max: 1.22e-7, addRange: function() { } });
...
QUnit.test("endOnTick is undefined - calculate ticks inside data bounds", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0.95, max: 10.05, addRange: function() { } });
...
QUnit.test("endOnTick is undefined - calculate ticks outside data bounds", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0.5, max: 10.5, addRange: function() { } });
...
QUnit.test("endOnTick is undefined - calculate ticks outside data bounds (large tickInterval)", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0.95, max: 3.05, addRange: function() { } });
...
QUnit.test("endOnTick === false - calculate ticks as multipliers of tickInterval", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 2, max: 11, addRange: function() { } });
...
QUnit.test("endOnTick === true - calculate ticks outside or on data bounds", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 2, max: 12, addRange: function() { } });
...
QUnit.test("Force user tick interval if it is too small for given screenDelta and spacing factor", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0, max: 20, addRange: function() { } });
...
QUnit.test("Stub data. User's tickIntervsal 4 - ignore users tickInterval", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0, max: 10, stubData: true, addRange: function() { } });
...
QUnit.test("BusinessDelta is 0", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 200, max: 200, addRange: function() { } });
...
QUnit.test("tickInterval > businessDelta, no data as multiplier of tickInterval (endOnTick == undefined)", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 13, max: 20, addRange: function() { } });
...
QUnit.test("2*tickInterval > businessDelta > tickInterval, no data as multiplier of tickInterval (endOnTick == undefined)", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 3, max: 89, addRange: function() { } });
...
QUnit.test("tickInterval > businessDelta, there is data as multiplier of tickInterval - calculate tick", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 17.5, max: 24, addRange: function() { } });
...
QUnit.test("Custom numberMultipliers", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0, max: 18.1, addRange: function() { } });
...
QUnit.test("Add extra tick (continuous, numeric) for the bar point is equal to the minimum tick value", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 200, max: 605, checkMinDataVisibility: true, addRange: function() { } });
...
QUnit.test("Add extra tick (continuous, numeric) for the bar point is equal to the maximum tick value", function(assert) {
    ...
    this.axis.setBusinessRange({ min: -605, max: -200, checkMaxDataVisibility: true, addRange: function() { } });
...
QUnit.test("Add extra tick (logarithmic, numeric) for the bar point is equal to the minimum tick value", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0.01, max: 10011, checkMinDataVisibility: true, addRange: function() { } });
...
QUnit.test("getAggregationInfo. Ticks was generated with endOnTick", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 4, maxVisible: 12, addRange: sinon.stub().returnsThis() });
...
QUnit.test("getAggregationInfo. get tick from minVisible - tickInterval if tickInterval is greater than viewport", function(assert) {
    ...
    this.axis.setMarginOptions({ checkInterval: true });
    this.axis.setBusinessRange({ min: 0.8, max: 1, addRange: sinon.stub().returnsThis() });
    this.axis.createTicks(canvas(170));
    // act
...
QUnit.test("datetime getAggregationInfo", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2012, 3, 1, 12, 3, 5, 123), max: new Date(2012, 3, 1, 12, 3, 5, 149), addRange: sinon.stub().returnsThis() });
    this.axis.createTicks(canvas(300));
    // act
...
QUnit.test("Do not get tickInterval less than data interval", function(assert) {
    ...
    this.axis.setMarginOptions({ checkInterval: true });
    this.axis.setBusinessRange({ min: new Date(2012, 3, 1), max: new Date(2012, 3, 2), addRange: sinon.stub().returnsThis() });
    this.axis.createTicks(canvas(170));
    // act
...
QUnit.test("logarithmic getAggregationInfo", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0.01, max: 10, addRange: sinon.stub().returnsThis() });
...
QUnit.test("Do not get tickInterval less than data interval. Logarithmic", function(assert) {
    ...
    this.axis.setMarginOptions({ checkInterval: true });
    this.axis.setBusinessRange({ min: 10, max: 100, addRange: sinon.stub().returnsThis() });
    this.axis.createTicks(canvas(170));
    // act
...
QUnit.test("Minor ticks do not go beyond bounds if endOnTick = fasle", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 2.5, max: 12.3, addRange: function() { } });
...
QUnit.test("Minor ticks go beyond bounds if endOnTick = true", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 4, max: 12.3, addRange: function() { } });
...
QUnit.test("Minor ticks with given minorTickCount", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0, max: 12, addRange: function() { } });
...
QUnit.test("Minor ticks when there is only one major tick on min (big tickInterval)", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 13, max: 40, addRange: function() { } });
...
QUnit.test("Do not generate ticks when screen delta is 0", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 1, max: 2, addRange: function() { } });
...
QUnit.test("0.0001 - 10000, screenDelta 450 - tickInterval 1", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0.0001, max: 10000, addRange: function() { } });
...
QUnit.test("0.0001 - 100000, screenDelta 70 - tickInterval 10", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0.0001, max: 100000, addRange: function() { } });
...
QUnit.test("tickInterval can not be less than 1", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 1, max: 1000, addRange: function() { } });
...
QUnit.test("endOnTick is undefined - calculate ticks inside data bounds", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0.00009, max: 11000, addRange: function() { } });
...
QUnit.test("endOnTick === false - calculate ticks inside data bounds", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0.00008, max: 11000, addRange: function() { } });
...
QUnit.test("endOnTick === true - calculate ticks outside or on data bounds", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0.0001, max: 9000, addRange: function() { } });
...
QUnit.test("logBase 2", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 3.74, max: 1100, addRange: function() { } });
...
QUnit.test("min = 0, max = 0", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0, max: 0, addRange: function() { } });
...
QUnit.test("tickInterval > businessDelta, no data as multiplier of tickInterval (endOnTick == undefined), take 2 ticks always", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 1638, max: 3166, addRange: function() { } });
...
QUnit.test("minorTickInterval as exponent, but ticks not", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 1, max: 100, addRange: function() { } });
...
QUnit.test("Minor ticks do not go beyond bounds if endOnTick = fasle", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 5, max: 300, addRange: function() { } });
...
QUnit.test("Minor ticks when there is only one major tick on min (big tickInterval)", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 1, max: 800, addRange: function() { } });
...
QUnit.test("Minor ticks when there is only one major tick in the middle (big tickInterval)", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 50, max: 250, addRange: function() { } });
...
QUnit.test("Minor ticks when given minorTickCount", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 10, max: 100, addRange: function() { } });
...
QUnit.test("Seconds tickInterval (5s)", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2012, 3, 1, 12, 3, 3), max: new Date(2012, 3, 1, 12, 3, 26), addRange: function() { } });
...
QUnit.test("Minutes tickInterval (3)", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2012, 3, 1, 12, 1), max: new Date(2012, 3, 1, 12, 16), addRange: function() { } });
...
QUnit.test("Hours tickInterval (4)", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2012, 3, 1, 3), max: new Date(2012, 3, 1, 21), addRange: function() { } });
...
QUnit.test("Days tickInterval (2)", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2012, 3, 2, 13), max: new Date(2012, 3, 11, 5), addRange: function() { } });
...
QUnit.test("Weeks tickInterval (2)", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2012, 2, 30), max: new Date(2012, 4, 30), addRange: function() { } });
...
QUnit.test("Months tickInterval (3)", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2011, 10, 20), max: new Date(2013, 0, 15), addRange: function() { } });
...
QUnit.test("Years tickInterval (2)", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2005, 0, 1), max: new Date(2013, 0, 1), addRange: function() { } });
...
QUnit.test("Years tickInterval can not be 2.5 (5)", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(1994, 11, 20), max: new Date(2015, 5, 1), addRange: function() { } });
...
QUnit.test("Years tickInterval (25)", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(1899, 0, 1), max: new Date(2001, 0, 1), addRange: function() { } });
...
QUnit.test("endOnTick === false - calculate ticks inside data bounds", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2017, 1, 3, 13, 28, 33), max: new Date(2017, 1, 12, 5, 3), addRange: function() { } });
...
QUnit.test("endOnTick === true - calculate ticks outside or on data bounds", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2017, 1, 3, 13, 28, 33), max: new Date(2017, 1, 11, 5, 3), addRange: function() { } });
...
QUnit.test("endOnTick === true - calculate ticks outside or on data bounds. Take into account local timezone offset", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2017, 1, 3), max: new Date(2017, 1, 13), addRange: function() { } });
...
QUnit.test("Force user tick interval if it is too small for given screenDelta and spacing factor", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2017, 1, 4, 13, 28, 33), max: new Date(2017, 1, 8, 5, 3), addRange: function() { } });
...
QUnit.test("Quarters custom interval", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2011, 0, 10), max: new Date(2011, 10, 1), addRange: function() { } });
...
QUnit.test("Custom tickInterval with several keys - use bigger key as multiplier", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2012, 3, 1, 11, 3, 3), max: new Date(2012, 3, 1, 21), addRange: function() { } });
...
QUnit.test("Custom tickInterval is very small - ignore tickInterval and raise W2003 warning", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2012, 3, 2, 2), max: new Date(2012, 3, 12, 12), addRange: function() { } });
...
QUnit.test("Tick interval can be set as string value", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2017, 1, 3, 13, 28, 33), max: new Date(2017, 1, 7, 5, 3), addRange: function() { } });
...
QUnit.test("The Daylight Saving day on the Central European time zone", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date("2017-10-28T23:59:00+01:00"), max: new Date("2017-10-29T05:01:00+00:00"), addRange: function() { } });
...
QUnit.test("tickInterval month - minorTickInterval can not be in weeks", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2012, 3, 1), max: new Date(2012, 5, 1), addRange: function() { } });
...
QUnit.test("Minor ticks when there is only one major tick on min (big tickInterval)", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2012, 3, 10), max: new Date(2012, 3, 30), addRange: function() { } });
...
QUnit.test("Minor ticks when there is only one major tick in the middle (big tickInterval)", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2012, 2, 20), max: new Date(2012, 3, 9), addRange: function() { } });
...
QUnit.test("Minor ticks with given minorTickCount", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2015, 11, 24), max: new Date(2017, 0, 7), addRange: function() { } });
...
QUnit.test("Do not generate minor ticks more than minorTickCount", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2016, 11, 24), max: new Date(2017, 1, 7), addRange: function() { } });
...
QUnit.test("Do not generate minor ticks more than minorTickCount before first tick", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2016, 0, 15), max: new Date(2016, 2, 7), addRange: function() { } });
...
QUnit.test("Do not generate minor ticks nor calculate minorTickInterval when data range is zero (min == max)", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2012, 10, 1, 12), max: new Date(2012, 10, 1, 12), addRange: function() { } });
...
QUnit.test("Tune scale break values. Datetime", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2017, 0, 1), max: new Date(2017, 9, 1), addRange: function() { return this; } });
...
QUnit.test("Tune scale break values. Logarithmic", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0.0001, max: 100000, addRange: function() { return this; } });
...
QUnit.test("Tune scale break values when axis division factor is too big", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0, max: 10000, addRange: function() { return this; } });
...
QUnit.test("Do not tune day off scale break", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2017, 8, 13), max: new Date(2017, 8, 20), addRange: function() { return this; } });
...
QUnit.test("Do not remove day off scale break if it less than tickInterval", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2017, 8, 13), max: new Date(2017, 9, 20), addRange: function() { return this; } });
...
QUnit.test("Generate minor ticks when scale breaks at the begin and at the end", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 1, max: 105, addRange: function() { return this; } });
...
QUnit.test("Move datetime ticks to work day", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2017, 8, 15), max: new Date(2017, 8, 19), addRange: function() { return this; } });
...
QUnit.test("Correct first tick to work day", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(1994, 2, 1), max: new Date(1994, 2, 31), addRange: function() { return this; } });
...
QUnit.test("Do not give 2 days tick interval if big weekend", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(1994, 2, 1), max: new Date(1994, 5, 31), addRange: function() { return this; } });
...
QUnit.test("Do not move datetime ticks to work day if work day has tick", function(assert) {
    ...
    this.axis.setBusinessRange({ min: new Date(2017, 8, 16), max: new Date(2017, 8, 22), addRange: function() { return this; } });
...
QUnit.test("Logarithmick with scale breaks", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0.0001, max: 10000, addRange: function() { return this; } });
...
QUnit.test("Generate sexy tick when there are breaks", function(assert) {
    ...
    this.axis.setBusinessRange({ min: 0, max: 318, addRange: function() { return this; } });
