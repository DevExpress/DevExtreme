...
QUnit.module('Keyboard keys', {
    ...
    // T973782
    QUnit.testInActiveWindow('Focus overlay should not overlap the whole row after addRow and tab if editing is batch', function(assert) {
        ...
        // assert
        assert.equal($('#container .dx-datagrid-focus-overlay').outerWidth(), $('#container td').eq(1).outerWidth(), 'focus overlay is not visible');
