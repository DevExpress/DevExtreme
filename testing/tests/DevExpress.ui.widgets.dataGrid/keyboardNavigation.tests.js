...
var $ = require("jquery"),
    ...
    KeyboardNavigationController = require("ui/data_grid/ui.data_grid.keyboard_navigation").KeyboardNavigationController,
...
QUnit.testInActiveWindow("Do not prevent default on 'tab' if the current cell is the last", function(assert) {
    ...
    var $lastCell = this.rowsView.element().find(".dx-row:visible").last().find("td").last();
...
QUnit.testInActiveWindow("closeEditCell and reset focus on 'tab' if the current cell is the last editable cell and contains editor", function(assert) {
    ...
    var $lastCell = this.rowsView.element().find(".dx-row:visible").last().find("td").eq(1);
...
QUnit.testInActiveWindow("Focus link elements on tab key", function(assert) {
    ...
    //act
    var $cell = this.rowsView.element().find(".dx-row:visible").eq(0).find("td").eq(0);
    ...
    //assert
    assert.ok(isPreventDefaultCalled, "preventDefault is called");
    assert.ok(this.rowsView.element().find(".dx-row:visible").eq(0).find("td").eq(2).is(":focus"), "last cell is focused");
});
...
QUnit.testInActiveWindow("Focus link elements on shift+tab key", function(assert) {
    ...
    //act
    var $cell = this.rowsView.element().find(".dx-row:visible").eq(0).find("td").eq(2);
    $cell.focus().trigger("dxpointerdown");
    ...
    //assert
    assert.ok(isPreventDefaultCalled, "preventDefault is called");
    assert.ok(this.rowsView.element().find(".dx-row:visible").eq(0).find("td").eq(0).is(":focus"), "first cell is focused");
