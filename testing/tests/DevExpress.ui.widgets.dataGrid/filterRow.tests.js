...
if(device.deviceType === "desktop") {
    ...
    QUnit.testInActiveWindow("Filter range - keyboard navigation", function(assert) {
        ...
        // act
        $($numberBoxElements.last().find(TEXTEDITOR_INPUT_SELECTOR)).trigger($.Event("keydown", { key: "Tab", keyName: "tab" })); // focus on menu of the second cell, hide range
    ...
    QUnit.testInActiveWindow("Filter range - keyboard navigation with key pressed the shift", function(assert) {
        ...
        // act
        $($numberBoxElements.first().find("input")).trigger($.Event("keydown", { key: "Tab", keyName: "tab", shiftKey: true })); // focus on menu of the first cell, hide range
