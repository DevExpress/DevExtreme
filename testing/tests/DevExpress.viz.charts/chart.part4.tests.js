...
QUnit.test("Update clipRects. After update elements & canvas", function(assert) {
    ...
    assert.deepEqual(chart._canvasClipRect.attr.lastCall.args, [{
        x: dirtyCanvas.left,
        y: dirtyCanvas.top,
        width: dirtyCanvas.width - dirtyCanvas.left - dirtyCanvas.right,
        height: dirtyCanvas.height - dirtyCanvas.top - dirtyCanvas.bottom
    }]);
});
