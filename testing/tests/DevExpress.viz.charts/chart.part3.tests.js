...
QUnit.test('stack is null', function(assert) {
    ...
    // arrange
    const point1 = new MockPoint({ argument: '1', val: 1 });
    const point2 = new MockPoint({ argument: '2', val: 2 });
    const point3 = new MockPoint({ argument: '3', val: 3 });
    const point4 = new MockPoint({ argument: '1', val: 3 });
    const point5 = new MockPoint({ argument: '2', val: 5 });
    const point6 = new MockPoint({ argument: '3', val: 7 });
    const stubSeries1 = new MockSeries({ points: [point1, point2, point3], stack: null });
    const stubSeries2 = new MockSeries({ points: [point4, point5, point6], stack: null });
    ...
    // assert
    const checkStackPoints = function(series, points) {
...
QUnit.test('different stack', function(assert) {
    ...
    const point2 = new MockPoint({ argument: '2', val: 2 });
    const point3 = new MockPoint({ argument: '3', val: 3 });
    const point4 = new MockPoint({ argument: '1', val: 4 });
    const point5 = new MockPoint({ argument: '2', val: 5 });
    const point6 = new MockPoint({ argument: '3', val: 6 });
    const point7 = new MockPoint({ argument: '1', val: 7 });
    const point8 = new MockPoint({ argument: '2', val: 8 });
    const point9 = new MockPoint({ argument: '3', val: 9 });
    const stubSeries1 = new MockSeries({ points: [point1, point2, point3], stack: null });
    const stubSeries2 = new MockSeries({ points: [point4, point5, point6], stack: 'a' });
    const stubSeries3 = new MockSeries({ points: [point7, point8, point9], stack: 'b' });
    ...
    // assert
    const checkStackPoints = function(series, points, stackName) {
        $.each(series.getPoints(), function(i, point) {
            assert.equal(point.stackPoints[0].argument, points[0 + i].argument);
            assert.equal(point.stackPoints[0].stackName, null);
...
QUnit.test('different stack', function(assert) {
    ...
    const point8 = new MockPoint({ argument: '2', val: 8 });
    const point9 = new MockPoint({ argument: '3', val: 9 });
    const stubSeries1 = new MockSeries({ points: [point1, point2, point3], stack: 'a' });
    const stubSeries2 = new MockSeries({ points: [point4, point5, point6], stack: null });
    const stubSeries3 = new MockSeries({ points: [point7, point8, point9], stack: 'b' });
    chartMocks.seriesMockData.series.push(stubSeries1, stubSeries2, stubSeries3);
    // act
...
QUnit.test('update shared tooltip with not shared', function(assert) {
    ...
    // assert
    const checkStackPoints = function(series) {
        $.each(series.getPoints(), function(i, point) {
