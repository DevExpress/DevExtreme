...
QUnit.module('widget sizing render', () => {
    QUnit.test('default', function(assert) {
        ...
        assert.ok(instance._popup.$content().outerWidth() > 0, 'outer width of the element must be more than zero');
    });
    ...
    QUnit.test('constructor', function(assert) {
        ...
        assert.strictEqual(instance._popup.$content().outerWidth(), 400, 'outer width of the element must be equal to custom width');
    });
    ...
    QUnit.test('change width', function(assert) {
        ...
        instance.show();
        assert.strictEqual(instance._popup.$content().outerWidth(), customWidth, 'outer width of the element must be equal to custom width');
    });
});
