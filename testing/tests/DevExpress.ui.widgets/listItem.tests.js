...
const LIST_ITEM_ICON_CONTAINER_CLASS = 'dx-list-item-icon-container', LIST_ITEM_ICON_CLASS = 'dx-list-item-icon', LIST_ITEM_CHEVRON_CONTAINER_CLASS = 'dx-list-item-chevron-container', LIST_ITEM_CHEVRON_CLASS = 'dx-list-item-chevron';
...
QUnit.module('showChevron builtin', () => {
    ...
    QUnit.test('showChevron should be rendered correctly with value = true', function(assert) {
        ...
        const $chevronContainer = $item.children().eq(-1), $chevron = $chevronContainer.children();
...
QUnit.module('badge builtin', () => {
    const LIST_ITEM_BADGE_CONTAINER_CLASS = 'dx-list-item-badge-container', LIST_ITEM_BADGE_CLASS = 'dx-list-item-badge', BADGE_CLASS = 'dx-badge';
    ...
    QUnit.test('badge should be rendered correctly with value = true', function(assert) {
        ...
        const $badgeContainer = $item.children().eq(-1), $badge = $badgeContainer.children();
