...
const { module, test, testInActiveWindow, assert } = QUnit;
...
module("keyboard support", () => {
    test("support arrow keys", function(assert) {
    ...
    test("support pageup and pagedown", function(assert) {
        if(devices.real().deviceType !== "desktop") {
            assert.ok(true, "mobile device does not support tabindex on div element");
            return;
        }
    ...
    test("support end and home", function(assert) {
        if(devices.real().deviceType !== "desktop") {
            assert.ok(true, "mobile device does not support tabindex on div element");
            return;
        }
    ...
    test("supportKeyboard option", function(assert) {
        if(devices.real().deviceType !== "desktop") {
            assert.ok(true, "mobile device does not support tabindex on div element");
            return;
        }
    ...
    test("supportKeyboard option after render", function(assert) {
        if(devices.real().deviceType !== "desktop") {
            assert.ok(true, "mobile device does not support tabindex on div element");
            return;
        }
    ...
    test("arrow keys does not trigger when it not need", function(assert) {
        if(devices.real().deviceType !== "desktop") {
            assert.ok(true, "mobile device does not support tabindex on div element");
            return;
        }
    ...
    test("arrows work correctly after scroll by scrollbar", function(assert) {
        if(devices.real().deviceType !== "desktop") {
            assert.ok(true, "mobile device does not support tabindex on div element");
            return;
        }
    ...
    testInActiveWindow("arrows was not handled when focus on input element", function(assert) {
        var $scrollable = $("#scrollable");
    ...
    [true, false].forEach((useNativeMode) => {
        ["vertical", "horizontal"].forEach((scrollbarDirection) => {
            function checkScrollLocation($scrollable, expectedLocation) {
                ...
                assert.deepEqual(scrollLocation, expectedLocation, "scroll location");
            }

            testInActiveWindow(`Update vertical scroll location on focus: useNative - ${useNativeMode}`, function(assert) {
                if(devices.real().deviceType !== "desktop") {
                    assert.ok(true, "mobile device does not support tabindex on div element");
                    return;
                }
