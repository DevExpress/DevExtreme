...
QUnit.module('Checkboxes', () => {
    QUnit.test('all.selected: false -> search(item2) -> select(item1) -> removeSearch', function(assert) {
        const wrapper = new TreeViewTestWrapper({ showCheckBoxesMode: 'normal', dataStructure: 'plain',
            items: [
                { id: 1, text: 'item1', parentId: 0, selected: false },
                { id: 2, text: 'item2', parentId: 0, selected: false }] });
        ...
        wrapper.checkSelectedKeys([], 'after removeSearch');
        wrapper.checkSelectedNodes([], 'after removeSearch');
    ...
    QUnit.test('all.selected: false -> search(item2) -> selectAll() -> removeSearch', function(assert) {
        ...
        wrapper.checkSelectedKeys([2], 'after selectAll');
        wrapper.checkSelectedNodes([0], 'after selectAll');
        wrapper.checkEventLog(['selectionChanged'], 'after selectAll');
        wrapper.clearEventLog();

        wrapper.instance.option('searchValue', '');
        wrapper.checkSelectedKeys([2], 'after removeSearch');
        wrapper.checkSelectedNodes([1], 'after removeSearch');
    ...
    QUnit.test('all.selected: true -> search(item2) -> unselect(item1) -> removeSearch', function(assert) {
        const wrapper = new TreeViewTestWrapper({ showCheckBoxesMode: 'normal', dataStructure: 'plain',
            items: [
                { id: 1, text: 'item1', parentId: 0, selected: true },
                { id: 2, text: 'item2', parentId: 0, selected: true }] });

        wrapper.instance.option('searchValue', '2');
        wrapper.checkSelectedKeys([2], 'after search');
        ...
        wrapper.instance.option('searchValue', '');
        wrapper.checkSelectedKeys([1, 2], 'after removeSearch');
        wrapper.checkSelectedNodes([0, 1], 'after removeSearch');
        wrapper.checkEventLog([], 'after removeSearch');
    });
    ...
    QUnit.test('all.selected: true -> search(item2) -> unselectAll -> removeSearch', function(assert) {
        ...
        wrapper.instance.option('searchValue', '');
        wrapper.checkSelectedKeys([1], 'after removeSearch');
        wrapper.checkSelectedNodes([0], 'after removeSearch');
        wrapper.checkEventLog([], 'after removeSearch');
    });
});
