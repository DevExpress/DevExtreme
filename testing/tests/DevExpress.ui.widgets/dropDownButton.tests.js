...
QUnit.module('list integration', {}, () => {
    ...
    [true, false].forEach(wrapItemText => {
        QUnit.test(`toggleButton should render inside of dropDownButton when width option is defined in generic themes when wrapItemText=${wrapItemText} (T847072)`, (assert) => {
            const dropDownButton = $('#dropDownButton').dxDropDownButton({
                items: [{
                    'id': 1,
    ...
    QUnit.test('dropDownButton content should be centered vertically (T847072)', (assert) => {
        const $dropDownButton = $('#dropDownButton').dxDropDownButton({
            items: [{
                'id': 1,
                'name': 'VeryVeryVeryVeryLongString',
    ...
    QUnit.test('toggleButton should have static width (T847072)', (assert) => {
        const dropDownButton = $('#dropDownButton').dxDropDownButton({
            items: [{
                'id': 1,
                'name': 'I',
    ...
    QUnit.test('toggle/action buttons should have correct height when height option is not defined (T847072)', (assert) => {
        const dropDownButton = $('#dropDownButton').dxDropDownButton({
            items: [{
                'id': 1,
                'name': 'I',
