define(function(require) {
    ...
    var $ = require("jquery"),
        ...
        NewXmlaStore = require("ui/pivot_grid/new_xmla_store"),
    ...
    function prepareEnvironment(Store) {
        return {
            beforeEach: function() {
    ...
    function startTests(Store) {
        var testEnvironment = prepareEnvironment(Store);
    ...
    startTests(XmlaStore);
    startTests(NewXmlaStore);

    QUnit.module("Subset", prepareEnvironment(XmlaStore));
