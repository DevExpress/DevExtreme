...
QUnit.test("Expanded all items", function(assert) {
    var done = assert.async();
    this.store.load({
        columns: [{ dataField: "[Product].[Category]", expanded: true }, { dataField: "[Product].[Subcategory]", expanded: true }],
...
QUnit.test("Load from hierachy", function(assert) {
    var done = assert.async();
    this.store.load({
        columns: [{ dataField: "[Product].[Product Categories].[Category]", hierarchyName: "[Product].[Product Categories]" }],
...
QUnit.test("Hierarchy. Expand second level child", function(assert) {
    var done = assert.async();
    this.store.load({
        columns: [{ dataField: "[Product].[Product Categories].[Category]", hierarchyName: "[Product].[Product Categories]" }, { dataField: "[Product].[Product Categories].[Subcategory]", hierarchyName: "[Product].[Product Categories]" }],
        rows: [
            { dataField: "[Ship Date].[Calendar].[Calendar Year]", hierarchyName: "[Ship Date].[Calendar]" },
            { dataField: "[Ship Date].[Calendar].[Month]", hierarchyName: "[Ship Date].[Calendar]" },
...
QUnit.test("Hierarchy Load expanded axis", function(assert) {
    ...
    this.store.load({
        columns: [
            { dataField: "[Product].[Product Categories].[Category]", hierarchyName: "[Product].[Product Categories]", expanded: true },
            { dataField: "[Product].[Product Categories].[Subcategory]", hierarchyName: "[Product].[Product Categories]" }
        ],
        rows: [
            { dataField: "[Ship Date].[Calendar].[Calendar Year]", hierarchyName: "[Ship Date].[Calendar]" }
...
QUnit.test("Hierarchy. Load with expanded hidden level item", function(assert) {
    ...
    this.store.load({
        columns: [
            { dataField: "[Product].[Product Categories].[Category]", hierarchyName: "[Product].[Product Categories]" },
            { dataField: "[Product].[Product Categories].[Subcategory]", hierarchyName: "[Product].[Product Categories]", expanded: true }
        ],
        rows: [
            { dataField: "[Ship Date].[Calendar].[Calendar Year]", hierarchyName: "[Ship Date].[Calendar]" }
        ],
...
QUnit.test("Hierarchy. Expanded all items", function(assert) {
    ...
    this.store.load({
        ...
        rows: [
            { dataField: "[Ship Date].[Calendar].[Calendar Year]", hierarchyName: "[Ship Date].[Calendar]", expanded: true }
        ],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count' }]
    }).done(function(data) {
        assert.equal(data.columns.length, 3);
...
QUnit.test("Hierachy. Loaded with two level expanded items", function(assert) {
    ...
    this.store.load({
        ...
        rows: [
            { dataField: "[Ship Date].[Calendar].[Calendar Year]", hierarchyName: "[Ship Date].[Calendar]", expanded: true },
            { dataField: "[Ship Date].[Calendar].[Calendar Quarter]", hierarchyName: "[Ship Date].[Calendar]", expanded: true },
            { dataField: "[Ship Date].[Calendar].[Month]", hierarchyName: "[Ship Date].[Calendar]" }
        ],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count' }]
    }).done(function(data) {
...
QUnit.test("Hierarchy. Expand item with expanded children", function(assert) {
    ...
    this.store.load({
        ...
        rows: [
            { dataField: "[Ship Date].[Calendar].[Calendar Year]", hierarchyName: "[Ship Date].[Calendar]" },
            { dataField: "[Ship Date].[Calendar].[Calendar Semester]", hierarchyName: "[Ship Date].[Calendar]", expanded: true },
...
QUnit.test("Hierarchy & not hierarchy. Load expanded axis. With filter", function(assert) {
    ...
    this.load({
        columns: [
                { dataField: "[Product].[Product Categories].[Category]", hierarchyName: "[Product].[Product Categories]", expanded: true, sortOrder: "desc", sortBy: "value", groupIndex: 0 },
                { dataField: "[Ship Date].[Calendar].[Calendar Year]", hierarchyName: "[Ship Date].[Calendar]", expanded: true, sortOrder: "desc", sortBy: "value", groupIndex: 0 },
                { dataField: "[Ship Date].[Calendar].[Month]", hierarchyName: "[Ship Date].[Calendar]", sortOrder: "desc", sortBy: "value", groupIndex: 1 }
        ],
        filters: [
            { dataField: "[Product].[Product Categories]", hierarchyName: "[Product].[Product Categories]", sortOrder: "desc", sortBy: "value", area: "column", filterValues: ["Clothing"], filterType: "include" },
            { dataField: "[Ship Date].[Calendar]", hierarchyName: "[Ship Date].[Calendar]", sortOrder: "desc", sortBy: "value", area: "column", filterValues: ["CY 2003"], filterType: "include" }
        ],
...
QUnit.test("Hierarchy & not hierarchy. expanded hierarchy level", function(assert) {
    ...
    this.store.load({
        columns: [
            { dataField: "[Ship Date].[Calendar].[Month]", hierarchyName: "[Ship Date].[Calendar]", expanded: true },
            { dataField: "[Product].[Category]" }
        ],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count' }]
    }).done(function(data) {
...
QUnit.test("FilterValues in row and column fields. Include filter", function(assert) {
    var done = assert.async();
    this.store.load({
        columns: [{ dataField: "[Product].[Category]", filterValues: ["Bikes", "Accessories"], filterType: "include" }],
        rows: [{ dataField: "[Ship Date].[Calendar Year]", filterValues: ["CY 2002", "CY 2003"], filterType: "include" }],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count' }]
    }).done(function(data) {
        assert.deepEqual(removeIndexesAndValue(data.columns), [
            { text: "Accessories" },
...
QUnit.test("FilterValues in row and column fields. Exclude Filter", function(assert) {
    var done = assert.async();
    this.store.load({
        columns: [{ dataField: "[Product].[Category]", filterValues: ["Bikes", "Accessories"], filterType: "exclude" }],
        rows: [{ dataField: "[Ship Date].[Calendar Year]", filterValues: ["CY 2002", "CY 2003"], filterType: "exclude" }],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count' }]
    }).done(function(data) {
        assert.deepEqual(removeIndexesAndValue(data.columns), [
        { text: "Clothing" }
...
QUnit.test("FilterValues in rows field", function(assert) {
    ...
    this.store.load({
        columns: [{ dataField: "[Product].[Category]" }],
        rows: [
            { dataField: "[Ship Date].[Calendar Year]", filterValues: ["CY 2001", "CY 2002"], filterType: "exclude" },
            { dataField: "[Ship Date].[Month Of Year]", filterValues: ["January", "February"], filterType: "include" }
        ],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count' }]
    }).done(function(data) {
        assert.deepEqual(removeIndexesAndValue(data.columns), [
...
QUnit.test("Filter field. Include type", function(assert) {
    ...
    this.store.load({
        ...
        rows: [{ dataField: "[Ship Date].[Calendar Year]" }],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count' }],
        filters: [{ dataField: "[Ship Date].[Month Of Year]", filterValues: ["January", "February"], filterType: "include" }]
    }).done(function(data) {
        assert.deepEqual(data.columns, CATEGORIES_DATA);
        assert.deepEqual(removeIndexesAndValue(data.rows), [
            { text: "CY 2002" },
...
QUnit.test("Filter field. Exclude type", function(assert) {
    ...
    this.store.load({
        ...
        rows: [{ dataField: "[Ship Date].[Calendar Year]" }],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count' }],
        filters: [{ dataField: "[Ship Date].[Month Of Year]", filterValues: ["January", "February"], filterType: "exclude" }]
    }).done(function(data) {
        assert.deepEqual(data.columns, CATEGORIES_DATA);
        assert.deepEqual(data.rows, CALENDAR_YEAR_DATA);
        assert.strictEqual(data.grandTotalColumnIndex, 0);
...
QUnit.test("Filter field. Include and exclude filters", function(assert) {
    ...
    this.store.load({
        ...
        filters: [
            { dataField: "[Ship Date].[Month Of Year]", filterValues: ["January", "February"], filterType: "include" },
            { dataField: "[Customer].[Country]", filterValues: ["Australia", "United Kingdom", "United States"], filterType: "exclude" }
        ]
    }).done(function(data) {
        assert.deepEqual(data.columns, CATEGORIES_DATA);
        assert.deepEqual(removeIndexesAndValue(data.rows), [
...
QUnit.test("Ignore filterValues for hierarchyLevel field", function(assert) {
    var done = assert.async();
    this.store.load({
        columns: [{ dataField: "[Product].[Product Categories].[Category]", hierarchyName: "[Product].[Product Categories]", filterValues: ["Bikes"], groupIndex: 1 }],
...
QUnit.test("Filter hierarchyLevel field. Exclude type", function(assert) {
    ...
    this.store.load({
        ...
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count' }],
        filters: [
            { dataField: "[Product].[Product Categories]", hierarchyName: "[Product].[Product Categories]", filterValues: ["Clothing", "Mountain Bikes"], filterType: "exclude" }
        ]
    }).done(function(data) {
        assert.deepEqual(removeIndexesAndValue(data.columns), [
            { text: "Accessories" },
...
QUnit.test("Sorting by none two dimension on axis and expanded item", function(assert) {
    ...
    this.load({
        columns: [
            { dataField: "[Product].[Category]", "caption": "Category", "displayFolder": "", "isMeasure": false, "area": "row", "index": 131, "sortOrder": "asc", "areaIndex": 0 },
            { dataField: "[Product].[Subcategory]", "caption": "Subcategory", "displayFolder": "", "isMeasure": false, "area": "row", "index": 156, "sortOrder": "desc", "areaIndex": 1 }
        ],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count', sortOrder: "desc", sortBy: "none" }],
        columnExpandedPaths: [["&[1]"]]
    }).done(function(data) {
...
QUnit.test("Sorting group by none", function(assert) {
    ...
    this.load({
        rows: [
            { dataField: "[Ship Date].[Calendar].[Calendar Year]", hierarchyName: "[Ship Date].[Calendar]", expanded: true, sortOrder: "desc", sortBy: "none" },
            { dataField: "[Ship Date].[Calendar].[Month]", hierarchyName: "[Ship Date].[Calendar]", sortOrder: "desc", sortBy: "none" }
        ],
        columns: [
            { dataField: "[Product].[Product Categories].[Category]", hierarchyName: "[Product].[Product Categories]", expanded: true, sortOrder: "asc", sortBy: "none" },
            { dataField: "[Product].[Product Categories].[Subcategory]", hierarchyName: "[Product].[Product Categories]", sortOrder: "asc", sortBy: "none" }
        ],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count', sortOrder: "desc", sortBy: "none" }]
    }).done(function(data) {
        assert.strictEqual(data.rows.length, 4);
...
QUnit.test("Sorting by Summary field", function(assert) {
    ...
    this.load({
        ...
        rows: [
            { dataField: "[Ship Date].[Calendar Year]", expanded: true },
            { dataField: "[Ship Date].[Month of Year]", sortOrder: "desc", sortBySummaryField: "[Measures].[Customer Count]" }
        ],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count' }]
    }).done(function(data) {
...
QUnit.test("Sorting by Summary field when expanded items with expanded", function(assert) {
    ...
    this.load({
        ...
        rows: [
            ...
            { dataField: "[Ship Date].[Month of Year]", sortOrder: "desc", sortBySummaryField: "[Measures].[Customer Count]", expanded: true },
...
QUnit.test("Sorting group by Summary field", function(assert) {
    ...
    this.load({
        columns: [{ dataField: "[Product].[Category]" }],
        rows: [
            { dataField: "[Ship Date].[Calendar].[Calendar Year]", hierarchyName: "[Ship Date].[Calendar]", expanded: true, sortOrder: "desc", sortBySummaryField: "[Measures].[Customer Count]" },
            { dataField: "[Ship Date].[Calendar].[Month]", hierarchyName: "[Ship Date].[Calendar]", sortOrder: "desc", sortBySummaryField: "[Measures].[Customer Count]" }
        ],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count' }]
    }).done(function(data) {
        assert.deepEqual(data.columns, CATEGORIES_DATA);
...
QUnit.test("Sorting by Summary field in first field on axis", function(assert) {
    ...
    this.load({
        columns: [{ dataField: "[Product].[Category]" }],
        rows: [
            { dataField: "[Ship Date].[Calendar Year]", expanded: true, sortBySummaryField: "[Measures].[Customer Count]" },
            { dataField: "[Ship Date].[Month of Year]" }
        ],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count', sortOrder: "desc", sortBy: "value" }]
    }).done(function(data) {
...
QUnit.test("Sorting by Summary field in first field on axis with path", function(assert) {
    var done = assert.async();
    this.load({
        columns: [{ dataField: "[Product].[Category]", expanded: true, filterValues: ["Bikes"] }, { dataField: "[Product].[Subcategory]" }],
        rows: [
            { dataField: "[Ship Date].[Calendar Year]", expanded: true, sortOrder: "asc", sortBySummaryField: "[Measures].[Customer Count]", sortBySummaryPath: ["Bikes", "Road Bikes"] },
            { dataField: "[Ship Date].[Month of Year]" }
        ],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count', sortOrder: "desc", sortBy: "value" }]
    }).done(function(data) {
...
QUnit.test("Sorting by Summary field in with path with length greater then columns count", function(assert) {
    ...
    this.load({
        ...
        rows: [
            { dataField: "[Ship Date].[Calendar Year]", expanded: true, sortOrder: "desc", sortBySummaryField: "[Measures].[Customer Count]", sortBySummaryPath: ["Bikes", "Road Bikes"] },
            { dataField: "[Ship Date].[Month of Year]" }
        ],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count', sortOrder: "desc", sortBy: "value" }]
    }).done(function(data) {
...
QUnit.test("Sorting by Summary two dimension on axis", function(assert) {
    ...
    this.load({
        "rows": [
            { "dimension": "[Product]", "dataField": "[Product].[Category]", "caption": "Category", "displayFolder": "", "isMeasure": false, "area": "row", "index": 0, "allowSorting": true, "allowFiltering": true, "allowExpandAll": true, "sortBySummaryField": "[Measures].[Customer Count]", "sortBySummaryPath": ["CY 2004"], "sortOrder": "desc", "areaIndex": 0 },
            { "dimension": "[Product]", "dataField": "[Product].[Subcategory]", "caption": "Subcategory", "displayFolder": "", "isMeasure": false, "area": "row", "index": 1, "allowSorting": true, "allowFiltering": true, "allowExpandAll": true, "sortBySummaryField": "[Measures].[Customer Count]", "sortBySummaryPath": ["CY 2004"], "sortOrder": "desc", "areaIndex": 1 }
        ],
        "columns": [
            { "dimension": "[Ship Date]", "dataField": "[Ship Date].[Calendar Year]", "caption": "Ship Date.Calendar Year", "displayFolder": "Calendar", "isMeasure": false, "area": "column", "index": 2, "allowSorting": true, "allowFiltering": true, "allowExpandAll": true, "expanded": false, "areaIndex": 0 },
            { "dimension": "[Ship Date]", "dataField": "[Ship Date].[Month of Year]", "caption": "Ship Date.Month of Year", "displayFolder": "", "isMeasure": false, "area": "column", "index": 3, "allowSorting": true, "allowFiltering": true, "allowExpandAll": true, "areaIndex": 1 }],

        "values": [{ "dimension": "[Measures]", "dataField": "[Measures].[Customer Count]", "caption": "Customer Count", "displayFolder": "Internet Customers", "isMeasure": true, "area": "data", "index": 4, "allowSorting": true, "allowFiltering": true, "allowExpandAll": true, "areaIndex": 0 }],
        "rowExpandedPaths": [["&[3]"]]
    }).done(function(data) {
...
QUnit.test("Sorting by Summary field when hierarchy in column", function(assert) {
    ...
    this.load({
        ...
        columns: [{ dataField: "[Product].[Product Categories].[Category]", hierarchyName: "[Product].[Product Categories]", expanded: true, filterValues: ["Bikes"] }, { dataField: "[Product].[Product Categories].[Subcategory]", hierarchyName: "[Product].[Product Categories]" }],
        rows: [
            { dataField: "[Ship Date].[Calendar Year]", expanded: true, sortOrder: "asc", sortBySummaryField: "[Measures].[Customer Count]", sortBySummaryPath: ["Bikes", "Road Bikes"] },
            { dataField: "[Ship Date].[Month of Year]" }
        ],
...
QUnit.test("Sort fields with several expanded levels when expanded item", function(assert) {
    ...
    this.load({
        ...
        rows: [
            { dataField: "[Ship Date].[Calendar Year]" },
            { dataField: "[Ship Date].[Calendar Quarter of Year]", expanded: true, sortOrder: "desc", sortBy: "value" },
...
QUnit.test("Sort group when expanded item", function(assert) {
    ...
    this.load({
        columns: [
            { dataField: "[Product].[Product Categories].[Category]", hierarchyName: "[Product].[Product Categories]", sortOrder: "desc", sortBy: "value" }
        ],
        rows: [
...
QUnit.test("Sort when several groups on axis. Expand item", function(assert) {
    ...
    this.load({
        columns: [
            { dataField: "[Ship Date].[Calendar].[Calendar Year]", hierarchyName: "[Ship Date].[Calendar]", sortOrder: "desc", sortBy: "value" },
            { dataField: "[Product].[Product Categories].[Category]", hierarchyName: "[Product].[Product Categories]", expanded: true, sortOrder: "desc", sortBy: "value" },
            { dataField: "[Product].[Product Categories].[Subcategory]", hierarchyName: "[Product].[Product Categories]", sortOrder: "desc", sortBy: "value" }
        ],
        headerName: "columns",
        path: ["&[2004]"],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count' }]
...
QUnit.test("Sort when several expanded groups on axis", function(assert) {
    ...
    this.load({
        columns: [
            { dataField: "[Ship Date].[Calendar].[Calendar Year]", hierarchyName: "[Ship Date].[Calendar]", expanded: true, sortOrder: "desc", sortBy: "value" },
            { dataField: "[Ship Date].[Calendar].[Month]", hierarchyName: "[Ship Date].[Calendar]", expanded: true, sortOrder: "desc", sortBy: "value" },
            { dataField: "[Product].[Product Categories].[Category]", hierarchyName: "[Product].[Product Categories]", expanded: true, sortOrder: "desc", sortBy: "value" },
            { dataField: "[Product].[Product Categories].[Subcategory]", hierarchyName: "[Product].[Product Categories]", sortOrder: "desc", sortBy: "value" }
        ],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count' }],
        filters: [
            { dataField: "[Ship Date].[Calendar]", hierarchyName: "[Ship Date].[Calendar]", filterValues: ["CY 2003", "CY 2002"], filterType: "include" }
        ]
    }).done(function(data) {
...
QUnit.test("Sorting group in two dimension", function(assert) {
    ...
    this.load({
        ...
        filters: [
            { dataField: "[Ship Date].[Calendar]", hierarchyName: "[Ship Date].[Calendar]", filterValues: ["CY 2003", "CY 2002"], filterType: "include" },
            { dataField: "[Product].[Product Categories]", hierarchyName: "[Product].[Product Categories]", filterValues: ["Bikes", "Clothing"], filterType: "include" }
        ]
    }).done(function(data) {
        assert.strictEqual(data.columns.length, 2);
...
QUnit.test("send ajax request on load", function(assert) {
    ...
    assert.deepEqual(ajaxArg.xhrFields, {
    }, "xhrFields");
...
QUnit.test("send ajax request with before send callback", function(assert) {
    var dataSource = this.dataSource,
        beforeSend = function(settings) {
            ...
            assert.deepEqual(settings.xhrFields, {
            }, "xhrFields");
...
QUnit.test("Use fields with expression", function(assert) {
    this.store.load({
        columns: [{ dataField: "[Product].[My_Category]", expression: "[Poduct].[Category]+[Poduct].[Subcategory]" }],
...
QUnit.test("Use fields with expression as function", function(assert) {
    this.store.load({
        ...
        rows: [{ dataField: "[Ship_Date].[Calendar_Year]" }],
        values: [{ dataField: "[Measures].[My_Measure]", expression: function() { } }]
    });
...
QUnit.test("FilterValues using key and caption", function(assert) {
    this.store.load({
        ...
        rows: [{ dataField: "[Ship Date].[Calendar Year]", filterValues: ["CY 2002", "&[2003]"], filterType: "include" }],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count' }]
    });
...
QUnit.test("getDrillDownItems with custom columns", function(assert) {
    ...
    this.store.getDrillDownItems(loadOptions, { columnPath: [], rowPath: [], customColumns: ["Column1", "Column2"] });
...
QUnit.test("getDrillDownItems with several value fields", function(assert) {
    var loadOptions = {
        columns: [{ dataField: "[Product].[Category]", filterType: "include" }],
        rows: [{ dataField: "[Ship Date].[Calendar Year]", filterType: "include" }],
        values: [{ dataField: "[Measures].[Customer Count]", caption: 'Count' }, { dataField: "[Measures].[Internet Sales Order]", caption: 'Sales Order' }]
    };
