...
[false, true].forEach(customizeYearField => {
    QUnit.test(`Export [string x date x number], expandAll(date), customizeYearField: ${customizeYearField}`, function(assert) {
        const worksheet = helper.WORKSHEET_HEADER_XML +
            '<sheetPr/><dimension ref="A1:C1"/>' +
