...
import pivotGridUtils, { calculateScrollbarWidth } from '__internal/grids/pivot_grid/widget_utils';
...
QUnit.module('dxPivotGrid', {
    ...
    QUnit.test('Render to invisible container', function(assert) {
        ...
        assert.equal(pivotGrid.__scrollBarWidth, calculateScrollbarWidth(dataAreaContainerElement));
    });
