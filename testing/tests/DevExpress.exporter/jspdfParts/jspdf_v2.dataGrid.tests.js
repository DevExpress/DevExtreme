...
QUnit.module('exportDataGrid', moduleConfig, () => {
    ...
    QUnit.test('Bands, [{band1-[{f1_1}]}]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
    ...
    QUnit.test('Bands, [{band1-[{f1_1}, {f1_2}]}]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const expectedLog = [
            ...
            'text,f1_2,80,63,{baseline:middle}', 'setLineWidth,1', 'rect,80,51,70,24',
        ];
    ...
    QUnit.test('Bands, [{band1-[{f1_1}, {f1_2}]}] - splitToTablesByColumns: [1]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const expectedLog = [
            ...
            'text,f1_2,10,63,{baseline:middle}', 'setLineWidth,1', 'rect,10,51,75,24',
        ];
    ...
    QUnit.test('Bands, [{band1-[{f1_1}, {f1_2}]}, {f2}]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const dataGrid = createDataGrid({
            ...
            dataSource: [{ f1: 'f1_1', f2: 'f1_2', f3: 'f2' }],
        });
        ...
        const expectedLog = [
            ...
            'text,f1_1,10,63,{baseline:middle}', 'setLineWidth,1', 'rect,10,51,70,24',
            'text,f1_2,80,63,{baseline:middle}', 'setLineWidth,1', 'rect,80,51,70,24',
            'text,f2,150,63,{baseline:middle}', 'setLineWidth,1', 'rect,150,51,60,24',
        ];
    ...
    QUnit.test('Bands, [{band1-[{f1_1}, {f1_2}]}, {f2}] - splitToTablesByColumns: [1]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const expectedLog = [
            ...
            'text,f1_2,10,63,{baseline:middle}', 'setLineWidth,1', 'rect,10,51,60,24',
    ...
    QUnit.test('Bands, [{band1-[{f1_1}, {f1_2}]}, {f2}] - splitToTablesByColumns: [2]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const expectedLog = [
            ...
            'text,f1_1,10,63,{baseline:middle}', 'setLineWidth,1', 'rect,10,51,50,24',
            'text,f1_2,60,63,{baseline:middle}', 'setLineWidth,1', 'rect,60,51,60,24',
            'addPage,',
    ...
    QUnit.test('Bands, [{band1-[{f1_1}, {f1_2}]}, {f2}] - splitToTablesByColumns: [1,2]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
    ...
    QUnit.test('Bands, [{band1-[{band1_1-[{f1_1_1}], {f1_2}]}]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const expectedLog = [
            ...
            'text,f1_2,80,90,{baseline:middle}', 'setLineWidth,1', 'rect,80,75,80,30',
        ];
    ...
    QUnit.test('Bands, [{band1-[{band1_1-[{f1_1_1}], {f1_2}]}] - splitToTablesByColumns: [1]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const expectedLog = [
            ...
            'text,f1_2,10,90,{baseline:middle}', 'setLineWidth,1', 'rect,10,75,80,30',
        ];
    ...
    QUnit.test('Bands, [{band1-[{band1_1-[{f1_1_1}, {f1_1_2}]}, {f1_2}]}]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const dataGrid = createDataGrid({
            ...
            dataSource: [{ f1: 'f1_1_1', f2: 'f1_1_2', f3: 'f1_2' }],
        });
        ...
        const expectedLog = [
            ...
            'text,f1_1_2,70,90,{baseline:middle}', 'setLineWidth,1', 'rect,70,75,70,30',
            'text,f1_2,140,90,{baseline:middle}', 'setLineWidth,1', 'rect,140,75,80,30',
        ];
    ...
    QUnit.test('Bands, [{band1-[{band1_1-[{f1_1_1}, {f1_1_2}]}, {f1_2}]}] - splitToTablesByColumns: [1]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const expectedLog = [
            ...
            'text,F2,10,63,{baseline:middle}', 'setLineWidth,1', 'rect,10,51,70,24',
            'text,f1_1_2,10,90,{baseline:middle}', 'setLineWidth,1', 'rect,10,75,70,30',
            'text,f1_2,80,90,{baseline:middle}', 'setLineWidth,1', 'rect,80,75,80,30',
        ];
    ...
    QUnit.test('Bands, [{band1-[{band1_1-[{f1_1_1}, {f1_1_2}]}, {f1_2}]}] - splitToTablesByColumns: [2]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
    ...
    QUnit.test('Bands, [{band1-[{band1_1-[{f1_1_1}, {f1_1_2}]}, {f1_2}]}] - splitToTablesByColumns: [1,2]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
    ...
    QUnit.test('Bands, [{band1-[{f1_1}, {band1_2-[{f1_2_1}]}]}]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const expectedLog = [
            ...
            'text,f1_2_1,70,90,{baseline:middle}', 'setLineWidth,1', 'rect,70,75,70,30',
        ];
    ...
    QUnit.test('Bands, [{band1-[{f1_1}, {band1_2-[{f1_2_1}]}]}] - splitToTablesByColumns: [1]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const expectedLog = [
            ...
            'text,F2,10,63,{baseline:middle}', 'setLineWidth,1', 'rect,10,51,70,24',
            'text,f1_2_1,10,90,{baseline:middle}', 'setLineWidth,1', 'rect,10,75,70,30',
        ];
    ...
    QUnit.test('Bands, [{band1-[{f1_1}, {band1_2-[{f1_2_1, f1_2_2}]}]}]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const dataGrid = createDataGrid({
            ...
            dataSource: [{ f1: 'f1_1', f2: 'f1_2_1', f3: 'f1_2_2' }],
        });
        ...
        const expectedLog = [
            ...
            'text,f1_1,10,90,{baseline:middle}', 'setLineWidth,1', 'rect,10,75,60,30',
            'text,f1_2_1,70,90,{baseline:middle}', 'setLineWidth,1', 'rect,70,75,70,30',
            'text,f1_2_2,140,90,{baseline:middle}', 'setLineWidth,1', 'rect,140,75,80,30',
        ];
    ...
    QUnit.test('Bands, [{band1-[{f1_1}, {band1_2-[{f1_2_1, f1_2_2}]}]}] - splitToTablesByColumns: [1]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const expectedLog = [
            ...
            'text,f1_2_1,10,90,{baseline:middle}', 'setLineWidth,1', 'rect,10,75,70,30',
            'text,f1_2_2,80,90,{baseline:middle}', 'setLineWidth,1', 'rect,80,75,80,30',
        ];
    ...
    QUnit.test('Bands, [{band1-[{f1_1}, {band1_2-[{f1_2_1, f1_2_2}]}]}] - splitToTablesByColumns: [2]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const expectedLog = [
            ...
            'text,f1_2_2,10,90,{baseline:middle}', 'setLineWidth,1', 'rect,10,75,80,30',
        ];
    ...
    QUnit.test('Bands, [{band1-[{f1_1}, {band1_2-[{f1_2_1, f1_2_2}]}]}] - splitToTablesByColumns: [1,2]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
    ...
    QUnit.test('Bands, [{f1}, {band2-[{f2_1}]}]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
    ...
    QUnit.test('Bands, [{f1}, {band2-[{f2_1}]}] - splitToTablesByColumns: [1]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
    ...
    QUnit.test('Bands, [{f1}, {band2-[{f2_1},{f2_2}]}]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const dataGrid = createDataGrid({
            ...
            dataSource: [{ f1: 'f1_1', f2: 'f2_1', f3: 'f2_2' }],
        });
        ...
        const expectedLog = [
            ...
            'text,f1_1,10,63,{baseline:middle}', 'setLineWidth,1', 'rect,10,51,70,24',
            'text,f2_1,80,63,{baseline:middle}', 'setLineWidth,1', 'rect,80,51,80,24',
            'text,f2_2,160,63,{baseline:middle}', 'setLineWidth,1', 'rect,160,51,60,24',
        ];
    ...
    QUnit.test('Bands, [{f1}, {band2-[{f2_1},{f2_2}]}] - splitToTablesByColumns: [1]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const expectedLog = [
            ...
            'text,f2_1,10,63,{baseline:middle}', 'setLineWidth,1', 'rect,10,51,80,24',
            'text,f2_2,90,63,{baseline:middle}', 'setLineWidth,1', 'rect,90,51,60,24',
        ];
    ...
    QUnit.test('Bands, [{f1}, {band2-[{f2_1},{f2_2}]}] - splitToTablesByColumns: [2]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const expectedLog = [
            ...
            'text,f2_2,10,63,{baseline:middle}', 'setLineWidth,1', 'rect,10,51,60,24',
        ];
    ...
    QUnit.test('Bands, [{f1}, {band2-[{f2_1},{f2_2}]}] - splitToTablesByColumns: [1,2]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
    ...
    QUnit.test('Bands, [{f1}, {band2-[{f2_1}]}, {f3}]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
    ...
    QUnit.test('Bands, [{f1}, {band2-[{f2_1}]}, {f3}] - splitToTablesByColumns: [1]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
    ...
    QUnit.test('Bands, [{f1}, {band2-[{f2_1}]}, {f3}] - splitToTablesByColumns: [2]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
    ...
    QUnit.test('Bands, [{f1}, {band2-[{f2_1}]}, {f3}] - splitToTablesByColumns: [1,2]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
    ...
    QUnit.test('Bands, [{f1}, {band2-[{f2_1},{f2_2}]}, {f3}]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const dataGrid = createDataGrid({
            ...
            dataSource: [{ f1: 'f1_1', f2: 'f2_1', f3: 'f2_2', f4: 'f3_1' }],
        });
        ...
        const expectedLog = [
            ...
            'text,f2_1,80,63,{baseline:middle}', 'setLineWidth,1', 'rect,80,51,80,24',
            'text,f2_2,160,63,{baseline:middle}', 'setLineWidth,1', 'rect,160,51,60,24',
            'text,f3_1,220,63,{baseline:middle}', 'setLineWidth,1', 'rect,220,51,70,24',
        ];
    ...
    QUnit.test('Bands, [{f1}, {band2-[{f2_1},{f2_2}]}, {f3}] - splitToTablesByColumns: [1]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
        ...
        const expectedLog = [
            ...
            'text,f2_1,10,63,{baseline:middle}', 'setLineWidth,1', 'rect,10,51,80,24',
            'text,f2_2,90,63,{baseline:middle}', 'setLineWidth,1', 'rect,90,51,60,24',
            'text,f3_1,150,63,{baseline:middle}', 'setLineWidth,1', 'rect,150,51,70,24',
        ];
    ...
    QUnit.test('Bands, [{f1}, {band2-[{f2_1},{f2_2}]}, {f3}] - splitToTablesByColumns: [2]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
    ...
    QUnit.test('Bands, [{f1}, {band2-[{f2_1},{f2_2}]}, {f3}] - splitToTablesByColumns: [1,2]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
    ...
    QUnit.test('Bands, [{f1}, {band2-[{f2_1},{f2_2}]}, {f3}] - splitToTablesByColumns: [3]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
    ...
    QUnit.test('Bands, [{f1}, {band2-[{f2_1},{f2_2}]}, {f3}] - splitToTablesByColumns: [2,3]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
    ...
    QUnit.test('Bands, [{f1}, {band2-[{f2_1},{f2_2}]}, {f3}] - splitToTablesByColumns: [1,2,3]', function(assert) {
        const done = assert.async();
        const doc = createMockPdfDoc();
