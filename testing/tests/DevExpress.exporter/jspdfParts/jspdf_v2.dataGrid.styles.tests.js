...
const JSPdfStylesTests = {
    runTests(moduleConfig, createMockPdfDoc, createDataGrid) {
        ...
        QUnit.module('Styles - Border color', moduleConfig, () => {
            ...
            QUnit.test('Simple - [{f1, f2, f3] - Custom border color for middle column', function(assert) {
                const done = assert.async();
                const doc = createMockPdfDoc();
            ...
            QUnit.test('Simple - [{f1, f2, f3] - Custom border color for single cell', function(assert) {
                const done = assert.async();
                const doc = createMockPdfDoc();
