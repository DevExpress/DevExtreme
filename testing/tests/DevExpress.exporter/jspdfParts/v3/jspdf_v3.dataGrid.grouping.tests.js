        ...
        QUnit.module('Grouping', moduleConfig, () => {
            QUnit.test('1 level - 1 group - [{f1, groupIndex: 0}, f2, f3]', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,F1: f1,55.333,81,{baseline:middle}',
                    'setFont,helvetica,normal,',
                    'text,f1_2,55.333,103,{baseline:middle}',
                    'text,f1_3,145.333,103,{baseline:middle}',
                    'text,f2_2,55.333,130,{baseline:middle}',
                    'text,f2_3,145.333,130,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,90,16',
                    'setLineWidth,0.6',
            ...
            QUnit.test('1 level - 1 group - [{f1, groupIndex: 0}, f2, f3] - height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setFont,helvetica,normal,',
                    'text,f1_2,55.333,110.417,{baseline:middle}',
                    'text,f1_3,145.333,110.417,{baseline:middle}',
                    'text,f2_2,55.333,132.583,{baseline:middle}',
                    'text,f2_3,145.333,132.583,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
            ...
            QUnit.test('1 level - 1 group - [{f1, groupIndex: 0}, f2, f3] - height auto, padding', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setFont,helvetica,normal,',
                    'text,f1_2,55.333,109.75,{baseline:middle}',
                    'text,f1_3,145.333,109.75,{baseline:middle}',
                    'text,f2_2,55.333,131.917,{baseline:middle}',
                    'text,f2_3,145.333,131.917,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,90,22.167',
                    'setLineWidth,0.6',
            ...
            QUnit.test('1 level - 2 group - [{f1, groupIndex: 0}, f2, f3]', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setTextColor,#000000',
                    'setFont,helvetica,bold,',
                    'text,F1: f1_1,55.333,81,{baseline:middle}',
                    'setFont,helvetica,normal,',
                    'text,f1_2,55.333,103,{baseline:middle}',
                    'text,f1_3,145.333,103,{baseline:middle}',
                    'setFont,helvetica,bold,',
                    'text,F1: f2_1,55.333,125,{baseline:middle}',
                    'setFont,helvetica,normal,',
                    'text,f2_2,55.333,147,{baseline:middle}',
                    'text,f2_3,145.333,147,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,90,16',
                    'setLineWidth,0.6',
            ...
            QUnit.test('1 level - 2 group - [{f1, groupIndex: 0}, f2, f3] - height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setTextColor,#000000',
                    'setFont,helvetica,bold,',
                    'text,F1: f1_1,55.333,88.25,{baseline:middle}',
                    'setFont,helvetica,normal,',
                    'text,f1_2,55.333,110.417,{baseline:middle}',
                    'text,f1_3,145.333,110.417,{baseline:middle}',
                    'setFont,helvetica,bold,',
                    'text,F1: f2_1,55.333,132.583,{baseline:middle}',
                    'setFont,helvetica,normal,',
                    'text,f2_2,55.333,154.75,{baseline:middle}',
                    'text,f2_3,145.333,154.75,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,90,22.167',
                    'setLineWidth,0.6',
            ...
            QUnit.test('1 level - 2 group - [{f1, groupIndex: 0}, f2, f3] - height auto, padding', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setFont,helvetica,normal,',
                    'text,f2_2,55.333,153.417,{baseline:middle}',
                    'text,f2_3,145.333,153.417,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,90,22.167',
                    'setLineWidth,0.6',
            ...
            QUnit.test('2 level - 1 group - [{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4]', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setTextColor,128',
                    'text,F4,145.333,63,{baseline:middle}',
                    'setTextColor,#000000',
                    'setFont,helvetica,bold,',
                    'text,F1: f1,55.333,81,{baseline:middle}',
                    'text,F2: f2,55.333,101,{baseline:middle}',
                    'setFont,helvetica,normal,',
                    'text,f1_3,55.333,123,{baseline:middle}',
                    'text,f1_4,145.333,123,{baseline:middle}',
                    'text,f2_3,55.333,150,{baseline:middle}',
                    'text,f2_4,145.333,150,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,90,16',
                    'setLineWidth,0.6',
            ...
            QUnit.test('2 level - 1 group - [{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4] - height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setFont,helvetica,normal,',
                    'text,f1_3,55.333,132.583,{baseline:middle}',
                    'text,f1_4,145.333,132.583,{baseline:middle}',
                    'text,f2_3,55.333,154.75,{baseline:middle}',
                    'text,f2_4,145.333,154.75,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,90,22.167',
                    'setLineWidth,0.6',
            ...
            QUnit.test('2 level - 1 group - [{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4] - height auto, padding', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setFont,helvetica,normal,',
                    'text,f1_3,55.333,131.25,{baseline:middle}',
                    'text,f1_4,145.333,131.25,{baseline:middle}',
                    'text,f2_3,55.333,153.417,{baseline:middle}',
                    'text,f2_4,145.333,153.417,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,90,22.167',
                    'setLineWidth,0.6',
            ...
            QUnit.test('2 level - 2 groups - [{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4]', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setFont,helvetica,bold,',
                    'text,F1: f1,55.333,81,{baseline:middle}',
                    'text,F2: f1_2,55.333,101,{baseline:middle}',
                    'setFont,helvetica,normal,',
                    'text,f1_3,55.333,123,{baseline:middle}',
                    'text,f1_4,145.333,123,{baseline:middle}',
                    'setFont,helvetica,bold,',
                    'text,F2: f2_2,55.333,145,{baseline:middle}',
                    'setFont,helvetica,normal,',
                    'text,f2_3,55.333,167,{baseline:middle}',
                    'text,f2_4,145.333,167,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,90,16',
                    'setLineWidth,0.6',
            ...
            QUnit.test('2 level - 2 groups - [{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4] - height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setFont,helvetica,bold,',
                    'text,F1: f1,55.333,88.25,{baseline:middle}',
                    'text,F2: f1_2,55.333,110.417,{baseline:middle}',
                    'setFont,helvetica,normal,',
                    'text,f1_3,55.333,132.583,{baseline:middle}',
                    'text,f1_4,145.333,132.583,{baseline:middle}',
                    'setFont,helvetica,bold,',
                    ...
                    'setFont,helvetica,normal,',
                    'text,f2_3,55.333,176.917,{baseline:middle}',
                    'text,f2_4,145.333,176.917,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,90,22.167',
                    'setLineWidth,0.6',
            ...
            QUnit.test('2 level - 2 groups - [{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4] - height auto, padding', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setFont,helvetica,normal,',
                    'text,f2_3,55.333,174.917,{baseline:middle}',
                    'text,f2_4,145.333,174.917,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,90,22.167',
                    'setLineWidth,0.6',
