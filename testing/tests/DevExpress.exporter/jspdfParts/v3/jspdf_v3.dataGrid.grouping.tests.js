        ...
        QUnit.module('Grouping', moduleConfig, () => {
            QUnit.test('1 level - 1 group - [{f1, groupIndex: 0}, f2, f3]', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,F1: f1,10,41,{baseline:middle,align:left}',
                    'text,f1_2,20,63,{baseline:middle,align:left}',
                    'text,f1_3,100,63,{baseline:middle,align:left}',
                    'text,f2_2,20,90,{baseline:middle,align:left}',
                    'text,f2_3,100,90,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,10,15,90,16',
                    'setLineWidth,1',
                    'rect,100,15,80,16',
            ...
            QUnit.test('1 level - 1 group - [{f1, groupIndex: 0}, f2, f3] - height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,f1_2,20,61,{baseline:middle,align:left}',
                    'text,f1_3,100,61,{baseline:middle,align:left}',
                    'text,f2_2,20,79.4,{baseline:middle,align:left}',
                    'text,f2_3,100,79.4,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,10,15,90,18.4',
                    'setLineWidth,1',
                    'rect,100,15,80,18.4',
            ...
            QUnit.test('1 level - 1 group - [{f1, groupIndex: 0}, f2, f3] - height auto, padding', function(assert) {
                ...
                const expectedLog = [
                    'text,F2,10,24.2,{baseline:middle,align:left}',
                    'text,F3,100,24.2,{baseline:middle,align:left}',
                    'text,F1: f1,15,47.6,{baseline:middle,align:left}',
                    'text,f1_2,20,71,{baseline:middle,align:left}',
                    'text,f1_3,100,71,{baseline:middle,align:left}',
                    'text,f2_2,20,89.4,{baseline:middle,align:left}',
                    'text,f2_3,100,89.4,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,10,15,90,18.4',
                    'setLineWidth,1',
                    'rect,100,15,80,18.4',
            ...
            QUnit.test('1 level - 2 group - [{f1, groupIndex: 0}, f2, f3]', function(assert) {
                ...
                const expectedLog = [
                    'text,F2,10,23,{baseline:middle,align:left}',
                    'text,F3,100,23,{baseline:middle,align:left}',
                    'text,F1: f1_1,10,41,{baseline:middle,align:left}',
                    'text,f1_2,20,63,{baseline:middle,align:left}',
                    'text,f1_3,100,63,{baseline:middle,align:left}',
                    'text,F1: f2_1,10,85,{baseline:middle,align:left}',
                    'text,f2_2,20,107,{baseline:middle,align:left}',
                    'text,f2_3,100,107,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,10,15,90,16',
                    'setLineWidth,1',
                    'rect,100,15,80,16',
            ...
            QUnit.test('1 level - 2 group - [{f1, groupIndex: 0}, f2, f3] - height auto', function(assert) {
                ...
                const expectedLog = [
                    'text,F2,10,24.2,{baseline:middle,align:left}',
                    'text,F3,100,24.2,{baseline:middle,align:left}',
                    'text,F1: f1_1,10,42.6,{baseline:middle,align:left}',
                    'text,f1_2,20,61,{baseline:middle,align:left}',
                    'text,f1_3,100,61,{baseline:middle,align:left}',
                    'text,F1: f2_1,10,79.4,{baseline:middle,align:left}',
                    'text,f2_2,20,97.8,{baseline:middle,align:left}',
                    'text,f2_3,100,97.8,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,10,15,90,18.4',
                    'setLineWidth,1',
                    'rect,100,15,80,18.4',
            ...
            QUnit.test('1 level - 2 group - [{f1, groupIndex: 0}, f2, f3] - height auto, padding', function(assert) {
                ...
                const expectedLog = [
                    'text,F2,10,24.2,{baseline:middle,align:left}',
                    'text,F3,100,24.2,{baseline:middle,align:left}',
                    'text,F1: f1_1,15,47.6,{baseline:middle,align:left}',
                    'text,f1_2,20,71,{baseline:middle,align:left}',
                    'text,f1_3,100,71,{baseline:middle,align:left}',
                    'text,F1: f2_1,15,94.4,{baseline:middle,align:left}',
                    'text,f2_2,20,117.8,{baseline:middle,align:left}',
                    'text,f2_3,100,117.8,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,10,15,90,18.4',
                    'setLineWidth,1',
                    'rect,100,15,80,18.4',
            ...
            QUnit.test('2 level - 1 group - [{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4]', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,F4,100,23,{baseline:middle,align:left}',
                    'text,F1: f1,10,41,{baseline:middle,align:left}',
                    'text,F2: f2,20,61,{baseline:middle,align:left}',
                    'text,f1_3,30,83,{baseline:middle,align:left}',
                    'text,f1_4,100,83,{baseline:middle,align:left}',
                    'text,f2_3,30,110,{baseline:middle,align:left}',
                    'text,f2_4,100,110,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,10,15,90,16',
                    'setLineWidth,1',
                    'rect,100,15,80,16',
            ...
            QUnit.test('2 level - 1 group - [{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4] - height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,F1: f1,10,42.6,{baseline:middle,align:left}',
                    'text,F2: f2,20,61,{baseline:middle,align:left}',
                    'text,f1_3,30,79.4,{baseline:middle,align:left}',
                    'text,f1_4,100,79.4,{baseline:middle,align:left}',
                    'text,f2_3,30,97.8,{baseline:middle,align:left}',
                    'text,f2_4,100,97.8,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,10,15,90,18.4',
                    'setLineWidth,1',
                    'rect,100,15,80,18.4',
            ...
            QUnit.test('2 level - 1 group - [{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4] - height auto, padding', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,F4,100,24.2,{baseline:middle,align:left}',
                    'text,F1: f1,15,47.6,{baseline:middle,align:left}',
                    'text,F2: f2,25,76,{baseline:middle,align:left}',
                    'text,f1_3,30,99.4,{baseline:middle,align:left}',
                    'text,f1_4,100,99.4,{baseline:middle,align:left}',
                    'text,f2_3,30,117.8,{baseline:middle,align:left}',
                    'text,f2_4,100,117.8,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,10,15,90,18.4',
                    'setLineWidth,1',
                    'rect,100,15,80,18.4',
            ...
            QUnit.test('2 level - 2 groups - [{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4]', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,F4,100,23,{baseline:middle,align:left}',
                    'text,F1: f1,10,41,{baseline:middle,align:left}',
                    'text,F2: f1_2,20,61,{baseline:middle,align:left}',
                    'text,f1_3,30,83,{baseline:middle,align:left}',
                    'text,f1_4,100,83,{baseline:middle,align:left}',
                    'text,F2: f2_2,20,105,{baseline:middle,align:left}',
                    'text,f2_3,30,127,{baseline:middle,align:left}',
                    'text,f2_4,100,127,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,10,15,90,16',
                    'setLineWidth,1',
                    'rect,100,15,80,16',
            ...
            QUnit.test('2 level - 2 groups - [{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4] - height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,f2_3,30,116.2,{baseline:middle,align:left}',
            ...
            QUnit.test('2 level - 2 groups - [{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4] - height auto, padding', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,F4,100,24.2,{baseline:middle,align:left}',
                    'text,F1: f1,15,47.6,{baseline:middle,align:left}',
                    'text,F2: f1_2,25,76,{baseline:middle,align:left}',
                    'text,f1_3,30,99.4,{baseline:middle,align:left}',
                    'text,f1_4,100,99.4,{baseline:middle,align:left}',
                    'text,F2: f2_2,25,122.8,{baseline:middle,align:left}',
                    'text,f2_3,30,146.2,{baseline:middle,align:left}',
                    'text,f2_4,100,146.2,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,10,15,90,18.4',
                    'setLineWidth,1',
                    'rect,100,15,80,18.4',
