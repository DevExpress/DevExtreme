        ...
        QUnit.module('Multiline text', moduleConfig, () => {
            QUnit.test('1 col - 1 text line. fontSize default', function(assert) {
                ...
                const expectedLog = [
                    'setTextColor,128',
                    'setFontSize,10',
                    'text,line1,55.333,85,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,100,60',
                    'setFontSize,16',
            ...
            QUnit.test('1 col - 1 text line. fontSize default, height auto', function(assert) {
                ...
                const expectedLog = [
                    'setTextColor,128',
                    'setFontSize,10',
                    'text,line1,55.333,66.083,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
            ...
            QUnit.test('1 col - 1 text line. fontSize 20, height auto', function(assert) {
                ...
                const expectedLog = [
                    'setTextColor,128',
                    'setFontSize,20',
                    'text,line1,55.333,71.833,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
            ...
            QUnit.test('1 col - 2 text lines. fontSize default', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setFontSize,10',
                    'text,line1\n' +
'line2,55.333,79.25,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,100,60',
                    'setFontSize,16',
            ...
            QUnit.test('1 col - 2 text lines. fontSize default, height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setFontSize,10',
                    'text,line1\n' +
'line2,55.333,66.083,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,100,33.667',
                    'setFontSize,16',
            ...
            QUnit.test('1 col - 2 text lines. fontSize 20', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setFontSize,20',
                    'text,line1\n' +
'line2,55.333,73.5,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,100,60',
                    'setFontSize,16',
            ...
            QUnit.test('1 col - 2 text lines. fontSize 20, height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setFontSize,20',
                    'text,line1\n' +
'line2,55.333,71.833,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
...
'line2,55,71.5,{baseline:middle}',
            ...
            QUnit.test('1 col - 3 text lines. fontSize default', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,line1\n' +
'line2\n' +
'line3,55.333,83.5,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,100,80',
                    'setFontSize,16',
            ...
            QUnit.test('1 col - 3 text lines. fontSize default, height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,line1\n' +
'line2\n' +
'line3,55.333,66.083,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
            ...
            QUnit.test('1 col - 3 text lines. fontSize 20', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,line1\n' +
'line2\n' +
'line3,55.333,72,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,100,80',
                    'setFontSize,16',
            ...
            QUnit.test('1 col - 3 text lines. fontSize 20, height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,line1\n' +
'line2\n' +
'line3,55.333,71.833,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
...
'line3,55,71.5,{baseline:middle}',
            ...
            QUnit.test('2 col - 1 text line. col1.fontSize default, col2.fontSize 20', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setTextColor,128',
                    'setFontSize,20',
                    'text,line1,155.333,85,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,100,60',
                    'setLineWidth,0.6',
            ...
            QUnit.test('2 col - 1 text line. col1.fontSize default, col2.fontSize 20, height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setTextColor,128',
                    'setFontSize,20',
                    'text,line1,155.333,71.833,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,100,33.667',
                    'setLineWidth,0.6',
            ...
            QUnit.test('2 col - 1 text line. col1.fontSize 20, col2.fontSize 30, height auto', function(assert) {
                ...
                const expectedLog = [
                    'setTextColor,128',
                    'setFontSize,20',
                    'text,line1,55.333,77.583,{baseline:middle}',
                    'setTextColor,128',
                    'setFontSize,30',
                    'text,line1,155.333,77.583,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,100,45.167',
                    'setLineWidth,0.6',
...
'line2,55.333,79.25,{baseline:middle}',
                    ...
                    'setFontSize,20',
                    'text,line1\n' +
'line2,155.333,73.5,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,100,60',
                    'setLineWidth,0.6',
            ...
            QUnit.test('2 col - 2 text lines. col1.fontSize default, col2.fontSize: 20, height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setFontSize,10',
                    'text,line1\n' +
'line2,55.333,77.583,{baseline:middle}',
                    'setTextColor,128',
                    'setFontSize,20',
                    'text,line1\n' +
'line2,155.333,71.833,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,100,56.667',
                    'setLineWidth,0.6',
...
'line2,55.333,73.5,{baseline:middle}',
                    ...
                    'setFontSize,30',
                    'text,line1\n' +
'line2,155.333,67.75,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,100,60',
                    'setLineWidth,0.6',
            ...
            QUnit.test('2 col - 2 text lines. col1.fontSize 20 col2.fontSize: 30, height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setFontSize,20',
                    'text,line1\n' +
'line2,55.333,83.333,{baseline:middle}',
                    'setTextColor,128',
                    'setFontSize,30',
                    'text,line1\n' +
'line2,155.333,77.583,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,100,79.667',
                    'setLineWidth,0.6',
...
'line3,55.333,83.5,{baseline:middle}',
                    ...
                    'text,line1\n' +
'line2\n' +
'line3,155.333,72,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,100,80',
                    'setLineWidth,0.6',
            ...
            QUnit.test('2 col - 3 text lines. col1.fontSize default, col2.fontSize: 20, height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,line1\n' +
'line2\n' +
'line3,55.333,83.333,{baseline:middle}',
                    'setTextColor,128',
                    'setFontSize,20',
                    'text,line1\n' +
'line2\n' +
'line3,155.333,71.833,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,100,79.667',
                    'setLineWidth,0.6',
            ...
            QUnit.test('2 col - 3 text lines. col1.fontSize 20, col2.fontSize: 30', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,line1\n' +
'line2\n' +
'line3,55.333,77,{baseline:middle}',
                    'setTextColor,128',
                    'setFontSize,30',
                    'text,line1\n' +
'line2\n' +
'line3,155.333,65.5,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,100,90',
                    'setLineWidth,0.6',
            ...
            QUnit.test('2 col - 3 text lines. col1.fontSize 20, col2.fontSize: 30, height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,line1\n' +
'line2\n' +
'line3,55.333,89.083,{baseline:middle}',
                    'setTextColor,128',
                    'setFontSize,30',
                    'text,line1\n' +
'line2\n' +
'line3,155.333,77.583,{baseline:middle}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
