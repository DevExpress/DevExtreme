        ...
        QUnit.module('Grouped rows with summaries', moduleConfig, () => {
            ...
            QUnit.test('[{f1, groupIndex: 0}, f2, f3, f4], groupItems: [f1] - height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'rect,180,15,80,18.4',
                    'setLineWidth,1',
                    'line,10,33.4,90,33.4',
                    'line,10,33.4,10,51.8',
                    'line,10,51.8,90,51.8',
                    'setLineWidth,1',
                    'line,90,33.4,180,33.4',
                    'line,90,51.8,180,51.8',
                    'setLineWidth,1',
                    'line,180,33.4,260,33.4',
                    'line,260,33.4,260,51.8',
                    'line,180,51.8,260,51.8',
                    'setLineWidth,1',
            ...
            QUnit.test('[{f1, groupIndex: 0}, f2, f3, f4], groupItems: [f1, f2]', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,F3,90,23,{baseline:middle}',
                    'text,F4,180,23,{baseline:middle}',
                    'text,F1: f1 (Max: f1, Max of F2 is f2),10,39,{baseline:middle}',
                    'text,f2,20,55,{baseline:middle}',
                    'text,f3,90,55,{baseline:middle}',
                    'text,f4,180,55,{baseline:middle}',
                    'setLineWidth,1',
            ...
            QUnit.test('[{f1, groupIndex: 0}, f2, f3, f4], groupItems: [f1, { f3, alignByColumn }]', function(assert) {
                ...
                const expectedLog = [
                    'text,F2,10,23,{baseline:middle}',
                    'text,F3,160,23,{baseline:middle}',
                    'text,F4,250,23,{baseline:middle}',
                    'text,F1: f1 (Max: f1),10,39,{baseline:middle}',
                    'text,Max: f3,160,39,{baseline:middle}',
                    'text,f2,20,55,{baseline:middle}',
                    'text,f3,160,55,{baseline:middle}',
                    'text,f4,250,55,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,150,16',
                    'setLineWidth,1',
                    'rect,160,15,90,16',
            ...
            QUnit.test('[{f1, groupIndex: 0}, f2, f3, f4], groupItems: [f1, { f3, alignByColumn }, { f4, alignByColumn }]', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,F1: f1 (Max: f1),10,39,{baseline:middle}',
                    'text,Max: f3,160,39,{baseline:middle}',
                    'text,Max: f4,250,39,{baseline:middle}',
                    'text,f2,20,55,{baseline:middle}',
                    'text,f3,160,55,{baseline:middle}',
                    'text,f4,250,55,{baseline:middle}',
                    'setLineWidth,1',
            ...
            QUnit.test('[{f1, groupIndex: 0}, f2, f3, f4], groupItems: [f3]', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,F3,90,23,{baseline:middle}',
                    'text,F4,180,23,{baseline:middle}',
                    'text,F1: f1 (Max of F2 is f2),10,39,{baseline:middle}',
                    'text,f2,20,55,{baseline:middle}',
                    'text,f3,90,55,{baseline:middle}',
                    'text,f4,180,55,{baseline:middle}',
                    'setLineWidth,1',
            ...
            QUnit.test('[{f1, groupIndex: 0}, f2, f3, f4], groupItems: [{f3, alignByColumn}]', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,Max: f3,90,39,{baseline:middle}',
                    'text,f2,20,55,{baseline:middle}',
                    'text,f3,90,55,{baseline:middle}',
                    'text,f4,180,55,{baseline:middle}',
                    'setLineWidth,1',
            ...
            QUnit.test('[{f1, groupIndex: 0}, {f2, groupIndex: 1, f3, f4], groupItems: [f1, {f4, alignByColumn}] - height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,F1: f1 (Max: f1),10,42.6,{baseline:middle}',
                    'text,Max: f4,260,42.6,{baseline:middle}',
                    'text,F2: f2 (Max of F1 is f1),20,61,{baseline:middle}',
                    'text,Max: f4,260,61,{baseline:middle}',
        ...
        QUnit.module('Grouped rows with summaries shown in group footer', moduleConfig, () => {
            ...
            QUnit.test('[{f1, groupIndex: 0}, f2, f3, f4], groupItems: [f1, { f3, alignByColumn, showInGroupFooter }]', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,f3,160,55,{baseline:middle}',
                    'text,f4,250,55,{baseline:middle}',
                    'text,Max: f3,160,71,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,150,16',
                    'setLineWidth,1',
                    'rect,160,15,90,16',
            ...
            QUnit.test('[{f1, groupIndex: 0}, f2, f3, f4], groupItems: [f1, { f3, alignByColumn, showInGroupFooter }] - height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,Max: f3,160,79.4,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,150,18.4',
                    'setLineWidth,1',
                    'rect,160,15,90,18.4',
                    ...
                    'line,10,33.4,10,51.8',
                    'line,10,51.8,160,51.8',
                    'setLineWidth,1',
                    'line,160,33.4,250,33.4',
                    'line,160,51.8,250,51.8',
                    'setLineWidth,1',
                    'line,250,33.4,330,33.4',
                    'line,330,33.4,330,51.8',
                    'line,250,51.8,330,51.8',
                    'setLineWidth,1',
            ...
            QUnit.test('[{f1, groupIndex: 0}, f2, f3, f4], groupItems: [f1, { f3, alignByColumn, showInGroupFooter }, { f4, alignByColumn, showInGroupFooter }]', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,f4,250,55,{baseline:middle}',
                    'text,Max: f3,160,71,{baseline:middle}',
                    'text,Max: f4,250,71,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,150,16',
                    'setLineWidth,1',
                    'rect,160,15,90,16',
            ...
            QUnit.test('[{f1, groupIndex: 0}, f2, f3, f4], groupItems: [{f3, alignByColumn, showInGroupFooter}]', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,f3,90,55,{baseline:middle}',
                    'text,f4,180,55,{baseline:middle}',
                    'text,Max: f3,90,71,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,80,16',
                    'setLineWidth,1',
                    'rect,90,15,90,16',
            ...
            QUnit.test('[{f1, groupIndex: 0}, f2, f3, f4], groupItems: [{f3, alignByColumn, showInGroupFooter}] - height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,f3,90,61,{baseline:middle}',
                    'text,f4,180,61,{baseline:middle}',
                    'text,Max: f3,90,79.4,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,80,18.4',
                    'setLineWidth,1',
                    'rect,90,15,90,18.4',
            ...
            QUnit.test('[{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4], groupItems: [f1, {f4, alignByColumn, showInGroupFooter}] - height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,f3,30,79.4,{baseline:middle}',
                    'text,f4,260,79.4,{baseline:middle}',
                    'text,Max: f4,260,97.8,{baseline:middle}',
                    'text,Max: f4,260,116.2,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,250,18.4',
                    'setLineWidth,1',
                    'rect,260,15,100,18.4',
            ...
            QUnit.test('[{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4], groupItems: [f1, {f3, alignByColumn, showInGroupFooter}, {f4, alignByColumn, showInGroupFooter}]', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,f3,30,71,{baseline:middle}',
                    'text,f4,260,71,{baseline:middle}',
                    'text,Max: f3,30,87,{baseline:middle}',
                    'text,Max: f4,260,87,{baseline:middle}',
                    'text,Max: f3,20,103,{baseline:middle}',
                    'text,Max: f4,260,103,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,250,16',
                    'setLineWidth,1',
            ...
            QUnit.test('[{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4], groupItems: [f1, {f3, alignByColumn, showInGroupFooter}, {f4, alignByColumn, showInGroupFooter}], 2 groups', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,F4,260,23,{baseline:middle}',
                    'text,F1: f1 (Max: f1),10,39,{baseline:middle}',
                    'text,F2: f2_1 (Max of F1 is f1),20,55,{baseline:middle}',
                    'text,f3,30,71,{baseline:middle}',
                    'text,f4,260,71,{baseline:middle}',
                    'text,Max: f3,30,87,{baseline:middle}',
                    'text,Max: f4,260,87,{baseline:middle}',
                    'text,F2: f2_2 (Max of F1 is f1),20,103,{baseline:middle}',
                    'text,f3,30,119,{baseline:middle}',
                    'text,f4,260,119,{baseline:middle}',
                    'text,Max: f3,30,135,{baseline:middle}',
                    'text,Max: f4,260,135,{baseline:middle}',
                    'text,Max: f3,20,151,{baseline:middle}',
                    'text,Max: f4,260,151,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,250,16',
                    'setLineWidth,1',
                    'rect,260,15,100,16',
            ...
            QUnit.test('[{f1, groupIndex: 0}, {f2, groupIndex: 1}, {f3, groupIndex: 2}, f4, f5], groupItems: [f1, {f5, alignByColumn, showInGroupFooter}]', function(assert) {
                ...
                const expectedLog = [
                    'text,F4,10,23,{baseline:middle}',
                    'text,F5,260,23,{baseline:middle}',
                    'text,F1: f1 (Max: f1),10,39,{baseline:middle}',
                    'text,F2: f2 (Max of F1 is f1),20,55,{baseline:middle}',
                    'text,F3: f3 (Max of F1 is f1),30,71,{baseline:middle}',
                    'text,f4,40,87,{baseline:middle}',
                    'text,f5,260,87,{baseline:middle}',
                    'text,Max: f5,260,103,{baseline:middle}',
                    'text,Max: f5,260,119,{baseline:middle}',
                    'text,Max: f5,260,135,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,250,16',
                    'setLineWidth,1',
                    'rect,260,15,100,16',
            ...
            QUnit.test('[{f1, groupIndex: 0}, {f2, groupIndex: 1}, {f3, groupIndex: 2}, f4, f5], groupItems: [f1, {f4, alignByColumn, showInGroupFooter}, {f5, alignByColumn, showInGroupFooter}]', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,f4,40,87,{baseline:middle}',
                    'text,f5,260,87,{baseline:middle}',
                    'text,Max: f4,40,103,{baseline:middle}',
                    'text,Max: f5,260,103,{baseline:middle}',
                    'text,Max: f4,30,119,{baseline:middle}',
                    'text,Max: f5,260,119,{baseline:middle}',
                    'text,Max: f4,20,135,{baseline:middle}',
                    'text,Max: f5,260,135,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,250,16',
                    'setLineWidth,1',
            ...
            QUnit.test('[{f1, groupIndex: 0}, {f2, groupIndex: 1}, {f3, groupIndex: 2}, f4, f5], groupItems: [f1, {f4, alignByColumn, showInGroupFooter}, {f5, alignByColumn, showInGroupFooter}], 2 groups', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,Max: f4,30,119,{baseline:middle}',
                    'text,Max: f5,260,119,{baseline:middle}',
                    'text,F2: f2_2 (Max of F1 is f1),20,135,{baseline:middle}',
                    'text,F3: f3 (Max of F1 is f1),30,151,{baseline:middle}',
                    'text,f4,40,167,{baseline:middle}',
                    'text,f5,260,167,{baseline:middle}',
                    'text,Max: f4,40,183,{baseline:middle}',
                    'text,Max: f5,260,183,{baseline:middle}',
                    'text,Max: f4,30,199,{baseline:middle}',
                    'text,Max: f5,260,199,{baseline:middle}',
                    'text,Max: f4,20,215,{baseline:middle}',
                    'text,Max: f5,260,215,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,250,16',
                    'setLineWidth,1',
                    'rect,260,15,100,16',
                    ...
                    'line,20,143,260,143',
                    'setLineWidth,1',
                    'line,260,127,360,127',
                    'line,360,127,360,143',
                    'line,260,143,360,143',
                    'setLineWidth,1',
                    'line,30,143,260,143',
                    'line,30,143,30,159',
                    'line,30,159,260,159',
                    'setLineWidth,1',
                    'line,260,143,360,143',
                    'line,360,143,360,159',
                    'line,260,159,360,159',
                    'setLineWidth,1',
                    'rect,40,159,220,16',
                    'setLineWidth,1',
                    'rect,260,159,100,16',
        ...
        QUnit.module('Total summaries', moduleConfig, () => {
            ...
            QUnit.test('[{f1, groupIndex: 0}, f2, f3], totalItems: [f2] - height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,f2,20,61,{baseline:middle}',
                    'text,f3,90,61,{baseline:middle}',
                    'text,Max: f2,10,79.4,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,80,18.4',
                    'setLineWidth,1',
                    'rect,90,15,90,18.4',
            ...
            QUnit.test('[{f1, groupIndex: 0}, f2, f3], groupItems: [{f2, alignByColumn, showInGroupFooter}], totalItems: [f2]', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,f2,20,55,{baseline:middle}',
                    'text,f3,90,55,{baseline:middle}',
                    'text,Max: f2,20,71,{baseline:middle}',
                    'text,Max: f2,10,87,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,80,16',
                    'setLineWidth,1',
                    'rect,90,15,90,16',
            ...
            QUnit.test('[{f1, groupIndex: 0}, f2, f3], groupItems: [{f2, alignByColumn, showInGroupFooter}], totalItems: [f2] - height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,Max: f2,10,97.8,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,80,18.4',
                    'setLineWidth,1',
                    'rect,90,15,90,18.4',
            ...
            QUnit.test('[{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4], totalItems: [f3]', function(assert) {
                ...
                const expectedLog = [
                    'text,F3,10,23,{baseline:middle}',
                    'text,F4,90,23,{baseline:middle}',
                    'text,F1: f1,10,39,{baseline:middle}',
                    'text,F2: f2,20,55,{baseline:middle}',
                    'text,f3,30,71,{baseline:middle}',
                    'text,f4,90,71,{baseline:middle}',
                    'text,Max: f3,10,87,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,80,16',
                    'setLineWidth,1',
                    'rect,90,15,90,16',
            ...
            QUnit.test('[{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4], totalItems: [f3] - height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,Max: f3,10,97.8,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,80,18.4',
                    'setLineWidth,1',
                    'rect,90,15,90,18.4',
                    ...
                    'line,90,51.8,180,51.8',
                    'setLineWidth,1',
                    'line,20,51.8,90,51.8',
                    'line,20,51.8,20,70.2',
                    'line,20,70.2,90,70.2',
                    'setLineWidth,1',
                    'line,90,51.8,180,51.8',
                    'line,180,51.8,180,70.2',
                    'line,90,70.2,180,70.2',
                    'setLineWidth,1',
            ...
            QUnit.test('[{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4], groupItems: [{f3, alignByColumn, showInGroupFooter}], totalItems: [f3]', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,Max: f3,30,87,{baseline:middle}',
                    'text,Max: f3,20,103,{baseline:middle}',
                    'text,Max: f3,10,119,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,80,16',
                    'setLineWidth,1',
                    'rect,90,15,90,16',
            ...
            QUnit.test('[{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4], totalItems: [f3], 2 groups', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,F4,90,23,{baseline:middle}',
                    'text,F1: f1,10,39,{baseline:middle}',
                    'text,F2: f2_1,20,55,{baseline:middle}',
                    'text,f3,30,71,{baseline:middle}',
                    'text,f4,90,71,{baseline:middle}',
                    'text,F2: f2_2,20,87,{baseline:middle}',
                    'text,f3,30,103,{baseline:middle}',
                    'text,f4,90,103,{baseline:middle}',
                    'text,Max: f3,10,119,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,80,16',
                    'setLineWidth,1',
            ...
            QUnit.test('[{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4], totalItems: [f3], 2 groups - height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,Max: f3,10,134.6,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,80,18.4',
                    'setLineWidth,1',
                    'rect,90,15,90,18.4',
                    ...
                    'rect,90,70.2,90,18.4',
                    'setLineWidth,1',
                    'line,20,88.6,90,88.6',
                    'line,20,88.6,20,107',
                    'line,20,107,90,107',
                    'setLineWidth,1',
                    'line,90,88.6,180,88.6',
            ...
            QUnit.test('[{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4], groupItems: [{f3, alignByColumn, showInGroupFooter}], totalItems: [f3], 2 groups', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,f4,90,71,{baseline:middle}',
                    'text,Max: f3,30,87,{baseline:middle}',
                    'text,F2: f2_2,20,103,{baseline:middle}',
                    'text,f3,30,119,{baseline:middle}',
                    'text,f4,90,119,{baseline:middle}',
                    'text,Max: f3,30,135,{baseline:middle}',
                    'text,Max: f3,20,151,{baseline:middle}',
                    'text,Max: f3,10,167,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,80,16',
                    'setLineWidth,1',
                    'rect,90,15,90,16',
            ...
            QUnit.test('[{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4], groupItems: [{f3, alignByColumn, showInGroupFooter}], totalItems: [f3], 2 groups - height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,Max: f3,10,189.8,{baseline:middle}',
                    'setLineWidth,1',
                    'rect,10,15,80,18.4',
                    'setLineWidth,1',
                    'rect,90,15,90,18.4',
                    ...
                    'setLineWidth,1',
                    'line,20,107,90,107',
                    'line,20,107,20,125.4',
                    'line,20,125.4,90,125.4',
                    'setLineWidth,1',
                    'line,90,107,180,107',
                    'line,180,107,180,125.4',
                    'line,90,125.4,180,125.4',
                    'setLineWidth,1',
