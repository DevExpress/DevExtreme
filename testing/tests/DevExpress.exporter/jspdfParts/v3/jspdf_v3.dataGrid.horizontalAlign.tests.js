        ...
        QUnit.module('Horizontal align', moduleConfig, () => {
            QUnit.test('1 col - 1 row. Font size default, horizontal align: undefined. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setTextColor,128',
                    'setFontSize,10',
                    'text,line 1,55.333,66.083,{baseline:middle,align:left}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
            ...
            QUnit.test('1 col - 1 row. Font size default, horizontal align: right. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setTextColor,128',
                    'setFontSize,10',
                    'text,line 1,244.667,66.083,{baseline:middle,align:right}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,200,22.167',
                    'setFontSize,16',
            ...
            QUnit.test('1 col - 1 row. Font size 20, horizontal align: left. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setTextColor,128',
                    'setFontSize,20',
                    'text,line 1,55.333,71.833,{baseline:middle,align:left}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
            ...
            QUnit.test('1 col - 1 row. Font size 20, horizontal align: right. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setTextColor,128',
                    'setFontSize,20',
                    'text,line 1,244.667,71.833,{baseline:middle,align:right}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,200,33.667',
                    'setFontSize,16',
            ...
            QUnit.test('1 col - 2 row. Font size default, horizontal align: left. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setFontSize,10',
                    'text,line 1\n' +
'long line 2,55.333,66.083,{baseline:middle,align:left}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,200,33.667',
                    'setFontSize,16',
...
'long line 2,150,66.083,{baseline:middle,align:center}',
            ...
            QUnit.test('1 col - 2 row. Font size default, horizontal align: right. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setFontSize,10',
                    'text,line 1\n' +
'long line 2,244.667,66.083,{baseline:middle,align:right}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,200,33.667',
                    'setFontSize,16',
...
'long line 2,244.667,66.083,{baseline:middle,align:right}',
            ...
            QUnit.test('1 col - 2 row. Font size 20, horizontal align: left. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setFontSize,20',
                    'text,line 1\n' +
'long line 2,55.333,71.833,{baseline:middle,align:left}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
...
'long line 2,150,71.833,{baseline:middle,align:center}',
            ...
            QUnit.test('1 col - 2 row. Font size 20, horizontal align: right. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setFontSize,20',
                    'text,line 1\n' +
'long line 2,244.667,71.833,{baseline:middle,align:right}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,200,56.667',
                    'setFontSize,16',
            ...
            QUnit.test('1 col - 3 row. Font size default, horizontal align: left. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,line 1\n' +
'long line 2\n' +
'very long line 3,55.333,66.083,{baseline:middle,align:left}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
...
'very long line 3,150,66.083,{baseline:middle,align:center}',
            ...
            QUnit.test('1 col - 3 row. Font size default, horizontal align: right. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,line 1\n' +
'long line 2\n' +
'very long line 3,244.667,66.083,{baseline:middle,align:right}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,200,45.167',
                    'setFontSize,16',
...
'very long line 3,244.667,66.083,{baseline:middle,align:right}',
            ...
            QUnit.test('1 col - 3 row. Font size 20, horizontal align: left. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,line 1\n' +
'long line 2\n' +
'very long line 3,55.333,71.833,{baseline:middle,align:left}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
...
'very long line 3,150,71.833,{baseline:middle,align:center}',
            ...
            QUnit.test('1 col - 3 row. Font size 20, horizontal align: right. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,line 1\n' +
'long line 2\n' +
'very long line 3,244.667,71.833,{baseline:middle,align:right}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,200,79.667',
                    'setFontSize,16',
        ...
        QUnit.module('Pass horizontal alignment settings from dxDataGrid', moduleConfig, () => {
            ...
            QUnit.test('1 col - 3 row. col.dataType: number, col.alignment: undefined, pdfCell.alignment: undefined, cellWidth = 200px', function(assert) {
                ...
                const expectedLog = [
                    'setTextColor,128',
                    'setFontSize,10',
                    'text,F1,244.667,66.083,{baseline:middle,align:right}',
                    'setTextColor,#000000',
                    'text,1,244.667,88.25,{baseline:middle,align:right}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,200,22.167',
                    'setLineWidth,0.6',
            ...
            QUnit.test('1 col - 3 row. col.dataType: number, col.alignment: center, pdfCell.alignment: left, Cell width = 200px', function(assert) {
                ...
                const expectedLog = [
                    'setTextColor,128',
                    'setFontSize,10',
                    'text,F1,55.333,66.083,{baseline:middle,align:left}',
                    'setTextColor,#000000',
                    'text,1,55.333,88.25,{baseline:middle,align:left}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,200,22.167',
                    'setLineWidth,0.6',
            ...
            QUnit.test('1 col - 3 row. col.dataType: string, col.alignment: undefined, pdfCell.alignment: undefined, cellWidth = 200px', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,F1,55.333,66.083,{baseline:middle,align:left}',
                    'setTextColor,#000000',
                    'text,f1_1,55.333,88.25,{baseline:middle,align:left}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,200,22.167',
                    'setLineWidth,0.6',
            ...
            QUnit.test('1 col - 3 row. col.dataType: string, col.alignment: center, pdfCell.alignment: right, cellWidth = 200px ', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,F1,244.667,66.083,{baseline:middle,align:right}',
                    'setTextColor,#000000',
                    'text,f1_1,244.667,88.25,{baseline:middle,align:right}',
                    'setLineWidth,0.6',
                    'setDrawColor,128',
                    'rect,50,55,200,22.167',
                    'setLineWidth,0.6',
