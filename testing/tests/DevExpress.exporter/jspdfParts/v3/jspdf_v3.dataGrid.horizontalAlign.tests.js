    ...
    runTests(moduleConfig, createMockPdfDoc, createDataGrid) {
        QUnit.module('Horizontal align', moduleConfig, () => {
            ...
            QUnit.test('1 col - 1 row. Font size default, horizontal align: undefined, rtlEnabled, Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'text,line 1,585.28,24.2,{baseline:middle,align:right}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,18.4'
                ];
            ...
            QUnit.test('1 col - 1 row. Font size default, horizontal align: left, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'text,line 1,385.28,24.2,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,18.4'
                ];
            ...
            QUnit.test('1 col - 1 row. Font size default, horizontal align: center, rtlEnabled, Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'text,line 1,485.28,24.2,{baseline:middle,align:center}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,18.4'
                ];
            ...
            QUnit.test('1 col - 1 row. Font size 10, horizontal align: undefined. Cell width = 200px ', function(assert) {
                const done = assert.async();
                const doc = createMockPdfDoc();
                doc.__logOptions.textOptions.hAlign = true;
            ...
            QUnit.test('1 col - 1 row. Font size 10, horizontal align: undefined, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setFontSize,10',
                    'text,line 1,585.28,20.75,{baseline:middle,align:right}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,11.5',
                    'setFontSize,16'
                ];
            ...
            QUnit.test('1 col - 1 row. Font size 10, horizontal align: left, rtlEnabled: true, Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setFontSize,10',
                    'text,line 1,385.28,20.75,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,11.5',
                    'setFontSize,16'
                ];
            ...
            QUnit.test('1 col - 1 row. Font size 10, horizontal align: center, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setFontSize,10',
                    'text,line 1,485.28,20.75,{baseline:middle,align:center}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,11.5',
                    'setFontSize,16'
                ];
            ...
            QUnit.test('1 col - 1 row. Font size 20, horizontal align: undefined. Cell width = 200px ', function(assert) {
                const done = assert.async();
                const doc = createMockPdfDoc();
                doc.__logOptions.textOptions.hAlign = true;
            ...
            QUnit.test('1 col - 1 row. Font size 20, horizontal align: undefined, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setFontSize,20',
                    'text,line 1,585.28,26.5,{baseline:middle,align:right}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,23',
                    'setFontSize,16'
                ];
            ...
            QUnit.test('1 col - 1 row. Font size 20, horizontal align: left, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setFontSize,20',
                    'text,line 1,385.28,26.5,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,23',
                    'setFontSize,16'
                ];
            ...
            QUnit.test('1 col - 1 row. Font size 20, horizontal align: center, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setFontSize,20',
                    'text,line 1,485.28,26.5,{baseline:middle,align:center}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,23',
                    'setFontSize,16'
                ];
            ...
            QUnit.test('1 col - 2 row. Font size default, horizontal align: undefined. Cell width = 200px ', function(assert) {
                const done = assert.async();
                const doc = createMockPdfDoc();
                doc.__logOptions.textOptions.hAlign = true;
            ...
            QUnit.test('1 col - 2 row. Font size default, horizontal align: undefined, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'text,line 1\nlong line 2,585.28,24.2,{baseline:middle,align:right}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,36.8'
                ];
            ...
            QUnit.test('1 col - 2 row. Font size default, horizontal align: left, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'text,line 1\nlong line 2,385.28,24.2,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,36.8'
                ];
            ...
            QUnit.test('1 col - 2 row. Font size default, horizontal align: center, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'text,line 1\nlong line 2,485.28,24.2,{baseline:middle,align:center}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,36.8'
                ];
            ...
            QUnit.test('1 col - 2 row. Font size 10, horizontal align: undefined. Cell width = 200px ', function(assert) {
                const done = assert.async();
                const doc = createMockPdfDoc();
                doc.__logOptions.textOptions.hAlign = true;
            ...
            QUnit.test('1 col - 2 row. Font size 10, horizontal align: undefined, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setFontSize,10',
                    'text,line 1\nlong line 2,585.28,20.75,{baseline:middle,align:right}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,23',
                    'setFontSize,16'
                ];
            ...
            QUnit.test('1 col - 2 row. Font size 10, horizontal align: left, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setFontSize,10',
                    'text,line 1\nlong line 2,385.28,20.75,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,23',
                    'setFontSize,16'
                ];
            ...
            QUnit.test('1 col - 2 row. Font size 10, horizontal align: center, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setFontSize,10',
                    'text,line 1\nlong line 2,485.28,20.75,{baseline:middle,align:center}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,23',
                    'setFontSize,16'
                ];
            ...
            QUnit.test('1 col - 2 row. Font size 20, horizontal align: undefined. Cell width = 200px ', function(assert) {
                const done = assert.async();
                const doc = createMockPdfDoc();
                doc.__logOptions.textOptions.hAlign = true;
            ...
            QUnit.test('1 col - 2 row. Font size 20, horizontal align: undefined, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setFontSize,20',
                    'text,line 1\nlong line 2,585.28,26.5,{baseline:middle,align:right}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,46',
                    'setFontSize,16'
                ];
            ...
            QUnit.test('1 col - 2 row. Font size 20, horizontal align: left, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setFontSize,20',
                    'text,line 1\nlong line 2,385.28,26.5,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,46',
                    'setFontSize,16'
                ];
            ...
            QUnit.test('1 col - 2 row. Font size 20, horizontal align: center, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setFontSize,20',
                    'text,line 1\nlong line 2,485.28,26.5,{baseline:middle,align:center}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,46',
                    'setFontSize,16'
                ];
            ...
            QUnit.test('1 col - 3 row. Font size default, horizontal align: undefined. Cell width = 200px ', function(assert) {
                const done = assert.async();
                const doc = createMockPdfDoc();
                doc.__logOptions.textOptions.hAlign = true;
            ...
            QUnit.test('1 col - 3 row. Font size default, horizontal align: undefined, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'text,line 1\nlong line 2\nvery long line 3,585.28,24.2,{baseline:middle,align:right}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,55.2'
                ];
            ...
            QUnit.test('1 col - 3 row. Font size default, horizontal align: left, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'text,line 1\nlong line 2\nvery long line 3,385.28,24.2,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,55.2'
                ];
            ...
            QUnit.test('1 col - 3 row. Font size default, horizontal align: center, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'text,line 1\nlong line 2\nvery long line 3,485.28,24.2,{baseline:middle,align:center}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,55.2'
                ];
            ...
            QUnit.test('1 col - 3 row. Font size 10, horizontal align: undefined. Cell width = 200px ', function(assert) {
                const done = assert.async();
                const doc = createMockPdfDoc();
                doc.__logOptions.textOptions.hAlign = true;
            ...
            QUnit.test('1 col - 3 row. Font size 10, horizontal align: undefined, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setFontSize,10',
                    'text,line 1\nlong line 2\nvery long line 3,585.28,20.75,{baseline:middle,align:right}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,34.5',
                    'setFontSize,16'
                ];
            ...
            QUnit.test('1 col - 3 row. Font size 10, horizontal align: left, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setFontSize,10',
                    'text,line 1\nlong line 2\nvery long line 3,385.28,20.75,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,34.5',
                    'setFontSize,16'
                ];
            ...
            QUnit.test('1 col - 3 row. Font size 10, horizontal align: center, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setFontSize,10',
                    'text,line 1\nlong line 2\nvery long line 3,485.28,20.75,{baseline:middle,align:center}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,34.5',
                    'setFontSize,16'
                ];
            ...
            QUnit.test('1 col - 3 row. Font size 20, horizontal align: undefined. Cell width = 200px ', function(assert) {
                const done = assert.async();
                const doc = createMockPdfDoc();
                doc.__logOptions.textOptions.hAlign = true;
            ...
            QUnit.test('1 col - 3 row. Font size 20, horizontal align: undefined, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setFontSize,20',
                    'text,line 1\nlong line 2\nvery long line 3,585.28,26.5,{baseline:middle,align:right}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,69',
                    'setFontSize,16'
                ];
            ...
            QUnit.test('1 col - 3 row. Font size 20, horizontal align: left, rtlEnabled, Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setFontSize,20',
                    'text,line 1\nlong line 2\nvery long line 3,385.28,26.5,{baseline:middle,align:left}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,69',
                    'setFontSize,16'
                ];
            ...
            QUnit.test('1 col - 3 row. Font size 20, horizontal align: center, rtlEnabled. Cell width = 200px ', function(assert) {
                ...
                const expectedLog = [
                    'setFontSize,20',
                    'text,line 1\nlong line 2\nvery long line 3,485.28,26.5,{baseline:middle,align:center}',
                    'setLineWidth,1',
                    'rect,385.28,15,200,69',
                    'setFontSize,16'
                ];
