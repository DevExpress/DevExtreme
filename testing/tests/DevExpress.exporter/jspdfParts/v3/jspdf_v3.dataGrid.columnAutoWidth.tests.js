    ...
    runTests(moduleConfig, createMockPdfDoc, createDataGrid) {
        QUnit.module('column auto width', moduleConfig, () => {
            ...
            QUnit.test('1 col. options.topLeft = 0, rtlEnabled', function(assert) {
                ...
                const expectedLog = [
                    'text,f1,595.28,24.2,{baseline:middle,align:right}',
                    'setLineWidth,1',
                    'rect,0,15,595.28,18.4'
                ];
            ...
            QUnit.test('2 cols - 2 rows, rtlEnabled', function(assert) {
                ...
                const expectedLog = [
                    'text,F1,585.28,24.2,{baseline:middle,align:right}',
                    'text,F2,292.64,24.2,{baseline:middle,align:right}',
                    'text,v1_1,585.28,42.6,{baseline:middle,align:right}',
                    'text,v2_1,292.64,42.6,{baseline:middle,align:right}',
                    'text,v1_2,585.28,61,{baseline:middle,align:right}',
                    'text,v2_2,292.64,61,{baseline:middle,align:right}',
                    'setLineWidth,1',
                    'rect,292.64,15,292.64,18.4',
                    'setLineWidth,1',
                    'rect,0,15,292.64,18.4',
                    'setLineWidth,1',
                    'rect,292.64,33.4,292.64,18.4',
                    'setLineWidth,1',
                    'rect,0,33.4,292.64,18.4',
                    'setLineWidth,1',
                    'rect,292.64,51.8,292.64,18.4',
                    'setLineWidth,1',
                    'rect,0,51.8,292.64,18.4'
                ];
                exportDataGrid(doc, dataGrid, { topLeft: { x: 10, y: 15 } }).then(() => {
                    // doc.save(assert.test.testName + '.pdf');
                    assert.deepEqual(doc.__log, expectedLog);
            ...
            QUnit.test('2 cols - 2 rows, col1.width = 100, col2.width = 200, rtlEnabled', function(assert) {
                ...
                const expectedLog = [
                    'text,F1,585.28,24.2,{baseline:middle,align:right}',
                    'text,F2,485.28,24.2,{baseline:middle,align:right}',
                    'text,v1_1,585.28,42.6,{baseline:middle,align:right}',
                    'text,v2_1,485.28,42.6,{baseline:middle,align:right}',
                    'text,v1_2,585.28,61,{baseline:middle,align:right}',
                    'text,v2_2,485.28,61,{baseline:middle,align:right}',
                    'setLineWidth,1',
                    'rect,485.28,15,100,18.4',
                    'setLineWidth,1',
                    'rect,285.28,15,200,18.4',
                    'setLineWidth,1',
                    'rect,485.28,33.4,100,18.4',
                    'setLineWidth,1',
                    'rect,285.28,33.4,200,18.4',
                    'setLineWidth,1',
                    'rect,485.28,51.8,100,18.4',
                    'setLineWidth,1',
                    'rect,285.28,51.8,200,18.4'
                ];
                exportDataGrid(doc, dataGrid, { topLeft: { x: 10, y: 15 } }).then(() => {
                    // doc.save(assert.test.testName + '.pdf');
                    assert.deepEqual(doc.__log, expectedLog);
            ...
            QUnit.test('2 cols - 2 rows, col1.width = 100, col2.width = undefined, rtlEnabled', function(assert) {
                ...
                const expectedLog = [
                    'text,F1,585.28,24.2,{baseline:middle,align:right}',
                    'text,F2,526.752,24.2,{baseline:middle,align:right}',
                    'text,v1_1,585.28,42.6,{baseline:middle,align:right}',
                    'text,v2_1,526.752,42.6,{baseline:middle,align:right}',
                    'text,v1_2,585.28,61,{baseline:middle,align:right}',
                    'text,v2_2,526.752,61,{baseline:middle,align:right}',
                    'setLineWidth,1',
                    'rect,526.752,15,58.528,18.4',
                    'setLineWidth,1',
                    'rect,0,15,526.752,18.4',
                    'setLineWidth,1',
                    'rect,526.752,33.4,58.528,18.4',
                    'setLineWidth,1',
                    'rect,0,33.4,526.752,18.4',
                    'setLineWidth,1',
                    'rect,526.752,51.8,58.528,18.4',
                    'setLineWidth,1',
                    'rect,0,51.8,526.752,18.4'
                ];
                exportDataGrid(doc, dataGrid, { topLeft: { x: 10, y: 15 } }).then(() => {
                    // doc.save(assert.test.testName + '.pdf');
                    assert.deepEqual(doc.__log, expectedLog);
            ...
            QUnit.test('2 cols - 2 rows, col1.width = undefined, col2.width = 200, rtlEnabled', function(assert) {
                ...
                const expectedLog = [
                    'text,F1,585.28,24.2,{baseline:middle,align:right}',
                    'text,F2,117.056,24.2,{baseline:middle,align:right}',
                    'text,v1_1,585.28,42.6,{baseline:middle,align:right}',
                    'text,v2_1,117.056,42.6,{baseline:middle,align:right}',
                    'text,v1_2,585.28,61,{baseline:middle,align:right}',
                    'text,v2_2,117.056,61,{baseline:middle,align:right}',
                    'setLineWidth,1',
                    'rect,117.056,15,468.224,18.4',
                    'setLineWidth,1',
                    'rect,0,15,117.056,18.4',
                    'setLineWidth,1',
                    'rect,117.056,33.4,468.224,18.4',
                    'setLineWidth,1',
                    'rect,0,33.4,117.056,18.4',
                    'setLineWidth,1',
                    'rect,117.056,51.8,468.224,18.4',
                    'setLineWidth,1',
                    'rect,0,51.8,117.056,18.4'
                ];
                exportDataGrid(doc, dataGrid, { topLeft: { x: 10, y: 15 } }).then(() => {
                    // doc.save(assert.test.testName + '.pdf');
                    assert.deepEqual(doc.__log, expectedLog);
        ...
        QUnit.module('column auto width with wordWrap and Bands', moduleConfig, () => {
            ...
            QUnit.test('[band1-[f1]], rtleEnabled', function(assert) {
                ...
                const expectedLog = [
                    'text,Band1 line1 line 2,595.28,24.2,{baseline:middle,align:right}',
                    'text,F1,595.28,42.6,{baseline:middle,align:right}',
                    'text,f1_1 long line very long line,595.28,61,{baseline:middle,align:right}',
                    'setLineWidth,1',
                    'rect,0,15,595.28,18.4',
                    'setLineWidth,1',
                    'rect,0,33.4,595.28,18.4',
            ...
            QUnit.test('[band1-[f1, f2, f3]], rtlEnabled', function(assert) {
                const done = assert.async();
                const doc = createMockPdfDoc();
            ...
            QUnit.test('[f1, band-[band-[f3,f4]]], short text, rtlEnabled', function(assert) {
                ...
                const expectedLog = [
                    'text,line1\nline2\nline3\nline4\nline5\nline6\nline7\nline8\nline9,595.28,24.2,{baseline:middle,align:right}',
                    'text,Band1 line,396.853,30.333,{baseline:middle,align:right}',
                    'text,Band1_2,396.853,79.4,{baseline:middle,align:right}',
                    'text,line1\nline2\nline3\nline4\nline5\nline6,198.427,67.133,{baseline:middle,align:right}',
                    'text,f3,396.853,146.867,{baseline:middle,align:right}',
                    'text,f1_1,595.28,189.8,{baseline:middle,align:right}',
                    'text,f3_1,396.853,189.8,{baseline:middle,align:right}',
                    'text,f4_1,198.427,189.8,{baseline:middle,align:right}',
                    'setLineWidth,1',
                    'rect,396.853,15,198.427,165.6',
                    'setLineWidth,1',
                    'rect,0,15,396.853,30.667',
                    'setLineWidth,1',
                    'rect,198.427,45.667,198.427,67.467',
                    'setLineWidth,1',
                    'rect,0,45.667,198.427,134.933',
                    'setLineWidth,1',
                    'rect,198.427,113.133,198.427,67.467',
                    'setLineWidth,1',
                    'rect,396.853,180.6,198.427,18.4',
            ...
            QUnit.test('[f1, band-[band-[f3,f4]]], long text, rtlEnabled', function(assert) {
                ...
                const expectedLog = [
                    'text,line1\nline2\nline3\nline4\nline5\nline6\nline7\nline8\nline9,595.28,24.2,{baseline:middle,align:right}',
                    'text,Band1 line,396.853,24.2,{baseline:middle,align:right}',
                    'text,Band1_2,396.853,70.2,{baseline:middle,align:right}',
                    'text,line1\nline2\nline3\nline4\nline5\nline6\nline7\nline8,198.427,42.6,{baseline:middle,align:right}',
                    'text,f3,396.853,143.8,{baseline:middle,align:right}',
                    'text,f1_1,595.28,189.8,{baseline:middle,align:right}',
                    'text,f3_1,396.853,189.8,{baseline:middle,align:right}',
                    'text,f4_1,198.427,189.8,{baseline:middle,align:right}',
                    'setLineWidth,1',
                    'rect,396.853,15,198.427,165.6',
                    'setLineWidth,1',
                    'rect,0,15,396.853,18.4',
                    'setLineWidth,1',
                    'rect,198.427,33.4,198.427,73.6',
                    'setLineWidth,1',
                    'rect,0,33.4,198.427,147.2',
                    'setLineWidth,1',
                    'rect,198.427,107,198.427,73.6',
                    'setLineWidth,1',
                    'rect,396.853,180.6,198.427,18.4',
            ...
            QUnit.test('[f1, band-[band-[band-[f3],f4]]], short text, rtlEnabled', function(assert) {
                ...
                const expectedLog = [
                    'text,line1\nline2\nline3\nline4\nline5\nline6\nline7\nline8\nline9,595.28,33.4,{baseline:middle,align:right}',
                    'text,Band1 line,396.853,24.2,{baseline:middle,align:right}',
                    'text,Band1_2,396.853,51.8,{baseline:middle,align:right}',
                    'text,line1\nline2\nline3\nline4\nline5\nline6\nline7\nline8\nline9,198.427,42.6,{baseline:middle,align:right}',
                    'text,f1_2_3,396.853,88.6,{baseline:middle,align:right}',
                    'text,line1\nline2\nline3\nline4,396.853,125.4,{baseline:middle,align:right}',
                    'text,f1_1,595.28,208.2,{baseline:middle,align:right}',
                    'text,f3_1_1,396.853,208.2,{baseline:middle,align:right}',
                    'text,f4_1,198.427,208.2,{baseline:middle,align:right}',
                    'setLineWidth,1',
                    'rect,396.853,15,198.427,184',
                    'setLineWidth,1',
                    'rect,0,15,396.853,18.4',
                    'setLineWidth,1',
                    'rect,198.427,33.4,198.427,36.8',
                    'setLineWidth,1',
                    'rect,0,33.4,198.427,165.6',
                    'setLineWidth,1',
                    'rect,198.427,70.2,198.427,36.8',
                    'setLineWidth,1',
                    'rect,198.427,107,198.427,92',
            ...
            QUnit.test('[f1, band-[band-[band-[f3],f4]]], long text, rtlEnabled', function(assert) {
                ...
                const expectedLog = [
                    'text,line1\nline2\nline3\nline4\nline5\nline6\nline7\nline8\nline9,595.28,33.4,{baseline:middle,align:right}',
                    'text,Band1 line,396.853,24.2,{baseline:middle,align:right}',
                    'text,Band1_2,396.853,45.667,{baseline:middle,align:right}',
                    'text,line1\nline2\nline3\nline4\nline5\nline6\nline7\nline8\nline9,198.427,42.6,{baseline:middle,align:right}',
                    'text,f1_2_3,396.853,70.2,{baseline:middle,align:right}',
                    'text,line1\nline2\nline3\nline4\nline5\nline6,396.853,94.733,{baseline:middle,align:right}',
                    'text,f1_1,595.28,208.2,{baseline:middle,align:right}',
                    'text,f3_1_1,396.853,208.2,{baseline:middle,align:right}',
                    'text,f4_1,198.427,208.2,{baseline:middle,align:right}',
                    'setLineWidth,1',
