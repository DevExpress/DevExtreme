...
QUnit.module('Table', moduleConfig, () => {
    ...
    QUnit.test('1 col', function(assert) {
        ...
        const expectedLog = [
            'setTextColor,128',
            'setFontSize,10',
            'text,f1,55.333,65,{baseline:middle}',
            'setLineWidth,0.6',
            'setDrawColor,128',
            'rect,50,55,100,20',
            'setFontSize,16',
    ...
    QUnit.test('1 col - 1 row', function(assert) {
        ...
        const expectedLog = [
            ...
            'text,F1,55.333,65,{baseline:middle}',
            'setTextColor,#000000',
            'text,v1,55.333,87,{baseline:middle}',
            'setLineWidth,0.6',
            'setDrawColor,128',
            'rect,50,55,100,20',
            'setLineWidth,0.6',
    ...
    QUnit.test('1 col - 1 row - height auto', function(assert) {
        ...
        const expectedLog = [
            ...
            'text,F1,55.333,66.083,{baseline:middle}',
            'setTextColor,#000000',
            'text,v1,55.333,88.25,{baseline:middle}',
            'setLineWidth,0.6',
            'setDrawColor,128',
            'rect,50,55,100,22.167',
            'setLineWidth,0.6',
    ...
    QUnit.test('1 col - 2 rows', function(assert) {
        ...
        const expectedLog = [
            ...
            'setTextColor,#000000',
            'text,v1_1,55.333,81,{baseline:middle}',
            'text,v1_2,55.333,103,{baseline:middle}',
            'setLineWidth,0.6',
            'setDrawColor,128',
            'rect,50,55,100,16',
            'setLineWidth,0.6',
    ...
    QUnit.test('2 cols', function(assert) {
        ...
        const expectedLog = [
            ...
            'text,f1,55.333,63,{baseline:middle}',
            'setTextColor,128',
            'text,f2,95.333,63,{baseline:middle}',
            'setLineWidth,0.6',
            'setDrawColor,128',
            'rect,50,55,40,16',
            'setLineWidth,0.6',
    ...
    QUnit.test('2 cols - height auto', function(assert) {
        ...
        const expectedLog = [
            ...
            'text,f1,55.333,66.083,{baseline:middle}',
            'setTextColor,128',
            'text,f2,95.333,66.083,{baseline:middle}',
            'setLineWidth,0.6',
            'setDrawColor,128',
            'rect,50,55,40,22.167',
            'setLineWidth,0.6',
            'setDrawColor,128',
            'rect,90,55,60,22.167',
            'setFontSize,16',
            'setDrawColor,#000000',
            'setTextColor,#000000'
        ];
    ...
    QUnit.test('2 cols - 1 row', function(assert) {
        ...
        const expectedLog = [
            ...
            'text,F2,95.333,63,{baseline:middle}',
            'setTextColor,#000000',
            'text,v1,55.333,81,{baseline:middle}',
            'text,v2,95.333,81,{baseline:middle}',
            'setLineWidth,0.6',
            'setDrawColor,128',
            'rect,50,55,40,16',
            'setLineWidth,0.6',
    ...
    QUnit.test('2 cols - 1 row - height auto', function(assert) {
        ...
        const expectedLog = [
            ...
            'setTextColor,#000000',
            'text,v1,55.333,88.25,{baseline:middle}',
            'text,v2,95.333,88.25,{baseline:middle}',
            'setLineWidth,0.6',
            'setDrawColor,128',
            'rect,50,55,40,22.167',
            'setLineWidth,0.6',
            ...
            'setLineWidth,0.6',
            'setDrawColor,128',
            'rect,50,77.167,40,22.167',
            'setLineWidth,0.6',
            'setDrawColor,128',
            'rect,90,77.167,60,22.167',
            'setFontSize,16',
            'setDrawColor,#000000'
        ];
        exportDataGrid(doc, dataGrid, { topLeft: { x: 10, y: 15 }, columnWidths: [ 40, 60 ], onRowExporting: () => {} }).then(() => {
    ...
    QUnit.test('2 cols - 2 rows', function(assert) {
        ...
        const expectedLog = [
            ...
            'setTextColor,#000000',
            'text,v1_1,55.333,81,{baseline:middle}',
            'text,v2_1,95.333,81,{baseline:middle}',
            'text,v1_2,55.333,103,{baseline:middle}',
            'text,v2_2,95.333,103,{baseline:middle}',
            'setLineWidth,0.6',
            'setDrawColor,128',
            'rect,50,55,40,16',
            'setLineWidth,0.6',
    ...
    QUnit.test('2 cols - 2 rows - height auto', function(assert) {
        ...
        const expectedLog = [
            ...
            'setTextColor,#000000',
            'text,v1_1,55.333,88.25,{baseline:middle}',
            'text,v2_1,95.333,88.25,{baseline:middle}',
            'text,v1_2,55.333,110.417,{baseline:middle}',
            'text,v2_2,95.333,110.417,{baseline:middle}',
            'setLineWidth,0.6',
            'setDrawColor,128',
            'rect,50,55,40,22.167',
            'setLineWidth,0.6',
            ...
            'setLineWidth,0.6',
            'setDrawColor,128',
            'rect,50,99.333,40,22.167',
            'setLineWidth,0.6',
            'setDrawColor,128',
            'rect,90,99.333,60,22.167',
            'setFontSize,16',
            'setDrawColor,#000000'
        ];
        exportDataGrid(doc, dataGrid, { topLeft: { x: 10, y: 15 }, columnWidths: [ 40, 60 ], onRowExporting: () => {} }).then(() => {
    ...
    QUnit.test('2 cols - 2 rows - column[0] width is zero', function(assert) {
        ...
        const expectedLog = [
            ...
            'setTextColor,#000000',
            'text,v1_1,55.333,81,{baseline:middle}',
            'text,v2_1,55.333,81,{baseline:middle}',
            'text,v1_2,55.333,103,{baseline:middle}',
            'text,v2_2,55.333,103,{baseline:middle}',
            'setLineWidth,0.6',
            'setDrawColor,128',
            'rect,50,55,0,16',
            'setLineWidth,0.6',
    ...
    QUnit.test('3 cols - 2 rows - hide left border of [1,1] cell', function(assert) {
        ...
        const expectedLog = [
            ...
            'text,F2,95.333,63,{baseline:middle}',
            'setTextColor,128',
            'text,F3,145.333,63,{baseline:middle}',
            'setTextColor,#000000',
            'text,v1_1,55.333,81,{baseline:middle}',
            'text,v2_1,95.333,81,{baseline:middle}',
            'text,v3_1,145.333,81,{baseline:middle}',
            'text,v1_2,55.333,103,{baseline:middle}',
            'text,v2_2,95.333,103,{baseline:middle}',
            'text,v3_2,145.333,103,{baseline:middle}',
            'setLineWidth,0.6',
            'setDrawColor,128',
            'rect,50,55,40,16',
            'setLineWidth,0.6',
