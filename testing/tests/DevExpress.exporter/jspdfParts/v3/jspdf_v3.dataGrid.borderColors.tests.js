        ...
        QUnit.module('Styles - Border color', moduleConfig, () => {
            ...
            QUnit.test('Simple - [{f1, f2] - Custom border HEX color for one header cell', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setTextColor,128',
                    'text,F3,226.667,66.083,',
                    'setTextColor,#000000',
                    'text,f1_1,56.667,88.25,',
                    'text,f1_2,146.667,88.25,',
                    'text,f1_3,226.667,88.25,',
            ...
            QUnit.test('Simple - [{f1, f2, f3] - Custom border color for center cell', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,f1_2,146.667,88.25,',
                    'text,f1_3,226.667,88.25,',
                    'text,f2_1,56.667,110.417,',
                    'text,f2_2,146.667,110.417,',
                    'text,f2_3,226.667,110.417,',
                    'setLineWidth,0.6666666666666666',
                    'setDrawColor,128',
                    'rect,50,55,90,22.167',
                    'setLineWidth,0.6666666666666666',
            ...
            QUnit.test('Grouped rows - 1 level - [{f1, groupIndex: 0}, f2, f3] - custom border color in grouped row', function(assert) {
                ...
                const expectedLog = [
                    'setTextColor,128',
                    'setFontSize,10',
                    'text,F2,56.667,66.083,',
                    'setTextColor,128',
                    'text,F3,146.667,66.083,',
                    'setTextColor,#000000',
                    'setFont,helvetica,bold,',
                    'text,F1: f1_1,56.667,88.25,',
                    'setFont,helvetica,normal,',
                    'text,f1_2,56.667,110.417,',
                    'text,f1_3,146.667,110.417,',
                    'setFont,helvetica,bold,',
                    'text,F1: f2_1,56.667,132.583,',
                    'setFont,helvetica,normal,',
                    'text,f2_2,56.667,154.75,',
                    'text,f2_3,146.667,154.75,',
                    'setLineWidth,0.6666666666666666',
                    'setDrawColor,128',
                    'rect,50,55,90,22.167',
                    'setLineWidth,0.6666666666666666',
            ...
            QUnit.test('Grouped rows - 2 level - [{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4] - custom border color in grouped row - different colors for group levels', function(assert) {
                ...
                const expectedLog = [
                    'setTextColor,128',
                    'setFontSize,10',
                    'text,F3,56.667,66.083,',
                    'setTextColor,128',
                    'text,F4,146.667,66.083,',
                    'setTextColor,#000000',
                    'setFont,helvetica,bold,',
                    'text,F1: f1,56.667,88.25,',
                    'text,F2: f1_2,56.667,110.417,',
                    'setFont,helvetica,normal,',
                    'text,f1_3,56.667,132.583,',
                    'text,f1_4,146.667,132.583,',
                    'setFont,helvetica,bold,',
                    'text,F2: f2_2,56.667,154.75,',
                    'setFont,helvetica,normal,',
                    'text,f2_3,56.667,176.917,',
                    'text,f2_4,146.667,176.917,',
                    'setLineWidth,0.6666666666666666',
                    'setDrawColor,128',
                    'rect,50,55,90,22.167',
                    'setLineWidth,0.6666666666666666',
            ...
            QUnit.test('Group summaries - 1 level - [{f1, groupIndex: 0}, f2, f3, f4], groupItems: [{f4, alignByColumn, showInGroupFooter}] - custom border color in group footer row', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,F2,56.667,66.083,',
                    'setTextColor,128',
                    'text,F3,136.667,66.083,',
                    'setTextColor,128',
                    'text,F4,226.667,66.083,',
                    'setTextColor,#000000',
                    'setFont,helvetica,bold,',
                    'text,F1: f1,56.667,88.25,',
                    'setFont,helvetica,normal,',
                    'text,f2,56.667,110.417,',
                    'text,f3,136.667,110.417,',
                    'text,f4,226.667,110.417,',
                    'setFontSize,16',
                    'text,Max: f4,226.667,136.033,',
                    'setLineWidth,0.6666666666666666',
                    'setDrawColor,128',
            ...
            QUnit.test('Group summaries - 2 level - [{f1, groupIndex: 0}, {f2, groupIndex: 1}, f3, f4], groupItems: [f1, {f4, alignByColumn, showInGroupFooter}] - custom border color in group footer row - different colors for group levels', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,F3,56.667,66.083,',
                    'setTextColor,128',
                    'text,F4,306.667,66.083,',
                    'setTextColor,#000000',
                    'setFont,helvetica,bold,',
                    'text,F1: f1 (Max: f1),56.667,88.25,',
                    'text,F2: f2 (Max of F1 is f1),56.667,110.417,',
                    'setFont,helvetica,normal,',
                    'text,f3,56.667,132.583,',
                    'text,f4,306.667,132.583,',
                    'setFontSize,16',
                    'text,Max: f4,306.667,158.2,',
                    'text,Max: f4,306.667,187.267,',
                    'setLineWidth,0.6666666666666666',
                    'setDrawColor,128',
            ...
            QUnit.test('Total summaries - [f1, f2], totalItems: [f1] - custom color in summary row', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,F1,56.667,66.083,',
                    'setTextColor,128',
                    'text,F2,136.667,66.083,',
                    'setTextColor,#000000',
                    'text,f1,56.667,88.25,',
                    'text,f2,136.667,88.25,',
                    'setFontSize,16',
                    'text,Max: f1,56.667,113.867,',
                    'setLineWidth,0.6666666666666666',
                    'setDrawColor,128',
                    'rect,50,55,80,22.167',
                    'setLineWidth,0.6666666666666666',
                    ...
                    'setLineWidth,0.6666666666666666',
                    'setDrawColor,#dddd00',
                    'rect,50,99.333,80,29.067',
                    'setLineWidth,0.6666666666666666',
                    'rect,130,99.333,90,29.067',
                    'setDrawColor,#000000'
                ];
            ...
            QUnit.test('[band1-[f1, f2]] - custom color for BAND cell', function(assert) {
                ...
                const expectedLog = [
                    'setTextColor,128',
                    'setFontSize,10',
                    'text,Band1,56.667,66.083,',
                    'setTextColor,128',
                    'text,F1,56.667,88.25,',
                    'setTextColor,128',
                    'text,F2,126.667,88.25,',
                    'setTextColor,#000000',
                    'text,f1_1,56.667,110.417,',
                    'text,f2_1,126.667,110.417,',
                    'setLineWidth,0.6666666666666666',
                    'setDrawColor,#ffff00',
            ...
            QUnit.test('[band1-[band1_1-[f1], f2]] - custom color for BAND cell', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,Band1,56.667,66.083,',
                    'setTextColor,128',
                    'text,Band1_1,56.667,88.25,',
                    'setTextColor,128',
                    'text,F2,126.667,99.333,',
                    'setTextColor,128',
                    'text,F1,56.667,110.417,',
                    'setTextColor,#000000',
                    'text,f1_1_1,56.667,132.583,',
                    'text,f2_1,126.667,132.583,',
                    'setLineWidth,0.6666666666666666',
                    'setDrawColor,221,221,0',
            ...
            QUnit.test('[band1-[f1, band1_2-[f2]]] - custom color for BAND cell', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'text,Band1,56.667,66.083,',
                    'setTextColor,128',
                    'text,F1,56.667,99.333,',
                    'setTextColor,128',
                    'text,Band1_2,116.667,88.25,',
                    'setTextColor,128',
                    'text,F2,116.667,110.417,',
                    'setTextColor,#000000',
                    'text,f1_1,56.667,132.583,',
                    'text,f2_1_1,116.667,132.583,',
                    'setLineWidth,0.6666666666666666',
                    'setDrawColor,221,221,0',
