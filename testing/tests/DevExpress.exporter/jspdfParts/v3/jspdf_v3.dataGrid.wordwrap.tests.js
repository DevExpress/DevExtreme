...
'long text,55,65.75,{baseline:middle}',
            ...
            QUnit.test('1 col - 2 text lines. fontSize 20', function(assert) {
                ...
                const expectedLog = [
                    'setTextColor,#979797',
                    'setFontSize,20',
                    'text,long...,55,85,{baseline:middle}',
                    'setLineWidth,0.5',
                    'setDrawColor,#979797',
                    'rect,50,55,100,60',
                    'setFontSize,16',
...
'long line,55,73.5,{baseline:middle}',
            ...
            QUnit.test('1 col - 2 text lines. fontSize 20, height auto', function(assert) {
                ...
                const expectedLog = [
                    'setTextColor,#979797',
                    'setFontSize,20',
                    'text,long...,55,71.5,{baseline:middle}',
                    'setLineWidth,0.5',
                    'setDrawColor,#979797',
                    'rect,50,55,100,33',
                    'setFontSize,16',
...
'long line,55,65.75,{baseline:middle}',
            ...
            QUnit.test('1 col - 3 text lines. fontSize 20', function(assert) {
                ...
                const expectedLog = [
                    'setTextColor,#979797',
                    'setFontSize,20',
                    'text,long...,55,95,{baseline:middle}',
                    'setLineWidth,0.5',
                    'setDrawColor,#979797',
                    'rect,50,55,100,80',
                    'setFontSize,16',
...
'long line,55,71.5,{baseline:middle}',
            ...
            QUnit.test('2 col - 1 text line. col1.fontSize 20, col2.fontSize 30', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setTextColor,#979797',
                    'setFontSize,30',
                    'text,big...,155,85,{baseline:middle}',
                    'setLineWidth,0.5',
                    'setDrawColor,#979797',
                    'rect,50,55,100,60',
                    'setDrawColor,#979797',
...
'line,155,67.75,{baseline:middle}',
            ...
            QUnit.test('2 col - 1 text line. col1.fontSize 20, col2.fontSize 30, height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setTextColor,#979797',
                    'setFontSize,30',
                    'text,big...,155,77.25,{baseline:middle}',
                    'setLineWidth,0.5',
                    'setDrawColor,#979797',
                    'rect,50,55,100,44.5',
                    'setDrawColor,#979797',
...
'line,155,77.25,{baseline:middle}',
            ...
            QUnit.test('2 col - 2 text lines. col1.fontSize default, col2.fontSize: 20', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setTextColor,#979797',
                    'setFontSize,20',
                    'text,long...,155,85,{baseline:middle}',
                    'setLineWidth,0.5',
                    'setDrawColor,#979797',
                    'rect,50,55,100,60',
                    'setDrawColor,#979797',
...
'long line,155,73.5,{baseline:middle}',
            ...
            QUnit.test('2 col - 2 text lines. col1.fontSize default, col2.fontSize: 20, height auto', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setTextColor,#979797',
                    'setFontSize,20',
                    'text,long...,155,71.5,{baseline:middle}',
                    'setLineWidth,0.5',
                    'setDrawColor,#979797',
                    'rect,50,55,100,33',
                    'setDrawColor,#979797',
...
'line,155,33.25,{baseline:middle}',
            ...
            QUnit.test('2 col - 2 text lines. col1.fontSize 20 col2.fontSize: 30, height auto', function(assert) {
                ...
                const expectedLog = [
                    'setTextColor,#979797',
                    'setFontSize,20',
                    'text,long...,55,77.25,{baseline:middle}',
                    'setTextColor,#979797',
                    'setFontSize,30',
                    'text,big...,155,77.25,{baseline:middle}',
                    'setLineWidth,0.5',
...
'line,155,77.25,{baseline:middle}',
            ...
            QUnit.test('2 col - 3 text lines. col1.fontSize default, col2.fontSize: 20', function(assert) {
                ...
                const expectedLog = [
                    ...
                    'setTextColor,#979797',
                    'setFontSize,20',
                    'text,long...,155,95,{baseline:middle}',
                    'setLineWidth,0.5',
                    'setDrawColor,#979797',
                    'rect,50,55,100,80',
                    'setDrawColor,#979797',
...
'long line,155,71.5,{baseline:middle}',
            ...
            QUnit.test('2 col - 3 text lines. col1.fontSize 20, col2.fontSize: 30', function(assert) {
                ...
                const expectedLog = [
                    'setTextColor,#979797',
                    'setFontSize,20',
                    'text,long...,55,100,{baseline:middle}',
                    'setTextColor,#979797',
                    'setFontSize,30',
                    'text,big...,155,100,{baseline:middle}',
                    'setLineWidth,0.5',
                    'setDrawColor,#979797',
                    'rect,50,55,100,90',
                    'setDrawColor,#979797',
...
'long line,55,71.5,{baseline:middle}',
                    'setTextColor,#979797',
                    'setFontSize,30',
                    'text,big...,155,94.5,{baseline:middle}',
                    'setLineWidth,0.5',
                    'setDrawColor,#979797',
                    'rect,50,55,100,79',
                    'setDrawColor,#979797',
...
'long line,55,71.5,{baseline:middle}',
                    'setTextColor,#979797',
                    'setFontSize,30',
                    'text,big...,150,94.5,{baseline:middle}',
                    'setLineWidth,0.5',
                    'setDrawColor,#979797',
                    'rect,50,55,100,79',
                    'setDrawColor,#979797',
