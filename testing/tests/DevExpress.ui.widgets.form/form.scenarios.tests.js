...
[true, false].forEach(alignItemLabels => {
    [true, false].forEach(alignItemLabelsInAllGroups => {
        QUnit.module(`Items layout and labels alignment. alignItemLabels: ${alignItemLabels}, alignItemLabelsInAllGroups: ${alignItemLabelsInAllGroups}`, () => {
            ...
            testChromeOnly('1 column-> [group.alignItemLabels: false [text, longText]]', function() {
                const wrapper = new FormLayoutTestWrapper(1, { alignItemLabels, alignItemLabelsInAllGroups }, [
                    { itemType: 'group', alignItemLabels: false, items: ['text', 'longText'] }]);
                test_1Column_2Items_NotAlignedLabels(wrapper);
            });

            testChromeOnly('1 column-> [group.alignItemLabels: true [text, longText]]', function() {
                const wrapper = new FormLayoutTestWrapper(1, { alignItemLabels, alignItemLabelsInAllGroups }, [
            ...
            testChromeOnly('2 column-> group.colCount:2.alignItemLabels:false  [a, abc, text, longText ]', function(assert) {
                const wrapper = new FormLayoutTestWrapper(1, { alignItemLabels, alignItemLabelsInAllGroups }, [{
            ...
            testChromeOnly('2 column-> group.colCount:2.alignItemLabels:true  [a, abc, text, longText ]', function(assert) {
                const wrapper = new FormLayoutTestWrapper(1, { alignItemLabels, alignItemLabelsInAllGroups }, [{
            ...
            testChromeOnly('3 column -> group.colCount:3.alignItemLabels:false [a, abc, text, longText ]', function(assert) {
                const wrapper = new FormLayoutTestWrapper(1, { alignItemLabels, alignItemLabelsInAllGroups }, [{
            ...
            testChromeOnly('3 column -> group.colCount:3.alignItemLabels:true [a, abc, text, longText ]', function(assert) {
                const wrapper = new FormLayoutTestWrapper(1, { alignItemLabels, alignItemLabelsInAllGroups }, [{
