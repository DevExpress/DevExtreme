...
QUnit.test("tags should be recalculated after separateTagLimit option changed", function(assert) {
    var $tagBox = $("#tagBox").dxTagBox({
            items: [1, 2, 3, 4],
            value: [1, 2, 4]
        }),
