...
QUnit.test("dropButton rendered correctly when dataSource is async", function(assert) {
    var $dropDownList = $("#dropDownList").dxDropDownList({
        dataSource: {
            load: function() {
                var deferred = $.Deferred();
    ...
    assert.ok($dropDownList.find(".dx-dropdowneditor-button").length, "dropButton rendered");
});
