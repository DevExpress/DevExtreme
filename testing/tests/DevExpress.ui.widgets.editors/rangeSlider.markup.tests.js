...
QUnit.module('hidden inputs', () => {
    QUnit.test('two inputs should be rendered', function(assert) {
        const $element = $('#slider').dxRangeSlider(), $inputs = $element.find('input');
    ...
    QUnit.test('first input gets correct value after widget the \'start\' option change', function(assert) {
        const expectedStart = 33, $element = $('#slider').dxRangeSlider(), instance = $element.dxRangeSlider('instance'), $input = $element.find('input').eq(0);
    ...
    QUnit.test('second input gets correct value after widget the \'end\' option change', function(assert) {
        const expectedEnd = 88, $element = $('#slider').dxRangeSlider(), instance = $element.dxRangeSlider('instance'), $input = $element.find('input').eq(1);
