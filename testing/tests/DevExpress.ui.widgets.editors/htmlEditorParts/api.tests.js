...
QUnit.module("API", moduleConfig, () => {
    ...
    test("format", (assert) => {
        ...
        assert.equal(this.instance.option("value"), "<p>T<strong>es</strong>t 1<br/>Test 2<br/>Test 3</p>", "format applied");
    });

    test("formatText", (assert) => {
        const expected = "<h1>T<strong>est 1</strong></h1><p><strong>Tes</strong>t 2<br/>Test 3</p>";
    ...
    test("formatLine", (assert) => {
        ...
        assert.equal(this.instance.option("value"), "<h1>Test 1<br/>Test 2</h1><p>Test 3</p>", "just block format applied");
    });
    ...
    test("removeFormat", (assert) => {
        ...
        assert.equal(this.instance.option("value"), "<p><strong>T</strong>es<strong>t Test</strong></p>", "remove format from specific range");
    });
    ...
    test("insertText", (assert) => {
        ...
        assert.equal(this.instance.option("value"), "<p>Tonees<em>two</em>t 1<br/>Test 2<br/>Test 3</p>", "insert simple and formatted text");
    });
    ...
    test("undo/redo", (assert) => {
        ...
        assert.equal(this.instance.option("value"), "<p>baTest 1<br/>Test 2<br/>Test 3</p>", "undo operation");

        this.instance.redo();
        assert.equal(this.instance.option("value"), "<p>cbaTest 1<br/>Test 2<br/>Test 3</p>", "redo operation");
    });
