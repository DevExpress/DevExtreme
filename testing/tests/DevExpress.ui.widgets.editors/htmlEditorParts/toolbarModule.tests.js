...
// TODO: const BOX_ITEM_CONTENT_CLASS = 'dx-box-item-content';
...
testModule('Toolbar dialogs', dialogModuleConfig, () => {
    test('show color dialog', function(assert) {
        ...
        // TODO: const $boxItemContent = $colorView.closest(`.${BOX_ITEM_CONTENT_CLASS}`);
        ...
        // TODO: assert.strictEqual($boxItemContent.css('flexBasis'), 'auto', 'Box item content flex-basis is \'auto\'');
