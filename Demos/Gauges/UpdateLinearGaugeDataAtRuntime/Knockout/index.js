window.onload = function () {
  const temperature = ko.observable(cities[0].data.temperature);
  const humidity = ko.observable(cities[0].data.humidity);
  const pressure = ko.observable(cities[0].data.pressure);
