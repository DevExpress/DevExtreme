      ...
      <div className="form">
        ...
        <div className="dx-fieldset">
          ...
          <div className="dx-field">
            ...
            <TextBox className="dx-field-value" value="424 N Main St." />
          </div>
          <div className="dx-field">
            <div className="dx-field-label">City</div>
            <TextBox className="dx-field-value" value="San Diego" />
          </div>
        </div>
        <div className="dx-fieldset" id="notes-container">
          ...
          <div className="dx-field">
            ...
            <TextArea className="dx-field-value" height={80} value="Kevin is our hard-working shipping manager and has been helping that department work like clockwork for 18 months. When not in the office, he is usually on the basketball court playing pick-up games." />
          </div>
        </div>
      </div>
    );
