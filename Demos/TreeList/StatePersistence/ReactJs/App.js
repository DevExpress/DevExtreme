  ...
  return (
    <div>
      <div id="descContainer">
        ...
        <a onClick={reloadPage}>refresh</a> the web page to see that the grid’s state is
        automatically persisted to continue working from where you stopped or you can{' '}
        <a onClick={onStateResetClick}>reset</a> the grid to its initial state.
      </div>
      <TreeList
        id="employees"
        ref={treeList}
