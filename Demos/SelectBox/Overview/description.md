The [SelectBox](/Documentation/ApiReference/UI_Widgets/dxSelectBox/) widget allows users to select an item from a drop-down list. This demo illustrates the following  **SelectBox** options:
