...
function App() {
  ...
  const changeArgumentPosition = React.useCallback((e) => {
    setArgumentCustomPosition(e.value);
  }, [setArgumentCustomPosition]);

  const changeArgumentOffset = React.useCallback((e) => {
    setArgumentOffset(e.value);
  }, [setArgumentOffset]);

  const changeValuePosition = React.useCallback((e) => {
    setValueCustomPosition(e.value);
  }, [setValueCustomPosition]);

  const changeValueOffset = React.useCallback((e) => {
