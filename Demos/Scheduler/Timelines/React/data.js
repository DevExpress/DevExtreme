...
export const data = [{
  ...
  ownerId: [4],
  'startDate': new Date('2021-05-01T10:15:00.000Z'),
  'endDate': new Date('2021-05-01T13:15:00.000Z'),
  priority: 1
}, {
  'text': 'Website Re-Design Plan',
  ownerId: [3],
  'startDate': new Date('2021-05-01T13:45:00.000Z'),
  'endDate': new Date('2021-05-02T08:15:00.000Z'),
  priority: 2
}, {
  ...
  ownerId: [2],
  'startDate': new Date('2021-05-02T09:00:00.000Z'),
  'endDate': new Date('2021-05-02T10:45:00.000Z'),
  priority: 1
}, {
  ...
  ownerId: [1],
  'startDate': new Date('2021-05-03T08:45:00.000Z'),
  'endDate': new Date('2021-05-03T10:45:00.000Z'),
  priority: 2
}, {
  'text': 'Update Employee Files with New NDA',
  ownerId: [2],
  'startDate': new Date('2021-05-03T11:00:00.000Z'),
  'endDate': new Date('2021-05-03T13:45:00.000Z'),
  priority: 1
}, {
  ...
  ownerId: [2],
  'startDate': new Date('2021-05-04T09:45:00.000Z'),
  'endDate': new Date('2021-05-04T11:00:00.000Z'),
  priority: 1
}, {
  ...
  ownerId: [3],
  'startDate': new Date('2021-05-05T09:45:00.000Z'),
  'endDate': new Date('2021-05-05T11:15:00.000Z'),
  priority: 2
}, {
  'text': 'Review Changes to Health Insurance Coverage',
  ownerId: [2],
  'startDate': new Date('2021-05-05T11:15:00.000Z'),
  'endDate': new Date('2021-05-05T12:30:00.000Z'),
  priority: 1
}, {
  'text': 'Review Training Course for any Ommissions',
  ownerId: [2],
  'startDate': new Date('2021-05-08T11:00:00.000Z'),
  'endDate': new Date('2021-05-09T09:00:00.000Z'),
  priority: 2
}, {
  'text': 'Recall Rebate Form',
  ownerId: [1],
  'startDate': new Date('2021-05-08T09:45:00.000Z'),
  'endDate': new Date('2021-05-08T10:15:00.000Z'),
  priority: 1
}, {
  ...
  ownerId: [4],
  'startDate': new Date('2021-05-10T09:30:00.000Z'),
  'endDate': new Date('2021-05-10T10:30:00.000Z'),
  priority: 1
}, {
  'text': 'Provide Feedback on Shippers',
  ownerId: [2],
  'startDate': new Date('2021-05-10T11:15:00.000Z'),
  'endDate': new Date('2021-05-10T13:00:00.000Z'),
  priority: 2
}, {
  'text': 'Select Preferred Shipper',
  ownerId: [1],
  'startDate': new Date('2021-05-10T14:30:00.000Z'),
  'endDate': new Date('2021-05-10T17:00:00.000Z'),
  priority: 1
}, {
  'text': 'Complete Shipper Selection Form',
  ownerId: [2],
  'startDate': new Date('2021-05-11T05:30:00.000Z'),
  'endDate': new Date('2021-05-11T07:00:00.000Z'),
  priority: 2
}, {
  ...
  ownerId: [1],
  'startDate': new Date('2021-05-12T11:45:00.000Z'),
  'endDate': new Date('2021-05-12T13:30:00.000Z'),
  priority: 1
}, {
  'text': 'Report on Tranistion to Touch-Based Apps',
  ownerId: [2],
  'startDate': new Date('2021-05-12T15:30:00.000Z'),
  ...
  ownerId: [4],
  'startDate': new Date('2021-05-15T08:30:00.000Z'),
  'endDate': new Date('2021-05-15T10:15:00.000Z'),
  priority: 1
}, {
  ...
  ownerId: [3],
  'startDate': new Date('2021-05-16T09:00:00.000Z'),
  'endDate': new Date('2021-05-16T12:15:00.000Z'),
  priority: 1
}, {
  ...
  ownerId: [2],
  'startDate': new Date('2021-05-18T14:00:00.000Z'),
  'endDate': new Date('2021-05-18T17:00:00.000Z'),
  priority: 1
}, {
  'text': 'Review New Training Material',
  ownerId: [3],
  'startDate': new Date('2021-05-19T05:00:00.000Z'),
  'endDate': new Date('2021-05-19T06:15:00.000Z'),
  priority: 2
}, {
  ...
  ownerId: [2],
  'startDate': new Date('2021-05-19T11:15:00.000Z'),
  'endDate': new Date('2021-05-19T13:15:00.000Z'),
  priority: 1
}, {
  'text': 'Approval on Converting to New HDMI Specification',
  ownerId: [4],
  'startDate': new Date('2021-05-22T06:30:00.000Z'),
  'endDate': new Date('2021-05-22T07:15:00.000Z'),
  priority: 2
}, {
  'text': 'Create New Spike for Automation Server',
  ownerId: [3],
  'startDate': new Date('2021-05-22T07:00:00.000Z'),
  'endDate': new Date('2021-05-22T09:30:00.000Z'),
  priority: 2
}, {
  'text': 'Code Review - New Automation Server',
  ownerId: [1],
  'startDate': new Date('2021-05-22T10:00:00.000Z'),
  'endDate': new Date('2021-05-22T12:00:00.000Z'),
  priority: 1
}, {
  ...
  ownerId: [2],
  'startDate': new Date('2021-05-23T13:15:00.000Z'),
  'endDate': new Date('2021-05-23T15:00:00.000Z'),
  priority: 2
}, {
  'text': 'Send 2 Remotes for Giveaways',
  ownerId: [3],
  'startDate': new Date('2021-05-24T06:30:00.000Z'),
  'endDate': new Date('2021-05-24T08:45:00.000Z'),
  priority: 1
}, {
  'text': 'Discuss Product Giveaways with Management',
  ownerId: [1],
  'startDate': new Date('2021-05-24T09:15:00.000Z'),
  'endDate': new Date('2021-05-24T13:45:00.000Z'),
  priority: 2
}, {
  ...
  ownerId: [1],
  'startDate': new Date('2021-05-25T11:45:00.000Z'),
  'endDate': new Date('2021-05-25T12:30:00.000Z'),
  priority: 2
}, {
  ...
  ownerId: [4],
  'startDate': new Date('2021-05-26T13:15:00.000Z'),
  'endDate': new Date('2021-05-26T16:30:00.000Z'),
  priority: 2
}];
